...
public partial class PCM {
    /// <summary>
    /// mtUserLevelPermission
    /// </summary>
    [MaybeNull]
    public static MtUserLevelPermission mtUserLevelPermission
    {
        get => HttpData.Resolve<MtUserLevelPermission>("MTUserLevelPermission");
        set => HttpData["MTUserLevelPermission"] = value;
    }

    /// <summary>
    /// Table class for MTUserLevelPermission
    /// </summary>
    public class MtUserLevelPermission : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtUserLevelPermission()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTUserLevelPermission";
            Name = "MTUserLevelPermission";
            Type = "TABLE";
            UpdateTable = "dbo.MTUserLevelPermission"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            UserLevelID = new (this, "x_UserLevelID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTUserLevelPermission", "UserLevelID", "CustomMsg"),
                IsUpload = false
            };
            UserLevelID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("UserLevelID", "MTUserLevel", false, "UserLevelID", new List<string> {"UserLevelName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[UserLevelName]"),
                "id-ID" => new Lookup<DbField>("UserLevelID", "MTUserLevel", false, "UserLevelID", new List<string> {"UserLevelName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[UserLevelName]"),
                _ => new Lookup<DbField>("UserLevelID", "MTUserLevel", false, "UserLevelID", new List<string> {"UserLevelName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[UserLevelName]")
            };
            ...
            _TableName = new (this, "x__TableName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTUserLevelPermission", "_TableName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Permission = new (this, "x_Permission", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTUserLevelPermission", "Permission", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTUserLevelPermission";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "MtUserLevelPermissionList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "MtUserLevelPermissionView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtUserLevelPermissionEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtUserLevelPermissionAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtUserLevelPermissionView",
                Config.ApiAddAction => "MtUserLevelPermissionAdd",
                Config.ApiEditAction => "MtUserLevelPermissionEdit",
                Config.ApiDeleteAction => "MtUserLevelPermissionDelete",
                Config.ApiListAction => "MtUserLevelPermissionList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtUserLevelPermissionList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtUserLevelPermissionView", parm);
            else
                url = KeyUrl("MtUserLevelPermissionView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtUserLevelPermissionAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtUserLevelPermissionAdd?" + parm;
            else
                url = "MtUserLevelPermissionAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtUserLevelPermissionEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtUserLevelPermissionList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtUserLevelPermissionAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtUserLevelPermissionList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtUserLevelPermissionDelete")); // DN
        ...
        {
            string pageName = "MtUserLevelPermissionList";
