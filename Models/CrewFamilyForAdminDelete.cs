...
public partial class PCM {
    /// <summary>
    /// crewFamilyForAdminDelete
    /// </summary>
    public static CrewFamilyForAdminDelete crewFamilyForAdminDelete
    {
        get => HttpData.Get<CrewFamilyForAdminDelete>("crewFamilyForAdminDelete")!;
        set => HttpData["crewFamilyForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewFamilyForAdmin
    /// </summary>
    public class CrewFamilyForAdminDelete : CrewFamilyForAdminDeleteBase
    {
        // Constructor
        public CrewFamilyForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFamilyForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFamilyForAdminDeleteBase : CrewFamilyForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFamilyForAdminDelete";
        ...
        // Constructor
        public CrewFamilyForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewFamilyForAdminDelete";
        ...
        // Constructor
        public CrewFamilyForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewFamilyForAdminList"); // Prevent SQL injection, return to List page
            ...
            using (Recordset = await Connection.OpenDataReaderAsync(sql)) {
                if (Recordset != null) {
                    ...
                    if (!res)
                        return Terminate("CrewFamilyForAdminList"); // Return to List page
                }
            }
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewFamilyForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFamilyForAdminDelete?.PageRender();
            }
            return PageResult();
        }
