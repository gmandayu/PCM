...
public partial class PCM {
    ...
    /// mtRankSearch
    /// </summary>
    public static MtRankSearch mtRankSearch
    {
        get => HttpData.Get<MtRankSearch>("mtRankSearch")!;
        set => HttpData["mtRankSearch"] = value;
    }

    /// <summary>
    /// Page class for MTRank
    /// </summary>
    public class MtRankSearch : MtRankSearchBase
    {
        // Constructor
        public MtRankSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRankSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRankSearchBase : MtRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRankSearch";
        ...
        // Page name
        public string PageName => "MtRankSearch";
        ...
        // Constructor
        public MtRankSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
