...
public partial class PCM {
    ...
    /// mtCertificateSearch
    /// </summary>
    public static MtCertificateSearch mtCertificateSearch
    {
        get => HttpData.Get<MtCertificateSearch>("mtCertificateSearch")!;
        set => HttpData["mtCertificateSearch"] = value;
    }

    /// <summary>
    /// Page class for MTCertificate
    /// </summary>
    public class MtCertificateSearch : MtCertificateSearchBase
    {
        // Constructor
        public MtCertificateSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateSearchBase : MtCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateSearch";
        ...
        // Constructor
        public MtCertificateSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCertificateSearch";
        ...
        // Constructor
        public MtCertificateSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtCertificateList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCertificateSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string BuildAdvancedSearch() {
            string srchUrl = "";
            BuildSearchUrl(ref srchUrl, CategoryName); // CategoryName
        ...
        protected void LoadSearchValues() {
            // CategoryName
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_CategoryName"))
                    CategoryName.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_CategoryName");
            if (Form.ContainsKey("z_CategoryName"))
                CategoryName.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_CategoryName");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!CategoryName.Raw)
                    CategoryName.AdvancedSearch.SearchValue = HtmlDecode(CategoryName.AdvancedSearch.SearchValue);
                CategoryName.EditValue = HtmlEncode(CategoryName.AdvancedSearch.SearchValue);
