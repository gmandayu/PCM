...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtCountry mtCountry
    {
        get => HttpData.Resolve<MtCountry>("MTCountry");
        set => HttpData["MTCountry"] = value;
    }

    /// <summary>
    /// Table class for MTCountry
    /// </summary>
    public class MtCountry : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Nationality;

        public readonly DbField<SqlDbType> CallingCode;
        ...
        public MtCountry()
        {
            ...
            Name = "MTCountry";
            Type = "TABLE";
            UpdateTable = "dbo.MTCountry"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCountry", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            _Name = new (this, "x__Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCountry", "_Name", "CustomMsg"),
                IsUpload = false
            };
            _Name.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Name", "MTCountry", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Name", "MTCountry", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Name", "MTCountry", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Name", _Name);

            // Nationality
            Nationality = new (this, "x_Nationality", 202, SqlDbType.NVarChar) {
                Name = "Nationality",
                Expression = "[Nationality]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Nationality]",
                DateTimeFormat = -1,
                VirtualExpression = "[Nationality]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("MTCountry", "Nationality", "CustomMsg"),
                IsUpload = false
            };
            Nationality.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Nationality", "MTCountry", true, "Nationality", new List<string> {"Nationality", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Nationality", "MTCountry", true, "Nationality", new List<string> {"Nationality", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Nationality", "MTCountry", true, "Nationality", new List<string> {"Nationality", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Nationality", Nationality);

            // CallingCode
            CallingCode = new (this, "x_CallingCode", 202, SqlDbType.NVarChar) {
                Name = "CallingCode",
                Expression = "[CallingCode]",
                UseBasicSearch = true,
                BasicSearchExpression = "[CallingCode]",
                DateTimeFormat = -1,
                VirtualExpression = "[CallingCode]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCountry", "CallingCode", "CustomMsg"),
                IsUpload = false
            };
            CallingCode.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CallingCode", "MTCountry", true, "CallingCode", new List<string> {"CallingCode", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CallingCode", "MTCountry", true, "CallingCode", new List<string> {"CallingCode", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CallingCode", "MTCountry", true, "CallingCode", new List<string> {"CallingCode", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("CallingCode", CallingCode);
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCountry", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCountry", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("MTCountry", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCountry", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCountry", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCountry", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCountry", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCountry", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCountry", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCountry", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCountry", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Nationality.DbValue = row["Nationality"]; // Set DB value only
                CallingCode.DbValue = row["CallingCode"]; // Set DB value only
        ...
        {
            if (SameString(pageName, "MtCountryView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCountryEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCountryAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCountryView",
                Config.ApiAddAction => "MtCountryAdd",
                Config.ApiEditAction => "MtCountryEdit",
                Config.ApiDeleteAction => "MtCountryDelete",
                Config.ApiListAction => "MtCountryList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCountryList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCountryView", parm);
            else
                url = KeyUrl("MtCountryView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCountryAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCountryEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCountryList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCountryAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCountryList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCountryDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            Nationality.SetDbValue(dr["Nationality"]);
            CallingCode.SetDbValue(dr["CallingCode"]);
        ...
        public async Task RenderEditRow()
        {
            ...
            // Nationality
            Nationality.SetupEditAttributes();
            if (!Nationality.Raw)
                Nationality.CurrentValue = HtmlDecode(Nationality.CurrentValue);
            Nationality.EditValue = HtmlEncode(Nationality.CurrentValue);
            Nationality.PlaceHolder = RemoveHtml(Nationality.Caption);

            // CallingCode
            CallingCode.SetupEditAttributes();
            if (!CallingCode.Raw)
                CallingCode.CurrentValue = HtmlDecode(CallingCode.CurrentValue);
            CallingCode.EditValue = HtmlEncode(CallingCode.CurrentValue);
            CallingCode.PlaceHolder = RemoveHtml(CallingCode.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Nationality);
                        doc.ExportCaption(CallingCode);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Nationality);
                            await doc.ExportField(CallingCode);
