...
public partial class PCM {
    ...
    /// mtDocumentAdd
    /// </summary>
    public static MtDocumentAdd mtDocumentAdd
    {
        get => HttpData.Get<MtDocumentAdd>("mtDocumentAdd")!;
        set => HttpData["mtDocumentAdd"] = value;
    }

    /// <summary>
    /// Page class for MTDocument
    /// </summary>
    public class MtDocumentAdd : MtDocumentAddBase
    {
        // Constructor
        public MtDocumentAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtDocumentAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtDocumentAddBase : MtDocument
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtDocumentAdd";
        ...
        // Page name
        public string PageName => "MtDocumentAdd";
        ...
        // Constructor
        public MtDocumentAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtDocumentList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtDocumentList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtDocumentView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtDocumentList") {
                                ...
                                returnUrl = "MtDocumentList"; // Return list page content
                            }
                        }
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            if (!Empty(_Type.CurrentValue)) { // Check field with unique index
                var filter = "(Type = '" + AdjustSql(_Type.CurrentValue, DbId) + "')";
                using var rschk = await LoadReader(filter);
                if (rschk?.HasRows ?? false) { // DN
                    FailureMessage = Language.Phrase("DupIndex").Replace("%f", _Type.Caption).Replace("%v", ConvertToString(_Type.CurrentValue));
                    return JsonBoolResult.FalseResult;
                }
            }
