...
public partial class PCM {
    /// <summary>
    /// crewCertificateForAdminEdit
    /// </summary>
    public static CrewCertificateForAdminEdit crewCertificateForAdminEdit
    {
        get => HttpData.Get<CrewCertificateForAdminEdit>("crewCertificateForAdminEdit")!;
        set => HttpData["crewCertificateForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewCertificateForAdmin
    /// </summary>
    public class CrewCertificateForAdminEdit : CrewCertificateForAdminEditBase
    {
        // Constructor
        public CrewCertificateForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewCertificateForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewCertificateForAdminAdd?crewID=" + ConvertToString(lastUpdatedCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewCertificateForAdminEditBase : CrewCertificateForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewCertificateForAdminEdit";
        ...
        // Constructor
        public CrewCertificateForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewCertificateForAdminEdit";
        ...
        // Constructor
        public CrewCertificateForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewCertificateForAdminList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewCertificateForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
