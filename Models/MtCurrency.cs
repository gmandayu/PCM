...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtCurrency mtCurrency
    {
        get => HttpData.Resolve<MtCurrency>("MTCurrency");
        set => HttpData["MTCurrency"] = value;
    }

    /// <summary>
    /// Table class for MTCurrency
    /// </summary>
    public class MtCurrency : DbTable, IQueryFactory
    {
        ...
        public MtCurrency()
        {
            ...
            Name = "MTCurrency";
            Type = "TABLE";
            UpdateTable = "dbo.MTCurrency"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCurrency", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            _Name = new (this, "x__Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCurrency", "_Name", "CustomMsg"),
                IsUpload = false
            };
            _Name.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Name", "MTCurrency", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Name", "MTCurrency", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Name", "MTCurrency", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Name", _Name);

            // Code
            Code = new (this, "x_Code", 130, SqlDbType.NChar) {
                Name = "Code",
                Expression = "[Code]",
                UseBasicSearch = true,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("MTCurrency", "Code", "CustomMsg"),
                IsUpload = false
            };
            Code.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Code", "MTCurrency", true, "Code", new List<string> {"Code", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Code", "MTCurrency", true, "Code", new List<string> {"Code", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Code", "MTCurrency", true, "Code", new List<string> {"Code", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Code.GetServerValidateArguments = () => @"^[A-Z]{3}$";
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCurrency", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCurrency", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("MTCurrency", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCurrency", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCurrency", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCurrency", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCurrency", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCurrency", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCurrency", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCurrency", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCurrency", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            if (SameString(pageName, "MtCurrencyView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCurrencyEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCurrencyAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCurrencyView",
                Config.ApiAddAction => "MtCurrencyAdd",
                Config.ApiEditAction => "MtCurrencyEdit",
                Config.ApiDeleteAction => "MtCurrencyDelete",
                Config.ApiListAction => "MtCurrencyList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCurrencyList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCurrencyView", parm);
            else
                url = KeyUrl("MtCurrencyView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCurrencyAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCurrencyEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCurrencyList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCurrencyAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCurrencyList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCurrencyDelete")); // DN
        ...
        {
            string pageName = "MtCurrencyList";
