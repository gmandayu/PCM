...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static NotificationForCrew notificationForCrew
    {
        get => HttpData.Resolve<NotificationForCrew>("NotificationForCrew");
        set => HttpData["NotificationForCrew"] = value;
    }

    /// <summary>
    /// Table class for NotificationForCrew
    /// </summary>
    public class NotificationForCrew : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> MarkAsRead;

        // Constructor
        public NotificationForCrew()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "NotificationForCrew";
            Name = "NotificationForCrew";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("NotificationForCrew", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("NotificationForCrew", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Subject = new (this, "x_Subject", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("NotificationForCrew", "Subject", "CustomMsg"),
                IsUpload = false
            };
            ...
            Body = new (this, "x_Body", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("NotificationForCrew", "Body", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("NotificationForCrew", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("CreatedDateTime", CreatedDateTime);

            // MarkAsRead
            MarkAsRead = new (this, "x_MarkAsRead", 11, SqlDbType.Bit) {
                Name = "MarkAsRead",
                Expression = "dbo.TRNotification.MarkAsRead",
                BasicSearchExpression = "dbo.TRNotification.MarkAsRead",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.TRNotification.MarkAsRead",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("NotificationForCrew", "MarkAsRead", "CustomMsg"),
                IsUpload = false
            };
            MarkAsRead.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MarkAsRead", "NotificationForCrew", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MarkAsRead", "NotificationForCrew", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MarkAsRead", "NotificationForCrew", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("MarkAsRead", MarkAsRead);
        ...
        public string SqlSelect { // Select
            get => _sqlSelect ?? "SELECT dbo.TRNotification.ID, dbo.TRNotification.MTUserID, dbo.TRNotification.Subject, dbo.TRNotification.Body, dbo.TRNotification.CreatedDateTime, dbo.TRNotification.MarkAsRead FROM " + SqlFrom;
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                MarkAsRead.DbValue = (ConvertToBool(row["MarkAsRead"]) ? "1" : "0"); // Set DB value only
            } catch {}
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "NotificationForCrewList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "NotificationForCrewView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "NotificationForCrewEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "NotificationForCrewAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "NotificationForCrewView",
                Config.ApiAddAction => "NotificationForCrewAdd",
                Config.ApiEditAction => "NotificationForCrewEdit",
                Config.ApiDeleteAction => "NotificationForCrewDelete",
                Config.ApiListAction => "NotificationForCrewList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "NotificationForCrewList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("NotificationForCrewView", parm);
            else
                url = KeyUrl("NotificationForCrewView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "NotificationForCrewAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "NotificationForCrewAdd?" + parm;
            else
                url = "NotificationForCrewAdd";
        ...
        {
            string url = "";
            url = KeyUrl("NotificationForCrewEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("NotificationForCrewList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("NotificationForCrewAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("NotificationForCrewList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("NotificationForCrewDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            MarkAsRead.SetDbValue(ConvertToBool(dr["MarkAsRead"]) ? "1" : "0");
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "NotificationForCrewList";
        ...
        public async Task RenderListRow()
        {
            ...
            // MarkAsRead
            MarkAsRead.CellCssStyle = "white-space: nowrap;";
            ...
            // Body
            Body.ViewValue = ConvertToString(Body.CurrentValue); // DN
            ...
            // MarkAsRead
            if (ConvertToBool(MarkAsRead.CurrentValue)) {
                MarkAsRead.ViewValue = MarkAsRead.TagCaption(1) != "" ? MarkAsRead.TagCaption(1) : "Yes";
            } else {
                MarkAsRead.ViewValue = MarkAsRead.TagCaption(2) != "" ? MarkAsRead.TagCaption(2) : "No";
            }
            MarkAsRead.ViewCustomAttributes = "";
            ...
            // MarkAsRead
            MarkAsRead.HrefValue = "";
            MarkAsRead.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!Body.Raw)
                Body.CurrentValue = HtmlDecode(Body.CurrentValue);
            Body.EditValue = HtmlEncode(Body.CurrentValue);
            ...
            // MarkAsRead
            MarkAsRead.EditValue = MarkAsRead.Options(false);
            MarkAsRead.PlaceHolder = RemoveHtml(MarkAsRead.Caption);
        ...
        public void RecordsetSelecting(ref string filter) {
            ...
            AddFilter(ref filter, "MTUserID IS NULL", "OR");
        }
