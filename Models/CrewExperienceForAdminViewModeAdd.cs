...
public partial class PCM {
    /// <summary>
    /// crewExperienceForAdminViewModeAdd
    /// </summary>
    public static CrewExperienceForAdminViewModeAdd crewExperienceForAdminViewModeAdd
    {
        get => HttpData.Get<CrewExperienceForAdminViewModeAdd>("crewExperienceForAdminViewModeAdd")!;
        set => HttpData["crewExperienceForAdminViewModeAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewExperienceForAdminViewMode
    /// </summary>
    public class CrewExperienceForAdminViewModeAdd : CrewExperienceForAdminViewModeAddBase
    {
        // Constructor
        public CrewExperienceForAdminViewModeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewExperienceForAdminViewModeAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewExperienceForAdminViewModeList?crewID=" + ConvertToString(lastAddedExperienceCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewExperienceForAdminViewModeAddBase : CrewExperienceForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewExperienceForAdminViewModeAdd";
        ...
        // Constructor
        public CrewExperienceForAdminViewModeAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewExperienceForAdminViewModeAdd";
        ...
        // Constructor
        public CrewExperienceForAdminViewModeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewExperienceForAdminViewModeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "CrewExperienceForAdminViewModeList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "CrewExperienceForAdminViewModeView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewExperienceForAdminViewModeList") {
                                ...
                                returnUrl = "CrewExperienceForAdminViewModeList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewExperienceForAdminViewModeAdd?.PageRender();
            }
            return PageResult();
        }
