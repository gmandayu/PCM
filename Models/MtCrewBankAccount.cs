...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtCrewBankAccount mtCrewBankAccount
    {
        get => HttpData.Resolve<MtCrewBankAccount>("MTCrewBankAccount");
        set => HttpData["MTCrewBankAccount"] = value;
    }

    /// <summary>
    /// Table class for MTCrewBankAccount
    /// </summary>
    public class MtCrewBankAccount : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtCrewBankAccount()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTCrewBankAccount";
            Name = "MTCrewBankAccount";
            Type = "TABLE";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTBankID = new (this, "x_MTBankID", 3, SqlDbType.Int) {
                Name = "MTBankID",
                Expression = "[MTBankID]",
                BasicSearchExpression = "CAST([MTBankID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[MTBankID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "MTBankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            OtherBankName = new (this, "x_OtherBankName", 202, SqlDbType.NVarChar) {
                Name = "OtherBankName",
                Expression = "[OtherBankName]",
                UseBasicSearch = true,
                BasicSearchExpression = "[OtherBankName]",
                DateTimeFormat = -1,
                VirtualExpression = "[OtherBankName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "OtherBankName", "CustomMsg"),
                IsUpload = false
            };
            ...
            AccountNumber = new (this, "x_AccountNumber", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "AccountNumber", "CustomMsg"),
                IsUpload = false
            };
            AccountNumber.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("AccountNumber", "MTCrewBankAccount", true, "AccountNumber", new List<string> {"AccountNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("AccountNumber", "MTCrewBankAccount", true, "AccountNumber", new List<string> {"AccountNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("AccountNumber", "MTCrewBankAccount", true, "AccountNumber", new List<string> {"AccountNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Beneficiary = new (this, "x_Beneficiary", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[Beneficiary]",
                DateTimeFormat = -1,
                VirtualExpression = "[Beneficiary]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "Beneficiary", "CustomMsg"),
                IsUpload = false
            };
            Beneficiary.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Beneficiary", "MTCrewBankAccount", true, "Beneficiary", new List<string> {"Beneficiary", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Beneficiary", "MTCrewBankAccount", true, "Beneficiary", new List<string> {"Beneficiary", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
            ...
            MTCurrencyID = new (this, "x_MTCurrencyID", 3, SqlDbType.Int) {
                Name = "MTCurrencyID",
                Expression = "[MTCurrencyID]",
                BasicSearchExpression = "CAST([MTCurrencyID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[MTCurrencyID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "MTCurrencyID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MainAcc = new (this, "x_MainAcc", 11, SqlDbType.Bit) {
                Name = "MainAcc",
                Expression = "[MainAcc]",
                BasicSearchExpression = "[MainAcc]",
                DateTimeFormat = -1,
                VirtualExpression = "[MainAcc]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "MainAcc", "CustomMsg"),
                IsUpload = false
            };
            MainAcc.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MainAcc", "MTCrewBankAccount", true, "MainAcc", new List<string> {"MainAcc", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MainAcc", "MTCrewBankAccount", true, "MainAcc", new List<string> {"MainAcc", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MainAcc", "MTCrewBankAccount", true, "MainAcc", new List<string> {"MainAcc", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Attachment = new (this, "x_Attachment", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "Attachment", "CustomMsg"),
                IsUpload = true
            };
            Attachment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Attachment", "MTCrewBankAccount", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Attachment", "MTCrewBankAccount", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Attachment", "MTCrewBankAccount", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCrewBankAccount", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCrewBankAccount", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCrewBankAccount", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewBankAccount", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewBankAccount", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewBankAccount", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewBankAccount", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "MtCrewBankAccountView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCrewBankAccountEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCrewBankAccountAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCrewBankAccountView",
                Config.ApiAddAction => "MtCrewBankAccountAdd",
                Config.ApiEditAction => "MtCrewBankAccountEdit",
                Config.ApiDeleteAction => "MtCrewBankAccountDelete",
                Config.ApiListAction => "MtCrewBankAccountList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCrewBankAccountList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCrewBankAccountView", parm);
            else
                url = KeyUrl("MtCrewBankAccountView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCrewBankAccountAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtCrewBankAccountAdd?" + parm;
            else
                url = "MtCrewBankAccountAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewBankAccountEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewBankAccountList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewBankAccountAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewBankAccountList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCrewBankAccountDelete")); // DN
        ...
        {
            string pageName = "MtCrewBankAccountList";
