...
public partial class PCM {
    /// <summary>
    /// crewFormalEducationForAdminViewModeDelete
    /// </summary>
    public static CrewFormalEducationForAdminViewModeDelete crewFormalEducationForAdminViewModeDelete
    {
        get => HttpData.Get<CrewFormalEducationForAdminViewModeDelete>("crewFormalEducationForAdminViewModeDelete")!;
        set => HttpData["crewFormalEducationForAdminViewModeDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewFormalEducationForAdminViewMode
    /// </summary>
    public class CrewFormalEducationForAdminViewModeDelete : CrewFormalEducationForAdminViewModeDeleteBase
    {
        // Constructor
        public CrewFormalEducationForAdminViewModeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFormalEducationForAdminViewModeDelete() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastDeletedFormalEducationCrewID = Session.GetInt("lastDeletedFormalEducationCrewID");
            Session.Remove("lastDeletedFormalEducationCrewID");
            url = "CrewFormalEducationForAdminViewModeList?crewID=" + ConvertToString(lastDeletedFormalEducationCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFormalEducationForAdminViewModeDeleteBase : CrewFormalEducationForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFormalEducationForAdminViewModeDelete";
        ...
        // Constructor
        public CrewFormalEducationForAdminViewModeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewFormalEducationForAdminViewModeDelete";
        ...
        // Constructor
        public CrewFormalEducationForAdminViewModeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewFormalEducationForAdminViewModeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewFormalEducationForAdminViewModeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFormalEducationForAdminViewModeDelete?.PageRender();
            }
            return PageResult();
        }
