...
public partial class PCM {
    ...
    /// mtCertificateList
    /// </summary>
    public static MtCertificateList mtCertificateList
    {
        get => HttpData.Get<MtCertificateList>("mtCertificateList")!;
        set => HttpData["mtCertificateList"] = value;
    }

    /// <summary>
    /// Page class for MTCertificate
    /// </summary>
    public class MtCertificateList : MtCertificateListBase
    {
        // Constructor
        public MtCertificateList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateListBase : MtCertificate
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "MTCertificate";

        // Page object name
        public string PageObjName = "mtCertificateList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMTCertificatelist";
        ...
        // Constructor
        public MtCertificateListBase()
        {
            // CSS class name as context
            TableVar = "MTCertificate";
            ...
            // Table object (mtCertificate)
            if (mtCertificate == null || mtCertificate is MtCertificate)
                mtCertificate = this;

            // Initialize URLs
            AddUrl = "MtCertificateAdd";
            ...
            MultiDeleteUrl = "MtCertificateDelete";
            MultiUpdateUrl = "MtCertificateUpdate";
        ...
        // Page name
        public string PageName => "MtCertificateList";
        ...
        // Constructor
        public MtCertificateListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "MtCertificateView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(CategoryName.AdvancedSearch.ToJson())); // Field CategoryName
        ...
        protected bool RestoreFilterList() {
            ...
            // Field CategoryName
            if (filter?.TryGetValue("x_CategoryName", out sv) ?? false) {
                CategoryName.AdvancedSearch.SearchValue = sv;
                CategoryName.AdvancedSearch.SearchOperator = filter["z_CategoryName"];
                CategoryName.AdvancedSearch.SearchCondition = filter["v_CategoryName"];
                CategoryName.AdvancedSearch.SearchValue2 = filter["y_CategoryName"];
                CategoryName.AdvancedSearch.SearchOperator2 = filter["w_CategoryName"];
                CategoryName.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            if (!Security.CanSearch)
                return "";
            BuildSearchSql(ref where, CategoryName, def, true); // CategoryName
            ...
            if (!def && Command == "search") {
                CategoryName.AdvancedSearch.Save(); // CategoryName
        ...
        public void ShowFilterList()
        {
            ...
            // Field CategoryName
            filter = QueryBuilderWhere("CategoryName");
            if (Empty(filter))
                BuildSearchSql(ref filter, CategoryName, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + CategoryName.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        protected bool CheckSearchParms() {
            ...
            if (BasicSearch.IssetSession)
                return true;
            if (CategoryName.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            CategoryName.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            CategoryName.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Command != "json") {
                string defaultSort = CategoryName.Expression + " ASC" + ", " + _Name.Expression + " ASC"; // Set up default sort
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(CategoryName, ctrl); // CategoryName
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""MTCertificate"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""MTCertificate"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTCertificatelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTCertificatelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""MTCertificate"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("CategoryName")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fMTCertificatesrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fMTCertificatesrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fMTCertificatelist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_MTCertificate");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtCertificateList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtCertificateList.RowCount) + "_MTCertificate");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtCertificateList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtCertificateList.RowType == RowType.Add || IsEdit && mtCertificateList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            // CategoryName
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_CategoryName[]"))
                    CategoryName.AdvancedSearch.SearchValue = Get("x_CategoryName[]");
                else
                    CategoryName.AdvancedSearch.SearchValue = Get("CategoryName"); // Default Value // DN
            if (!Empty(CategoryName.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_CategoryName"))
                CategoryName.AdvancedSearch.SearchOperator = Get("z_CategoryName");
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            CategoryName.SetDbValue(row["CategoryName"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("CategoryName", CategoryName.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            // CategoryName
            CategoryName.CellCssStyle = "white-space: nowrap;";
            ...
            if (RowType == RowType.View) {
                // CategoryName
                CategoryName.ViewValue = ConvertToString(CategoryName.CurrentValue); // DN
                ...
                // CategoryName
                if (CategoryName.UseFilter && !Empty(CategoryName.AdvancedSearch.SearchValue)) {
                    CategoryName.EditValue = ConvertToString(CategoryName.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fMTCertificatesrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"MTCertificate\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("MtCertificateSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("MtCertificateSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
