...
public partial class PCM {
    ...
    /// mtCountryAdd
    /// </summary>
    public static MtCountryAdd mtCountryAdd
    {
        get => HttpData.Get<MtCountryAdd>("mtCountryAdd")!;
        set => HttpData["mtCountryAdd"] = value;
    }

    /// <summary>
    /// Page class for MTCountry
    /// </summary>
    public class MtCountryAdd : MtCountryAddBase
    {
        // Constructor
        public MtCountryAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCountryAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCountryAddBase : MtCountry
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCountryAdd";
        ...
        // Page name
        public string PageName => "MtCountryAdd";
        ...
        // Constructor
        public MtCountryAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtCountryList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "MtCountryView")
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // Nationality
                Nationality.SetDbValue(rsnew, Nationality.CurrentValue);

                // CallingCode
                CallingCode.SetDbValue(rsnew, CallingCode.CurrentValue);
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
