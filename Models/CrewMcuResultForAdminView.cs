...
public partial class PCM {
    /// <summary>
    /// crewMcuResultForAdminView
    /// </summary>
    public static CrewMcuResultForAdminView crewMcuResultForAdminView
    {
        get => HttpData.Get<CrewMcuResultForAdminView>("crewMcuResultForAdminView")!;
        set => HttpData["crewMcuResultForAdminView"] = value;
    }

    /// <summary>
    /// Page class for CrewMcuResultForAdmin
    /// </summary>
    public class CrewMcuResultForAdminView : CrewMcuResultForAdminViewBase
    {
        // Constructor
        public CrewMcuResultForAdminView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMcuResultForAdminView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMcuResultForAdminViewBase : CrewMcuResultForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMcuResultForAdminView";
        ...
        // Constructor
        public CrewMcuResultForAdminViewBase()
        {
            // Custom template // DN
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["McuResult_ID"] = keys[0];
            } else {
                RecordKeys["McuResult_ID"] = RouteValues.TryGetValue("McuResult_ID", out obj) && obj != null ? UrlDecode(obj) : Get("McuResult_ID"); // DN
            }
        ...
        // Page name
        public string PageName => "CrewMcuResultForAdminView";
        ...
        // Constructor
        public CrewMcuResultForAdminViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("McuResult_ID", out v) && !Empty(v)) { // DN
                McuResult_ID.QueryValue = UrlDecode(v); // DN
                RecordKeys["McuResult_ID"] = McuResult_ID.QueryValue;
            } else if (Get("McuResult_ID", out sv)) {
                McuResult_ID.QueryValue = sv.ToString();
                RecordKeys["McuResult_ID"] = McuResult_ID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                McuResult_ID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["McuResult_ID"] = McuResult_ID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "CrewMcuResultForAdminList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("CrewMcuResultForAdminList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMcuResultForAdminView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fCrewMcuResultForAdminview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
