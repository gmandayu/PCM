...
public partial class PCM {
    /// <summary>
    /// crewDocumentForAdminDelete
    /// </summary>
    public static CrewDocumentForAdminDelete crewDocumentForAdminDelete
    {
        get => HttpData.Get<CrewDocumentForAdminDelete>("crewDocumentForAdminDelete")!;
        set => HttpData["crewDocumentForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewDocumentForAdmin
    /// </summary>
    public class CrewDocumentForAdminDelete : CrewDocumentForAdminDeleteBase
    {
        // Constructor
        public CrewDocumentForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewDocumentForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewDocumentForAdminDeleteBase : CrewDocumentForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewDocumentForAdminDelete";
        ...
        // Constructor
        public CrewDocumentForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewDocumentForAdminDelete";
        ...
        // Constructor
        public CrewDocumentForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewDocumentForAdminList"); // Prevent SQL injection, return to List page
            ...
            using (Recordset = await Connection.OpenDataReaderAsync(sql)) {
                if (Recordset != null) {
                    ...
                    if (!res)
                        return Terminate("CrewDocumentForAdminList"); // Return to List page
                }
            }
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewDocumentForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewDocumentForAdminDelete?.PageRender();
            }
            return PageResult();
        }
