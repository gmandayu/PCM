...
public partial class PCM {
    /// <summary>
    /// crewFamilyForAdminViewModeAdd
    /// </summary>
    public static CrewFamilyForAdminViewModeAdd crewFamilyForAdminViewModeAdd
    {
        get => HttpData.Get<CrewFamilyForAdminViewModeAdd>("crewFamilyForAdminViewModeAdd")!;
        set => HttpData["crewFamilyForAdminViewModeAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewFamilyForAdminViewMode
    /// </summary>
    public class CrewFamilyForAdminViewModeAdd : CrewFamilyForAdminViewModeAddBase
    {
        // Constructor
        public CrewFamilyForAdminViewModeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFamilyForAdminViewModeAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewFamilyForAdminViewModeList?crewID=" + ConvertToString(lastAddedFamilyCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFamilyForAdminViewModeAddBase : CrewFamilyForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFamilyForAdminViewModeAdd";
        ...
        // Constructor
        public CrewFamilyForAdminViewModeAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewFamilyForAdminViewModeAdd";
        ...
        // Constructor
        public CrewFamilyForAdminViewModeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewFamilyForAdminViewModeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "CrewFamilyForAdminViewModeView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFamilyForAdminViewModeAdd?.PageRender();
            }
            return PageResult();
        }
