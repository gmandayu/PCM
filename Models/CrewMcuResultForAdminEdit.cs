...
public partial class PCM {
    /// <summary>
    /// crewMcuResultForAdminEdit
    /// </summary>
    public static CrewMcuResultForAdminEdit crewMcuResultForAdminEdit
    {
        get => HttpData.Get<CrewMcuResultForAdminEdit>("crewMcuResultForAdminEdit")!;
        set => HttpData["crewMcuResultForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewMcuResultForAdmin
    /// </summary>
    public class CrewMcuResultForAdminEdit : CrewMcuResultForAdminEditBase
    {
        // Constructor
        public CrewMcuResultForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMcuResultForAdminEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMcuResultForAdminEditBase : CrewMcuResultForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMcuResultForAdminEdit";
        ...
        // Constructor
        public CrewMcuResultForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewMcuResultForAdminEdit";
        ...
        // Constructor
        public CrewMcuResultForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewMcuResultForAdminList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "CrewMcuResultForAdminList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewMcuResultForAdminList") {
                                ...
                                returnUrl = "CrewMcuResultForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMcuResultForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
