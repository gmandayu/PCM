...
public partial class PCM {
    /// <summary>
    /// crewBankAccountForAdminEdit
    /// </summary>
    public static CrewBankAccountForAdminEdit crewBankAccountForAdminEdit
    {
        get => HttpData.Get<CrewBankAccountForAdminEdit>("crewBankAccountForAdminEdit")!;
        set => HttpData["crewBankAccountForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewBankAccountForAdmin
    /// </summary>
    public class CrewBankAccountForAdminEdit : CrewBankAccountForAdminEditBase
    {
        // Constructor
        public CrewBankAccountForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewBankAccountForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewBankAccountForAdminAdd?crewID=" + ConvertToString(lastUpdatedBankAccountCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewBankAccountForAdminEditBase : CrewBankAccountForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewBankAccountForAdminEdit";
        ...
        // Constructor
        public CrewBankAccountForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewBankAccountForAdminEdit";
        ...
        // Constructor
        public CrewBankAccountForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewBankAccountForAdminList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewBankAccountForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
