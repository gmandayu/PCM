...
public partial class PCM {
    ...
    /// Page base class
    /// </summary>
    public class UserprivBase : MtUserLevel
    {
        // Page ID
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            CurrentBreadcrumb.Add("list", "MTUserLevel", AppPath("MtUserLevelList"), "", "MTUserLevel");
            ...
            switch (CurrentAction) {
                case "show": // Display
                    ...
                    foreach (string privilege in Config.Privileges)
                        Privileges.Add(privilege, Enum.Parse<Allow>(TitleCase(privilege)));
                    break;
                case "update": // Update
