...
public partial class PCM {
    /// <summary>
    /// crewCertificateForAdminViewModeView
    /// </summary>
    public static CrewCertificateForAdminViewModeView crewCertificateForAdminViewModeView
    {
        get => HttpData.Get<CrewCertificateForAdminViewModeView>("crewCertificateForAdminViewModeView")!;
        set => HttpData["crewCertificateForAdminViewModeView"] = value;
    }

    /// <summary>
    /// Page class for CrewCertificateForAdminViewMode
    /// </summary>
    public class CrewCertificateForAdminViewModeView : CrewCertificateForAdminViewModeViewBase
    {
        // Constructor
        public CrewCertificateForAdminViewModeView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewCertificateForAdminViewModeView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewCertificateForAdminViewModeViewBase : CrewCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewCertificateForAdminViewModeView";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeViewBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewCertificateForAdminViewModeView";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "CrewCertificateForAdminViewModeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("CrewCertificateForAdminViewModeList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewCertificateForAdminViewModeView?.PageRender();
            }
            return PageResult();
        }
