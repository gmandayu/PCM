...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtManningAgent mtManningAgent
    {
        get => HttpData.Resolve<MtManningAgent>("MTManningAgent");
        set => HttpData["MTManningAgent"] = value;
    }

    /// <summary>
    /// Table class for MTManningAgent
    /// </summary>
    public class MtManningAgent : DbTable, IQueryFactory
    {
        ...
        public MtManningAgent()
        {
            ...
            Name = "MTManningAgent";
            Type = "TABLE";
            UpdateTable = "dbo.MTManningAgent"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTManningAgent", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            Code = new (this, "x_Code", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTManningAgent", "Code", "CustomMsg"),
                IsUpload = false
            };
            Code.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Code", "MTManningAgent", true, "Code", new List<string> {"Code", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Code", "MTManningAgent", true, "Code", new List<string> {"Code", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Code", "MTManningAgent", true, "Code", new List<string> {"Code", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            _Name = new (this, "x__Name", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTManningAgent", "_Name", "CustomMsg"),
                IsUpload = false
            };
            _Name.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Name", "MTManningAgent", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Name", "MTManningAgent", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Name", "MTManningAgent", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Name", _Name);

            // Active
            Active = new (this, "x_Active", 11, SqlDbType.Bit) {
                Name = "Active",
                Expression = "[Active]",
                ...
                CustomMessage = Language.FieldPhrase("MTManningAgent", "Active", "CustomMsg"),
                IsUpload = false
            };
            Active.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Active", "MTManningAgent", true, "Active", new List<string> {"Active", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Active", "MTManningAgent", true, "Active", new List<string> {"Active", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Active", "MTManningAgent", true, "Active", new List<string> {"Active", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTManningAgent", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTManningAgent", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTManningAgent", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTManningAgent", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTManningAgent", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTManningAgent", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTManningAgent", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTManningAgent", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTManningAgent", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTManningAgent", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTManningAgent";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Active.DbValue = (ConvertToBool(row["Active"]) ? "1" : "0"); // Set DB value only
        ...
        {
            if (SameString(pageName, "MtManningAgentView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtManningAgentEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtManningAgentAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtManningAgentView",
                Config.ApiAddAction => "MtManningAgentAdd",
                Config.ApiEditAction => "MtManningAgentEdit",
                Config.ApiDeleteAction => "MtManningAgentDelete",
                Config.ApiListAction => "MtManningAgentList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtManningAgentList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtManningAgentView", parm);
            else
                url = KeyUrl("MtManningAgentView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtManningAgentAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtManningAgentAdd?" + parm;
            else
                url = "MtManningAgentAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtManningAgentEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtManningAgentList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtManningAgentAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtManningAgentList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtManningAgentDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            Active.SetDbValue(ConvertToBool(dr["Active"]) ? "1" : "0");
        ...
        {
            string pageName = "MtManningAgentList";
        ...
        public async Task RenderEditRow()
        {
            ...
            Active.PlaceHolder = RemoveHtml(Active.Caption);
