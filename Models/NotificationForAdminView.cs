...
public partial class PCM {
    /// <summary>
    /// notificationForAdminView
    /// </summary>
    public static NotificationForAdminView notificationForAdminView
    {
        get => HttpData.Get<NotificationForAdminView>("notificationForAdminView")!;
        set => HttpData["notificationForAdminView"] = value;
    }

    /// <summary>
    /// Page class for NotificationForAdmin
    /// </summary>
    public class NotificationForAdminView : NotificationForAdminViewBase
    {
        // Constructor
        public NotificationForAdminView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public NotificationForAdminView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class NotificationForAdminViewBase : NotificationForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "notificationForAdminView";
        ...
        // Constructor
        public NotificationForAdminViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "NotificationForAdminView";
        ...
        // Constructor
        public NotificationForAdminViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "NotificationForAdminList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("NotificationForAdminList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                notificationForAdminView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fNotificationForAdminview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
