...
public partial class PCM {
    /// <summary>
    /// crewFamilyForAdminViewModeView
    /// </summary>
    public static CrewFamilyForAdminViewModeView crewFamilyForAdminViewModeView
    {
        get => HttpData.Get<CrewFamilyForAdminViewModeView>("crewFamilyForAdminViewModeView")!;
        set => HttpData["crewFamilyForAdminViewModeView"] = value;
    }

    /// <summary>
    /// Page class for CrewFamilyForAdminViewMode
    /// </summary>
    public class CrewFamilyForAdminViewModeView : CrewFamilyForAdminViewModeViewBase
    {
        // Constructor
        public CrewFamilyForAdminViewModeView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFamilyForAdminViewModeView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFamilyForAdminViewModeViewBase : CrewFamilyForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFamilyForAdminViewModeView";
        ...
        // Constructor
        public CrewFamilyForAdminViewModeViewBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewFamilyForAdminViewModeView";
        ...
        // Constructor
        public CrewFamilyForAdminViewModeViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "CrewFamilyForAdminViewModeList"; // Return to list
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFamilyForAdminViewModeView?.PageRender();
            }
            return PageResult();
        }
