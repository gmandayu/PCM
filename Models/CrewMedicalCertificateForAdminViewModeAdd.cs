...
public partial class PCM {
    /// <summary>
    /// crewMedicalCertificateForAdminViewModeAdd
    /// </summary>
    public static CrewMedicalCertificateForAdminViewModeAdd crewMedicalCertificateForAdminViewModeAdd
    {
        get => HttpData.Get<CrewMedicalCertificateForAdminViewModeAdd>("crewMedicalCertificateForAdminViewModeAdd")!;
        set => HttpData["crewMedicalCertificateForAdminViewModeAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalCertificateForAdminViewMode
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeAdd : CrewMedicalCertificateForAdminViewModeAddBase
    {
        // Constructor
        public CrewMedicalCertificateForAdminViewModeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalCertificateForAdminViewModeAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewMedicalCertificateForAdminViewModeList?crewID=" + ConvertToString(lastAddedMedicalCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeAddBase : CrewMedicalCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalCertificateForAdminViewModeAdd";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewMedicalCertificateForAdminViewModeAdd";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewMedicalCertificateForAdminViewModeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "CrewMedicalCertificateForAdminViewModeView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalCertificateForAdminViewModeAdd?.PageRender();
            }
            return PageResult();
        }
