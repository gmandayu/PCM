...
public partial class PCM {
    /// <summary>
    /// vCrewTrackingStatusView
    /// </summary>
    public static VCrewTrackingStatusView vCrewTrackingStatusView
    {
        get => HttpData.Get<VCrewTrackingStatusView>("vCrewTrackingStatusView")!;
        set => HttpData["vCrewTrackingStatusView"] = value;
    }

    /// <summary>
    /// Page class for v_CrewTrackingStatus
    /// </summary>
    public class VCrewTrackingStatusView : VCrewTrackingStatusViewBase
    {
        // Constructor
        public VCrewTrackingStatusView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewTrackingStatusView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewTrackingStatusViewBase : VCrewTrackingStatus
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewTrackingStatusView";
        ...
        // Constructor
        public VCrewTrackingStatusViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewTrackingStatusView";
        ...
        // Constructor
        public VCrewTrackingStatusViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "VCrewTrackingStatusList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("VCrewTrackingStatusList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewTrackingStatusView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fv_CrewTrackingStatusview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
