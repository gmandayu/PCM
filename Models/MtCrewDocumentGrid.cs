...
public partial class PCM {
    ...
    /// mtCrewDocumentGrid
    /// </summary>
    public static MtCrewDocumentGrid mtCrewDocumentGrid
    {
        get => HttpData.Get<MtCrewDocumentGrid>("mtCrewDocumentGrid")!;
        set => HttpData["mtCrewDocumentGrid"] = value;
    }

    /// <summary>
    /// Page class for MTCrewDocument
    /// </summary>
    public class MtCrewDocumentGrid : MtCrewDocumentGridBase
    {
        // Constructor
        public MtCrewDocumentGrid() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewDocumentGridBase : MtCrewDocument
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewDocumentGrid";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMTCrewDocumentgrid";
        ...
        // Page name
        public string PageName => "MtCrewDocumentGrid";
        ...
        public bool EmptyRow()
        {
            if (CurrentForm == null)
                return true;
            if (CurrentForm.HasValue("x_IsDraft") && CurrentForm.HasValue("o_IsDraft") && ConvertToBool(IsDraft.CurrentValue) != ConvertToBool(IsDraft.DefaultValue) &&
            !(IsDraft.IsForeignKey && CurrentMasterTable != "" && ConvertToBool(IsDraft.CurrentValue) == ConvertToBool(IsDraft.SessionValue)))
                return false;
            ...
            !(MTCrewID.IsForeignKey && CurrentMasterTable != "" && SameString(MTCrewID.CurrentValue, MTCrewID.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_MTDocumentID") && CurrentForm.HasValue("o_MTDocumentID") && !SameString(MTDocumentID.CurrentValue, MTDocumentID.DefaultValue) &&
            !(MTDocumentID.IsForeignKey && CurrentMasterTable != "" && SameString(MTDocumentID.CurrentValue, MTDocumentID.SessionValue)))
                return false;
            ...
            !(PlaceOfIssue.IsForeignKey && CurrentMasterTable != "" && SameString(PlaceOfIssue.CurrentValue, PlaceOfIssue.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_DateValidUntil") && CurrentForm.HasValue("o_DateValidUntil") && !SameString(FormatDateTime(DateValidUntil.CurrentValue, DateValidUntil.FormatPattern), FormatDateTime(DateValidUntil.DefaultValue, DateValidUntil.FormatPattern)) &&
            !(DateValidUntil.IsForeignKey && CurrentMasterTable != "" && SameString(FormatDateTime(DateValidUntil.CurrentValue, DateValidUntil.FormatPattern), FormatDateTime(DateValidUntil.SessionValue, DateValidUntil.FormatPattern))))
                return false;
        ...
        {
            IsDraft.ClearErrorMessage();
            MTCrewID.ClearErrorMessage();
            MTDocumentID.ClearErrorMessage();
            ...
            DateValidUntil.ClearErrorMessage();
        ...
        public async Task SetupRow()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtCrewDocumentGrid.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtCrewDocumentGrid.RowCount) + "_MTCrewDocument");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtCrewDocumentGrid.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtCrewDocumentGrid.RowType == RowType.Add || IsEdit && mtCrewDocumentGrid.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadDefaultValues() {
            IsDraft.DefaultValue = IsDraft.GetDefault(); // DN
            IsDraft.OldValue = IsDraft.DefaultValue;
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'IsDraft' before field var 'x_IsDraft'
            val = CurrentForm.HasValue("IsDraft") ? CurrentForm.GetValue("IsDraft") : CurrentForm.GetValue("x_IsDraft");
            if (!IsDraft.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("IsDraft") && !CurrentForm.HasValue("x_IsDraft")) // DN
                    IsDraft.Visible = false; // Disable update for API request
                else
                    IsDraft.SetFormValue(val);
            }
            if (CurrentForm.HasValue("o_IsDraft"))
                IsDraft.OldValue = CurrentForm.GetValue("o_IsDraft");
            ...
            if (CurrentForm.HasValue("o_MTDocumentID"))
                MTDocumentID.OldValue = CurrentForm.GetValue("o_MTDocumentID");
            ...
            DateValidUntil.OldValue = UnformatDateTime(CurrentForm.GetValue("o_DateValidUntil"), DateValidUntil.FormatPattern);
        ...
        public void RestoreFormValues()
        {
            ...
            IsDraft.CurrentValue = IsDraft.FormValue;
        ...
        protected async Task<bool> ValidateForm() {
            ...
            if (IsDraft.Required) {
                if (!IsDraft.IsDetailKey && Empty(IsDraft.FormValue)) {
                    IsDraft.AddErrorMessage(ConvertToString(IsDraft.RequiredErrorMessage).Replace("%s", IsDraft.Caption));
                }
            }
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // IsDraft
            IsDraft.SetDbValue(rsnew, SameString(IsDraft.CurrentValue, "1") ? "1" : "0", IsDraft.ReadOnly); // DN
            ...
            // MTDocumentID
            MTDocumentID.SetDbValue(rsnew, MTDocumentID.CurrentValue, MTDocumentID.ReadOnly);
            ...
            // DateValidUntil
            DateValidUntil.SetDbValue(rsnew, ConvertToDateTime(DateValidUntil.CurrentValue, DateValidUntil.FormatPattern), DateValidUntil.ReadOnly);
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                // IsDraft
                IsDraft.SetDbValue(rsnew, SameString(IsDraft.CurrentValue, "1") ? "1" : "0", Empty(IsDraft.CurrentValue)); // DN
