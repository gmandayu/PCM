...
public partial class PCM {
    /// <summary>
    /// crewPersonalDataForAdminSearch
    /// </summary>
    public static CrewPersonalDataForAdminSearch crewPersonalDataForAdminSearch
    {
        get => HttpData.Get<CrewPersonalDataForAdminSearch>("crewPersonalDataForAdminSearch")!;
        set => HttpData["crewPersonalDataForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewPersonalDataForAdmin
    /// </summary>
    public class CrewPersonalDataForAdminSearch : CrewPersonalDataForAdminSearchBase
    {
        // Constructor
        public CrewPersonalDataForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewPersonalDataForAdminSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewPersonalDataForAdminSearchBase : CrewPersonalDataForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewPersonalDataForAdminSearch";
        ...
        // Constructor
        public CrewPersonalDataForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewPersonalDataForAdminSearch";
        ...
        // Constructor
        public CrewPersonalDataForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewPersonalDataForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewPersonalDataForAdminSearch?.PageRender();
            }
            return PageResult();
        }
