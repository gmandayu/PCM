...
public partial class PCM {
    /// <summary>
    /// crewPersonalDataForAdminViewModeEdit
    /// </summary>
    public static CrewPersonalDataForAdminViewModeEdit crewPersonalDataForAdminViewModeEdit
    {
        get => HttpData.Get<CrewPersonalDataForAdminViewModeEdit>("crewPersonalDataForAdminViewModeEdit")!;
        set => HttpData["crewPersonalDataForAdminViewModeEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewPersonalDataForAdminViewMode
    /// </summary>
    public class CrewPersonalDataForAdminViewModeEdit : CrewPersonalDataForAdminViewModeEditBase
    {
        // Constructor
        public CrewPersonalDataForAdminViewModeEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewPersonalDataForAdminViewModeEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewPersonalDataForAdminViewModeEditBase : CrewPersonalDataForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewPersonalDataForAdminViewModeEdit";
        ...
        // Constructor
        public CrewPersonalDataForAdminViewModeEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewPersonalDataForAdminViewModeEdit";
        ...
        // Constructor
        public CrewPersonalDataForAdminViewModeEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewPersonalDataForAdminViewModeList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ViewUrl;
                    if (GetPageName(returnUrl) == "CrewPersonalDataForAdminViewModeList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewPersonalDataForAdminViewModeList") {
                                ...
                                returnUrl = "CrewPersonalDataForAdminViewModeList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewPersonalDataForAdminViewModeEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
