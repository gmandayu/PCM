...
public partial class PCM {
    /// <summary>
    /// crewAppraisalForAdminView
    /// </summary>
    public static CrewAppraisalForAdminView crewAppraisalForAdminView
    {
        get => HttpData.Get<CrewAppraisalForAdminView>("crewAppraisalForAdminView")!;
        set => HttpData["crewAppraisalForAdminView"] = value;
    }

    /// <summary>
    /// Page class for CrewAppraisalForAdmin
    /// </summary>
    public class CrewAppraisalForAdminView : CrewAppraisalForAdminViewBase
    {
        // Constructor
        public CrewAppraisalForAdminView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewAppraisalForAdminView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewAppraisalForAdminViewBase : CrewAppraisalForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewAppraisalForAdminView";
        ...
        // Constructor
        public CrewAppraisalForAdminViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewAppraisalForAdminView";
        ...
        // Constructor
        public CrewAppraisalForAdminViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "CrewAppraisalForAdminList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("CrewAppraisalForAdminList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewAppraisalForAdminView?.PageRender();
            }
            return PageResult();
        }
