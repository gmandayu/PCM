...
public partial class PCM {
    /// <summary>
    /// crewMedicalHistoryForAdminAdd
    /// </summary>
    public static CrewMedicalHistoryForAdminAdd crewMedicalHistoryForAdminAdd
    {
        get => HttpData.Get<CrewMedicalHistoryForAdminAdd>("crewMedicalHistoryForAdminAdd")!;
        set => HttpData["crewMedicalHistoryForAdminAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalHistoryForAdmin
    /// </summary>
    public class CrewMedicalHistoryForAdminAdd : CrewMedicalHistoryForAdminAddBase
    {
        // Constructor
        public CrewMedicalHistoryForAdminAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalHistoryForAdminAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastAddedMedicalHistoryCrewID = Session.GetInt("lastAddedMedicalHistoryCrewID");
            Session.Remove("lastAddedMedicalHistoryCrewID");
            url = "CrewMedicalHistoryForAdminAdd?crewID=" + ConvertToString(lastAddedMedicalHistoryCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalHistoryForAdminAddBase : CrewMedicalHistoryForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalHistoryForAdminAdd";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewMedicalHistoryForAdminAdd";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewMedicalHistoryForAdminList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "CrewMedicalHistoryForAdminList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "CrewMedicalHistoryForAdminView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewMedicalHistoryForAdminList") {
                                ...
                                returnUrl = "CrewMedicalHistoryForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalHistoryForAdminAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("CrewMedicalHistoryForAdminList")), "", TableVar, true);
