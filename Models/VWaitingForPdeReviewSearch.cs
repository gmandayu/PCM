...
public partial class PCM {
    /// <summary>
    /// vWaitingForPdeReviewSearch
    /// </summary>
    public static VWaitingForPdeReviewSearch vWaitingForPdeReviewSearch
    {
        get => HttpData.Get<VWaitingForPdeReviewSearch>("vWaitingForPdeReviewSearch")!;
        set => HttpData["vWaitingForPdeReviewSearch"] = value;
    }

    /// <summary>
    /// Page class for v_WaitingForPDEReview
    /// </summary>
    public class VWaitingForPdeReviewSearch : VWaitingForPdeReviewSearchBase
    {
        // Constructor
        public VWaitingForPdeReviewSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VWaitingForPdeReviewSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VWaitingForPdeReviewSearchBase : VWaitingForPdeReview
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vWaitingForPdeReviewSearch";
        ...
        // Constructor
        public VWaitingForPdeReviewSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VWaitingForPdeReviewSearch";
        ...
        // Constructor
        public VWaitingForPdeReviewSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "VWaitingForPdeReviewList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vWaitingForPdeReviewSearch?.PageRender();
            }
            return PageResult();
        }
