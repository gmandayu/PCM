...
public partial class PCM {
    /// <summary>
    /// waitingForAgencyReviewSearch
    /// </summary>
    public static WaitingForAgencyReviewSearch waitingForAgencyReviewSearch
    {
        get => HttpData.Get<WaitingForAgencyReviewSearch>("waitingForAgencyReviewSearch")!;
        set => HttpData["waitingForAgencyReviewSearch"] = value;
    }

    /// <summary>
    /// Page class for WaitingForAgencyReview
    /// </summary>
    public class WaitingForAgencyReviewSearch : WaitingForAgencyReviewSearchBase
    {
        // Constructor
        public WaitingForAgencyReviewSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public WaitingForAgencyReviewSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class WaitingForAgencyReviewSearchBase : WaitingForAgencyReview
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "waitingForAgencyReviewSearch";
        ...
        // Constructor
        public WaitingForAgencyReviewSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "WaitingForAgencyReviewSearch";
        ...
        // Constructor
        public WaitingForAgencyReviewSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "WaitingForAgencyReviewList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                waitingForAgencyReviewSearch?.PageRender();
            }
            return PageResult();
        }
