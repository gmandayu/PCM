...
public partial class PCM {
    /// <summary>
    /// crewCertificateForAdminDelete
    /// </summary>
    public static CrewCertificateForAdminDelete crewCertificateForAdminDelete
    {
        get => HttpData.Get<CrewCertificateForAdminDelete>("crewCertificateForAdminDelete")!;
        set => HttpData["crewCertificateForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewCertificateForAdmin
    /// </summary>
    public class CrewCertificateForAdminDelete : CrewCertificateForAdminDeleteBase
    {
        // Constructor
        public CrewCertificateForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewCertificateForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewCertificateForAdminDeleteBase : CrewCertificateForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewCertificateForAdminDelete";
        ...
        // Constructor
        public CrewCertificateForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewCertificateForAdminDelete";
        ...
        // Constructor
        public CrewCertificateForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewCertificateForAdminList"); // Prevent SQL injection, return to List page
            ...
            using (Recordset = await Connection.OpenDataReaderAsync(sql)) {
                if (Recordset != null) {
                    ...
                    if (!res)
                        return Terminate("CrewCertificateForAdminList"); // Return to List page
                }
            }
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewCertificateForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewCertificateForAdminDelete?.PageRender();
            }
            return PageResult();
        }
