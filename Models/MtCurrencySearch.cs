...
public partial class PCM {
    ...
    /// mtCurrencySearch
    /// </summary>
    public static MtCurrencySearch mtCurrencySearch
    {
        get => HttpData.Get<MtCurrencySearch>("mtCurrencySearch")!;
        set => HttpData["mtCurrencySearch"] = value;
    }

    /// <summary>
    /// Page class for MTCurrency
    /// </summary>
    public class MtCurrencySearch : MtCurrencySearchBase
    {
        // Constructor
        public MtCurrencySearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCurrencySearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCurrencySearchBase : MtCurrency
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCurrencySearch";
        ...
        // Page name
        public string PageName => "MtCurrencySearch";
        ...
        // Constructor
        public MtCurrencySearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtCurrencyList?" + srchStr;
