...
public partial class PCM {
    ...
    /// mtCountryDelete
    /// </summary>
    public static MtCountryDelete mtCountryDelete
    {
        get => HttpData.Get<MtCountryDelete>("mtCountryDelete")!;
        set => HttpData["mtCountryDelete"] = value;
    }

    /// <summary>
    /// Page class for MTCountry
    /// </summary>
    public class MtCountryDelete : MtCountryDeleteBase
    {
        // Constructor
        public MtCountryDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCountryDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCountryDeleteBase : MtCountry
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCountryDelete";
        ...
        // Page name
        public string PageName => "MtCountryDelete";
        ...
        // Constructor
        public MtCountryDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtCountryList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtCountryList"); // Return to list
                }
            }
