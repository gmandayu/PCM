...
public partial class PCM {
    ...
    /// mtDocumentDelete
    /// </summary>
    public static MtDocumentDelete mtDocumentDelete
    {
        get => HttpData.Get<MtDocumentDelete>("mtDocumentDelete")!;
        set => HttpData["mtDocumentDelete"] = value;
    }

    /// <summary>
    /// Page class for MTDocument
    /// </summary>
    public class MtDocumentDelete : MtDocumentDeleteBase
    {
        // Constructor
        public MtDocumentDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtDocumentDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtDocumentDeleteBase : MtDocument
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtDocumentDelete";
        ...
        // Page name
        public string PageName => "MtDocumentDelete";
        ...
        // Constructor
        public MtDocumentDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtDocumentList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtDocumentList"); // Return to list
                }
            }
