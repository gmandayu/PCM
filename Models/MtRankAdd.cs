...
public partial class PCM {
    ...
    /// mtRankAdd
    /// </summary>
    public static MtRankAdd mtRankAdd
    {
        get => HttpData.Get<MtRankAdd>("mtRankAdd")!;
        set => HttpData["mtRankAdd"] = value;
    }

    /// <summary>
    /// Page class for MTRank
    /// </summary>
    public class MtRankAdd : MtRankAddBase
    {
        // Constructor
        public MtRankAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRankAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRankAddBase : MtRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRankAdd";
        ...
        // Page name
        public string PageName => "MtRankAdd";
        ...
        // Constructor
        public MtRankAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtRankList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtRankList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtRankView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtRankList") {
                                ...
                                returnUrl = "MtRankList"; // Return list page content
                            }
                        }
