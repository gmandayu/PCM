...
public partial class PCM {
    /// <summary>
    /// trChecklistPerformance
    /// </summary>
    [MaybeNull]
    public static TrChecklistPerformance trChecklistPerformance
    {
        get => HttpData.Resolve<TrChecklistPerformance>("TRChecklistPerformance");
        set => HttpData["TRChecklistPerformance"] = value;
    }

    /// <summary>
    /// Table class for TRChecklistPerformance
    /// </summary>
    public class TrChecklistPerformance : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> TRChecklistID;
        ...
        // Constructor
        public TrChecklistPerformance()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "TRChecklistPerformance";
            Name = "TRChecklistPerformance";
            Type = "TABLE";
            UpdateTable = "dbo.TRChecklistPerformance"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);

            // TRChecklistID
            TRChecklistID = new (this, "x_TRChecklistID", 3, SqlDbType.Int) {
                Name = "TRChecklistID",
                Expression = "[TRChecklistID]",
                BasicSearchExpression = "CAST([TRChecklistID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[TRChecklistID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "TRChecklistID", "CustomMsg"),
                IsUpload = false
            };
            TRChecklistID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("TRChecklistID", "TRChecklist", false, "ID", new List<string> {"MTCrewID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "CAST([MTCrewID] AS NVARCHAR)"),
                "id-ID" => new Lookup<DbField>("TRChecklistID", "TRChecklist", false, "ID", new List<string> {"MTCrewID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "CAST([MTCrewID] AS NVARCHAR)"),
                _ => new Lookup<DbField>("TRChecklistID", "TRChecklist", false, "ID", new List<string> {"MTCrewID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "CAST([MTCrewID] AS NVARCHAR)")
            };
            Fields.Add("TRChecklistID", TRChecklistID);
            ...
            ManningAgent = new (this, "x_ManningAgent", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "ManningAgent", "CustomMsg"),
                IsUpload = false
            };
            ...
            VesselName = new (this, "x_VesselName", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "VesselName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Performance = new (this, "x_Performance", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "Performance", "CustomMsg"),
                IsUpload = false
            };
            ...
            DateChecked = new (this, "x_DateChecked", 133, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "DateChecked", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            CreatedByUserID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedByUserID", "MTUser", false, "ID", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Email]"),
                "id-ID" => new Lookup<DbField>("CreatedByUserID", "MTUser", false, "ID", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Email]"),
                _ => new Lookup<DbField>("CreatedByUserID", "MTUser", false, "ID", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Email]")
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedByUserID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedByUserID", "MTUser", false, "ID", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Email]"),
                "id-ID" => new Lookup<DbField>("LastUpdatedByUserID", "MTUser", false, "ID", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Email]"),
                _ => new Lookup<DbField>("LastUpdatedByUserID", "MTUser", false, "ID", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Email]")
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRChecklistPerformance", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string MasterFilterFromSession
        {
            get { // Master filter
                string masterFilter = "";
            if (CurrentMasterTable == "TRChecklist") {
                dynamic masterTable = Resolve("TRChecklist")!;
                if (!Empty(TRChecklistID.SessionValue))
                    masterFilter += "" + KeyFilter(masterTable.ID, TRChecklistID.SessionValue, masterTable.ID.DataType, masterTable.DbId);
                else
                    return "";
            }
            if (CurrentMasterTable == "CrewChecklistForAdmin") {
                dynamic masterTable = Resolve("CrewChecklistForAdmin")!;
                if (!Empty(TRChecklistID.SessionValue))
                    masterFilter += "" + KeyFilter(masterTable.ID, TRChecklistID.SessionValue, masterTable.ID.DataType, masterTable.DbId);
                else
                    return "";
        ...
        public string DetailFilterFromSession
        {
            get { // Detail filter
                ...
                if (CurrentMasterTable == "TRChecklist") {
                    dynamic masterTable = Resolve("TRChecklist")!;
                    if (!Empty(TRChecklistID.SessionValue))
                        detailFilter += "" + KeyFilter(TRChecklistID, TRChecklistID.SessionValue, masterTable.ID.DataType, DbId);
                    else
                        return "";
                }
                if (CurrentMasterTable == "CrewChecklistForAdmin") {
        ...
        public string? MasterFilter(dynamic? masterTable, Dictionary<string, object?> keys) // DN
        {
            ...
            case "TRChecklist":
                ...
                if (validKeys) {
                    return KeyFilter(masterTable.ID, keys["TRChecklistID"], TRChecklistID.DataType, DbId);
                }
                break;
            case "CrewChecklistForAdmin":
                key = keys["TRChecklistID"] ?? "";
                if (Empty(key)) {
                    if (masterTable.ID.Required) // Required field and empty value
                        return ""; // Return empty filter
        ...
        public string DetailFilter(dynamic masterTable) // DN
        {
            return masterTable.TableVar switch {
                "TRChecklist" => KeyFilter(TRChecklistID, masterTable.ID.DbValue, masterTable.ID.DataType, masterTable.DbId),
                "CrewChecklistForAdmin" => KeyFilter(TRChecklistID, masterTable.ID.DbValue, masterTable.ID.DataType, masterTable.DbId),
                _ => ""
            };
        }
        ...
        {
            get => _sqlFrom ?? "dbo.TRChecklistPerformance";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                TRChecklistID.DbValue = row["TRChecklistID"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "TrChecklistPerformanceList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "TrChecklistPerformanceView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TrChecklistPerformanceEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TrChecklistPerformanceAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TrChecklistPerformanceView",
                Config.ApiAddAction => "TrChecklistPerformanceAdd",
                Config.ApiEditAction => "TrChecklistPerformanceEdit",
                Config.ApiDeleteAction => "TrChecklistPerformanceDelete",
                Config.ApiListAction => "TrChecklistPerformanceList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TrChecklistPerformanceList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TrChecklistPerformanceView", parm);
            else
                url = KeyUrl("TrChecklistPerformanceView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TrChecklistPerformanceAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TrChecklistPerformanceAdd?" + parm;
            else
                url = "TrChecklistPerformanceAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TrChecklistPerformanceEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrChecklistPerformanceList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TrChecklistPerformanceAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrChecklistPerformanceList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TrChecklistPerformanceDelete")); // DN

        // Add master URL
        public string AddMasterUrl(string url)
        {
            if (CurrentMasterTable == "TRChecklist" && !url.Contains(Config.TableShowMaster + "=")) {
                url += (url.Contains("?") ? "&" : "?") + Config.TableShowMaster + "=" + CurrentMasterTable;
                url += "&" + ForeignKeyUrl("fk_ID", TRChecklistID.SessionValue); // Use Session Value
            }
            if (CurrentMasterTable == "CrewChecklistForAdmin" && !url.Contains(Config.TableShowMaster + "=")) {
                url += (url.Contains("?") ? "&" : "?") + Config.TableShowMaster + "=" + CurrentMasterTable;
                url += "&" + ForeignKeyUrl("fk_ID", TRChecklistID.SessionValue); // Use Session Value
            }
            return url;
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            ID.SetDbValue(dr["ID"]);
            TRChecklistID.SetDbValue(dr["TRChecklistID"]);
        ...
        {
            string pageName = "TrChecklistPerformanceList";
        ...
        public async Task RenderListRow()
        {
            ...
            // TRChecklistID
            TRChecklistID.ViewValue = TRChecklistID.CurrentValue;
            curVal = ConvertToString(TRChecklistID.CurrentValue);
            if (!Empty(curVal)) {
                if (TRChecklistID.Lookup != null && IsDictionary(TRChecklistID.Lookup?.Options) && TRChecklistID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    TRChecklistID.ViewValue = TRChecklistID.LookupCacheOption(curVal);
                } else { // Lookup from database // DN
                    filterWrk = SearchFilter("[ID]", "=", TRChecklistID.CurrentValue, DataType.Number, "");
                    sqlWrk = TRChecklistID.Lookup?.GetSql(false, filterWrk, null, this, true, true);
                    rswrk = sqlWrk != null ? Connection.GetRows(sqlWrk) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
                    if (rswrk?.Count > 0 && TRChecklistID.Lookup != null) { // Lookup values found
                        var listwrk = TRChecklistID.Lookup?.RenderViewRow(rswrk[0]);
                        TRChecklistID.ViewValue = TRChecklistID.HighlightLookup(ConvertToString(rswrk[0]), TRChecklistID.DisplayValue(listwrk));
                    } else {
                        TRChecklistID.ViewValue = FormatNumber(TRChecklistID.CurrentValue, TRChecklistID.FormatPattern);
                    }
                }
            } else {
                TRChecklistID.ViewValue = DbNullValue;
            }
            TRChecklistID.ViewCustomAttributes = "";
            ...
            // TRChecklistID
            TRChecklistID.HrefValue = "";
            TRChecklistID.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // TRChecklistID
            TRChecklistID.SetupEditAttributes();
            if (!Empty(TRChecklistID.SessionValue)) {
                TRChecklistID.CurrentValue = ForeignKeyValue(TRChecklistID.SessionValue);
                TRChecklistID.ViewValue = TRChecklistID.CurrentValue;
                curVal = ConvertToString(TRChecklistID.CurrentValue);
                if (!Empty(curVal)) {
                    if (TRChecklistID.Lookup != null && IsDictionary(TRChecklistID.Lookup?.Options) && TRChecklistID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                ...
                TRChecklistID.EditValue = TRChecklistID.CurrentValue; // DN
                TRChecklistID.PlaceHolder = RemoveHtml(TRChecklistID.Caption);
                if (!Empty(TRChecklistID.EditValue) && IsNumeric(TRChecklistID.EditValue))
                    TRChecklistID.EditValue = FormatNumber(TRChecklistID.EditValue, null);
            }
