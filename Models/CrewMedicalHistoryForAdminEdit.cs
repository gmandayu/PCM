...
public partial class PCM {
    /// <summary>
    /// crewMedicalHistoryForAdminEdit
    /// </summary>
    public static CrewMedicalHistoryForAdminEdit crewMedicalHistoryForAdminEdit
    {
        get => HttpData.Get<CrewMedicalHistoryForAdminEdit>("crewMedicalHistoryForAdminEdit")!;
        set => HttpData["crewMedicalHistoryForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalHistoryForAdmin
    /// </summary>
    public class CrewMedicalHistoryForAdminEdit : CrewMedicalHistoryForAdminEditBase
    {
        // Constructor
        public CrewMedicalHistoryForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalHistoryForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewMedicalHistoryForAdminAdd?crewID=" + ConvertToString(lastUpdatedMedicalHistoryCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalHistoryForAdminEditBase : CrewMedicalHistoryForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalHistoryForAdminEdit";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewMedicalHistoryForAdminEdit";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewMedicalHistoryForAdminList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalHistoryForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
