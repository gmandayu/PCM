...
public partial class PCM {
    /// <summary>
    /// vCrewAcceptedForAdminDelete
    /// </summary>
    public static VCrewAcceptedForAdminDelete vCrewAcceptedForAdminDelete
    {
        get => HttpData.Get<VCrewAcceptedForAdminDelete>("vCrewAcceptedForAdminDelete")!;
        set => HttpData["vCrewAcceptedForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for v_CrewAcceptedForAdmin
    /// </summary>
    public class VCrewAcceptedForAdminDelete : VCrewAcceptedForAdminDeleteBase
    {
        // Constructor
        public VCrewAcceptedForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewAcceptedForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewAcceptedForAdminDeleteBase : VCrewAcceptedForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewAcceptedForAdminDelete";
        ...
        // Constructor
        public VCrewAcceptedForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewAcceptedForAdminDelete";
        ...
        // Constructor
        public VCrewAcceptedForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("VCrewAcceptedForAdminList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("VCrewAcceptedForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewAcceptedForAdminDelete?.PageRender();
            }
            return PageResult();
        }
