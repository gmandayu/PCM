...
public partial class PCM {
    /// <summary>
    /// mtCertificateOnRankEdit
    /// </summary>
    public static MtCertificateOnRankEdit mtCertificateOnRankEdit
    {
        get => HttpData.Get<MtCertificateOnRankEdit>("mtCertificateOnRankEdit")!;
        set => HttpData["mtCertificateOnRankEdit"] = value;
    }

    /// <summary>
    /// Page class for MTCertificateOnRank
    /// </summary>
    public class MtCertificateOnRankEdit : MtCertificateOnRankEditBase
    {
        // Constructor
        public MtCertificateOnRankEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateOnRankEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateOnRankEditBase : MtCertificateOnRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateOnRankEdit";
        ...
        // Constructor
        public MtCertificateOnRankEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCertificateOnRankEdit";
        ...
        // Constructor
        public MtCertificateOnRankEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtCertificateOnRankList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCertificateOnRankEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
