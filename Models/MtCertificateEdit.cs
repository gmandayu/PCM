...
public partial class PCM {
    ...
    /// mtCertificateEdit
    /// </summary>
    public static MtCertificateEdit mtCertificateEdit
    {
        get => HttpData.Get<MtCertificateEdit>("mtCertificateEdit")!;
        set => HttpData["mtCertificateEdit"] = value;
    }

    /// <summary>
    /// Page class for MTCertificate
    /// </summary>
    public class MtCertificateEdit : MtCertificateEditBase
    {
        // Constructor
        public MtCertificateEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateEditBase : MtCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateEdit";
        ...
        // Page name
        public string PageName => "MtCertificateEdit";
        ...
        // Constructor
        public MtCertificateEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtCertificateList"); // No matching record, return to list
                        }
                    break;
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // CategoryName
            CategoryName.SetDbValue(rsnew, CategoryName.CurrentValue, CategoryName.ReadOnly);
