...
public partial class PCM {
    ...
    /// mtClothesSizeDelete
    /// </summary>
    public static MtClothesSizeDelete mtClothesSizeDelete
    {
        get => HttpData.Get<MtClothesSizeDelete>("mtClothesSizeDelete")!;
        set => HttpData["mtClothesSizeDelete"] = value;
    }

    /// <summary>
    /// Page class for MTClothesSize
    /// </summary>
    public class MtClothesSizeDelete : MtClothesSizeDeleteBase
    {
        // Constructor
        public MtClothesSizeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtClothesSizeDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtClothesSizeDeleteBase : MtClothesSize
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtClothesSizeDelete";
        ...
        // Constructor
        public MtClothesSizeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtClothesSizeDelete";
        ...
        // Constructor
        public MtClothesSizeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtClothesSizeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtClothesSizeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtClothesSizeDelete?.PageRender();
            }
            return PageResult();
        }
