...
public partial class PCM {
    ...
    /// mcuResultView
    /// </summary>
    public static McuResultView mcuResultView
    {
        get => HttpData.Get<McuResultView>("mcuResultView")!;
        set => HttpData["mcuResultView"] = value;
    }

    /// <summary>
    /// Page class for McuResult
    /// </summary>
    public class McuResultView : McuResultViewBase
    {
        // Constructor
        public McuResultView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public McuResultView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class McuResultViewBase : McuResult
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mcuResultView";
        ...
        // Page name
        public string PageName => "McuResultView";
        ...
        // Constructor
        public McuResultViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("McuResult_ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "McuResultList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("McuResultList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMcuResultview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
