...
public partial class PCM {
    ...
    /// mtCurrencyAdd
    /// </summary>
    public static MtCurrencyAdd mtCurrencyAdd
    {
        get => HttpData.Get<MtCurrencyAdd>("mtCurrencyAdd")!;
        set => HttpData["mtCurrencyAdd"] = value;
    }

    /// <summary>
    /// Page class for MTCurrency
    /// </summary>
    public class MtCurrencyAdd : MtCurrencyAddBase
    {
        // Constructor
        public MtCurrencyAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCurrencyAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCurrencyAddBase : MtCurrency
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCurrencyAdd";
        ...
        // Page name
        public string PageName => "MtCurrencyAdd";
        ...
        // Constructor
        public MtCurrencyAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtCurrencyList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtCurrencyList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtCurrencyView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtCurrencyList") {
                                ...
                                returnUrl = "MtCurrencyList"; // Return list page content
                            }
                        }
