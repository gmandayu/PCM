...
public partial class PCM {
    ...
    /// mtCountryView
    /// </summary>
    public static MtCountryView mtCountryView
    {
        get => HttpData.Get<MtCountryView>("mtCountryView")!;
        set => HttpData["mtCountryView"] = value;
    }

    /// <summary>
    /// Page class for MTCountry
    /// </summary>
    public class MtCountryView : MtCountryViewBase
    {
        // Constructor
        public MtCountryView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCountryView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCountryViewBase : MtCountry
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCountryView";
        ...
        // Page name
        public string PageName => "MtCountryView";
        ...
        // Constructor
        public MtCountryViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtCountryList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtCountryList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTCountryview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
