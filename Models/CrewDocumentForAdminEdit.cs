...
public partial class PCM {
    /// <summary>
    /// crewDocumentForAdminEdit
    /// </summary>
    public static CrewDocumentForAdminEdit crewDocumentForAdminEdit
    {
        get => HttpData.Get<CrewDocumentForAdminEdit>("crewDocumentForAdminEdit")!;
        set => HttpData["crewDocumentForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewDocumentForAdmin
    /// </summary>
    public class CrewDocumentForAdminEdit : CrewDocumentForAdminEditBase
    {
        // Constructor
        public CrewDocumentForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewDocumentForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastUpdatedDocumentCrewID = Session.GetInt("lastUpdatedDocumentCrewID");
            Session.Remove("lastUpdatedDocumentCrewID");
            url = "CrewDocumentForAdminAdd?crewID=" + ConvertToString(lastUpdatedDocumentCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewDocumentForAdminEditBase : CrewDocumentForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewDocumentForAdminEdit";
        ...
        // Constructor
        public CrewDocumentForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewDocumentForAdminEdit";
        ...
        // Constructor
        public CrewDocumentForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewDocumentForAdminList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "CrewDocumentForAdminList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewDocumentForAdminList") {
                                ...
                                returnUrl = "CrewDocumentForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewDocumentForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("CrewDocumentForAdminList")), "", TableVar, true);
            string pageId = "edit";
