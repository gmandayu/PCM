...
public partial class PCM {
    ...
    /// mtUserLevelView
    /// </summary>
    public static MtUserLevelView mtUserLevelView
    {
        get => HttpData.Get<MtUserLevelView>("mtUserLevelView")!;
        set => HttpData["mtUserLevelView"] = value;
    }

    /// <summary>
    /// Page class for MTUserLevel
    /// </summary>
    public class MtUserLevelView : MtUserLevelViewBase
    {
        // Constructor
        public MtUserLevelView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserLevelView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserLevelViewBase : MtUserLevel
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserLevelView";
        ...
        // Page name
        public string PageName => "MtUserLevelView";
        ...
        // Constructor
        public MtUserLevelViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("UserLevelID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtUserLevelList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtUserLevelList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTUserLevelview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtUserLevelList")), "", TableVar, true);
            string pageId = "view";
