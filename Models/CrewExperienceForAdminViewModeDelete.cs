...
public partial class PCM {
    /// <summary>
    /// crewExperienceForAdminViewModeDelete
    /// </summary>
    public static CrewExperienceForAdminViewModeDelete crewExperienceForAdminViewModeDelete
    {
        get => HttpData.Get<CrewExperienceForAdminViewModeDelete>("crewExperienceForAdminViewModeDelete")!;
        set => HttpData["crewExperienceForAdminViewModeDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewExperienceForAdminViewMode
    /// </summary>
    public class CrewExperienceForAdminViewModeDelete : CrewExperienceForAdminViewModeDeleteBase
    {
        // Constructor
        public CrewExperienceForAdminViewModeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewExperienceForAdminViewModeDelete() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastDeletedExperienceCrewID = Session.GetInt("lastDeletedExperienceCrewID");
            Session.Remove("lastDeletedExperienceCrewID");
            url = "CrewExperienceForAdminViewModeList?crewID=" + ConvertToString(lastDeletedExperienceCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewExperienceForAdminViewModeDeleteBase : CrewExperienceForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewExperienceForAdminViewModeDelete";
        ...
        // Constructor
        public CrewExperienceForAdminViewModeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewExperienceForAdminViewModeDelete";
        ...
        // Constructor
        public CrewExperienceForAdminViewModeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewExperienceForAdminViewModeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewExperienceForAdminViewModeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewExperienceForAdminViewModeDelete?.PageRender();
            }
            return PageResult();
        }
