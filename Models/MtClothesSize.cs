...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtClothesSize mtClothesSize
    {
        get => HttpData.Resolve<MtClothesSize>("MTClothesSize");
        set => HttpData["MTClothesSize"] = value;
    }

    /// <summary>
    /// Table class for MTClothesSize
    /// </summary>
    public class MtClothesSize : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> CoverallSizeDescription;

        public readonly DbField<SqlDbType> ShirtSizeDescription;
        ...
        public MtClothesSize()
        {
            ...
            Name = "MTClothesSize";
            Type = "TABLE";
            UpdateTable = "dbo.MTClothesSize"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTClothesSize", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            _Name = new (this, "x__Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTClothesSize", "_Name", "CustomMsg"),
                IsUpload = false
            };
            _Name.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Name", "MTClothesSize", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Name", "MTClothesSize", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Name", "MTClothesSize", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Name", _Name);

            // CoverallSizeDescription
            CoverallSizeDescription = new (this, "x_CoverallSizeDescription", 202, SqlDbType.NVarChar) {
                Name = "CoverallSizeDescription",
                Expression = "[CoverallSizeDescription]",
                BasicSearchExpression = "[CoverallSizeDescription]",
                DateTimeFormat = -1,
                VirtualExpression = "[CoverallSizeDescription]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTClothesSize", "CoverallSizeDescription", "CustomMsg"),
                IsUpload = false
            };
            CoverallSizeDescription.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CoverallSizeDescription", "MTClothesSize", true, "CoverallSizeDescription", new List<string> {"CoverallSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CoverallSizeDescription", "MTClothesSize", true, "CoverallSizeDescription", new List<string> {"CoverallSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CoverallSizeDescription", "MTClothesSize", true, "CoverallSizeDescription", new List<string> {"CoverallSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("CoverallSizeDescription", CoverallSizeDescription);

            // ShirtSizeDescription
            ShirtSizeDescription = new (this, "x_ShirtSizeDescription", 202, SqlDbType.NVarChar) {
                Name = "ShirtSizeDescription",
                Expression = "[ShirtSizeDescription]",
                BasicSearchExpression = "[ShirtSizeDescription]",
                DateTimeFormat = -1,
                VirtualExpression = "[ShirtSizeDescription]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTClothesSize", "ShirtSizeDescription", "CustomMsg"),
                IsUpload = false
            };
            ShirtSizeDescription.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("ShirtSizeDescription", "MTClothesSize", true, "ShirtSizeDescription", new List<string> {"ShirtSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("ShirtSizeDescription", "MTClothesSize", true, "ShirtSizeDescription", new List<string> {"ShirtSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("ShirtSizeDescription", "MTClothesSize", true, "ShirtSizeDescription", new List<string> {"ShirtSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("ShirtSizeDescription", ShirtSizeDescription);

            // TrouserSizeDescription
            TrouserSizeDescription = new (this, "x_TrouserSizeDescription", 202, SqlDbType.NVarChar) {
                Name = "TrouserSizeDescription",
                Expression = "[TrouserSizeDescription]",
                BasicSearchExpression = "[TrouserSizeDescription]",
                DateTimeFormat = -1,
                VirtualExpression = "[TrouserSizeDescription]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTClothesSize", "TrouserSizeDescription", "CustomMsg"),
                IsUpload = false
            };
            TrouserSizeDescription.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("TrouserSizeDescription", "MTClothesSize", true, "TrouserSizeDescription", new List<string> {"TrouserSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("TrouserSizeDescription", "MTClothesSize", true, "TrouserSizeDescription", new List<string> {"TrouserSizeDescription", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTClothesSize", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTClothesSize", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("MTClothesSize", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTClothesSize", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTClothesSize", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTClothesSize", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTClothesSize", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTClothesSize", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTClothesSize", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTClothesSize", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTClothesSize", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTClothesSize";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "MtClothesSizeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtClothesSizeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtClothesSizeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtClothesSizeView",
                Config.ApiAddAction => "MtClothesSizeAdd",
                Config.ApiEditAction => "MtClothesSizeEdit",
                Config.ApiDeleteAction => "MtClothesSizeDelete",
                Config.ApiListAction => "MtClothesSizeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtClothesSizeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtClothesSizeView", parm);
            else
                url = KeyUrl("MtClothesSizeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtClothesSizeAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtClothesSizeAdd?" + parm;
            else
                url = "MtClothesSizeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtClothesSizeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtClothesSizeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtClothesSizeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtClothesSizeList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtClothesSizeDelete")); // DN
        ...
        {
            string pageName = "MtClothesSizeList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // CoverallSizeDescription
            CoverallSizeDescription.SetupEditAttributes();
            if (!CoverallSizeDescription.Raw)
                CoverallSizeDescription.CurrentValue = HtmlDecode(CoverallSizeDescription.CurrentValue);
            CoverallSizeDescription.EditValue = HtmlEncode(CoverallSizeDescription.CurrentValue);
            CoverallSizeDescription.PlaceHolder = RemoveHtml(CoverallSizeDescription.Caption);

            // ShirtSizeDescription
            ShirtSizeDescription.SetupEditAttributes();
            if (!ShirtSizeDescription.Raw)
                ShirtSizeDescription.CurrentValue = HtmlDecode(ShirtSizeDescription.CurrentValue);
            ShirtSizeDescription.EditValue = HtmlEncode(ShirtSizeDescription.CurrentValue);
            ShirtSizeDescription.PlaceHolder = RemoveHtml(ShirtSizeDescription.Caption);

            // TrouserSizeDescription
            TrouserSizeDescription.SetupEditAttributes();
            if (!TrouserSizeDescription.Raw)
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(CoverallSizeDescription);
                        doc.ExportCaption(ShirtSizeDescription);
                        doc.ExportCaption(TrouserSizeDescription);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(CoverallSizeDescription);
                            await doc.ExportField(ShirtSizeDescription);
                            await doc.ExportField(TrouserSizeDescription);
