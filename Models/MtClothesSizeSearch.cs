...
public partial class PCM {
    ...
    /// mtClothesSizeSearch
    /// </summary>
    public static MtClothesSizeSearch mtClothesSizeSearch
    {
        get => HttpData.Get<MtClothesSizeSearch>("mtClothesSizeSearch")!;
        set => HttpData["mtClothesSizeSearch"] = value;
    }

    /// <summary>
    /// Page class for MTClothesSize
    /// </summary>
    public class MtClothesSizeSearch : MtClothesSizeSearchBase
    {
        // Constructor
        public MtClothesSizeSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtClothesSizeSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtClothesSizeSearchBase : MtClothesSize
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtClothesSizeSearch";
        ...
        // Constructor
        public MtClothesSizeSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtClothesSizeSearch";
        ...
        // Constructor
        public MtClothesSizeSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtClothesSizeList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtClothesSizeSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string BuildAdvancedSearch() {
            ...
            BuildSearchUrl(ref srchUrl, CoverallSizeDescription); // CoverallSizeDescription
            BuildSearchUrl(ref srchUrl, ShirtSizeDescription); // ShirtSizeDescription
            BuildSearchUrl(ref srchUrl, TrouserSizeDescription); // TrouserSizeDescription
        ...
        protected void LoadSearchValues() {
            ...
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_CoverallSizeDescription"))
                    CoverallSizeDescription.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_CoverallSizeDescription");
            if (Form.ContainsKey("z_CoverallSizeDescription"))
                CoverallSizeDescription.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_CoverallSizeDescription");

            // ShirtSizeDescription
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_ShirtSizeDescription"))
                    ShirtSizeDescription.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_ShirtSizeDescription");
            if (Form.ContainsKey("z_ShirtSizeDescription"))
                ShirtSizeDescription.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_ShirtSizeDescription");

            // TrouserSizeDescription
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_TrouserSizeDescription"))
                    TrouserSizeDescription.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_TrouserSizeDescription");
            if (Form.ContainsKey("z_TrouserSizeDescription"))
                TrouserSizeDescription.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_TrouserSizeDescription");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!CoverallSizeDescription.Raw)
                    CoverallSizeDescription.AdvancedSearch.SearchValue = HtmlDecode(CoverallSizeDescription.AdvancedSearch.SearchValue);
                CoverallSizeDescription.EditValue = HtmlEncode(CoverallSizeDescription.AdvancedSearch.SearchValue);
                ...
                if (!ShirtSizeDescription.Raw)
                    ShirtSizeDescription.AdvancedSearch.SearchValue = HtmlDecode(ShirtSizeDescription.AdvancedSearch.SearchValue);
                ShirtSizeDescription.EditValue = HtmlEncode(ShirtSizeDescription.AdvancedSearch.SearchValue);
                ...
                if (!TrouserSizeDescription.Raw)
                    TrouserSizeDescription.AdvancedSearch.SearchValue = HtmlDecode(TrouserSizeDescription.AdvancedSearch.SearchValue);
                TrouserSizeDescription.EditValue = HtmlEncode(TrouserSizeDescription.AdvancedSearch.SearchValue);
