...
public partial class PCM {
    ...
    /// mtCertificateView
    /// </summary>
    public static MtCertificateView mtCertificateView
    {
        get => HttpData.Get<MtCertificateView>("mtCertificateView")!;
        set => HttpData["mtCertificateView"] = value;
    }

    /// <summary>
    /// Page class for MTCertificate
    /// </summary>
    public class MtCertificateView : MtCertificateViewBase
    {
        // Constructor
        public MtCertificateView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateViewBase : MtCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateView";
        ...
        // Page name
        public string PageName => "MtCertificateView";
        ...
        // Constructor
        public MtCertificateViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtCertificateList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtCertificateList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTCertificateview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
