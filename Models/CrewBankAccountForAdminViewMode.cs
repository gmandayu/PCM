...
public partial class PCM {
    /// <summary>
    /// crewBankAccountForAdminViewMode
    /// </summary>
    [MaybeNull]
    public static CrewBankAccountForAdminViewMode crewBankAccountForAdminViewMode
    {
        get => HttpData.Resolve<CrewBankAccountForAdminViewMode>("CrewBankAccountForAdminViewMode");
        set => HttpData["CrewBankAccountForAdminViewMode"] = value;
    }

    /// <summary>
    /// Table class for CrewBankAccountForAdminViewMode
    /// </summary>
    public class CrewBankAccountForAdminViewMode : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public CrewBankAccountForAdminViewMode()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewBankAccountForAdminViewMode";
            Name = "CrewBankAccountForAdminViewMode";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            AccountNumber = new (this, "x_AccountNumber", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "AccountNumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            Beneficiary = new (this, "x_Beneficiary", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "Beneficiary", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTCurrencyID = new (this, "x_MTCurrencyID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "MTCurrencyID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MainAcc = new (this, "x_MainAcc", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "MainAcc", "CustomMsg"),
                IsUpload = false
            };
            MainAcc.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MainAcc", "CrewBankAccountForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MainAcc", "CrewBankAccountForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MainAcc", "CrewBankAccountForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Attachment = new (this, "x_Attachment", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "Attachment", "CustomMsg"),
                IsUpload = true
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewBankAccountForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewBankAccountForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewBankAccountForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewBankAccountForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewBankAccountForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewBankAccountForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTBankID = new (this, "x_MTBankID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "MTBankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            OtherBankName = new (this, "x_OtherBankName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewBankAccountForAdminViewMode", "OtherBankName", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewBankAccountForAdminViewModeList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewBankAccountForAdminViewModeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewBankAccountForAdminViewModeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewBankAccountForAdminViewModeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewBankAccountForAdminViewModeView",
                Config.ApiAddAction => "CrewBankAccountForAdminViewModeAdd",
                Config.ApiEditAction => "CrewBankAccountForAdminViewModeEdit",
                Config.ApiDeleteAction => "CrewBankAccountForAdminViewModeDelete",
                Config.ApiListAction => "CrewBankAccountForAdminViewModeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewBankAccountForAdminViewModeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewBankAccountForAdminViewModeView", parm);
            else
                url = KeyUrl("CrewBankAccountForAdminViewModeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewBankAccountForAdminViewModeAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewBankAccountForAdminViewModeAdd?" + parm;
            else
                url = "CrewBankAccountForAdminViewModeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewBankAccountForAdminViewModeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewBankAccountForAdminViewModeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewBankAccountForAdminViewModeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewBankAccountForAdminViewModeList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewBankAccountForAdminViewModeDelete")); // DN
        ...
        {
            string pageName = "CrewBankAccountForAdminViewModeList";
        ...
        public async Task RenderListRow()
        {
            ...
            if (Attachment.UseColorbox) {
                ...
                Attachment.LinkAttrs["data-rel"] = "CrewBankAccountForAdminViewMode_x_Attachment";
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            ...
            if ((object) crewQueryResult != null)
            {
                ...
                string bankAndAccountNumber = rsnew["MTBankID"] + "-" + rsnew["AccountNumber"];
        ...
        public void RowDeleted(Dictionary<string, object> rs) {
            //Log("Row Deleted");
            Session.SetInt("lastDeletedBankAccountCrewID", ConvertToInt(rs["MTCrewID"]));
        }
