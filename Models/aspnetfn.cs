...
public partial class PCM {
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(PCM).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(PCM).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
