...
public partial class PCM {
    ...
    /// mtBankSearch
    /// </summary>
    public static MtBankSearch mtBankSearch
    {
        get => HttpData.Get<MtBankSearch>("mtBankSearch")!;
        set => HttpData["mtBankSearch"] = value;
    }

    /// <summary>
    /// Page class for MTBank
    /// </summary>
    public class MtBankSearch : MtBankSearchBase
    {
        // Constructor
        public MtBankSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBankSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBankSearchBase : MtBank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBankSearch";
        ...
        // Page name
        public string PageName => "MtBankSearch";
        ...
        // Constructor
        public MtBankSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (!Empty(curVal)) {
                    if (CreatedByUserID.Lookup != null && IsDictionary(CreatedByUserID.Lookup?.Options) && CreatedByUserID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                        ...
                        if (rswrk?.Count > 0 && CreatedByUserID.Lookup != null) { // Lookup values found
                            ...
                            CreatedByUserID.EditValue = HtmlEncode(FormatNumber(CreatedByUserID.AdvancedSearch.SearchValue, CreatedByUserID.FormatPattern));
                        }
                    }
                } else {
                ...
                if (!Empty(curVal)) {
                    if (LastUpdatedByUserID.Lookup != null && IsDictionary(LastUpdatedByUserID.Lookup?.Options) && LastUpdatedByUserID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                        ...
                        if (rswrk?.Count > 0 && LastUpdatedByUserID.Lookup != null) { // Lookup values found
                            ...
                            LastUpdatedByUserID.EditValue = HtmlEncode(FormatNumber(LastUpdatedByUserID.AdvancedSearch.SearchValue, LastUpdatedByUserID.FormatPattern));
                        }
                    }
                } else {
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtBankList")), "", TableVar, true);
