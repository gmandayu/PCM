    ...
    public class UpdateTracking : DbTable, IQueryFactory
    {
        ...
        public UpdateTracking()
        {
            ...
            ColumnName = new (this, "x_ColumnName", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[ColumnName]",
                DateTimeFormat = -1,
                VirtualExpression = "[ColumnName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
            ...
            // ChangeType
            ChangeType = new (this, "x_ChangeType", 202, SqlDbType.NVarChar) {
                Name = "ChangeType",
                Expression = "[ChangeType]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ChangeType]",
                DateTimeFormat = -1,
                VirtualExpression = "[ChangeType]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
