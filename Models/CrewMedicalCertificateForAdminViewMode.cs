...
public partial class PCM {
    /// <summary>
    /// crewMedicalCertificateForAdminViewMode
    /// </summary>
    [MaybeNull]
    public static CrewMedicalCertificateForAdminViewMode crewMedicalCertificateForAdminViewMode
    {
        get => HttpData.Resolve<CrewMedicalCertificateForAdminViewMode>("CrewMedicalCertificateForAdminViewMode");
        set => HttpData["CrewMedicalCertificateForAdminViewMode"] = value;
    }

    /// <summary>
    /// Table class for CrewMedicalCertificateForAdminViewMode
    /// </summary>
    public class CrewMedicalCertificateForAdminViewMode : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewMode()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewMedicalCertificateForAdminViewMode";
            Name = "CrewMedicalCertificateForAdminViewMode";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                Name = "ID",
                Expression = "dbo.MTCrewMedicalCertificate.ID",
                BasicSearchExpression = "CAST(dbo.MTCrewMedicalCertificate.ID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.ID",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTMedicalCertificateID = new (this, "x_MTMedicalCertificateID", 3, SqlDbType.Int) {
                ...
                Expression = "dbo.MTCrewMedicalCertificate.MTMedicalCertificateID",
                BasicSearchExpression = "CAST(dbo.MTCrewMedicalCertificate.MTMedicalCertificateID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.MTMedicalCertificateID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "MTMedicalCertificateID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Number = new (this, "x_Number", 202, SqlDbType.NVarChar) {
                Name = "Number",
                Expression = "dbo.MTCrewMedicalCertificate.Number",
                UseBasicSearch = true,
                BasicSearchExpression = "dbo.MTCrewMedicalCertificate.Number",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.Number",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "Number", "CustomMsg"),
                IsUpload = false
            };
            Number.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Number", "CrewMedicalCertificateForAdminViewMode", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Number", "CrewMedicalCertificateForAdminViewMode", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Number", "CrewMedicalCertificateForAdminViewMode", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PlaceOfIssue = new (this, "x_PlaceOfIssue", 202, SqlDbType.NVarChar) {
                Name = "PlaceOfIssue",
                Expression = "dbo.MTCrewMedicalCertificate.PlaceOfIssue",
                UseBasicSearch = true,
                BasicSearchExpression = "dbo.MTCrewMedicalCertificate.PlaceOfIssue",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.PlaceOfIssue",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "PlaceOfIssue", "CustomMsg"),
                IsUpload = false
            };
            PlaceOfIssue.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PlaceOfIssue", "CrewMedicalCertificateForAdminViewMode", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PlaceOfIssue", "CrewMedicalCertificateForAdminViewMode", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PlaceOfIssue", "CrewMedicalCertificateForAdminViewMode", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            DateOfIssue = new (this, "x_DateOfIssue", 133, SqlDbType.Date) {
                Name = "DateOfIssue",
                Expression = "dbo.MTCrewMedicalCertificate.DateOfIssue",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewMedicalCertificate.DateOfIssue", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.DateOfIssue",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "DateOfIssue", "CustomMsg"),
                IsUpload = false
            };
            DateOfIssue.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateOfIssue", "CrewMedicalCertificateForAdminViewMode", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateOfIssue", "CrewMedicalCertificateForAdminViewMode", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateOfIssue", "CrewMedicalCertificateForAdminViewMode", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("DateOfIssue", DateOfIssue);

            // ExpirationDate
            ExpirationDate = new (this, "x_ExpirationDate", 133, SqlDbType.Date) {
                Name = "ExpirationDate",
                Expression = "dbo.MTCrewMedicalCertificate.ExpirationDate",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewMedicalCertificate.ExpirationDate", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.ExpirationDate",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "ExpirationDate", "CustomMsg"),
                IsUpload = false
            };
            ExpirationDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("ExpirationDate", "CrewMedicalCertificateForAdminViewMode", true, "ExpirationDate", new List<string> {"ExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("ExpirationDate", "CrewMedicalCertificateForAdminViewMode", true, "ExpirationDate", new List<string> {"ExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("ExpirationDate", "CrewMedicalCertificateForAdminViewMode", true, "ExpirationDate", new List<string> {"ExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Attachment = new (this, "x_Attachment", 202, SqlDbType.NVarChar) {
                Name = "Attachment",
                Expression = "dbo.MTCrewMedicalCertificate.Attachment",
                UseBasicSearch = true,
                BasicSearchExpression = "dbo.MTCrewMedicalCertificate.Attachment",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.Attachment",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "Attachment", "CustomMsg"),
                IsUpload = true
            };
            Attachment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Attachment", "CrewMedicalCertificateForAdminViewMode", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Attachment", "CrewMedicalCertificateForAdminViewMode", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Attachment", "CrewMedicalCertificateForAdminViewMode", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                Name = "MTCrewID",
                Expression = "dbo.MTCrewMedicalCertificate.MTCrewID",
                BasicSearchExpression = "CAST(dbo.MTCrewMedicalCertificate.MTCrewID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.MTCrewID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                Name = "MTUserID",
                Expression = "dbo.MTCrewMedicalCertificate.MTUserID",
                BasicSearchExpression = "CAST(dbo.MTCrewMedicalCertificate.MTUserID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.MTUserID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Expression = "dbo.MTCrewMedicalCertificate.ActiveDescription",
                BasicSearchExpression = "dbo.MTCrewMedicalCertificate.ActiveDescription",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.ActiveDescription",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                Expression = "dbo.MTCrewMedicalCertificate.CreatedByUserID",
                BasicSearchExpression = "CAST(dbo.MTCrewMedicalCertificate.CreatedByUserID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.CreatedByUserID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                Expression = "dbo.MTCrewMedicalCertificate.CreatedDateTime",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewMedicalCertificate.CreatedDateTime", 1, "DB"),
                DateTimeFormat = 1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.CreatedDateTime",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewMedicalCertificateForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewMedicalCertificateForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewMedicalCertificateForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                Expression = "dbo.MTCrewMedicalCertificate.LastUpdatedByUserID",
                BasicSearchExpression = "CAST(dbo.MTCrewMedicalCertificate.LastUpdatedByUserID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.LastUpdatedByUserID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                Expression = "dbo.MTCrewMedicalCertificate.LastUpdatedDateTime",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewMedicalCertificate.LastUpdatedDateTime", 1, "DB"),
                DateTimeFormat = 1,
                VirtualExpression = "dbo.MTCrewMedicalCertificate.LastUpdatedDateTime",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalCertificateForAdminViewMode", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewMedicalCertificateForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewMedicalCertificateForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewMedicalCertificateForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        public string SqlSelect { // Select
            get => _sqlSelect ?? "SELECT dbo.MTCrewMedicalCertificate.ID, dbo.MTCrewMedicalCertificate.MTMedicalCertificateID, dbo.MTCrewMedicalCertificate.Number, dbo.MTCrewMedicalCertificate.PlaceOfIssue, dbo.MTCrewMedicalCertificate.DateOfIssue, dbo.MTCrewMedicalCertificate.ExpirationDate, dbo.MTCrewMedicalCertificate.Attachment, dbo.MTCrewMedicalCertificate.MTCrewID, dbo.MTCrewMedicalCertificate.MTUserID, dbo.MTCrewMedicalCertificate.ActiveDescription, dbo.MTCrewMedicalCertificate.CreatedByUserID, dbo.MTCrewMedicalCertificate.CreatedDateTime, dbo.MTCrewMedicalCertificate.LastUpdatedByUserID, dbo.MTCrewMedicalCertificate.LastUpdatedDateTime FROM " + SqlFrom;
        ...
        private string _sqlKeyFilter => "dbo.MTCrewMedicalCertificate.ID = @ID@";
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewMedicalCertificateForAdminViewModeList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewMedicalCertificateForAdminViewModeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewMedicalCertificateForAdminViewModeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewMedicalCertificateForAdminViewModeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewMedicalCertificateForAdminViewModeView",
                Config.ApiAddAction => "CrewMedicalCertificateForAdminViewModeAdd",
                Config.ApiEditAction => "CrewMedicalCertificateForAdminViewModeEdit",
                Config.ApiDeleteAction => "CrewMedicalCertificateForAdminViewModeDelete",
                Config.ApiListAction => "CrewMedicalCertificateForAdminViewModeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewMedicalCertificateForAdminViewModeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewMedicalCertificateForAdminViewModeView", parm);
            else
                url = KeyUrl("CrewMedicalCertificateForAdminViewModeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewMedicalCertificateForAdminViewModeAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewMedicalCertificateForAdminViewModeAdd?" + parm;
            else
                url = "CrewMedicalCertificateForAdminViewModeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewMedicalCertificateForAdminViewModeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewMedicalCertificateForAdminViewModeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewMedicalCertificateForAdminViewModeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewMedicalCertificateForAdminViewModeList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewMedicalCertificateForAdminViewModeDelete")); // DN
        ...
        {
            string pageName = "CrewMedicalCertificateForAdminViewModeList";
        ...
        public async Task RenderListRow()
        {
            ...
            if (Attachment.UseColorbox) {
                ...
                Attachment.LinkAttrs["data-rel"] = "CrewMedicalCertificateForAdminViewMode_x_Attachment";
        ...
        public string AddUserIDFilter(string filter = "", string id = "")
        {
            ...
            if (!UserIDAllow(id) && !Security.IsAdmin) {
                ...
                if (!Empty(filterWrk))
                    filterWrk = "dbo.MTCrewMedicalCertificate.MTUserID IN (" + filterWrk + ")";
            }
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            ...
            if ((object) crewQueryResult != null)
            {
                ...
                dynamic medicalCertificateQueryResult = QueryBuilder("MTMedicalCertificate").Where("ID", rsnew["MTMedicalCertificateID"].ToString()).Select("Name").FirstOrDefault();
                if ((object) medicalCertificateQueryResult != null)
                {
                    string medicalCertificateName = medicalCertificateQueryResult.Name;
                    string medicalCertificateNameURLFriendly = GenerateSlug(medicalCertificateName);
                    rsnew["Attachment"] = crewIndividualCodeNumber + "-mc-" + medicalCertificateNameURLFriendly + attachmentFileExtension;
                }
        ...
        public void RowInserted(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            //Log("Row Inserted");
            Session.SetInt("lastAddedMedicalCertificateCrewID", ConvertToInt(rsnew["MTCrewID"]));
        }
        // Row Updating event
        ...
        public void RowUpdated(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            //Log("Row Updated");
            Session.SetInt("lastUpdatedMedicalCertificateCrewID", ConvertToInt(rsnew["MTCrewID"]));
        }
        ...
        public void RowDeleted(Dictionary<string, object> rs) {
            //Log("Row Deleted");
            Session.SetInt("lastDeletedMedicalCertificateCrewID", ConvertToInt(rs["MTCrewID"]));
        }
