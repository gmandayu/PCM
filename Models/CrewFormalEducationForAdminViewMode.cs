...
public partial class PCM {
    /// <summary>
    /// crewFormalEducationForAdminViewMode
    /// </summary>
    [MaybeNull]
    public static CrewFormalEducationForAdminViewMode crewFormalEducationForAdminViewMode
    {
        get => HttpData.Resolve<CrewFormalEducationForAdminViewMode>("CrewFormalEducationForAdminViewMode");
        set => HttpData["CrewFormalEducationForAdminViewMode"] = value;
    }

    /// <summary>
    /// Table class for CrewFormalEducationForAdminViewMode
    /// </summary>
    public class CrewFormalEducationForAdminViewMode : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> EducationLevel;

        public readonly DbField<SqlDbType> SchoolName;
        ...
        // Constructor
        public CrewFormalEducationForAdminViewMode()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewFormalEducationForAdminViewMode";
            Name = "CrewFormalEducationForAdminViewMode";
            Type = "CUSTOMVIEW";
            UpdateTable = "dbo.MTCrewFormalEducation"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                Name = "ID",
                Expression = "dbo.MTCrewFormalEducation.ID",
                BasicSearchExpression = "CAST(dbo.MTCrewFormalEducation.ID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.ID",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);

            // EducationLevel
            EducationLevel = new (this, "x_EducationLevel", 202, SqlDbType.NVarChar) {
                Name = "EducationLevel",
                Expression = "dbo.MTCrewFormalEducation.EducationLevel",
                UseBasicSearch = true,
                BasicSearchExpression = "dbo.MTCrewFormalEducation.EducationLevel",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.EducationLevel",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 8,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "EducationLevel", "CustomMsg"),
                IsUpload = false
            };
            EducationLevel.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("EducationLevel", "CrewFormalEducationForAdminViewMode", true, "EducationLevel", new List<string> {"EducationLevel", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("EducationLevel", "CrewFormalEducationForAdminViewMode", true, "EducationLevel", new List<string> {"EducationLevel", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("EducationLevel", "CrewFormalEducationForAdminViewMode", true, "EducationLevel", new List<string> {"EducationLevel", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("EducationLevel", EducationLevel);

            // SchoolName
            SchoolName = new (this, "x_SchoolName", 202, SqlDbType.NVarChar) {
                Name = "SchoolName",
                Expression = "dbo.MTCrewFormalEducation.SchoolName",
                UseBasicSearch = true,
                BasicSearchExpression = "dbo.MTCrewFormalEducation.SchoolName",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.SchoolName",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "SchoolName", "CustomMsg"),
                IsUpload = false
            };
            SchoolName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SchoolName", "CrewFormalEducationForAdminViewMode", true, "SchoolName", new List<string> {"SchoolName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SchoolName", "CrewFormalEducationForAdminViewMode", true, "SchoolName", new List<string> {"SchoolName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SchoolName", "CrewFormalEducationForAdminViewMode", true, "SchoolName", new List<string> {"SchoolName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("SchoolName", SchoolName);

            // City
            City = new (this, "x_City", 202, SqlDbType.NVarChar) {
                Name = "City",
                Expression = "dbo.MTCrewFormalEducation.City",
                UseBasicSearch = true,
                BasicSearchExpression = "dbo.MTCrewFormalEducation.City",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.City",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "City", "CustomMsg"),
                IsUpload = false
            };
            City.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("City", "CrewFormalEducationForAdminViewMode", true, "City", new List<string> {"City", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("City", "CrewFormalEducationForAdminViewMode", true, "City", new List<string> {"City", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("City", "CrewFormalEducationForAdminViewMode", true, "City", new List<string> {"City", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Attachment = new (this, "x_Attachment", 202, SqlDbType.NVarChar) {
                Name = "Attachment",
                Expression = "dbo.MTCrewFormalEducation.Attachment",
                UseBasicSearch = true,
                BasicSearchExpression = "dbo.MTCrewFormalEducation.Attachment",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.Attachment",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "Attachment", "CustomMsg"),
                IsUpload = true
            };
            Attachment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Attachment", "CrewFormalEducationForAdminViewMode", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Attachment", "CrewFormalEducationForAdminViewMode", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Attachment", "CrewFormalEducationForAdminViewMode", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Attachment", Attachment);

            // StartDate
            StartDate = new (this, "x_StartDate", 133, SqlDbType.Date) {
                Name = "StartDate",
                Expression = "dbo.MTCrewFormalEducation.StartDate",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewFormalEducation.StartDate", 0, "DB"),
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.StartDate",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "StartDate", "CustomMsg"),
                IsUpload = false
            };
            StartDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("StartDate", "CrewFormalEducationForAdminViewMode", true, "StartDate", new List<string> {"StartDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("StartDate", "CrewFormalEducationForAdminViewMode", true, "StartDate", new List<string> {"StartDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("StartDate", "CrewFormalEducationForAdminViewMode", true, "StartDate", new List<string> {"StartDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("StartDate", StartDate);

            // EndDate
            EndDate = new (this, "x_EndDate", 133, SqlDbType.Date) {
                Name = "EndDate",
                Expression = "dbo.MTCrewFormalEducation.EndDate",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewFormalEducation.EndDate", 0, "DB"),
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.EndDate",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "EndDate", "CustomMsg"),
                IsUpload = false
            };
            EndDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("EndDate", "CrewFormalEducationForAdminViewMode", true, "EndDate", new List<string> {"EndDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("EndDate", "CrewFormalEducationForAdminViewMode", true, "EndDate", new List<string> {"EndDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("EndDate", "CrewFormalEducationForAdminViewMode", true, "EndDate", new List<string> {"EndDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                Name = "MTCrewID",
                Expression = "dbo.MTCrewFormalEducation.MTCrewID",
                BasicSearchExpression = "CAST(dbo.MTCrewFormalEducation.MTCrewID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.MTCrewID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                Name = "MTUserID",
                Expression = "dbo.MTCrewFormalEducation.MTUserID",
                BasicSearchExpression = "CAST(dbo.MTCrewFormalEducation.MTUserID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.MTUserID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Expression = "dbo.MTCrewFormalEducation.ActiveDescription",
                BasicSearchExpression = "dbo.MTCrewFormalEducation.ActiveDescription",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.ActiveDescription",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                Expression = "dbo.MTCrewFormalEducation.CreatedByUserID",
                BasicSearchExpression = "CAST(dbo.MTCrewFormalEducation.CreatedByUserID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.CreatedByUserID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                Expression = "dbo.MTCrewFormalEducation.CreatedDateTime",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewFormalEducation.CreatedDateTime", 1, "DB"),
                DateTimeFormat = 1,
                VirtualExpression = "dbo.MTCrewFormalEducation.CreatedDateTime",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewFormalEducationForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewFormalEducationForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewFormalEducationForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                Expression = "dbo.MTCrewFormalEducation.LastUpdatedByUserID",
                BasicSearchExpression = "CAST(dbo.MTCrewFormalEducation.LastUpdatedByUserID AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "dbo.MTCrewFormalEducation.LastUpdatedByUserID",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                Expression = "dbo.MTCrewFormalEducation.LastUpdatedDateTime",
                BasicSearchExpression = CastDateFieldForLike("dbo.MTCrewFormalEducation.LastUpdatedDateTime", 1, "DB"),
                DateTimeFormat = 1,
                VirtualExpression = "dbo.MTCrewFormalEducation.LastUpdatedDateTime",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewFormalEducationForAdminViewMode", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewFormalEducationForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewFormalEducationForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewFormalEducationForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTCrewFormalEducation";
            set => _sqlFrom = value;
        }
        ...
        public string SqlSelect { // Select
            get => _sqlSelect ?? "SELECT dbo.MTCrewFormalEducation.ID, dbo.MTCrewFormalEducation.EducationLevel, dbo.MTCrewFormalEducation.SchoolName, dbo.MTCrewFormalEducation.City, dbo.MTCrewFormalEducation.Attachment, dbo.MTCrewFormalEducation.StartDate, dbo.MTCrewFormalEducation.EndDate, dbo.MTCrewFormalEducation.MTCrewID, dbo.MTCrewFormalEducation.MTUserID, dbo.MTCrewFormalEducation.ActiveDescription, dbo.MTCrewFormalEducation.CreatedByUserID, dbo.MTCrewFormalEducation.CreatedDateTime, dbo.MTCrewFormalEducation.LastUpdatedByUserID, dbo.MTCrewFormalEducation.LastUpdatedDateTime FROM " + SqlFrom;
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                EducationLevel.DbValue = row["EducationLevel"]; // Set DB value only
                SchoolName.DbValue = row["SchoolName"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "dbo.MTCrewFormalEducation.ID = @ID@";
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewFormalEducationForAdminViewModeList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewFormalEducationForAdminViewModeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewFormalEducationForAdminViewModeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewFormalEducationForAdminViewModeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewFormalEducationForAdminViewModeView",
                Config.ApiAddAction => "CrewFormalEducationForAdminViewModeAdd",
                Config.ApiEditAction => "CrewFormalEducationForAdminViewModeEdit",
                Config.ApiDeleteAction => "CrewFormalEducationForAdminViewModeDelete",
                Config.ApiListAction => "CrewFormalEducationForAdminViewModeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewFormalEducationForAdminViewModeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewFormalEducationForAdminViewModeView", parm);
            else
                url = KeyUrl("CrewFormalEducationForAdminViewModeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewFormalEducationForAdminViewModeAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewFormalEducationForAdminViewModeAdd?" + parm;
            else
                url = "CrewFormalEducationForAdminViewModeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewFormalEducationForAdminViewModeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewFormalEducationForAdminViewModeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewFormalEducationForAdminViewModeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewFormalEducationForAdminViewModeList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewFormalEducationForAdminViewModeDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            ID.SetDbValue(dr["ID"]);
            EducationLevel.SetDbValue(dr["EducationLevel"]);
            SchoolName.SetDbValue(dr["SchoolName"]);
        ...
        {
            string pageName = "CrewFormalEducationForAdminViewModeList";
        ...
        public async Task RenderListRow()
        {
            ...
            if (Attachment.UseColorbox) {
                ...
                Attachment.LinkAttrs["data-rel"] = "CrewFormalEducationForAdminViewMode_x_Attachment";
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(EducationLevel);
                        doc.ExportCaption(SchoolName);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(EducationLevel);
                            await doc.ExportField(SchoolName);
        ...
        public string AddUserIDFilter(string filter = "", string id = "")
        {
            ...
            if (!UserIDAllow(id) && !Security.IsAdmin) {
                ...
                if (!Empty(filterWrk))
                    filterWrk = "dbo.MTCrewFormalEducation.MTUserID IN (" + filterWrk + ")";
            }
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.MTCrewFormalEducation";
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            ...
            if ((object) crewQueryResult != null)
            {
                ...
                string newAttachmentFileNameURLFriendly = GenerateSlug(newAttachmentFileName);
                rsnew["Attachment"] = crewIndividualCodeNumber + "-fe-" + newAttachmentFileNameURLFriendly + attachmentFileExtension;
        ...
        public void RowInserted(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            //Log("Row Inserted");
            Session.SetInt("lastAddedFormalEducationCrewID", ConvertToInt(rsnew["MTCrewID"]));
        }
        // Row Updating event
        ...
        public void RowUpdated(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            //Log("Row Updated");
            Session.SetInt("lastUpdatedFormalEducationCrewID", ConvertToInt(rsnew["MTCrewID"]));
        }
        ...
        public void RowDeleted(Dictionary<string, object> rs) {
            //Log("Row Deleted");
            Session.SetInt("lastDeletedFormalEducationCrewID", ConvertToInt(rs["MTCrewID"]));
        }
