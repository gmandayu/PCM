...
public partial class PCM {
    /// <summary>
    /// crewExperienceForAdminDelete
    /// </summary>
    public static CrewExperienceForAdminDelete crewExperienceForAdminDelete
    {
        get => HttpData.Get<CrewExperienceForAdminDelete>("crewExperienceForAdminDelete")!;
        set => HttpData["crewExperienceForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewExperienceForAdmin
    /// </summary>
    public class CrewExperienceForAdminDelete : CrewExperienceForAdminDeleteBase
    {
        // Constructor
        public CrewExperienceForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewExperienceForAdminDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class CrewExperienceForAdminDeleteBase : CrewExperienceForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewExperienceForAdminDelete";
        ...
        // Constructor
        public CrewExperienceForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewExperienceForAdminDelete";
        ...
        // Constructor
        public CrewExperienceForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewExperienceForAdminList"); // Prevent SQL injection, return to List page
            ...
            using (Recordset = await Connection.OpenDataReaderAsync(sql)) {
                if (Recordset != null) {
                    ...
                    if (!res)
                        return Terminate("CrewExperienceForAdminList"); // Return to List page
                }
            }
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewExperienceForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewExperienceForAdminDelete?.PageRender();
            }
            return PageResult();
        }
