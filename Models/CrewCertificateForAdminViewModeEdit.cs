...
public partial class PCM {
    /// <summary>
    /// crewCertificateForAdminViewModeEdit
    /// </summary>
    public static CrewCertificateForAdminViewModeEdit crewCertificateForAdminViewModeEdit
    {
        get => HttpData.Get<CrewCertificateForAdminViewModeEdit>("crewCertificateForAdminViewModeEdit")!;
        set => HttpData["crewCertificateForAdminViewModeEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewCertificateForAdminViewMode
    /// </summary>
    public class CrewCertificateForAdminViewModeEdit : CrewCertificateForAdminViewModeEditBase
    {
        // Constructor
        public CrewCertificateForAdminViewModeEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewCertificateForAdminViewModeEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastUpdatedCertificateCrewID = Session.GetInt("lastUpdatedCertificateCrewID");
            Session.Remove("lastUpdatedCertificateCrewID");
            url = "CrewCertificateForAdminViewModeList?crewID=" + ConvertToString(lastUpdatedCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewCertificateForAdminViewModeEditBase : CrewCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewCertificateForAdminViewModeEdit";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewCertificateForAdminViewModeEdit";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewCertificateForAdminViewModeList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewCertificateForAdminViewModeEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
