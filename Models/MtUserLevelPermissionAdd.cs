...
public partial class PCM {
    /// <summary>
    /// mtUserLevelPermissionAdd
    /// </summary>
    public static MtUserLevelPermissionAdd mtUserLevelPermissionAdd
    {
        get => HttpData.Get<MtUserLevelPermissionAdd>("mtUserLevelPermissionAdd")!;
        set => HttpData["mtUserLevelPermissionAdd"] = value;
    }

    /// <summary>
    /// Page class for MTUserLevelPermission
    /// </summary>
    public class MtUserLevelPermissionAdd : MtUserLevelPermissionAddBase
    {
        // Constructor
        public MtUserLevelPermissionAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserLevelPermissionAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserLevelPermissionAddBase : MtUserLevelPermission
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserLevelPermissionAdd";
        ...
        // Constructor
        public MtUserLevelPermissionAddBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtUserLevelPermissionAdd";
        ...
        // Constructor
        public MtUserLevelPermissionAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtUserLevelPermissionList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtUserLevelPermissionList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtUserLevelPermissionView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtUserLevelPermissionList") {
                                ...
                                returnUrl = "MtUserLevelPermissionList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtUserLevelPermissionAdd?.PageRender();
            }
            return PageResult();
        }
                ...
                if (!Empty(curVal)) {
                    if (UserLevelID.Lookup != null && IsDictionary(UserLevelID.Lookup?.Options) && UserLevelID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                        ...
                        if (rswrk?.Count > 0 && UserLevelID.Lookup != null) { // Lookup values found
                            ...
                            UserLevelID.EditValue = HtmlEncode(FormatNumber(UserLevelID.CurrentValue, UserLevelID.FormatPattern));
                        }
                    }
                } else {
