...
public partial class PCM {
    ...
    /// mtVesselTypeList
    /// </summary>
    public static MtVesselTypeList mtVesselTypeList
    {
        get => HttpData.Get<MtVesselTypeList>("mtVesselTypeList")!;
        set => HttpData["mtVesselTypeList"] = value;
    }

    /// <summary>
    /// Page class for MTVesselType
    /// </summary>
    public class MtVesselTypeList : MtVesselTypeListBase
    {
        // Constructor
        public MtVesselTypeList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtVesselTypeList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtVesselTypeListBase : MtVesselType
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "MTVesselType";

        // Page object name
        public string PageObjName = "mtVesselTypeList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMTVesselTypelist";
        ...
        // Constructor
        public MtVesselTypeListBase()
        {
            // CSS class name as context
            TableVar = "MTVesselType";
            ...
            // Table object (mtVesselType)
            if (mtVesselType == null || mtVesselType is MtVesselType)
                mtVesselType = this;

            // Initialize URLs
            AddUrl = "MtVesselTypeAdd";
            ...
            MultiDeleteUrl = "MtVesselTypeDelete";
            MultiUpdateUrl = "MtVesselTypeUpdate";
        ...
        // Page name
        public string PageName => "MtVesselTypeList";
        ...
        // Constructor
        public MtVesselTypeListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "MtVesselTypeView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(Abbreviation.AdvancedSearch.ToJson())); // Field Abbreviation
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Abbreviation
            if (filter?.TryGetValue("x_Abbreviation", out sv) ?? false) {
                Abbreviation.AdvancedSearch.SearchValue = sv;
                Abbreviation.AdvancedSearch.SearchOperator = filter["z_Abbreviation"];
                Abbreviation.AdvancedSearch.SearchCondition = filter["v_Abbreviation"];
                Abbreviation.AdvancedSearch.SearchValue2 = filter["y_Abbreviation"];
                Abbreviation.AdvancedSearch.SearchOperator2 = filter["w_Abbreviation"];
                Abbreviation.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            if (!Security.CanSearch)
                return "";
            BuildSearchSql(ref where, Abbreviation, def, true); // Abbreviation
            ...
            if (!def && Command == "search") {
                Abbreviation.AdvancedSearch.Save(); // Abbreviation
        ...
        public void ShowFilterList()
        {
            ...
            // Field Abbreviation
            filter = QueryBuilderWhere("Abbreviation");
            if (Empty(filter))
                BuildSearchSql(ref filter, Abbreviation, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Abbreviation.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        protected bool CheckSearchParms() {
            ...
            if (BasicSearch.IssetSession)
                return true;
            if (Abbreviation.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            Abbreviation.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            Abbreviation.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Abbreviation, ctrl); // Abbreviation
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""MTVesselType"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""MTVesselType"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTVesselTypelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTVesselTypelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""MTVesselType"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Abbreviation")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fMTVesselTypesrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fMTVesselTypesrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fMTVesselTypelist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_MTVesselType");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtVesselTypeList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtVesselTypeList.RowCount) + "_MTVesselType");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtVesselTypeList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtVesselTypeList.RowType == RowType.Add || IsEdit && mtVesselTypeList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            // Abbreviation
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Abbreviation[]"))
                    Abbreviation.AdvancedSearch.SearchValue = Get("x_Abbreviation[]");
                else
                    Abbreviation.AdvancedSearch.SearchValue = Get("Abbreviation"); // Default Value // DN
            if (!Empty(Abbreviation.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_Abbreviation"))
                Abbreviation.AdvancedSearch.SearchOperator = Get("z_Abbreviation");
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Abbreviation.SetDbValue(row["Abbreviation"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Abbreviation", Abbreviation.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            // Abbreviation
            Abbreviation.CellCssStyle = "white-space: nowrap;";
            ...
            if (RowType == RowType.View) {
                // Abbreviation
                Abbreviation.ViewValue = ConvertToString(Abbreviation.CurrentValue); // DN
                Abbreviation.ViewCustomAttributes = "";
                ...
                // Abbreviation
                Abbreviation.HrefValue = "";
                Abbreviation.TooltipValue = "";
                ...
                // Abbreviation
                if (Abbreviation.UseFilter && !Empty(Abbreviation.AdvancedSearch.SearchValue)) {
                    Abbreviation.EditValue = ConvertToString(Abbreviation.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fMTVesselTypesrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"MTVesselType\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("MtVesselTypeSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("MtVesselTypeSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
