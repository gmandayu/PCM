...
public partial class PCM {
    /// <summary>
    /// crewPersonalDataForAdminViewMode
    /// </summary>
    [MaybeNull]
    public static CrewPersonalDataForAdminViewMode crewPersonalDataForAdminViewMode
    {
        get => HttpData.Resolve<CrewPersonalDataForAdminViewMode>("CrewPersonalDataForAdminViewMode");
        set => HttpData["CrewPersonalDataForAdminViewMode"] = value;
    }

    /// <summary>
    /// Table class for CrewPersonalDataForAdminViewMode
    /// </summary>
    public class CrewPersonalDataForAdminViewMode : DbTable, IQueryFactory
    {
        ...
        public CrewPersonalDataForAdminViewMode()
        {
            ...
            TableVar = "CrewPersonalDataForAdminViewMode";
            Name = "CrewPersonalDataForAdminViewMode";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            IndividualCodeNumber.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("IndividualCodeNumber", "CrewPersonalDataForAdminViewMode", true, "IndividualCodeNumber", new List<string> {"IndividualCodeNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("IndividualCodeNumber", "CrewPersonalDataForAdminViewMode", true, "IndividualCodeNumber", new List<string> {"IndividualCodeNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("IndividualCodeNumber", "CrewPersonalDataForAdminViewMode", true, "IndividualCodeNumber", new List<string> {"IndividualCodeNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            FullName = new (this, "x_FullName", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "FullName", "CustomMsg"),
                IsUpload = false
            };
            FullName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("FullName", "CrewPersonalDataForAdminViewMode", true, "FullName", new List<string> {"FullName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("FullName", "CrewPersonalDataForAdminViewMode", true, "FullName", new List<string> {"FullName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("FullName", "CrewPersonalDataForAdminViewMode", true, "FullName", new List<string> {"FullName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Nationality_CountryID = new (this, "x_Nationality_CountryID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "Nationality_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CountryOfOrigin_CountryID = new (this, "x_CountryOfOrigin_CountryID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "CountryOfOrigin_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            DateOfBirth = new (this, "x_DateOfBirth", 133, SqlDbType.Date) {
                ...
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "DateOfBirth", "CustomMsg"),
                IsUpload = false
            };
            DateOfBirth.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateOfBirth", "CrewPersonalDataForAdminViewMode", true, "DateOfBirth", new List<string> {"DateOfBirth", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateOfBirth", "CrewPersonalDataForAdminViewMode", true, "DateOfBirth", new List<string> {"DateOfBirth", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateOfBirth", "CrewPersonalDataForAdminViewMode", true, "DateOfBirth", new List<string> {"DateOfBirth", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            CityOfBirth = new (this, "x_CityOfBirth", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "CityOfBirth", "CustomMsg"),
                IsUpload = false
            };
            CityOfBirth.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CityOfBirth", "CrewPersonalDataForAdminViewMode", true, "CityOfBirth", new List<string> {"CityOfBirth", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CityOfBirth", "CrewPersonalDataForAdminViewMode", true, "CityOfBirth", new List<string> {"CityOfBirth", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CityOfBirth", "CrewPersonalDataForAdminViewMode", true, "CityOfBirth", new List<string> {"CityOfBirth", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Gender = new (this, "x_Gender", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "Gender", "CustomMsg"),
                IsUpload = false
            };
            Gender.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Gender", "CrewPersonalDataForAdminViewMode", true, "Gender", new List<string> {"Gender", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Gender", "CrewPersonalDataForAdminViewMode", true, "Gender", new List<string> {"Gender", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Gender", "CrewPersonalDataForAdminViewMode", true, "Gender", new List<string> {"Gender", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MaritalStatus = new (this, "x_MaritalStatus", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 3,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "MaritalStatus", "CustomMsg"),
                IsUpload = false
            };
            MaritalStatus.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MaritalStatus", "CrewPersonalDataForAdminViewMode", true, "MaritalStatus", new List<string> {"MaritalStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MaritalStatus", "CrewPersonalDataForAdminViewMode", true, "MaritalStatus", new List<string> {"MaritalStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MaritalStatus", "CrewPersonalDataForAdminViewMode", true, "MaritalStatus", new List<string> {"MaritalStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ReligionID = new (this, "x_ReligionID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "ReligionID", "CustomMsg"),
                IsUpload = false
            };
            ...
            RankAppliedFor_RankID = new (this, "x_RankAppliedFor_RankID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "RankAppliedFor_RankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            WillAcceptLowRank = new (this, "x_WillAcceptLowRank", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "WillAcceptLowRank", "CustomMsg"),
                IsUpload = false
            };
            WillAcceptLowRank.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("WillAcceptLowRank", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("WillAcceptLowRank", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("WillAcceptLowRank", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            AvailableFrom = new (this, "x_AvailableFrom", 133, SqlDbType.Date) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AvailableFrom", "CustomMsg"),
                IsUpload = false
            };
            ...
            AvailableUntil = new (this, "x_AvailableUntil", 133, SqlDbType.Date) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AvailableUntil", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressDetail = new (this, "x_PrimaryAddressDetail", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressDetail", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressCity = new (this, "x_PrimaryAddressCity", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressCity", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressNearestAirport = new (this, "x_PrimaryAddressNearestAirport", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressNearestAirport", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressState = new (this, "x_PrimaryAddressState", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressState", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressPostCode = new (this, "x_PrimaryAddressPostCode", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressPostCode", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressCountryID = new (this, "x_PrimaryAddressCountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressCountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressHomeTel = new (this, "x_PrimaryAddressHomeTel", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "tel",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressHomeTel", "CustomMsg"),
                IsUpload = false
            };
            ...
            AlternativeAddressDetail = new (this, "x_AlternativeAddressDetail", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AlternativeAddressDetail", "CustomMsg"),
                IsUpload = false
            };
            ...
            AlternativeAddressState = new (this, "x_AlternativeAddressState", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AlternativeAddressState", "CustomMsg"),
                IsUpload = false
            };
            ...
            AlternativeAddressCity = new (this, "x_AlternativeAddressCity", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AlternativeAddressCity", "CustomMsg"),
                IsUpload = false
            };
            ...
            AlternativeAddressHomeTel = new (this, "x_AlternativeAddressHomeTel", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "tel",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AlternativeAddressHomeTel", "CustomMsg"),
                IsUpload = false
            };
            ...
            AlternativeAddressPostCode = new (this, "x_AlternativeAddressPostCode", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AlternativeAddressPostCode", "CustomMsg"),
                IsUpload = false
            };
            ...
            AlternativeAddressCountryID = new (this, "x_AlternativeAddressCountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AlternativeAddressCountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MobileNumber = new (this, "x_MobileNumber", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "MobileNumber", "CustomMsg"),
                IsUpload = false
            };
            MobileNumber.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MobileNumber", "CrewPersonalDataForAdminViewMode", true, "MobileNumber", new List<string> {"MobileNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MobileNumber", "CrewPersonalDataForAdminViewMode", true, "MobileNumber", new List<string> {"MobileNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MobileNumber", "CrewPersonalDataForAdminViewMode", true, "MobileNumber", new List<string> {"MobileNumber", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            _Email = new (this, "x__Email", 202, SqlDbType.NVarChar) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "_Email", "CustomMsg"),
                IsUpload = false
            };
            _Email.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Email", "CrewPersonalDataForAdminViewMode", true, "Email", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Email", "CrewPersonalDataForAdminViewMode", true, "Email", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Email", "CrewPersonalDataForAdminViewMode", true, "Email", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            EmployeeStatus = new (this, "x_EmployeeStatus", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "EmployeeStatus", "CustomMsg"),
                IsUpload = false
            };
            EmployeeStatus.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("EmployeeStatus", "CrewPersonalDataForAdminViewMode", true, "EmployeeStatus", new List<string> {"EmployeeStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("EmployeeStatus", "CrewPersonalDataForAdminViewMode", true, "EmployeeStatus", new List<string> {"EmployeeStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("EmployeeStatus", "CrewPersonalDataForAdminViewMode", true, "EmployeeStatus", new List<string> {"EmployeeStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            FormSubmittedDateTime = new (this, "x_FormSubmittedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "FormSubmittedDateTime", "CustomMsg"),
                IsUpload = false
            };
            FormSubmittedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("FormSubmittedDateTime", "CrewPersonalDataForAdminViewMode", true, "FormSubmittedDateTime", new List<string> {"FormSubmittedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("FormSubmittedDateTime", "CrewPersonalDataForAdminViewMode", true, "FormSubmittedDateTime", new List<string> {"FormSubmittedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("FormSubmittedDateTime", "CrewPersonalDataForAdminViewMode", true, "FormSubmittedDateTime", new List<string> {"FormSubmittedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewPersonalDataForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewPersonalDataForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewPersonalDataForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewPersonalDataForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewPersonalDataForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewPersonalDataForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            SocialSecurityNumber = new (this, "x_SocialSecurityNumber", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "SocialSecurityNumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            SocialSecurityIssuingCountryID = new (this, "x_SocialSecurityIssuingCountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "SocialSecurityIssuingCountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            SocialSecurityImage = new (this, "x_SocialSecurityImage", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "SocialSecurityImage", "CustomMsg"),
                IsUpload = true
            };
            ...
            PersonalTaxNumber = new (this, "x_PersonalTaxNumber", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PersonalTaxNumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            PersonalTaxIssuingCountryID = new (this, "x_PersonalTaxIssuingCountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PersonalTaxIssuingCountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            PersonalTaxImage = new (this, "x_PersonalTaxImage", 202, SqlDbType.NVarChar) {
                ...
                UploadMaxFileSize = 2000000,
                SearchOperators = new () { "=", "<>", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PersonalTaxImage", "CustomMsg"),
                IsUpload = true
            };
            ...
            BloodType = new (this, "x_BloodType", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 8,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "BloodType", "CustomMsg"),
                IsUpload = false
            };
            BloodType.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("BloodType", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("BloodType", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("BloodType", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            RequiredPhoto = new (this, "x_RequiredPhoto", 202, SqlDbType.NVarChar) {
                ...
                UploadMaxFileSize = 2000000,
                SearchOperators = new () { "=", "<>", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "RequiredPhoto", "CustomMsg"),
                IsUpload = true
            };
            RequiredPhoto.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("RequiredPhoto", "CrewPersonalDataForAdminViewMode", true, "RequiredPhoto", new List<string> {"RequiredPhoto", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("RequiredPhoto", "CrewPersonalDataForAdminViewMode", true, "RequiredPhoto", new List<string> {"RequiredPhoto", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("RequiredPhoto", "CrewPersonalDataForAdminViewMode", true, "RequiredPhoto", new List<string> {"RequiredPhoto", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            VisaPhoto = new (this, "x_VisaPhoto", 202, SqlDbType.NVarChar) {
                ...
                UploadMaxFileSize = 2000000,
                SearchOperators = new () { "=", "<>", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "VisaPhoto", "CustomMsg"),
                IsUpload = true
            };
            VisaPhoto.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("VisaPhoto", "CrewPersonalDataForAdminViewMode", true, "VisaPhoto", new List<string> {"VisaPhoto", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("VisaPhoto", "CrewPersonalDataForAdminViewMode", true, "VisaPhoto", new List<string> {"VisaPhoto", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("VisaPhoto", "CrewPersonalDataForAdminViewMode", true, "VisaPhoto", new List<string> {"VisaPhoto", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Status = new (this, "x_Status", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "Status", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reason = new (this, "x_Reason", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "Reason", "CustomMsg"),
                IsUpload = false
            };
            ...
            Weight = new (this, "x_Weight", 3, SqlDbType.Int) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "Weight", "CustomMsg"),
                IsUpload = false
            };
            ...
            Height = new (this, "x_Height", 3, SqlDbType.Int) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "Height", "CustomMsg"),
                IsUpload = false
            };
            ...
            CoverallSize = new (this, "x_CoverallSize", 202, SqlDbType.NVarChar) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "CoverallSize", "CustomMsg"),
                IsUpload = false
            };
            ...
            SafetyShoesSize = new (this, "x_SafetyShoesSize", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "SafetyShoesSize", "CustomMsg"),
                IsUpload = false
            };
            SafetyShoesSize.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SafetyShoesSize", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SafetyShoesSize", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SafetyShoesSize", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ShirtSize = new (this, "x_ShirtSize", 202, SqlDbType.NVarChar) {
                ...
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "ShirtSize", "CustomMsg"),
                IsUpload = false
            };
            ...
            TrousersSize = new (this, "x_TrousersSize", 202, SqlDbType.NVarChar) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "TrousersSize", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeFullName = new (this, "x_NomineeFullName", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeFullName", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeRelationship = new (this, "x_NomineeRelationship", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeRelationship", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeGender = new (this, "x_NomineeGender", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeGender", "CustomMsg"),
                IsUpload = false
            };
            NomineeGender.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("NomineeGender", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("NomineeGender", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("NomineeGender", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            NomineeNationality_CountryID = new (this, "x_NomineeNationality_CountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeNationality_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeAddressDetail = new (this, "x_NomineeAddressDetail", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeAddressDetail", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeAddressCity = new (this, "x_NomineeAddressCity", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeAddressCity", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeAddressPostCode = new (this, "x_NomineeAddressPostCode", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeAddressPostCode", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeAddressCountryID = new (this, "x_NomineeAddressCountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeAddressCountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeAddressHomeTel = new (this, "x_NomineeAddressHomeTel", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeAddressHomeTel", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeEmail = new (this, "x_NomineeEmail", 202, SqlDbType.NVarChar) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectEmail"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeEmail", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeMobileNumber = new (this, "x_NomineeMobileNumber", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeMobileNumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            NSSF_Health_Number = new (this, "x_NSSF_Health_Number", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NSSF_Health_Number", "CustomMsg"),
                IsUpload = false
            };
            ...
            NSSF_Occupation_Number = new (this, "x_NSSF_Occupation_Number", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NSSF_Occupation_Number", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeRelationshipSelect = new (this, "x_NomineeRelationshipSelect", 200, SqlDbType.VarChar) {
                ...
                OptionCount = 5,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeRelationshipSelect", "CustomMsg"),
                IsUpload = false
            };
            NomineeRelationshipSelect.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("NomineeRelationshipSelect", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("NomineeRelationshipSelect", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("NomineeRelationshipSelect", "CrewPersonalDataForAdminViewMode", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            NomineeRelationshipDetail = new (this, "x_NomineeRelationshipDetail", 200, SqlDbType.VarChar) {
                ...
                IsCustom = true, // Custom field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeRelationshipDetail", "CustomMsg"),
                IsUpload = false
            };
            ...
            MobileNumberCode_CountryID = new (this, "x_MobileNumberCode_CountryID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "MobileNumberCode_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            PrimaryAddressHomeTelCode_CountryID = new (this, "x_PrimaryAddressHomeTelCode_CountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "PrimaryAddressHomeTelCode_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            AlternativeAddressHomeTelCode_CountryID = new (this, "x_AlternativeAddressHomeTelCode_CountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "AlternativeAddressHomeTelCode_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeAddressHomeTelCode_CountryID = new (this, "x_NomineeAddressHomeTelCode_CountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeAddressHomeTelCode_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomineeMobileNumberCode_CountryID = new (this, "x_NomineeMobileNumberCode_CountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewPersonalDataForAdminViewMode", "NomineeMobileNumberCode_CountryID", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewPersonalDataForAdminViewModeList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewPersonalDataForAdminViewModeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewPersonalDataForAdminViewModeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewPersonalDataForAdminViewModeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewPersonalDataForAdminViewModeView",
                Config.ApiAddAction => "CrewPersonalDataForAdminViewModeAdd",
                Config.ApiEditAction => "CrewPersonalDataForAdminViewModeEdit",
                Config.ApiDeleteAction => "CrewPersonalDataForAdminViewModeDelete",
                Config.ApiListAction => "CrewPersonalDataForAdminViewModeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewPersonalDataForAdminViewModeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewPersonalDataForAdminViewModeView", parm);
            else
                url = KeyUrl("CrewPersonalDataForAdminViewModeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewPersonalDataForAdminViewModeAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewPersonalDataForAdminViewModeAdd?" + parm;
            else
                url = "CrewPersonalDataForAdminViewModeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewPersonalDataForAdminViewModeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewPersonalDataForAdminViewModeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewPersonalDataForAdminViewModeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewPersonalDataForAdminViewModeList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewPersonalDataForAdminViewModeDelete")); // DN
        ...
        {
            string pageName = "CrewPersonalDataForAdminViewModeList";
        ...
        public async Task<IActionResult> GetFileData(string fldparm, string[] keys, bool resize, int width = -1, int height = -1)
        {
            ...
            if (SameText(fldparm, "SocialSecurityImage")) {
            ...
            } else if (SameText(fldparm, "RequiredPhoto")) {
