...
public partial class PCM {
    ...
    /// mtCertificateAdd
    /// </summary>
    public static MtCertificateAdd mtCertificateAdd
    {
        get => HttpData.Get<MtCertificateAdd>("mtCertificateAdd")!;
        set => HttpData["mtCertificateAdd"] = value;
    }

    /// <summary>
    /// Page class for MTCertificate
    /// </summary>
    public class MtCertificateAdd : MtCertificateAddBase
    {
        // Constructor
        public MtCertificateAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateAddBase : MtCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateAdd";
        ...
        // Page name
        public string PageName => "MtCertificateAdd";
        ...
        // Constructor
        public MtCertificateAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtCertificateList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtCertificateList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtCertificateView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtCertificateList") {
                                ...
                                returnUrl = "MtCertificateList"; // Return list page content
                            }
                        }
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'CategoryName' before field var 'x_CategoryName'
            val = CurrentForm.HasValue("CategoryName") ? CurrentForm.GetValue("CategoryName") : CurrentForm.GetValue("x_CategoryName");
            if (!CategoryName.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("CategoryName") && !CurrentForm.HasValue("x_CategoryName")) // DN
                    CategoryName.Visible = false; // Disable update for API request
                else
                    CategoryName.SetFormValue(val);
            }
        ...
        {
            CategoryName.CurrentValue = CategoryName.FormValue;
        ...
        protected async Task<bool> ValidateForm() {
            ...
            if (CategoryName.Required) {
                if (!CategoryName.IsDetailKey && Empty(CategoryName.FormValue)) {
                    CategoryName.AddErrorMessage(ConvertToString(CategoryName.RequiredErrorMessage).Replace("%s", CategoryName.Caption));
                }
            }
            if (_Name.Required) {
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                // CategoryName
                CategoryName.SetDbValue(rsnew, CategoryName.CurrentValue);
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtCertificateList")), "", TableVar, true);
