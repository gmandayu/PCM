...
public partial class PCM {
    /// <summary>
    /// crewBankAccountForAdminSearch
    /// </summary>
    public static CrewBankAccountForAdminSearch crewBankAccountForAdminSearch
    {
        get => HttpData.Get<CrewBankAccountForAdminSearch>("crewBankAccountForAdminSearch")!;
        set => HttpData["crewBankAccountForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewBankAccountForAdmin
    /// </summary>
    public class CrewBankAccountForAdminSearch : CrewBankAccountForAdminSearchBase
    {
        // Constructor
        public CrewBankAccountForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewBankAccountForAdminSearch() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class CrewBankAccountForAdminSearchBase : CrewBankAccountForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewBankAccountForAdminSearch";
        ...
        // Constructor
        public CrewBankAccountForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewBankAccountForAdminSearch";
        ...
        // Constructor
        public CrewBankAccountForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewBankAccountForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewBankAccountForAdminSearch?.PageRender();
            }
            return PageResult();
        }
