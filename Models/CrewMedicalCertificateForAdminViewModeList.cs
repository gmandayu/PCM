...
public partial class PCM {
    /// <summary>
    /// crewMedicalCertificateForAdminViewModeList
    /// </summary>
    public static CrewMedicalCertificateForAdminViewModeList crewMedicalCertificateForAdminViewModeList
    {
        get => HttpData.Get<CrewMedicalCertificateForAdminViewModeList>("crewMedicalCertificateForAdminViewModeList")!;
        set => HttpData["crewMedicalCertificateForAdminViewModeList"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalCertificateForAdminViewMode
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeList : CrewMedicalCertificateForAdminViewModeListBase
    {
        // Constructor
        public CrewMedicalCertificateForAdminViewModeList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalCertificateForAdminViewModeList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeListBase : CrewMedicalCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalCertificateForAdminViewModeList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fCrewMedicalCertificateForAdminViewModelist";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeListBase()
        {
            // CSS class name as context
            TableVar = "CrewMedicalCertificateForAdminViewMode";
            ...
            // Initialize URLs
            AddUrl = "CrewMedicalCertificateForAdminViewModeAdd";
            ...
            MultiDeleteUrl = "CrewMedicalCertificateForAdminViewModeDelete";
            MultiUpdateUrl = "CrewMedicalCertificateForAdminViewModeUpdate";
        ...
        // Page name
        public string PageName => "CrewMedicalCertificateForAdminViewModeList";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fCrewMedicalCertificateForAdminViewModegrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalCertificateForAdminViewModeList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(MTMedicalCertificateID.AdvancedSearch.ToJson())); // Field MTMedicalCertificateID
            ...
            filters.Merge(JObject.Parse(ExpirationDate.AdvancedSearch.ToJson())); // Field ExpirationDate
        ...
        protected bool RestoreFilterList() {
            ...
            // Field MTMedicalCertificateID
            if (filter?.TryGetValue("x_MTMedicalCertificateID", out sv) ?? false) {
                MTMedicalCertificateID.AdvancedSearch.SearchValue = sv;
                MTMedicalCertificateID.AdvancedSearch.SearchOperator = filter["z_MTMedicalCertificateID"];
                MTMedicalCertificateID.AdvancedSearch.SearchCondition = filter["v_MTMedicalCertificateID"];
                MTMedicalCertificateID.AdvancedSearch.SearchValue2 = filter["y_MTMedicalCertificateID"];
                MTMedicalCertificateID.AdvancedSearch.SearchOperator2 = filter["w_MTMedicalCertificateID"];
                MTMedicalCertificateID.AdvancedSearch.Save();
            }
            ...
            if (filter?.TryGetValue("x_ExpirationDate", out sv) ?? false) {
                ExpirationDate.AdvancedSearch.SearchValue = sv;
                ExpirationDate.AdvancedSearch.SearchOperator = filter["z_ExpirationDate"];
                ExpirationDate.AdvancedSearch.SearchCondition = filter["v_ExpirationDate"];
                ExpirationDate.AdvancedSearch.SearchValue2 = filter["y_ExpirationDate"];
                ExpirationDate.AdvancedSearch.SearchOperator2 = filter["w_ExpirationDate"];
                ExpirationDate.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            if (!Security.CanSearch)
                return "";
            BuildSearchSql(ref where, MTMedicalCertificateID, def, true); // MTMedicalCertificateID
            ...
            BuildSearchSql(ref where, ExpirationDate, def, true); // ExpirationDate
            ...
            if (!def && Command == "search") {
                MTMedicalCertificateID.AdvancedSearch.Save(); // MTMedicalCertificateID
                ...
                ExpirationDate.AdvancedSearch.Save(); // ExpirationDate
        ...
        public void ShowFilterList()
        {
            ...
            // Field MTMedicalCertificateID
            filter = QueryBuilderWhere("MTMedicalCertificateID");
            if (Empty(filter))
                BuildSearchSql(ref filter, MTMedicalCertificateID, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + MTMedicalCertificateID.Caption + "</span>" + captionSuffix + filter + "</div>";
            ...
            // Field ExpirationDate
            filter = QueryBuilderWhere("ExpirationDate");
            if (Empty(filter))
                BuildSearchSql(ref filter, ExpirationDate, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + ExpirationDate.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        protected bool CheckSearchParms() {
            ...
            if (BasicSearch.IssetSession)
                return true;
            if (MTMedicalCertificateID.AdvancedSearch.IssetSession)
                return true;
            ...
            if (DateOfIssue.AdvancedSearch.IssetSession)
                return true;
            if (ExpirationDate.AdvancedSearch.IssetSession)
                return true;
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""CrewMedicalCertificateForAdminViewMode"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""CrewMedicalCertificateForAdminViewMode"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCrewMedicalCertificateForAdminViewModelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCrewMedicalCertificateForAdminViewModelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""CrewMedicalCertificateForAdminViewMode"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("MTMedicalCertificateID")); // DN
                ...
                CreateColumnOption(option.Add("ExpirationDate")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fCrewMedicalCertificateForAdminViewModesrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fCrewMedicalCertificateForAdminViewModesrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fCrewMedicalCertificateForAdminViewModelist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_CrewMedicalCertificateForAdminViewMode");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(crewMedicalCertificateForAdminViewModeList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(crewMedicalCertificateForAdminViewModeList.RowCount) + "_CrewMedicalCertificateForAdminViewMode");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(crewMedicalCertificateForAdminViewModeList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && crewMedicalCertificateForAdminViewModeList.RowType == RowType.Add || IsEdit && crewMedicalCertificateForAdminViewModeList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_MTMedicalCertificateID[]"))
                    MTMedicalCertificateID.AdvancedSearch.SearchValue = Get("x_MTMedicalCertificateID[]");
                else
                    MTMedicalCertificateID.AdvancedSearch.SearchValue = Get("MTMedicalCertificateID"); // Default Value // DN
            if (!Empty(MTMedicalCertificateID.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_MTMedicalCertificateID"))
                MTMedicalCertificateID.AdvancedSearch.SearchOperator = Get("z_MTMedicalCertificateID");
            ...
            // ExpirationDate
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_ExpirationDate[]"))
                    ExpirationDate.AdvancedSearch.SearchValue = Get("x_ExpirationDate[]");
                else
                    ExpirationDate.AdvancedSearch.SearchValue = Get("ExpirationDate"); // Default Value // DN
            if (!Empty(ExpirationDate.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_ExpirationDate"))
                ExpirationDate.AdvancedSearch.SearchOperator = Get("z_ExpirationDate");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (Attachment.UseColorbox) {
                    ...
                    Attachment.LinkAttrs["data-rel"] = "CrewMedicalCertificateForAdminViewMode_x" + RowCount + "_Attachment";
                ...
                // MTMedicalCertificateID
                if (MTMedicalCertificateID.UseFilter && !Empty(MTMedicalCertificateID.AdvancedSearch.SearchValue)) {
                    MTMedicalCertificateID.EditValue = ConvertToString(MTMedicalCertificateID.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
                ...
                // ExpirationDate
                if (ExpirationDate.UseFilter && !Empty(ExpirationDate.AdvancedSearch.SearchValue)) {
                    ExpirationDate.EditValue = ConvertToString(ExpirationDate.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
        ...
        protected void SetupSearchOptions() {
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"CrewMedicalCertificateForAdminViewMode\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("CrewMedicalCertificateForAdminViewModeSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("CrewMedicalCertificateForAdminViewModeSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
