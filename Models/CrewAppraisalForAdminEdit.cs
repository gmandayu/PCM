...
public partial class PCM {
    /// <summary>
    /// crewAppraisalForAdminEdit
    /// </summary>
    public static CrewAppraisalForAdminEdit crewAppraisalForAdminEdit
    {
        get => HttpData.Get<CrewAppraisalForAdminEdit>("crewAppraisalForAdminEdit")!;
        set => HttpData["crewAppraisalForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewAppraisalForAdmin
    /// </summary>
    public class CrewAppraisalForAdminEdit : CrewAppraisalForAdminEditBase
    {
        // Constructor
        public CrewAppraisalForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewAppraisalForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewAppraisalForAdminAdd?crewID=" + ConvertToString(lastUpdatedAppraisalCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewAppraisalForAdminEditBase : CrewAppraisalForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewAppraisalForAdminEdit";
        ...
        // Constructor
        public CrewAppraisalForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewAppraisalForAdminEdit";
        ...
        // Constructor
        public CrewAppraisalForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewAppraisalForAdminList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewAppraisalForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
