...
public partial class PCM {
    /// <summary>
    /// crewCertificateForAdminAdd
    /// </summary>
    public static CrewCertificateForAdminAdd crewCertificateForAdminAdd
    {
        get => HttpData.Get<CrewCertificateForAdminAdd>("crewCertificateForAdminAdd")!;
        set => HttpData["crewCertificateForAdminAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewCertificateForAdmin
    /// </summary>
    public class CrewCertificateForAdminAdd : CrewCertificateForAdminAddBase
    {
        // Constructor
        public CrewCertificateForAdminAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewCertificateForAdminAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewCertificateForAdminAdd?crewID=" + ConvertToString(lastAddedCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewCertificateForAdminAddBase : CrewCertificateForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewCertificateForAdminAdd";
        ...
        // Constructor
        public CrewCertificateForAdminAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewCertificateForAdminAdd";
        ...
        // Constructor
        public CrewCertificateForAdminAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewCertificateForAdminList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "CrewCertificateForAdminList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "CrewCertificateForAdminView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewCertificateForAdminList") {
                                ...
                                returnUrl = "CrewCertificateForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewCertificateForAdminAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("CrewCertificateForAdminList")), "", TableVar, true);
