...
public partial class PCM {
    /// <summary>
    /// crewMedicalCertificateForAdminEdit
    /// </summary>
    public static CrewMedicalCertificateForAdminEdit crewMedicalCertificateForAdminEdit
    {
        get => HttpData.Get<CrewMedicalCertificateForAdminEdit>("crewMedicalCertificateForAdminEdit")!;
        set => HttpData["crewMedicalCertificateForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalCertificateForAdmin
    /// </summary>
    public class CrewMedicalCertificateForAdminEdit : CrewMedicalCertificateForAdminEditBase
    {
        // Constructor
        public CrewMedicalCertificateForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalCertificateForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewMedicalCertificateForAdminAdd?crewID=" + ConvertToString(lastUpdatedMedicalCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalCertificateForAdminEditBase : CrewMedicalCertificateForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalCertificateForAdminEdit";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewMedicalCertificateForAdminEdit";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewMedicalCertificateForAdminList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalCertificateForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
