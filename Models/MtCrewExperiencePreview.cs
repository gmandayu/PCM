...
public partial class PCM {
    /// <summary>
    /// mtCrewExperiencePreview
    /// </summary>
    public static MtCrewExperiencePreview mtCrewExperiencePreview
    {
        get => HttpData.Get<MtCrewExperiencePreview>("mtCrewExperiencePreview")!;
        set => HttpData["mtCrewExperiencePreview"] = value;
    }

    /// <summary>
    /// Page class for MTCrewExperience
    /// </summary>
    public class MtCrewExperiencePreview : MtCrewExperiencePreviewBase
    {
        // Constructor
        public MtCrewExperiencePreview(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCrewExperiencePreview() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewExperiencePreviewBase : MtCrewExperience
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewExperiencePreview";
        ...
        // Constructor
        public MtCrewExperiencePreviewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCrewExperiencePreview";
        ...
        // Constructor
        public MtCrewExperiencePreviewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void HideFieldsForAddEdit() {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCrewExperiencePreview?.PageRender();
            }
                return PageResult();
            }
