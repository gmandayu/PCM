...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtEmailTemplate mtEmailTemplate
    {
        get => HttpData.Resolve<MtEmailTemplate>("MTEmailTemplate");
        set => HttpData["MTEmailTemplate"] = value;
    }

    /// <summary>
    /// Table class for MTEmailTemplate
    /// </summary>
    public class MtEmailTemplate : DbTable, IQueryFactory
    {
        ...
        public MtEmailTemplate()
        {
            ...
            TableVar = "MTEmailTemplate";
            Name = "MTEmailTemplate";
            Type = "TABLE";
            UpdateTable = "dbo.MTEmailTemplate"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new (this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTEmailTemplate", "Id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Id", Id);

            // Category
            Category = new (this, "x_Category", 202, SqlDbType.NVarChar) {
                Name = "Category",
                Expression = "[Category]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Category]",
                DateTimeFormat = -1,
                ...
                CustomMessage = Language.FieldPhrase("MTEmailTemplate", "Category", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Category", Category);

            // Subject
            Subject = new (this, "x_Subject", 203, SqlDbType.NText) {
                Name = "Subject",
                Expression = "[Subject]",
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTEmailTemplate", "Subject", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Message = new (this, "x__Message", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTEmailTemplate", "_Message", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTEmailTemplate";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "MtEmailTemplateView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtEmailTemplateEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtEmailTemplateAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtEmailTemplateView",
                Config.ApiAddAction => "MtEmailTemplateAdd",
                Config.ApiEditAction => "MtEmailTemplateEdit",
                Config.ApiDeleteAction => "MtEmailTemplateDelete",
                Config.ApiListAction => "MtEmailTemplateList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtEmailTemplateList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtEmailTemplateView", parm);
            else
                url = KeyUrl("MtEmailTemplateView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtEmailTemplateAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtEmailTemplateAdd?" + parm;
            else
                url = "MtEmailTemplateAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtEmailTemplateEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtEmailTemplateList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtEmailTemplateAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtEmailTemplateList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtEmailTemplateDelete")); // DN
        ...
        {
            string pageName = "MtEmailTemplateList";
        ...
        public async Task RenderListRow()
        {
            ...
            // Category
            Category.ViewValue = ConvertToString(Category.CurrentValue); // DN
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!Category.Raw)
                Category.CurrentValue = HtmlDecode(Category.CurrentValue);
            Category.EditValue = HtmlEncode(Category.CurrentValue);
            Category.PlaceHolder = RemoveHtml(Category.Caption);

            // Subject
            Subject.SetupEditAttributes();
            Subject.EditValue = Subject.CurrentValue; // DN
