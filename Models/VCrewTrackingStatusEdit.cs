...
public partial class PCM {
    /// <summary>
    /// vCrewTrackingStatusEdit
    /// </summary>
    public static VCrewTrackingStatusEdit vCrewTrackingStatusEdit
    {
        get => HttpData.Get<VCrewTrackingStatusEdit>("vCrewTrackingStatusEdit")!;
        set => HttpData["vCrewTrackingStatusEdit"] = value;
    }

    /// <summary>
    /// Page class for v_CrewTrackingStatus
    /// </summary>
    public class VCrewTrackingStatusEdit : VCrewTrackingStatusEditBase
    {
        // Constructor
        public VCrewTrackingStatusEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewTrackingStatusEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewTrackingStatusEditBase : VCrewTrackingStatus
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewTrackingStatusEdit";
        ...
        // Constructor
        public VCrewTrackingStatusEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewTrackingStatusEdit";
        ...
        // Constructor
        public VCrewTrackingStatusEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("VCrewTrackingStatusList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "VCrewTrackingStatusList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "VCrewTrackingStatusList") {
                                ...
                                returnUrl = "VCrewTrackingStatusList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewTrackingStatusEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task RenderRow()
        {
            ...
            // AgencyReviewed
            AgencyReviewed.RowCssClass = "row";

            // PDEReviewed
            PDEReviewed.RowCssClass = "row";
