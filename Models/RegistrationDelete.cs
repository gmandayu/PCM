...
public partial class PCM {
    ...
    /// registrationDelete
    /// </summary>
    public static RegistrationDelete registrationDelete
    {
        get => HttpData.Get<RegistrationDelete>("registrationDelete")!;
        set => HttpData["registrationDelete"] = value;
    }

    /// <summary>
    /// Page class for Registration
    /// </summary>
    public class RegistrationDelete : RegistrationDeleteBase
    {
        // Constructor
        public RegistrationDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RegistrationDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RegistrationDeleteBase : Registration
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "registrationDelete";
        ...
        // Page name
        public string PageName => "RegistrationDelete";
        ...
        // Constructor
        public RegistrationDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("RegistrationList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("RegistrationList"); // Return to list
                }
            }
