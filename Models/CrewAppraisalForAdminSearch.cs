...
public partial class PCM {
    /// <summary>
    /// crewAppraisalForAdminSearch
    /// </summary>
    public static CrewAppraisalForAdminSearch crewAppraisalForAdminSearch
    {
        get => HttpData.Get<CrewAppraisalForAdminSearch>("crewAppraisalForAdminSearch")!;
        set => HttpData["crewAppraisalForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewAppraisalForAdmin
    /// </summary>
    public class CrewAppraisalForAdminSearch : CrewAppraisalForAdminSearchBase
    {
        // Constructor
        public CrewAppraisalForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewAppraisalForAdminSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewAppraisalForAdminSearchBase : CrewAppraisalForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewAppraisalForAdminSearch";
        ...
        // Constructor
        public CrewAppraisalForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewAppraisalForAdminSearch";
        ...
        // Constructor
        public CrewAppraisalForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewAppraisalForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewAppraisalForAdminSearch?.PageRender();
            }
            return PageResult();
        }
