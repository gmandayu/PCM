...
public partial class PCM {
    /// <summary>
    /// mtUserLevelPermissionDelete
    /// </summary>
    public static MtUserLevelPermissionDelete mtUserLevelPermissionDelete
    {
        get => HttpData.Get<MtUserLevelPermissionDelete>("mtUserLevelPermissionDelete")!;
        set => HttpData["mtUserLevelPermissionDelete"] = value;
    }

    /// <summary>
    /// Page class for MTUserLevelPermission
    /// </summary>
    public class MtUserLevelPermissionDelete : MtUserLevelPermissionDeleteBase
    {
        // Constructor
        public MtUserLevelPermissionDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserLevelPermissionDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserLevelPermissionDeleteBase : MtUserLevelPermission
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserLevelPermissionDelete";
        ...
        // Constructor
        public MtUserLevelPermissionDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtUserLevelPermissionDelete";
        ...
        // Constructor
        public MtUserLevelPermissionDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtUserLevelPermissionList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtUserLevelPermissionList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtUserLevelPermissionDelete?.PageRender();
            }
            return PageResult();
        }
