...
public partial class PCM {
    /// <summary>
    /// crewMedicalHistoryForAdminViewModeAdd
    /// </summary>
    public static CrewMedicalHistoryForAdminViewModeAdd crewMedicalHistoryForAdminViewModeAdd
    {
        get => HttpData.Get<CrewMedicalHistoryForAdminViewModeAdd>("crewMedicalHistoryForAdminViewModeAdd")!;
        set => HttpData["crewMedicalHistoryForAdminViewModeAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalHistoryForAdminViewMode
    /// </summary>
    public class CrewMedicalHistoryForAdminViewModeAdd : CrewMedicalHistoryForAdminViewModeAddBase
    {
        // Constructor
        public CrewMedicalHistoryForAdminViewModeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalHistoryForAdminViewModeAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewMedicalHistoryForAdminViewModeList?crewID=" + ConvertToString(lastAddedMedicalHistoryCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalHistoryForAdminViewModeAddBase : CrewMedicalHistoryForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalHistoryForAdminViewModeAdd";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminViewModeAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewMedicalHistoryForAdminViewModeAdd";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminViewModeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewMedicalHistoryForAdminViewModeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "CrewMedicalHistoryForAdminViewModeView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalHistoryForAdminViewModeAdd?.PageRender();
            }
            return PageResult();
        }
