...
public partial class PCM {
    ...
    /// mtManningAgentView
    /// </summary>
    public static MtManningAgentView mtManningAgentView
    {
        get => HttpData.Get<MtManningAgentView>("mtManningAgentView")!;
        set => HttpData["mtManningAgentView"] = value;
    }

    /// <summary>
    /// Page class for MTManningAgent
    /// </summary>
    public class MtManningAgentView : MtManningAgentViewBase
    {
        // Constructor
        public MtManningAgentView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtManningAgentView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtManningAgentViewBase : MtManningAgent
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtManningAgentView";
        ...
        // Page name
        public string PageName => "MtManningAgentView";
        ...
        // Constructor
        public MtManningAgentViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtManningAgentList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtManningAgentList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTManningAgentview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
