...
public partial class PCM {
    /// <summary>
    /// crewDocumentForAdminViewModeSearch
    /// </summary>
    public static CrewDocumentForAdminViewModeSearch crewDocumentForAdminViewModeSearch
    {
        get => HttpData.Get<CrewDocumentForAdminViewModeSearch>("crewDocumentForAdminViewModeSearch")!;
        set => HttpData["crewDocumentForAdminViewModeSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewDocumentForAdminViewMode
    /// </summary>
    public class CrewDocumentForAdminViewModeSearch : CrewDocumentForAdminViewModeSearchBase
    {
        // Constructor
        public CrewDocumentForAdminViewModeSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewDocumentForAdminViewModeSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewDocumentForAdminViewModeSearchBase : CrewDocumentForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewDocumentForAdminViewModeSearch";
        ...
        // Constructor
        public CrewDocumentForAdminViewModeSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewDocumentForAdminViewModeSearch";
        ...
        // Constructor
        public CrewDocumentForAdminViewModeSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewDocumentForAdminViewModeList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewDocumentForAdminViewModeSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string BuildAdvancedSearch() {
            ...
            BuildSearchUrl(ref srchUrl, Image); // Image
            ...
            BuildSearchUrl(ref srchUrl, IsDraft, true); // IsDraft
            if (!Empty(srchUrl))
                srchUrl += "&";
            srchUrl += "cmd=search";
            return srchUrl;
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                MTDocumentID.EditValue = MTDocumentID.AdvancedSearch.SearchValue; // DN
