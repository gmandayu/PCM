...
public partial class PCM {
    /// <summary>
    /// trUpdateTrackingDelete
    /// </summary>
    public static TrUpdateTrackingDelete trUpdateTrackingDelete
    {
        get => HttpData.Get<TrUpdateTrackingDelete>("trUpdateTrackingDelete")!;
        set => HttpData["trUpdateTrackingDelete"] = value;
    }

    /// <summary>
    /// Page class for TRUpdateTracking
    /// </summary>
    public class TrUpdateTrackingDelete : TrUpdateTrackingDeleteBase
    {
        // Constructor
        public TrUpdateTrackingDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrUpdateTrackingDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrUpdateTrackingDeleteBase : TrUpdateTracking
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trUpdateTrackingDelete";
        ...
        // Constructor
        public TrUpdateTrackingDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TrUpdateTrackingDelete";
        ...
        // Constructor
        public TrUpdateTrackingDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("TrUpdateTrackingList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("TrUpdateTrackingList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                trUpdateTrackingDelete?.PageRender();
            }
            return PageResult();
        }
