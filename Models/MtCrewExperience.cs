...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtCrewExperience mtCrewExperience
    {
        get => HttpData.Resolve<MtCrewExperience>("MTCrewExperience");
        set => HttpData["MTCrewExperience"] = value;
    }

    /// <summary>
    /// Table class for MTCrewExperience
    /// </summary>
    public class MtCrewExperience : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtCrewExperience()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTCrewExperience";
            Name = "MTCrewExperience";
            Type = "TABLE";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CompanyName = new (this, "x_CompanyName", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[CompanyName]",
                DateTimeFormat = -1,
                VirtualExpression = "[CompanyName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "CompanyName", "CustomMsg"),
                IsUpload = false
            };
            CompanyName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CompanyName", "MTCrewExperience", true, "CompanyName", new List<string> {"CompanyName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CompanyName", "MTCrewExperience", true, "CompanyName", new List<string> {"CompanyName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CompanyName", "MTCrewExperience", true, "CompanyName", new List<string> {"CompanyName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            FlagName_CountryID = new (this, "x_FlagName_CountryID", 3, SqlDbType.Int) {
                ...
                Expression = "[FlagName_CountryID]",
                UseBasicSearch = true,
                BasicSearchExpression = "CAST([FlagName_CountryID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[FlagName_CountryID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "FlagName_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            VesselName = new (this, "x_VesselName", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "VesselName", "CustomMsg"),
                IsUpload = false
            };
            VesselName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("VesselName", "MTCrewExperience", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("VesselName", "MTCrewExperience", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("VesselName", "MTCrewExperience", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTVesselTypeID = new (this, "x_MTVesselTypeID", 3, SqlDbType.Int) {
                Name = "MTVesselTypeID",
                Expression = "[MTVesselTypeID]",
                BasicSearchExpression = "CAST([MTVesselTypeID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[MTVesselTypeID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "MTVesselTypeID", "CustomMsg"),
                IsUpload = false
            };
            ...
            GRT = new (this, "x_GRT", 3, SqlDbType.Int) {
                Name = "GRT",
                Expression = "[GRT]",
                BasicSearchExpression = "CAST([GRT] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[GRT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "GRT", "CustomMsg"),
                IsUpload = false
            };
            GRT.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("GRT", "MTCrewExperience", true, "GRT", new List<string> {"GRT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("GRT", "MTCrewExperience", true, "GRT", new List<string> {"GRT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("GRT", "MTCrewExperience", true, "GRT", new List<string> {"GRT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("GRT", GRT);
            ...
            DWT = new (this, "x_DWT", 3, SqlDbType.Int) {
                Name = "DWT",
                Expression = "[DWT]",
                BasicSearchExpression = "CAST([DWT] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[DWT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "DWT", "CustomMsg"),
                IsUpload = false
            };
            DWT.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DWT", "MTCrewExperience", true, "DWT", new List<string> {"DWT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DWT", "MTCrewExperience", true, "DWT", new List<string> {"DWT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DWT", "MTCrewExperience", true, "DWT", new List<string> {"DWT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("DWT", DWT);
            ...
            MainEngine = new (this, "x_MainEngine", 202, SqlDbType.NVarChar) {
                Name = "MainEngine",
                Expression = "[MainEngine]",
                UseBasicSearch = true,
                BasicSearchExpression = "[MainEngine]",
                DateTimeFormat = -1,
                VirtualExpression = "[MainEngine]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "MainEngine", "CustomMsg"),
                IsUpload = false
            };
            MainEngine.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MainEngine", "MTCrewExperience", true, "MainEngine", new List<string> {"MainEngine", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MainEngine", "MTCrewExperience", true, "MainEngine", new List<string> {"MainEngine", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MainEngine", "MTCrewExperience", true, "MainEngine", new List<string> {"MainEngine", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            BHP = new (this, "x_BHP", 3, SqlDbType.Int) {
                Name = "BHP",
                Expression = "[BHP]",
                BasicSearchExpression = "CAST([BHP] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[BHP]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "BHP", "CustomMsg"),
                IsUpload = false
            };
            BHP.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("BHP", "MTCrewExperience", true, "BHP", new List<string> {"BHP", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("BHP", "MTCrewExperience", true, "BHP", new List<string> {"BHP", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("BHP", "MTCrewExperience", true, "BHP", new List<string> {"BHP", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("BHP", BHP);
            ...
            MTRankID = new (this, "x_MTRankID", 3, SqlDbType.Int) {
                Name = "MTRankID",
                Expression = "[MTRankID]",
                BasicSearchExpression = "CAST([MTRankID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[MTRankID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "MTRankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            // DateFrom
            DateFrom = new (this, "x_DateFrom", 133, SqlDbType.DateTime) {
                Name = "DateFrom",
                Expression = "[DateFrom]",
                BasicSearchExpression = CastDateFieldForLike("[DateFrom]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[DateFrom]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "DateFrom", "CustomMsg"),
                IsUpload = false
            };
            DateFrom.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateFrom", "MTCrewExperience", true, "DateFrom", new List<string> {"DateFrom", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateFrom", "MTCrewExperience", true, "DateFrom", new List<string> {"DateFrom", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateFrom", "MTCrewExperience", true, "DateFrom", new List<string> {"DateFrom", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            SignOnPortName = new (this, "x_SignOnPortName", 202, SqlDbType.NVarChar) {
                Name = "SignOnPortName",
                Expression = "[SignOnPortName]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SignOnPortName]",
                DateTimeFormat = -1,
                VirtualExpression = "[SignOnPortName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "SignOnPortName", "CustomMsg"),
                IsUpload = false
            };
            SignOnPortName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SignOnPortName", "MTCrewExperience", true, "SignOnPortName", new List<string> {"SignOnPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SignOnPortName", "MTCrewExperience", true, "SignOnPortName", new List<string> {"SignOnPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SignOnPortName", "MTCrewExperience", true, "SignOnPortName", new List<string> {"SignOnPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("SignOnPortName", SignOnPortName);

            // DateUntil
            DateUntil = new (this, "x_DateUntil", 133, SqlDbType.DateTime) {
                Name = "DateUntil",
                Expression = "[DateUntil]",
                BasicSearchExpression = CastDateFieldForLike("[DateUntil]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[DateUntil]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "DateUntil", "CustomMsg"),
                IsUpload = false
            };
            DateUntil.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateUntil", "MTCrewExperience", true, "DateUntil", new List<string> {"DateUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateUntil", "MTCrewExperience", true, "DateUntil", new List<string> {"DateUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateUntil", "MTCrewExperience", true, "DateUntil", new List<string> {"DateUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            SignOffPortName = new (this, "x_SignOffPortName", 202, SqlDbType.NVarChar) {
                ...
                Expression = "[SignOffPortName]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SignOffPortName]",
                DateTimeFormat = -1,
                VirtualExpression = "[SignOffPortName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "SignOffPortName", "CustomMsg"),
                IsUpload = false
            };
            SignOffPortName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SignOffPortName", "MTCrewExperience", true, "SignOffPortName", new List<string> {"SignOffPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SignOffPortName", "MTCrewExperience", true, "SignOffPortName", new List<string> {"SignOffPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SignOffPortName", "MTCrewExperience", true, "SignOffPortName", new List<string> {"SignOffPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            SignOffReason = new (this, "x_SignOffReason", 202, SqlDbType.NVarChar) {
                Name = "SignOffReason",
                Expression = "[SignOffReason]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SignOffReason]",
                DateTimeFormat = -1,
                VirtualExpression = "[SignOffReason]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "SignOffReason", "CustomMsg"),
                IsUpload = false
            };
            SignOffReason.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SignOffReason", "MTCrewExperience", true, "SignOffReason", new List<string> {"SignOffReason", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SignOffReason", "MTCrewExperience", true, "SignOffReason", new List<string> {"SignOffReason", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SignOffReason", "MTCrewExperience", true, "SignOffReason", new List<string> {"SignOffReason", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCrewExperience", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCrewExperience", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCrewExperience", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewExperience", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewExperience", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewExperience", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewExperience", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "MtCrewExperienceView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCrewExperienceEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCrewExperienceAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCrewExperienceView",
                Config.ApiAddAction => "MtCrewExperienceAdd",
                Config.ApiEditAction => "MtCrewExperienceEdit",
                Config.ApiDeleteAction => "MtCrewExperienceDelete",
                Config.ApiListAction => "MtCrewExperienceList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCrewExperienceList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCrewExperienceView", parm);
            else
                url = KeyUrl("MtCrewExperienceView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCrewExperienceAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtCrewExperienceAdd?" + parm;
            else
                url = "MtCrewExperienceAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewExperienceEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewExperienceList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewExperienceAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewExperienceList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCrewExperienceDelete")); // DN
        ...
        {
            string pageName = "MtCrewExperienceList";
