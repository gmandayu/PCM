...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtRecruitmentStatus mtRecruitmentStatus
    {
        get => HttpData.Resolve<MtRecruitmentStatus>("MTRecruitmentStatus");
        set => HttpData["MTRecruitmentStatus"] = value;
    }

    /// <summary>
    /// Table class for MTRecruitmentStatus
    /// </summary>
    public class MtRecruitmentStatus : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtRecruitmentStatus()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTRecruitmentStatus";
            Name = "MTRecruitmentStatus";
            Type = "TABLE";
            UpdateTable = "dbo.MTRecruitmentStatus"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatus", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);

            // Code
            Code = new (this, "x_Code", 3, SqlDbType.Int) {
                Name = "Code",
                Expression = "[Code]",
                BasicSearchExpression = "CAST([Code] AS NVARCHAR)",
                DateTimeFormat = -1,
                ...
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatus", "Code", "CustomMsg"),
                IsUpload = false
            };
            ...
            Description = new (this, "x_Description", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatus", "Description", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatus", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatus", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatus", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatus", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTRecruitmentStatus";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "MtRecruitmentStatusList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "MtRecruitmentStatusView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtRecruitmentStatusEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtRecruitmentStatusAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtRecruitmentStatusView",
                Config.ApiAddAction => "MtRecruitmentStatusAdd",
                Config.ApiEditAction => "MtRecruitmentStatusEdit",
                Config.ApiDeleteAction => "MtRecruitmentStatusDelete",
                Config.ApiListAction => "MtRecruitmentStatusList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtRecruitmentStatusList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtRecruitmentStatusView", parm);
            else
                url = KeyUrl("MtRecruitmentStatusView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtRecruitmentStatusAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtRecruitmentStatusAdd?" + parm;
            else
                url = "MtRecruitmentStatusAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtRecruitmentStatusEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtRecruitmentStatusList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtRecruitmentStatusAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtRecruitmentStatusList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtRecruitmentStatusDelete")); // DN
        ...
        {
            string pageName = "MtRecruitmentStatusList";
