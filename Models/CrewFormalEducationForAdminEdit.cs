...
public partial class PCM {
    /// <summary>
    /// crewFormalEducationForAdminEdit
    /// </summary>
    public static CrewFormalEducationForAdminEdit crewFormalEducationForAdminEdit
    {
        get => HttpData.Get<CrewFormalEducationForAdminEdit>("crewFormalEducationForAdminEdit")!;
        set => HttpData["crewFormalEducationForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewFormalEducationForAdmin
    /// </summary>
    public class CrewFormalEducationForAdminEdit : CrewFormalEducationForAdminEditBase
    {
        // Constructor
        public CrewFormalEducationForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFormalEducationForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewFormalEducationForAdminAdd?crewID=" + ConvertToString(lastUpdatedFormalEducationCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFormalEducationForAdminEditBase : CrewFormalEducationForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFormalEducationForAdminEdit";
        ...
        // Constructor
        public CrewFormalEducationForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewFormalEducationForAdminEdit";
        ...
        // Constructor
        public CrewFormalEducationForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewFormalEducationForAdminList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFormalEducationForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
