...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static VwInactiveCrew vwInactiveCrew
    {
        get => HttpData.Resolve<VwInactiveCrew>("vw_InactiveCrew");
        set => HttpData["vw_InactiveCrew"] = value;
    }

    /// <summary>
    /// Table class for vw_InactiveCrew
    /// </summary>
    public class VwInactiveCrew : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> LastUpdateBy;
        ...
        // Constructor
        public VwInactiveCrew()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "vw_InactiveCrew";
            Name = "vw_InactiveCrew";
            Type = "VIEW";
            UpdateTable = "dbo.vw_InactiveCrew"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            IndividualCodeNumber = new (this, "x_IndividualCodeNumber", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "IndividualCodeNumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            FullName = new (this, "x_FullName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "FullName", "CustomMsg"),
                IsUpload = false
            };
            ...
            EmployeeStatus = new (this, "x_EmployeeStatus", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "EmployeeStatus", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("EmployeeStatus", EmployeeStatus);

            // Last Update By
            LastUpdateBy = new (this, "x_LastUpdateBy", 202, SqlDbType.NVarChar) {
                Name = "Last Update By",
                Expression = "[Last Update By]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Last Update By]",
                DateTimeFormat = -1,
                VirtualExpression = "[Last Update By]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "LastUpdateBy", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Last Update By", LastUpdateBy);
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedBy = new (this, "x_CreatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[Created By]",
                DateTimeFormat = -1,
                VirtualExpression = "[Created By]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "CreatedBy", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Created By", CreatedBy);
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("vw_InactiveCrew", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.vw_InactiveCrew";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                LastUpdateBy.DbValue = row["Last Update By"]; // Set DB value only
                LastUpdatedDateTime.DbValue = row["LastUpdatedDateTime"]; // Set DB value only
                CreatedBy.DbValue = row["Created By"]; // Set DB value only
        ...
        {
            if (SameString(pageName, "VwInactiveCrewView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "VwInactiveCrewEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "VwInactiveCrewAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VwInactiveCrewView",
                Config.ApiAddAction => "VwInactiveCrewAdd",
                Config.ApiEditAction => "VwInactiveCrewEdit",
                Config.ApiDeleteAction => "VwInactiveCrewDelete",
                Config.ApiListAction => "VwInactiveCrewList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VwInactiveCrewList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VwInactiveCrewView", parm);
            else
                url = KeyUrl("VwInactiveCrewView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VwInactiveCrewAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "VwInactiveCrewAdd?" + parm;
            else
                url = "VwInactiveCrewAdd";
        ...
        {
            string url = "";
            url = KeyUrl("VwInactiveCrewEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VwInactiveCrewList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("VwInactiveCrewAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VwInactiveCrewList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("VwInactiveCrewDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            LastUpdateBy.SetDbValue(dr["Last Update By"]);
            LastUpdatedDateTime.SetDbValue(dr["LastUpdatedDateTime"]);
            CreatedBy.SetDbValue(dr["Created By"]);
        ...
        {
            string pageName = "VwInactiveCrewList";
        ...
        public async Task RenderListRow()
        {
            ...
            // Last Update By
            LastUpdateBy.ViewValue = ConvertToString(LastUpdateBy.CurrentValue); // DN
            LastUpdateBy.ViewCustomAttributes = "";
            ...
            // Last Update By
            LastUpdateBy.HrefValue = "";
            LastUpdateBy.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Last Update By
            LastUpdateBy.SetupEditAttributes();
            if (!LastUpdateBy.Raw)
                LastUpdateBy.CurrentValue = HtmlDecode(LastUpdateBy.CurrentValue);
            LastUpdateBy.EditValue = HtmlEncode(LastUpdateBy.CurrentValue);
            LastUpdateBy.PlaceHolder = RemoveHtml(LastUpdateBy.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(LastUpdateBy);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(LastUpdateBy);
