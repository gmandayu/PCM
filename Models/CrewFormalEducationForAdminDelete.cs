...
public partial class PCM {
    /// <summary>
    /// crewFormalEducationForAdminDelete
    /// </summary>
    public static CrewFormalEducationForAdminDelete crewFormalEducationForAdminDelete
    {
        get => HttpData.Get<CrewFormalEducationForAdminDelete>("crewFormalEducationForAdminDelete")!;
        set => HttpData["crewFormalEducationForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewFormalEducationForAdmin
    /// </summary>
    public class CrewFormalEducationForAdminDelete : CrewFormalEducationForAdminDeleteBase
    {
        // Constructor
        public CrewFormalEducationForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFormalEducationForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFormalEducationForAdminDeleteBase : CrewFormalEducationForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFormalEducationForAdminDelete";
        ...
        // Constructor
        public CrewFormalEducationForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewFormalEducationForAdminDelete";
        ...
        // Constructor
        public CrewFormalEducationForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewFormalEducationForAdminList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewFormalEducationForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFormalEducationForAdminDelete?.PageRender();
            }
            return PageResult();
        }
