...
public partial class PCM {
    ...
    /// mtCurrencyDelete
    /// </summary>
    public static MtCurrencyDelete mtCurrencyDelete
    {
        get => HttpData.Get<MtCurrencyDelete>("mtCurrencyDelete")!;
        set => HttpData["mtCurrencyDelete"] = value;
    }

    /// <summary>
    /// Page class for MTCurrency
    /// </summary>
    public class MtCurrencyDelete : MtCurrencyDeleteBase
    {
        // Constructor
        public MtCurrencyDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCurrencyDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCurrencyDeleteBase : MtCurrency
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCurrencyDelete";
        ...
        // Page name
        public string PageName => "MtCurrencyDelete";
        ...
        // Constructor
        public MtCurrencyDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtCurrencyList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtCurrencyList"); // Return to list
                }
            }
