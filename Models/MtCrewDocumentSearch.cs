...
public partial class PCM {
    /// <summary>
    /// mtCrewDocumentSearch
    /// </summary>
    public static MtCrewDocumentSearch mtCrewDocumentSearch
    {
        get => HttpData.Get<MtCrewDocumentSearch>("mtCrewDocumentSearch")!;
        set => HttpData["mtCrewDocumentSearch"] = value;
    }

    /// <summary>
    /// Page class for MTCrewDocument
    /// </summary>
    public class MtCrewDocumentSearch : MtCrewDocumentSearchBase
    {
        // Constructor
        public MtCrewDocumentSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCrewDocumentSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewDocumentSearchBase : MtCrewDocument
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewDocumentSearch";
        ...
        // Constructor
        public MtCrewDocumentSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCrewDocumentSearch";
        ...
        // Constructor
        public MtCrewDocumentSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtCrewDocumentList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCrewDocumentSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string BuildAdvancedSearch() {
            string srchUrl = "";
            BuildSearchUrl(ref srchUrl, IsDraft); // IsDraft
            BuildSearchUrl(ref srchUrl, MTCrewID); // MTCrewID
            BuildSearchUrl(ref srchUrl, MTDocumentID); // MTDocumentID
            ...
            BuildSearchUrl(ref srchUrl, DateValidUntil); // DateValidUntil
        ...
        protected void LoadSearchValues() {
            // IsDraft
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_IsDraft"))
                    IsDraft.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_IsDraft");
            if (Form.ContainsKey("z_IsDraft"))
                IsDraft.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_IsDraft");
            ...
            // MTDocumentID
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_MTDocumentID"))
                    MTDocumentID.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_MTDocumentID");
            if (Form.ContainsKey("z_MTDocumentID"))
                MTDocumentID.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_MTDocumentID");
            ...
            // DateValidUntil
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_DateValidUntil"))
                    DateValidUntil.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_DateValidUntil");
            if (Form.ContainsKey("z_DateValidUntil"))
                DateValidUntil.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_DateValidUntil");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                curVal = ConvertToString(MTDocumentID.AdvancedSearch.SearchValue)?.Trim() ?? "";
                if (MTDocumentID.Lookup != null && IsDictionary(MTDocumentID.Lookup?.Options) && MTDocumentID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    ...
                    if (curVal == "") {
                        ...
                        filterWrk = SearchFilter("[ID]", "=", MTDocumentID.AdvancedSearch.SearchValue, DataType.Number, "");
                    }
                ...
                DateValidUntil.EditValue = FormatDateTime(UnformatDateTime(DateValidUntil.AdvancedSearch.SearchValue, DateValidUntil.FormatPattern), DateValidUntil.FormatPattern); // DN
        ...
        protected bool ValidateSearch() {
            ...
            if (!CheckDate(ConvertToString(DateValidUntil.AdvancedSearch.SearchValue), DateValidUntil.FormatPattern)) {
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtCrewDocumentList")), "", TableVar, true);
