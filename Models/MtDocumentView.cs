...
public partial class PCM {
    ...
    /// mtDocumentView
    /// </summary>
    public static MtDocumentView mtDocumentView
    {
        get => HttpData.Get<MtDocumentView>("mtDocumentView")!;
        set => HttpData["mtDocumentView"] = value;
    }

    /// <summary>
    /// Page class for MTDocument
    /// </summary>
    public class MtDocumentView : MtDocumentViewBase
    {
        // Constructor
        public MtDocumentView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtDocumentView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtDocumentViewBase : MtDocument
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtDocumentView";
        ...
        // Page name
        public string PageName => "MtDocumentView";
        ...
        // Constructor
        public MtDocumentViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtDocumentList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtDocumentList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTDocumentview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtDocumentList")), "", TableVar, true);
            string pageId = "view";
