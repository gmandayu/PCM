...
public partial class PCM {
    /// <summary>
    /// crewFamilyForAdminViewModeDelete
    /// </summary>
    public static CrewFamilyForAdminViewModeDelete crewFamilyForAdminViewModeDelete
    {
        get => HttpData.Get<CrewFamilyForAdminViewModeDelete>("crewFamilyForAdminViewModeDelete")!;
        set => HttpData["crewFamilyForAdminViewModeDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewFamilyForAdminViewMode
    /// </summary>
    public class CrewFamilyForAdminViewModeDelete : CrewFamilyForAdminViewModeDeleteBase
    {
        // Constructor
        public CrewFamilyForAdminViewModeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFamilyForAdminViewModeDelete() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastDeletedFamilyCrewID = Session.GetInt("lastDeletedFamilyCrewID");
            Session.Remove("lastDeletedFamilyCrewID");
            url = "CrewFamilyForAdminViewModeList?crewID=" + ConvertToString(lastDeletedFamilyCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFamilyForAdminViewModeDeleteBase : CrewFamilyForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFamilyForAdminViewModeDelete";
        ...
        // Constructor
        public CrewFamilyForAdminViewModeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewFamilyForAdminViewModeDelete";
        ...
        // Constructor
        public CrewFamilyForAdminViewModeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewFamilyForAdminViewModeList"); // Prevent SQL injection, return to List page
            ...
            using (Recordset = await Connection.OpenDataReaderAsync(sql)) {
                if (Recordset != null) {
                    ...
                    if (!res)
                        return Terminate("CrewFamilyForAdminViewModeList"); // Return to List page
                }
            }
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewFamilyForAdminViewModeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFamilyForAdminViewModeDelete?.PageRender();
            }
            return PageResult();
        }
