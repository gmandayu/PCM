...
public partial class PCM {
    /// <summary>
    /// crewPersonalDataForAdminViewModeList
    /// </summary>
    public static CrewPersonalDataForAdminViewModeList crewPersonalDataForAdminViewModeList
    {
        get => HttpData.Get<CrewPersonalDataForAdminViewModeList>("crewPersonalDataForAdminViewModeList")!;
        set => HttpData["crewPersonalDataForAdminViewModeList"] = value;
    }

    /// <summary>
    /// Page class for CrewPersonalDataForAdminViewMode
    /// </summary>
    public class CrewPersonalDataForAdminViewModeList : CrewPersonalDataForAdminViewModeListBase
    {
        // Constructor
        public CrewPersonalDataForAdminViewModeList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewPersonalDataForAdminViewModeList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewPersonalDataForAdminViewModeListBase : CrewPersonalDataForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewPersonalDataForAdminViewModeList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fCrewPersonalDataForAdminViewModelist";
        ...
        // Constructor
        public CrewPersonalDataForAdminViewModeListBase()
        {
            ...
            // Initialize URLs
            AddUrl = "CrewPersonalDataForAdminViewModeAdd";
            ...
            MultiDeleteUrl = "CrewPersonalDataForAdminViewModeDelete";
            MultiUpdateUrl = "CrewPersonalDataForAdminViewModeUpdate";
        ...
        // Page name
        public string PageName => "CrewPersonalDataForAdminViewModeList";
        ...
        // Constructor
        public CrewPersonalDataForAdminViewModeListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fCrewPersonalDataForAdminViewModegrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewPersonalDataForAdminViewModeList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(NomineeRelationshipSelect.AdvancedSearch.ToJson())); // Field NomineeRelationshipSelect
            filters.Merge(JObject.Parse(NomineeRelationshipDetail.AdvancedSearch.ToJson())); // Field NomineeRelationshipDetail
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NomineeRelationshipSelect
            if (filter?.TryGetValue("x_NomineeRelationshipSelect", out sv) ?? false) {
                NomineeRelationshipSelect.AdvancedSearch.SearchValue = sv;
                NomineeRelationshipSelect.AdvancedSearch.SearchOperator = filter["z_NomineeRelationshipSelect"];
                NomineeRelationshipSelect.AdvancedSearch.SearchCondition = filter["v_NomineeRelationshipSelect"];
                NomineeRelationshipSelect.AdvancedSearch.SearchValue2 = filter["y_NomineeRelationshipSelect"];
                NomineeRelationshipSelect.AdvancedSearch.SearchOperator2 = filter["w_NomineeRelationshipSelect"];
                NomineeRelationshipSelect.AdvancedSearch.Save();
            }

            // Field NomineeRelationshipDetail
            if (filter?.TryGetValue("x_NomineeRelationshipDetail", out sv) ?? false) {
                NomineeRelationshipDetail.AdvancedSearch.SearchValue = sv;
                NomineeRelationshipDetail.AdvancedSearch.SearchOperator = filter["z_NomineeRelationshipDetail"];
                NomineeRelationshipDetail.AdvancedSearch.SearchCondition = filter["v_NomineeRelationshipDetail"];
                NomineeRelationshipDetail.AdvancedSearch.SearchValue2 = filter["y_NomineeRelationshipDetail"];
                NomineeRelationshipDetail.AdvancedSearch.SearchOperator2 = filter["w_NomineeRelationshipDetail"];
                NomineeRelationshipDetail.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, NomineeRelationshipSelect, def, false); // NomineeRelationshipSelect
            BuildSearchSql(ref where, NomineeRelationshipDetail, def, false); // NomineeRelationshipDetail
            ...
            if (!def && Command == "search") {
                ...
                NomineeRelationshipSelect.AdvancedSearch.Save(); // NomineeRelationshipSelect
                NomineeRelationshipDetail.AdvancedSearch.Save(); // NomineeRelationshipDetail
        ...
        public void ShowFilterList()
        {
            ...
            // Field NomineeRelationshipSelect
            filter = QueryBuilderWhere("NomineeRelationshipSelect");
            if (Empty(filter))
                BuildSearchSql(ref filter, NomineeRelationshipSelect, false, false);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + NomineeRelationshipSelect.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field NomineeRelationshipDetail
            filter = QueryBuilderWhere("NomineeRelationshipDetail");
            if (Empty(filter))
                BuildSearchSql(ref filter, NomineeRelationshipDetail, false, false);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + NomineeRelationshipDetail.Caption + "</span>" + captionSuffix + filter + "</div>";
            if (!Empty(BasicSearch.Keyword))
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(NomineeRelationshipSelect);
            searchFlds.Add(NomineeRelationshipDetail);
        ...
        protected bool CheckSearchParms() {
            ...
            if (VisaPhoto.AdvancedSearch.IssetSession)
                return true;
            if (NomineeRelationshipSelect.AdvancedSearch.IssetSession)
                return true;
            if (NomineeRelationshipDetail.AdvancedSearch.IssetSession)
                return true;
            return false;
        }
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            NomineeRelationshipSelect.AdvancedSearch.UnsetSession();
            NomineeRelationshipDetail.AdvancedSearch.UnsetSession();
        }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(NomineeRelationshipSelect, ctrl); // NomineeRelationshipSelect
                UpdateSort(NomineeRelationshipDetail, ctrl); // NomineeRelationshipDetail
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""CrewPersonalDataForAdminViewMode"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""CrewPersonalDataForAdminViewMode"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCrewPersonalDataForAdminViewModelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCrewPersonalDataForAdminViewModelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("NomineeRelationshipSelect")); // DN
                CreateColumnOption(option.Add("NomineeRelationshipDetail")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fCrewPersonalDataForAdminViewModesrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fCrewPersonalDataForAdminViewModesrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fCrewPersonalDataForAdminViewModelist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_CrewPersonalDataForAdminViewMode");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(crewPersonalDataForAdminViewModeList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(crewPersonalDataForAdminViewModeList.RowCount) + "_CrewPersonalDataForAdminViewMode");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(crewPersonalDataForAdminViewModeList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && crewPersonalDataForAdminViewModeList.RowType == RowType.Add || IsEdit && crewPersonalDataForAdminViewModeList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_NomineeRelationshipSelect"))
                    NomineeRelationshipSelect.AdvancedSearch.SearchValue = Get("x_NomineeRelationshipSelect");
                else
                    NomineeRelationshipSelect.AdvancedSearch.SearchValue = Get("NomineeRelationshipSelect"); // Default Value // DN
            if (!Empty(NomineeRelationshipSelect.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_NomineeRelationshipSelect"))
                NomineeRelationshipSelect.AdvancedSearch.SearchOperator = Get("z_NomineeRelationshipSelect");

            // NomineeRelationshipDetail
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_NomineeRelationshipDetail"))
                    NomineeRelationshipDetail.AdvancedSearch.SearchValue = Get("x_NomineeRelationshipDetail");
                else
                    NomineeRelationshipDetail.AdvancedSearch.SearchValue = Get("NomineeRelationshipDetail"); // Default Value // DN
            if (!Empty(NomineeRelationshipDetail.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_NomineeRelationshipDetail"))
                NomineeRelationshipDetail.AdvancedSearch.SearchOperator = Get("z_NomineeRelationshipDetail");
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (RequiredPhoto.UseColorbox) {
                    ...
                    RequiredPhoto.LinkAttrs["data-rel"] = "CrewPersonalDataForAdminViewMode_x" + RowCount + "_RequiredPhoto";
                ...
                if (VisaPhoto.UseColorbox) {
                    ...
                    VisaPhoto.LinkAttrs["data-rel"] = "CrewPersonalDataForAdminViewMode_x" + RowCount + "_VisaPhoto";
        ...
        protected void SetupSearchOptions() {
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"CrewPersonalDataForAdminViewMode\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("CrewPersonalDataForAdminViewModeSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("CrewPersonalDataForAdminViewModeSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
