...
public partial class PCM {
    ...
    /// mtBankDelete
    /// </summary>
    public static MtBankDelete mtBankDelete
    {
        get => HttpData.Get<MtBankDelete>("mtBankDelete")!;
        set => HttpData["mtBankDelete"] = value;
    }

    /// <summary>
    /// Page class for MTBank
    /// </summary>
    public class MtBankDelete : MtBankDeleteBase
    {
        // Constructor
        public MtBankDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBankDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBankDeleteBase : MtBank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBankDelete";
        ...
        // Page name
        public string PageName => "MtBankDelete";
        ...
        // Constructor
        public MtBankDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtBankList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtBankList"); // Return to list
                }
            }
