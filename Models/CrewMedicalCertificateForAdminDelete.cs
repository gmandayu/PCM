...
public partial class PCM {
    /// <summary>
    /// crewMedicalCertificateForAdminDelete
    /// </summary>
    public static CrewMedicalCertificateForAdminDelete crewMedicalCertificateForAdminDelete
    {
        get => HttpData.Get<CrewMedicalCertificateForAdminDelete>("crewMedicalCertificateForAdminDelete")!;
        set => HttpData["crewMedicalCertificateForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalCertificateForAdmin
    /// </summary>
    public class CrewMedicalCertificateForAdminDelete : CrewMedicalCertificateForAdminDeleteBase
    {
        // Constructor
        public CrewMedicalCertificateForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalCertificateForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalCertificateForAdminDeleteBase : CrewMedicalCertificateForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalCertificateForAdminDelete";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewMedicalCertificateForAdminDelete";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewMedicalCertificateForAdminList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewMedicalCertificateForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalCertificateForAdminDelete?.PageRender();
            }
            return PageResult();
        }
