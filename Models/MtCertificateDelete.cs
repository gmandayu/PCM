...
public partial class PCM {
    ...
    /// mtCertificateDelete
    /// </summary>
    public static MtCertificateDelete mtCertificateDelete
    {
        get => HttpData.Get<MtCertificateDelete>("mtCertificateDelete")!;
        set => HttpData["mtCertificateDelete"] = value;
    }

    /// <summary>
    /// Page class for MTCertificate
    /// </summary>
    public class MtCertificateDelete : MtCertificateDeleteBase
    {
        // Constructor
        public MtCertificateDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateDeleteBase : MtCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateDelete";
        ...
        // Constructor
        public MtCertificateDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCertificateDelete";
        ...
        // Constructor
        public MtCertificateDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtCertificateList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtCertificateList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCertificateDelete?.PageRender();
            }
            return PageResult();
        }
