...
public partial class PCM {
    ...
    /// mtReligionSearch
    /// </summary>
    public static MtReligionSearch mtReligionSearch
    {
        get => HttpData.Get<MtReligionSearch>("mtReligionSearch")!;
        set => HttpData["mtReligionSearch"] = value;
    }

    /// <summary>
    /// Page class for MTReligion
    /// </summary>
    public class MtReligionSearch : MtReligionSearchBase
    {
        // Constructor
        public MtReligionSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtReligionSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtReligionSearchBase : MtReligion
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtReligionSearch";
        ...
        // Page name
        public string PageName => "MtReligionSearch";
        ...
        // Constructor
        public MtReligionSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtReligionList?" + srchStr;
