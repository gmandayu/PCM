...
public partial class PCM {
    /// <summary>
    /// mtCrewMedicalHistory
    /// </summary>
    [MaybeNull]
    public static MtCrewMedicalHistory mtCrewMedicalHistory
    {
        get => HttpData.Resolve<MtCrewMedicalHistory>("MTCrewMedicalHistory");
        set => HttpData["MTCrewMedicalHistory"] = value;
    }

    /// <summary>
    /// Table class for MTCrewMedicalHistory
    /// </summary>
    public class MtCrewMedicalHistory : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtCrewMedicalHistory()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTCrewMedicalHistory";
            Name = "MTCrewMedicalHistory";
            Type = "TABLE";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Type = new (this, "x__Type", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "_Type", "CustomMsg"),
                IsUpload = false
            };
            _Type.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Type", "MTCrewMedicalHistory", true, "Type", new List<string> {"Type", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Type", "MTCrewMedicalHistory", true, "Type", new List<string> {"Type", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Type", "MTCrewMedicalHistory", true, "Type", new List<string> {"Type", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            VesselName = new (this, "x_VesselName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "VesselName", "CustomMsg"),
                IsUpload = false
            };
            VesselName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("VesselName", "MTCrewMedicalHistory", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("VesselName", "MTCrewMedicalHistory", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("VesselName", "MTCrewMedicalHistory", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("VesselName", VesselName);

            // DateOccurence
            DateOccurence = new (this, "x_DateOccurence", 133, SqlDbType.DateTime) {
                Name = "DateOccurence",
                Expression = "[DateOccurence]",
                BasicSearchExpression = CastDateFieldForLike("[DateOccurence]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[DateOccurence]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "DateOccurence", "CustomMsg"),
                IsUpload = false
            };
            DateOccurence.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateOccurence", "MTCrewMedicalHistory", true, "DateOccurence", new List<string> {"DateOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateOccurence", "MTCrewMedicalHistory", true, "DateOccurence", new List<string> {"DateOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateOccurence", "MTCrewMedicalHistory", true, "DateOccurence", new List<string> {"DateOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PlaceOccurence = new (this, "x_PlaceOccurence", 202, SqlDbType.NVarChar) {
                Name = "PlaceOccurence",
                Expression = "[PlaceOccurence]",
                UseBasicSearch = true,
                BasicSearchExpression = "[PlaceOccurence]",
                DateTimeFormat = -1,
                VirtualExpression = "[PlaceOccurence]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "PlaceOccurence", "CustomMsg"),
                IsUpload = false
            };
            PlaceOccurence.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PlaceOccurence", "MTCrewMedicalHistory", true, "PlaceOccurence", new List<string> {"PlaceOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PlaceOccurence", "MTCrewMedicalHistory", true, "PlaceOccurence", new List<string> {"PlaceOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PlaceOccurence", "MTCrewMedicalHistory", true, "PlaceOccurence", new List<string> {"PlaceOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PeriodOfDisability = new (this, "x_PeriodOfDisability", 202, SqlDbType.NVarChar) {
                ...
                Expression = "[PeriodOfDisability]",
                UseBasicSearch = true,
                BasicSearchExpression = "[PeriodOfDisability]",
                DateTimeFormat = -1,
                VirtualExpression = "[PeriodOfDisability]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "PeriodOfDisability", "CustomMsg"),
                IsUpload = false
            };
            PeriodOfDisability.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PeriodOfDisability", "MTCrewMedicalHistory", true, "PeriodOfDisability", new List<string> {"PeriodOfDisability", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PeriodOfDisability", "MTCrewMedicalHistory", true, "PeriodOfDisability", new List<string> {"PeriodOfDisability", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PeriodOfDisability", "MTCrewMedicalHistory", true, "PeriodOfDisability", new List<string> {"PeriodOfDisability", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PresentCondition = new (this, "x_PresentCondition", 202, SqlDbType.NVarChar) {
                ...
                Expression = "[PresentCondition]",
                UseBasicSearch = true,
                BasicSearchExpression = "[PresentCondition]",
                DateTimeFormat = -1,
                VirtualExpression = "[PresentCondition]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "PresentCondition", "CustomMsg"),
                IsUpload = false
            };
            PresentCondition.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PresentCondition", "MTCrewMedicalHistory", true, "PresentCondition", new List<string> {"PresentCondition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PresentCondition", "MTCrewMedicalHistory", true, "PresentCondition", new List<string> {"PresentCondition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PresentCondition", "MTCrewMedicalHistory", true, "PresentCondition", new List<string> {"PresentCondition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Treatment = new (this, "x_Treatment", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[Treatment]",
                DateTimeFormat = -1,
                VirtualExpression = "[Treatment]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "Treatment", "CustomMsg"),
                IsUpload = false
            };
            Treatment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Treatment", "MTCrewMedicalHistory", true, "Treatment", new List<string> {"Treatment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Treatment", "MTCrewMedicalHistory", true, "Treatment", new List<string> {"Treatment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Treatment", "MTCrewMedicalHistory", true, "Treatment", new List<string> {"Treatment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Details = new (this, "x_Details", 202, SqlDbType.NVarChar) {
                ...
                Expression = "[Details]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Details]",
                DateTimeFormat = -1,
                VirtualExpression = "[Details]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "Details", "CustomMsg"),
                IsUpload = false
            };
            Details.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Details", "MTCrewMedicalHistory", true, "Details", new List<string> {"Details", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Details", "MTCrewMedicalHistory", true, "Details", new List<string> {"Details", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Details", "MTCrewMedicalHistory", true, "Details", new List<string> {"Details", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCrewMedicalHistory", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCrewMedicalHistory", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCrewMedicalHistory", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewMedicalHistory", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewMedicalHistory", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewMedicalHistory", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewMedicalHistory", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "MtCrewMedicalHistoryList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "MtCrewMedicalHistoryView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCrewMedicalHistoryEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCrewMedicalHistoryAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCrewMedicalHistoryView",
                Config.ApiAddAction => "MtCrewMedicalHistoryAdd",
                Config.ApiEditAction => "MtCrewMedicalHistoryEdit",
                Config.ApiDeleteAction => "MtCrewMedicalHistoryDelete",
                Config.ApiListAction => "MtCrewMedicalHistoryList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCrewMedicalHistoryList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCrewMedicalHistoryView", parm);
            else
                url = KeyUrl("MtCrewMedicalHistoryView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCrewMedicalHistoryAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtCrewMedicalHistoryAdd?" + parm;
            else
                url = "MtCrewMedicalHistoryAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewMedicalHistoryEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewMedicalHistoryList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewMedicalHistoryAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewMedicalHistoryList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCrewMedicalHistoryDelete")); // DN
        ...
        {
            string pageName = "MtCrewMedicalHistoryList";
