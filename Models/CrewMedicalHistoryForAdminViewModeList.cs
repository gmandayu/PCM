...
public partial class PCM {
    /// <summary>
    /// crewMedicalHistoryForAdminViewModeList
    /// </summary>
    public static CrewMedicalHistoryForAdminViewModeList crewMedicalHistoryForAdminViewModeList
    {
        get => HttpData.Get<CrewMedicalHistoryForAdminViewModeList>("crewMedicalHistoryForAdminViewModeList")!;
        set => HttpData["crewMedicalHistoryForAdminViewModeList"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalHistoryForAdminViewMode
    /// </summary>
    public class CrewMedicalHistoryForAdminViewModeList : CrewMedicalHistoryForAdminViewModeListBase
    {
        // Constructor
        public CrewMedicalHistoryForAdminViewModeList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalHistoryForAdminViewModeList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalHistoryForAdminViewModeListBase : CrewMedicalHistoryForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalHistoryForAdminViewModeList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fCrewMedicalHistoryForAdminViewModelist";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminViewModeListBase()
        {
            // CSS class name as context
            TableVar = "CrewMedicalHistoryForAdminViewMode";
            ...
            // Initialize URLs
            AddUrl = "CrewMedicalHistoryForAdminViewModeAdd";
            ...
            MultiDeleteUrl = "CrewMedicalHistoryForAdminViewModeDelete";
            MultiUpdateUrl = "CrewMedicalHistoryForAdminViewModeUpdate";
        ...
        // Page name
        public string PageName => "CrewMedicalHistoryForAdminViewModeList";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminViewModeListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fCrewMedicalHistoryForAdminViewModegrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalHistoryForAdminViewModeList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(_Type.AdvancedSearch.ToJson())); // Field Type
            filters.Merge(JObject.Parse(VesselName.AdvancedSearch.ToJson())); // Field VesselName
            filters.Merge(JObject.Parse(DateOccurence.AdvancedSearch.ToJson())); // Field DateOccurence
            filters.Merge(JObject.Parse(PlaceOccurence.AdvancedSearch.ToJson())); // Field PlaceOccurence
            filters.Merge(JObject.Parse(PeriodOfDisability.AdvancedSearch.ToJson())); // Field PeriodOfDisability
            filters.Merge(JObject.Parse(PresentCondition.AdvancedSearch.ToJson())); // Field PresentCondition
            filters.Merge(JObject.Parse(Treatment.AdvancedSearch.ToJson())); // Field Treatment
            filters.Merge(JObject.Parse(Details.AdvancedSearch.ToJson())); // Field Details
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Type
            if (filter?.TryGetValue("x__Type", out sv) ?? false) {
                _Type.AdvancedSearch.SearchValue = sv;
                _Type.AdvancedSearch.SearchOperator = filter["z__Type"];
                _Type.AdvancedSearch.SearchCondition = filter["v__Type"];
                _Type.AdvancedSearch.SearchValue2 = filter["y__Type"];
                _Type.AdvancedSearch.SearchOperator2 = filter["w__Type"];
                _Type.AdvancedSearch.Save();
            }
            ...
            // Field DateOccurence
            if (filter?.TryGetValue("x_DateOccurence", out sv) ?? false) {
                DateOccurence.AdvancedSearch.SearchValue = sv;
                DateOccurence.AdvancedSearch.SearchOperator = filter["z_DateOccurence"];
                DateOccurence.AdvancedSearch.SearchCondition = filter["v_DateOccurence"];
                DateOccurence.AdvancedSearch.SearchValue2 = filter["y_DateOccurence"];
                DateOccurence.AdvancedSearch.SearchOperator2 = filter["w_DateOccurence"];
                DateOccurence.AdvancedSearch.Save();
            }

            // Field PlaceOccurence
            if (filter?.TryGetValue("x_PlaceOccurence", out sv) ?? false) {
                PlaceOccurence.AdvancedSearch.SearchValue = sv;
                PlaceOccurence.AdvancedSearch.SearchOperator = filter["z_PlaceOccurence"];
                PlaceOccurence.AdvancedSearch.SearchCondition = filter["v_PlaceOccurence"];
                PlaceOccurence.AdvancedSearch.SearchValue2 = filter["y_PlaceOccurence"];
                PlaceOccurence.AdvancedSearch.SearchOperator2 = filter["w_PlaceOccurence"];
                PlaceOccurence.AdvancedSearch.Save();
            }

            // Field PeriodOfDisability
            if (filter?.TryGetValue("x_PeriodOfDisability", out sv) ?? false) {
                PeriodOfDisability.AdvancedSearch.SearchValue = sv;
                PeriodOfDisability.AdvancedSearch.SearchOperator = filter["z_PeriodOfDisability"];
                PeriodOfDisability.AdvancedSearch.SearchCondition = filter["v_PeriodOfDisability"];
                PeriodOfDisability.AdvancedSearch.SearchValue2 = filter["y_PeriodOfDisability"];
                PeriodOfDisability.AdvancedSearch.SearchOperator2 = filter["w_PeriodOfDisability"];
                PeriodOfDisability.AdvancedSearch.Save();
            }

            // Field PresentCondition
            if (filter?.TryGetValue("x_PresentCondition", out sv) ?? false) {
                PresentCondition.AdvancedSearch.SearchValue = sv;
                PresentCondition.AdvancedSearch.SearchOperator = filter["z_PresentCondition"];
                PresentCondition.AdvancedSearch.SearchCondition = filter["v_PresentCondition"];
                PresentCondition.AdvancedSearch.SearchValue2 = filter["y_PresentCondition"];
                PresentCondition.AdvancedSearch.SearchOperator2 = filter["w_PresentCondition"];
                PresentCondition.AdvancedSearch.Save();
            }

            // Field Treatment
            if (filter?.TryGetValue("x_Treatment", out sv) ?? false) {
                Treatment.AdvancedSearch.SearchValue = sv;
                Treatment.AdvancedSearch.SearchOperator = filter["z_Treatment"];
                Treatment.AdvancedSearch.SearchCondition = filter["v_Treatment"];
                Treatment.AdvancedSearch.SearchValue2 = filter["y_Treatment"];
                Treatment.AdvancedSearch.SearchOperator2 = filter["w_Treatment"];
                Treatment.AdvancedSearch.Save();
            }

            // Field Details
            if (filter?.TryGetValue("x_Details", out sv) ?? false) {
                Details.AdvancedSearch.SearchValue = sv;
                Details.AdvancedSearch.SearchOperator = filter["z_Details"];
                Details.AdvancedSearch.SearchCondition = filter["v_Details"];
                Details.AdvancedSearch.SearchValue2 = filter["y_Details"];
                Details.AdvancedSearch.SearchOperator2 = filter["w_Details"];
                Details.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, _Type, def, true); // _Type
            BuildSearchSql(ref where, VesselName, def, true); // VesselName
            BuildSearchSql(ref where, DateOccurence, def, true); // DateOccurence
            BuildSearchSql(ref where, PlaceOccurence, def, true); // PlaceOccurence
            BuildSearchSql(ref where, PeriodOfDisability, def, true); // PeriodOfDisability
            BuildSearchSql(ref where, PresentCondition, def, true); // PresentCondition
            BuildSearchSql(ref where, Treatment, def, true); // Treatment
            BuildSearchSql(ref where, Details, def, true); // Details
            ...
            if (!def && Command == "search") {
                ...
                _Type.AdvancedSearch.Save(); // Type
                VesselName.AdvancedSearch.Save(); // VesselName
                DateOccurence.AdvancedSearch.Save(); // DateOccurence
                PlaceOccurence.AdvancedSearch.Save(); // PlaceOccurence
                PeriodOfDisability.AdvancedSearch.Save(); // PeriodOfDisability
                PresentCondition.AdvancedSearch.Save(); // PresentCondition
                Treatment.AdvancedSearch.Save(); // Treatment
                Details.AdvancedSearch.Save(); // Details
        ...
        public void ShowFilterList()
        {
            ...
            // Field Type
            filter = QueryBuilderWhere("Type");
            if (Empty(filter))
                BuildSearchSql(ref filter, _Type, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + _Type.Caption + "</span>" + captionSuffix + filter + "</div>";
            ...
            // Field DateOccurence
            filter = QueryBuilderWhere("DateOccurence");
            if (Empty(filter))
                BuildSearchSql(ref filter, DateOccurence, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + DateOccurence.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field PlaceOccurence
            filter = QueryBuilderWhere("PlaceOccurence");
            if (Empty(filter))
                BuildSearchSql(ref filter, PlaceOccurence, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + PlaceOccurence.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field PeriodOfDisability
            filter = QueryBuilderWhere("PeriodOfDisability");
            if (Empty(filter))
                BuildSearchSql(ref filter, PeriodOfDisability, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + PeriodOfDisability.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field PresentCondition
            filter = QueryBuilderWhere("PresentCondition");
            if (Empty(filter))
                BuildSearchSql(ref filter, PresentCondition, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + PresentCondition.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field Treatment
            filter = QueryBuilderWhere("Treatment");
            if (Empty(filter))
                BuildSearchSql(ref filter, Treatment, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Treatment.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field Details
            filter = QueryBuilderWhere("Details");
            if (Empty(filter))
                BuildSearchSql(ref filter, Details, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Details.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(_Type);
            searchFlds.Add(VesselName);
            searchFlds.Add(PlaceOccurence);
            searchFlds.Add(PeriodOfDisability);
            searchFlds.Add(PresentCondition);
            searchFlds.Add(Treatment);
            searchFlds.Add(Details);
        ...
        protected bool CheckSearchParms() {
            ...
            if (MTCrewID.AdvancedSearch.IssetSession)
                return true;
            if (_Type.AdvancedSearch.IssetSession)
                return true;
            if (VesselName.AdvancedSearch.IssetSession)
                return true;
            if (DateOccurence.AdvancedSearch.IssetSession)
                return true;
            if (PlaceOccurence.AdvancedSearch.IssetSession)
                return true;
            if (PeriodOfDisability.AdvancedSearch.IssetSession)
                return true;
            if (PresentCondition.AdvancedSearch.IssetSession)
                return true;
            if (Treatment.AdvancedSearch.IssetSession)
                return true;
            if (Details.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            _Type.AdvancedSearch.UnsetSession();
            VesselName.AdvancedSearch.UnsetSession();
            DateOccurence.AdvancedSearch.UnsetSession();
            PlaceOccurence.AdvancedSearch.UnsetSession();
            PeriodOfDisability.AdvancedSearch.UnsetSession();
            PresentCondition.AdvancedSearch.UnsetSession();
            Treatment.AdvancedSearch.UnsetSession();
            Details.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            _Type.AdvancedSearch.Load();
            VesselName.AdvancedSearch.Load();
            DateOccurence.AdvancedSearch.Load();
            PlaceOccurence.AdvancedSearch.Load();
            PeriodOfDisability.AdvancedSearch.Load();
            PresentCondition.AdvancedSearch.Load();
            Treatment.AdvancedSearch.Load();
            Details.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(_Type, ctrl); // Type
                UpdateSort(VesselName, ctrl); // VesselName
                UpdateSort(DateOccurence, ctrl); // DateOccurence
                UpdateSort(PlaceOccurence, ctrl); // PlaceOccurence
                UpdateSort(PeriodOfDisability, ctrl); // PeriodOfDisability
                UpdateSort(PresentCondition, ctrl); // PresentCondition
                UpdateSort(Treatment, ctrl); // Treatment
                UpdateSort(Details, ctrl); // Details
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    DateOccurence.Sort = "";
                    PlaceOccurence.Sort = "";
                    PeriodOfDisability.Sort = "";
                    PresentCondition.Sort = "";
                    Treatment.Sort = "";
                    Details.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""CrewMedicalHistoryForAdminViewMode"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""CrewMedicalHistoryForAdminViewMode"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCrewMedicalHistoryForAdminViewModelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCrewMedicalHistoryForAdminViewModelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""CrewMedicalHistoryForAdminViewMode"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("DateOccurence")); // DN
                CreateColumnOption(option.Add("PlaceOccurence")); // DN
                CreateColumnOption(option.Add("PeriodOfDisability")); // DN
                CreateColumnOption(option.Add("PresentCondition")); // DN
                CreateColumnOption(option.Add("Treatment")); // DN
                CreateColumnOption(option.Add("Details")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fCrewMedicalHistoryForAdminViewModesrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fCrewMedicalHistoryForAdminViewModesrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fCrewMedicalHistoryForAdminViewModelist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_CrewMedicalHistoryForAdminViewMode");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(crewMedicalHistoryForAdminViewModeList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(crewMedicalHistoryForAdminViewModeList.RowCount) + "_CrewMedicalHistoryForAdminViewMode");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(crewMedicalHistoryForAdminViewModeList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && crewMedicalHistoryForAdminViewModeList.RowType == RowType.Add || IsEdit && crewMedicalHistoryForAdminViewModeList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            // _Type
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x__Type[]"))
                    _Type.AdvancedSearch.SearchValue = Get("x__Type[]");
                else
                    _Type.AdvancedSearch.SearchValue = Get("_Type"); // Default Value // DN
            if (!Empty(_Type.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z__Type"))
                _Type.AdvancedSearch.SearchOperator = Get("z__Type");
            ...
            // DateOccurence
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_DateOccurence[]"))
                    DateOccurence.AdvancedSearch.SearchValue = Get("x_DateOccurence[]");
                else
                    DateOccurence.AdvancedSearch.SearchValue = Get("DateOccurence"); // Default Value // DN
            if (!Empty(DateOccurence.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_DateOccurence"))
                DateOccurence.AdvancedSearch.SearchOperator = Get("z_DateOccurence");

            // PlaceOccurence
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_PlaceOccurence[]"))
                    PlaceOccurence.AdvancedSearch.SearchValue = Get("x_PlaceOccurence[]");
                else
                    PlaceOccurence.AdvancedSearch.SearchValue = Get("PlaceOccurence"); // Default Value // DN
            if (!Empty(PlaceOccurence.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_PlaceOccurence"))
                PlaceOccurence.AdvancedSearch.SearchOperator = Get("z_PlaceOccurence");

            // PeriodOfDisability
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_PeriodOfDisability[]"))
                    PeriodOfDisability.AdvancedSearch.SearchValue = Get("x_PeriodOfDisability[]");
                else
                    PeriodOfDisability.AdvancedSearch.SearchValue = Get("PeriodOfDisability"); // Default Value // DN
            if (!Empty(PeriodOfDisability.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_PeriodOfDisability"))
                PeriodOfDisability.AdvancedSearch.SearchOperator = Get("z_PeriodOfDisability");

            // PresentCondition
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_PresentCondition[]"))
                    PresentCondition.AdvancedSearch.SearchValue = Get("x_PresentCondition[]");
                else
                    PresentCondition.AdvancedSearch.SearchValue = Get("PresentCondition"); // Default Value // DN
            if (!Empty(PresentCondition.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_PresentCondition"))
                PresentCondition.AdvancedSearch.SearchOperator = Get("z_PresentCondition");

            // Treatment
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Treatment[]"))
                    Treatment.AdvancedSearch.SearchValue = Get("x_Treatment[]");
                else
                    Treatment.AdvancedSearch.SearchValue = Get("Treatment"); // Default Value // DN
            if (!Empty(Treatment.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_Treatment"))
                Treatment.AdvancedSearch.SearchOperator = Get("z_Treatment");

            // Details
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Details[]"))
                    Details.AdvancedSearch.SearchValue = Get("x_Details[]");
                else
                    Details.AdvancedSearch.SearchValue = Get("Details"); // Default Value // DN
            if (!Empty(Details.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_Details"))
                Details.AdvancedSearch.SearchOperator = Get("z_Details");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Type
                if (_Type.UseFilter && !Empty(_Type.AdvancedSearch.SearchValue)) {
                    _Type.EditValue = ConvertToString(_Type.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
                ...
                // DateOccurence
                if (DateOccurence.UseFilter && !Empty(DateOccurence.AdvancedSearch.SearchValue)) {
                    DateOccurence.EditValue = ConvertToString(DateOccurence.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }

                // PlaceOccurence
                if (PlaceOccurence.UseFilter && !Empty(PlaceOccurence.AdvancedSearch.SearchValue)) {
                    PlaceOccurence.EditValue = ConvertToString(PlaceOccurence.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }

                // PeriodOfDisability
                if (PeriodOfDisability.UseFilter && !Empty(PeriodOfDisability.AdvancedSearch.SearchValue)) {
                    PeriodOfDisability.EditValue = ConvertToString(PeriodOfDisability.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }

                // PresentCondition
                if (PresentCondition.UseFilter && !Empty(PresentCondition.AdvancedSearch.SearchValue)) {
                    PresentCondition.EditValue = ConvertToString(PresentCondition.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }

                // Treatment
                if (Treatment.UseFilter && !Empty(Treatment.AdvancedSearch.SearchValue)) {
                    Treatment.EditValue = ConvertToString(Treatment.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }

                // Details
                if (Details.UseFilter && !Empty(Details.AdvancedSearch.SearchValue)) {
                    Details.EditValue = ConvertToString(Details.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fCrewMedicalHistoryForAdminViewModelist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fCrewMedicalHistoryForAdminViewModelist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fCrewMedicalHistoryForAdminViewModelist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fCrewMedicalHistoryForAdminViewModesrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
