...
public partial class PCM {
    /// <summary>
    /// mtCertificateOnRankView
    /// </summary>
    public static MtCertificateOnRankView mtCertificateOnRankView
    {
        get => HttpData.Get<MtCertificateOnRankView>("mtCertificateOnRankView")!;
        set => HttpData["mtCertificateOnRankView"] = value;
    }

    /// <summary>
    /// Page class for MTCertificateOnRank
    /// </summary>
    public class MtCertificateOnRankView : MtCertificateOnRankViewBase
    {
        // Constructor
        public MtCertificateOnRankView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateOnRankView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateOnRankViewBase : MtCertificateOnRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateOnRankView";
        ...
        // Constructor
        public MtCertificateOnRankViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCertificateOnRankView";
        ...
        // Constructor
        public MtCertificateOnRankViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtCertificateOnRankList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtCertificateOnRankList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCertificateOnRankView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTCertificateOnRankview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtCertificateOnRankList")), "", TableVar, true);
            string pageId = "view";
