...
public partial class PCM {
    ...
    /// mtUserLevelDelete
    /// </summary>
    public static MtUserLevelDelete mtUserLevelDelete
    {
        get => HttpData.Get<MtUserLevelDelete>("mtUserLevelDelete")!;
        set => HttpData["mtUserLevelDelete"] = value;
    }

    /// <summary>
    /// Page class for MTUserLevel
    /// </summary>
    public class MtUserLevelDelete : MtUserLevelDeleteBase
    {
        // Constructor
        public MtUserLevelDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserLevelDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserLevelDeleteBase : MtUserLevel
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserLevelDelete";
        ...
        // Page name
        public string PageName => "MtUserLevelDelete";
        ...
        // Constructor
        public MtUserLevelDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtUserLevelList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtUserLevelList"); // Return to list
                }
            }
