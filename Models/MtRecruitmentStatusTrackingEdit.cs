...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusTrackingEdit
    /// </summary>
    public static MtRecruitmentStatusTrackingEdit mtRecruitmentStatusTrackingEdit
    {
        get => HttpData.Get<MtRecruitmentStatusTrackingEdit>("mtRecruitmentStatusTrackingEdit")!;
        set => HttpData["mtRecruitmentStatusTrackingEdit"] = value;
    }

    /// <summary>
    /// Page class for MTRecruitmentStatusTracking
    /// </summary>
    public class MtRecruitmentStatusTrackingEdit : MtRecruitmentStatusTrackingEditBase
    {
        // Constructor
        public MtRecruitmentStatusTrackingEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRecruitmentStatusTrackingEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRecruitmentStatusTrackingEditBase : MtRecruitmentStatusTracking
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRecruitmentStatusTrackingEdit";
        ...
        // Constructor
        public MtRecruitmentStatusTrackingEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtRecruitmentStatusTrackingEdit";
        ...
        // Constructor
        public MtRecruitmentStatusTrackingEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtRecruitmentStatusTrackingList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtRecruitmentStatusTrackingEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // MTRecruitmentStatusID
            MTRecruitmentStatusID.SetDbValue(rsnew, MTRecruitmentStatusID.CurrentValue, MTRecruitmentStatusID.ReadOnly);

            // Flag
            Flag.SetDbValue(rsnew, Flag.CurrentValue, Flag.ReadOnly);

            // FlagDescription
            FlagDescription.SetDbValue(rsnew, FlagDescription.CurrentValue, FlagDescription.ReadOnly);
