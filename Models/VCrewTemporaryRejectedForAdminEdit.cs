...
public partial class PCM {
    /// <summary>
    /// vCrewTemporaryRejectedForAdminEdit
    /// </summary>
    public static VCrewTemporaryRejectedForAdminEdit vCrewTemporaryRejectedForAdminEdit
    {
        get => HttpData.Get<VCrewTemporaryRejectedForAdminEdit>("vCrewTemporaryRejectedForAdminEdit")!;
        set => HttpData["vCrewTemporaryRejectedForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for v_CrewTemporaryRejectedForAdmin
    /// </summary>
    public class VCrewTemporaryRejectedForAdminEdit : VCrewTemporaryRejectedForAdminEditBase
    {
        // Constructor
        public VCrewTemporaryRejectedForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewTemporaryRejectedForAdminEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewTemporaryRejectedForAdminEditBase : VCrewTemporaryRejectedForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewTemporaryRejectedForAdminEdit";
        ...
        // Constructor
        public VCrewTemporaryRejectedForAdminEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewTemporaryRejectedForAdminEdit";
        ...
        // Constructor
        public VCrewTemporaryRejectedForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("VCrewTemporaryRejectedForAdminList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "VCrewTemporaryRejectedForAdminList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "VCrewTemporaryRejectedForAdminList") {
                                ...
                                returnUrl = "VCrewTemporaryRejectedForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewTemporaryRejectedForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
