...
public partial class PCM {
    /// <summary>
    /// mtCrewMedicalHistoryGrid
    /// </summary>
    public static MtCrewMedicalHistoryGrid mtCrewMedicalHistoryGrid
    {
        get => HttpData.Get<MtCrewMedicalHistoryGrid>("mtCrewMedicalHistoryGrid")!;
        set => HttpData["mtCrewMedicalHistoryGrid"] = value;
    }

    /// <summary>
    /// Page class for MTCrewMedicalHistory
    /// </summary>
    public class MtCrewMedicalHistoryGrid : MtCrewMedicalHistoryGridBase
    {
        // Constructor
        public MtCrewMedicalHistoryGrid() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewMedicalHistoryGridBase : MtCrewMedicalHistory
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewMedicalHistoryGrid";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMTCrewMedicalHistorygrid";
        ...
        // Constructor
        public MtCrewMedicalHistoryGridBase()
        {
        ...
        // Page name
        public string PageName => "MtCrewMedicalHistoryGrid";
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCrewMedicalHistoryGrid?.PageRender();
            }
            return new EmptyResult();
        }
        #pragma warning restore 219
        ...
        public bool EmptyRow()
        {
            ...
            !(MTCrewID.IsForeignKey && CurrentMasterTable != "" && SameString(MTCrewID.CurrentValue, MTCrewID.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x__Type") && CurrentForm.HasValue("o__Type") && !SameString(_Type.CurrentValue, _Type.DefaultValue) &&
            !(_Type.IsForeignKey && CurrentMasterTable != "" && SameString(_Type.CurrentValue, _Type.SessionValue)))
                return false;
            ...
            !(VesselName.IsForeignKey && CurrentMasterTable != "" && SameString(VesselName.CurrentValue, VesselName.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_DateOccurence") && CurrentForm.HasValue("o_DateOccurence") && !SameString(FormatDateTime(DateOccurence.CurrentValue, DateOccurence.FormatPattern), FormatDateTime(DateOccurence.DefaultValue, DateOccurence.FormatPattern)) &&
            !(DateOccurence.IsForeignKey && CurrentMasterTable != "" && SameString(FormatDateTime(DateOccurence.CurrentValue, DateOccurence.FormatPattern), FormatDateTime(DateOccurence.SessionValue, DateOccurence.FormatPattern))))
                return false;
            if (CurrentForm.HasValue("x_PlaceOccurence") && CurrentForm.HasValue("o_PlaceOccurence") && !SameString(PlaceOccurence.CurrentValue, PlaceOccurence.DefaultValue) &&
            !(PlaceOccurence.IsForeignKey && CurrentMasterTable != "" && SameString(PlaceOccurence.CurrentValue, PlaceOccurence.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_PeriodOfDisability") && CurrentForm.HasValue("o_PeriodOfDisability") && !SameString(PeriodOfDisability.CurrentValue, PeriodOfDisability.DefaultValue) &&
            !(PeriodOfDisability.IsForeignKey && CurrentMasterTable != "" && SameString(PeriodOfDisability.CurrentValue, PeriodOfDisability.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_PresentCondition") && CurrentForm.HasValue("o_PresentCondition") && !SameString(PresentCondition.CurrentValue, PresentCondition.DefaultValue) &&
            !(PresentCondition.IsForeignKey && CurrentMasterTable != "" && SameString(PresentCondition.CurrentValue, PresentCondition.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_Treatment") && CurrentForm.HasValue("o_Treatment") && !SameString(Treatment.CurrentValue, Treatment.DefaultValue) &&
            !(Treatment.IsForeignKey && CurrentMasterTable != "" && SameString(Treatment.CurrentValue, Treatment.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_Details") && CurrentForm.HasValue("o_Details") && !SameString(Details.CurrentValue, Details.DefaultValue) &&
            !(Details.IsForeignKey && CurrentMasterTable != "" && SameString(Details.CurrentValue, Details.SessionValue)))
                return false;
        ...
        public void ResetFormError()
        {
            ...
            _Type.ClearErrorMessage();
            VesselName.ClearErrorMessage();
            DateOccurence.ClearErrorMessage();
            PlaceOccurence.ClearErrorMessage();
            PeriodOfDisability.ClearErrorMessage();
            PresentCondition.ClearErrorMessage();
            Treatment.ClearErrorMessage();
            Details.ClearErrorMessage();
        ...
        public async Task SetupRow()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtCrewMedicalHistoryGrid.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtCrewMedicalHistoryGrid.RowCount) + "_MTCrewMedicalHistory");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtCrewMedicalHistoryGrid.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtCrewMedicalHistoryGrid.RowType == RowType.Add || IsEdit && mtCrewMedicalHistoryGrid.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected async Task LoadFormValues() {
            ...
            if (CurrentForm.HasValue("o__Type"))
                _Type.OldValue = CurrentForm.GetValue("o__Type");
            ...
            DateOccurence.OldValue = UnformatDateTime(CurrentForm.GetValue("o_DateOccurence"), DateOccurence.FormatPattern);
            ...
            if (CurrentForm.HasValue("o_PlaceOccurence"))
                PlaceOccurence.OldValue = CurrentForm.GetValue("o_PlaceOccurence");
            ...
            if (CurrentForm.HasValue("o_PeriodOfDisability"))
                PeriodOfDisability.OldValue = CurrentForm.GetValue("o_PeriodOfDisability");
            ...
            if (CurrentForm.HasValue("o_PresentCondition"))
                PresentCondition.OldValue = CurrentForm.GetValue("o_PresentCondition");
            ...
            if (CurrentForm.HasValue("o_Treatment"))
                Treatment.OldValue = CurrentForm.GetValue("o_Treatment");
            ...
            if (CurrentForm.HasValue("o_Details"))
                Details.OldValue = CurrentForm.GetValue("o_Details");
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // DateOccurence
                DateOccurence.SetDbValue(rsnew, ConvertToDateTime(DateOccurence.CurrentValue, DateOccurence.FormatPattern));

                // PlaceOccurence
                PlaceOccurence.SetDbValue(rsnew, PlaceOccurence.CurrentValue);

                // PeriodOfDisability
                PeriodOfDisability.SetDbValue(rsnew, PeriodOfDisability.CurrentValue);

                // PresentCondition
                PresentCondition.SetDbValue(rsnew, PresentCondition.CurrentValue);

                // Treatment
                Treatment.SetDbValue(rsnew, Treatment.CurrentValue);

                // Details
                Details.SetDbValue(rsnew, Details.CurrentValue);
