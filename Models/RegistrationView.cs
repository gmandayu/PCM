...
public partial class PCM {
    ...
    {
        get => HttpData.Get<RegistrationView>("registrationView")!;
        set => HttpData["registrationView"] = value;
    }

    /// <summary>
    /// Page class for Registration
    /// </summary>
    public class RegistrationView : RegistrationViewBase
    {
        // Constructor
        public RegistrationView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RegistrationView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RegistrationViewBase : Registration
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "registrationView";
        ...
        // Page name
        public string PageName => "RegistrationView";
        ...
        // Constructor
        public RegistrationViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("RegistrationList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fRegistrationview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("RegistrationList")), "", TableVar, true);
            string pageId = "view";
