...
public partial class PCM {
    ...
    /// registrationSearch
    /// </summary>
    public static RegistrationSearch registrationSearch
    {
        get => HttpData.Get<RegistrationSearch>("registrationSearch")!;
        set => HttpData["registrationSearch"] = value;
    }

    /// <summary>
    /// Page class for Registration
    /// </summary>
    public class RegistrationSearch : RegistrationSearchBase
    {
        // Constructor
        public RegistrationSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RegistrationSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RegistrationSearchBase : Registration
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "registrationSearch";
        ...
        // Page name
        public string PageName => "RegistrationSearch";
        ...
        // Constructor
        public RegistrationSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "RegistrationList?" + srchStr;
