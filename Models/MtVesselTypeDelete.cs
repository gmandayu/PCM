...
public partial class PCM {
    ...
    /// mtVesselTypeDelete
    /// </summary>
    public static MtVesselTypeDelete mtVesselTypeDelete
    {
        get => HttpData.Get<MtVesselTypeDelete>("mtVesselTypeDelete")!;
        set => HttpData["mtVesselTypeDelete"] = value;
    }

    /// <summary>
    /// Page class for MTVesselType
    /// </summary>
    public class MtVesselTypeDelete : MtVesselTypeDeleteBase
    {
        // Constructor
        public MtVesselTypeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtVesselTypeDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtVesselTypeDeleteBase : MtVesselType
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtVesselTypeDelete";
        ...
        // Page name
        public string PageName => "MtVesselTypeDelete";
        ...
        // Constructor
        public MtVesselTypeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtVesselTypeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtVesselTypeList"); // Return to list
                }
            }
