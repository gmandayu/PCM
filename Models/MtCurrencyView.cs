...
public partial class PCM {
    ...
    /// mtCurrencyView
    /// </summary>
    public static MtCurrencyView mtCurrencyView
    {
        get => HttpData.Get<MtCurrencyView>("mtCurrencyView")!;
        set => HttpData["mtCurrencyView"] = value;
    }

    /// <summary>
    /// Page class for MTCurrency
    /// </summary>
    public class MtCurrencyView : MtCurrencyViewBase
    {
        // Constructor
        public MtCurrencyView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCurrencyView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCurrencyViewBase : MtCurrency
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCurrencyView";
        ...
        // Page name
        public string PageName => "MtCurrencyView";
        ...
        // Constructor
        public MtCurrencyViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtCurrencyList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtCurrencyList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTCurrencyview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtCurrencyList")), "", TableVar, true);
            string pageId = "view";
