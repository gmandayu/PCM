...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusView
    /// </summary>
    public static MtRecruitmentStatusView mtRecruitmentStatusView
    {
        get => HttpData.Get<MtRecruitmentStatusView>("mtRecruitmentStatusView")!;
        set => HttpData["mtRecruitmentStatusView"] = value;
    }

    /// <summary>
    /// Page class for MTRecruitmentStatus
    /// </summary>
    public class MtRecruitmentStatusView : MtRecruitmentStatusViewBase
    {
        // Constructor
        public MtRecruitmentStatusView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRecruitmentStatusView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRecruitmentStatusViewBase : MtRecruitmentStatus
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRecruitmentStatusView";
        ...
        // Constructor
        public MtRecruitmentStatusViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtRecruitmentStatusView";
        ...
        // Constructor
        public MtRecruitmentStatusViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtRecruitmentStatusList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtRecruitmentStatusList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtRecruitmentStatusView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTRecruitmentStatusview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtRecruitmentStatusList")), "", TableVar, true);
            string pageId = "view";
