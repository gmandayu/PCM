...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusDelete
    /// </summary>
    public static MtRecruitmentStatusDelete mtRecruitmentStatusDelete
    {
        get => HttpData.Get<MtRecruitmentStatusDelete>("mtRecruitmentStatusDelete")!;
        set => HttpData["mtRecruitmentStatusDelete"] = value;
    }

    /// <summary>
    /// Page class for MTRecruitmentStatus
    /// </summary>
    public class MtRecruitmentStatusDelete : MtRecruitmentStatusDeleteBase
    {
        // Constructor
        public MtRecruitmentStatusDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRecruitmentStatusDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRecruitmentStatusDeleteBase : MtRecruitmentStatus
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRecruitmentStatusDelete";
        ...
        // Constructor
        public MtRecruitmentStatusDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtRecruitmentStatusDelete";
        ...
        // Constructor
        public MtRecruitmentStatusDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtRecruitmentStatusList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtRecruitmentStatusList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtRecruitmentStatusDelete?.PageRender();
            }
            return PageResult();
        }
