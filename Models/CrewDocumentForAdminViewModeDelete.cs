...
public partial class PCM {
    /// <summary>
    /// crewDocumentForAdminViewModeDelete
    /// </summary>
    public static CrewDocumentForAdminViewModeDelete crewDocumentForAdminViewModeDelete
    {
        get => HttpData.Get<CrewDocumentForAdminViewModeDelete>("crewDocumentForAdminViewModeDelete")!;
        set => HttpData["crewDocumentForAdminViewModeDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewDocumentForAdminViewMode
    /// </summary>
    public class CrewDocumentForAdminViewModeDelete : CrewDocumentForAdminViewModeDeleteBase
    {
        // Constructor
        public CrewDocumentForAdminViewModeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewDocumentForAdminViewModeDelete() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastDeletedDocumentCrewID = Session.GetInt("lastDeletedDocumentCrewID");
            Session.Remove("lastDeletedDocumentCrewID");
            url = "CrewDocumentForAdminViewModeList?crewID=" + ConvertToString(lastDeletedDocumentCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewDocumentForAdminViewModeDeleteBase : CrewDocumentForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewDocumentForAdminViewModeDelete";
        ...
        // Constructor
        public CrewDocumentForAdminViewModeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewDocumentForAdminViewModeDelete";
        ...
        // Constructor
        public CrewDocumentForAdminViewModeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewDocumentForAdminViewModeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewDocumentForAdminViewModeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewDocumentForAdminViewModeDelete?.PageRender();
            }
            return PageResult();
        }
