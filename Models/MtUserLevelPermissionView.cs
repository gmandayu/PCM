...
public partial class PCM {
    /// <summary>
    /// mtUserLevelPermissionView
    /// </summary>
    public static MtUserLevelPermissionView mtUserLevelPermissionView
    {
        get => HttpData.Get<MtUserLevelPermissionView>("mtUserLevelPermissionView")!;
        set => HttpData["mtUserLevelPermissionView"] = value;
    }

    /// <summary>
    /// Page class for MTUserLevelPermission
    /// </summary>
    public class MtUserLevelPermissionView : MtUserLevelPermissionViewBase
    {
        // Constructor
        public MtUserLevelPermissionView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserLevelPermissionView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserLevelPermissionViewBase : MtUserLevelPermission
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserLevelPermissionView";
        ...
        // Constructor
        public MtUserLevelPermissionViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtUserLevelPermissionView";
        ...
        // Constructor
        public MtUserLevelPermissionViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("UserLevelID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtUserLevelPermissionList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtUserLevelPermissionList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtUserLevelPermissionView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtUserLevelPermissionList")), "", TableVar, true);
            string pageId = "view";
