...
public partial class PCM {
    /// <summary>
    /// crewGeneralDataForAdmin
    /// </summary>
    [MaybeNull]
    public static CrewGeneralDataForAdmin crewGeneralDataForAdmin
    {
        get => HttpData.Resolve<CrewGeneralDataForAdmin>("CrewGeneralDataForAdmin");
        set => HttpData["CrewGeneralDataForAdmin"] = value;
    }

    /// <summary>
    /// Table class for CrewGeneralDataForAdmin
    /// </summary>
    public class CrewGeneralDataForAdmin : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public CrewGeneralDataForAdmin()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewGeneralDataForAdmin";
            Name = "CrewGeneralDataForAdmin";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            ForeignVisaHasBeenDenied = new (this, "x_ForeignVisaHasBeenDenied", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "ForeignVisaHasBeenDenied", "CustomMsg"),
                IsUpload = false
            };
            ForeignVisaHasBeenDenied.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("ForeignVisaHasBeenDenied", "CrewGeneralDataForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("ForeignVisaHasBeenDenied", "CrewGeneralDataForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("ForeignVisaHasBeenDenied", "CrewGeneralDataForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ForeignVisaDenied_CountryID = new (this, "x_ForeignVisaDenied_CountryID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "ForeignVisaDenied_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ForeignVisaDeniedReason = new (this, "x_ForeignVisaDeniedReason", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "ForeignVisaDeniedReason", "CustomMsg"),
                IsUpload = false
            };
            ...
            HasMaritimeAccidentOrCourtOfEnquiry = new (this, "x_HasMaritimeAccidentOrCourtOfEnquiry", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "HasMaritimeAccidentOrCourtOfEnquiry", "CustomMsg"),
                IsUpload = false
            };
            HasMaritimeAccidentOrCourtOfEnquiry.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("HasMaritimeAccidentOrCourtOfEnquiry", "CrewGeneralDataForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("HasMaritimeAccidentOrCourtOfEnquiry", "CrewGeneralDataForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("HasMaritimeAccidentOrCourtOfEnquiry", "CrewGeneralDataForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            HasMaritimeAccidentOrCourtOfEnquiryDetails = new (this, "x_HasMaritimeAccidentOrCourtOfEnquiryDetails", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "HasMaritimeAccidentOrCourtOfEnquiryDetails", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference1CompanyName = new (this, "x_Reference1CompanyName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference1CompanyName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference1ContactPersonName = new (this, "x_Reference1ContactPersonName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference1ContactPersonName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference1CompanyAddress = new (this, "x_Reference1CompanyAddress", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference1CompanyAddress", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference1CompanyCountryID = new (this, "x_Reference1CompanyCountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference1CompanyCountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference1CompanyTelephone = new (this, "x_Reference1CompanyTelephone", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "tel",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference1CompanyTelephone", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference2CompanyName = new (this, "x_Reference2CompanyName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference2CompanyName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference2ContactPersonName = new (this, "x_Reference2ContactPersonName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference2ContactPersonName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference2CompanyAddress = new (this, "x_Reference2CompanyAddress", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference2CompanyAddress", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference2CompanyCountryID = new (this, "x_Reference2CompanyCountryID", 3, SqlDbType.Int) {
                ...
                PleaseSelectText = Language.Phrase("PleaseSelect"), // PleaseSelect text
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference2CompanyCountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference2CompanyTelephone = new (this, "x_Reference2CompanyTelephone", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "tel",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference2CompanyTelephone", "CustomMsg"),
                IsUpload = false
            };
            ...
            EmployeeStatus = new (this, "x_EmployeeStatus", 202, SqlDbType.NVarChar) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "EmployeeStatus", "CustomMsg"),
                IsUpload = false
            };
            EmployeeStatus.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("EmployeeStatus", "CrewGeneralDataForAdmin", true, "EmployeeStatus", new List<string> {"EmployeeStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("EmployeeStatus", "CrewGeneralDataForAdmin", true, "EmployeeStatus", new List<string> {"EmployeeStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("EmployeeStatus", "CrewGeneralDataForAdmin", true, "EmployeeStatus", new List<string> {"EmployeeStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            FormSubmittedDateTime = new (this, "x_FormSubmittedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "FormSubmittedDateTime", "CustomMsg"),
                IsUpload = false
            };
            FormSubmittedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("FormSubmittedDateTime", "CrewGeneralDataForAdmin", true, "FormSubmittedDateTime", new List<string> {"FormSubmittedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("FormSubmittedDateTime", "CrewGeneralDataForAdmin", true, "FormSubmittedDateTime", new List<string> {"FormSubmittedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("FormSubmittedDateTime", "CrewGeneralDataForAdmin", true, "FormSubmittedDateTime", new List<string> {"FormSubmittedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewGeneralDataForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewGeneralDataForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewGeneralDataForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference1CompanyTelephoneCode_CountryID = new (this, "x_Reference1CompanyTelephoneCode_CountryID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference1CompanyTelephoneCode_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference2CompanyTelephoneCode_CountryID = new (this, "x_Reference2CompanyTelephoneCode_CountryID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewGeneralDataForAdmin", "Reference2CompanyTelephoneCode_CountryID", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewGeneralDataForAdminList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewGeneralDataForAdminView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewGeneralDataForAdminEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewGeneralDataForAdminAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewGeneralDataForAdminView",
                Config.ApiAddAction => "CrewGeneralDataForAdminAdd",
                Config.ApiEditAction => "CrewGeneralDataForAdminEdit",
                Config.ApiDeleteAction => "CrewGeneralDataForAdminDelete",
                Config.ApiListAction => "CrewGeneralDataForAdminList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewGeneralDataForAdminList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewGeneralDataForAdminView", parm);
            else
                url = KeyUrl("CrewGeneralDataForAdminView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewGeneralDataForAdminAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewGeneralDataForAdminAdd?" + parm;
            else
                url = "CrewGeneralDataForAdminAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewGeneralDataForAdminEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewGeneralDataForAdminList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewGeneralDataForAdminAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewGeneralDataForAdminList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewGeneralDataForAdminDelete")); // DN
        ...
        {
            string pageName = "CrewGeneralDataForAdminList";
