...
public partial class PCM {
    ...
    /// mtBankView
    /// </summary>
    public static MtBankView mtBankView
    {
        get => HttpData.Get<MtBankView>("mtBankView")!;
        set => HttpData["mtBankView"] = value;
    }

    /// <summary>
    /// Page class for MTBank
    /// </summary>
    public class MtBankView : MtBankViewBase
    {
        // Constructor
        public MtBankView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBankView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBankViewBase : MtBank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBankView";
        ...
        // Page name
        public string PageName => "MtBankView";
        ...
        // Constructor
        public MtBankViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtBankList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtBankList"); // Return to list page
                            }
                        }
                    break;
            }
