...
public partial class PCM {
    /// <summary>
    /// vWaitingForPdeReviewView
    /// </summary>
    public static VWaitingForPdeReviewView vWaitingForPdeReviewView
    {
        get => HttpData.Get<VWaitingForPdeReviewView>("vWaitingForPdeReviewView")!;
        set => HttpData["vWaitingForPdeReviewView"] = value;
    }

    /// <summary>
    /// Page class for v_WaitingForPDEReview
    /// </summary>
    public class VWaitingForPdeReviewView : VWaitingForPdeReviewViewBase
    {
        // Constructor
        public VWaitingForPdeReviewView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VWaitingForPdeReviewView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VWaitingForPdeReviewViewBase : VWaitingForPdeReview
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vWaitingForPdeReviewView";
        ...
        // Constructor
        public VWaitingForPdeReviewViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VWaitingForPdeReviewView";
        ...
        // Constructor
        public VWaitingForPdeReviewViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "VWaitingForPdeReviewList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("VWaitingForPdeReviewList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vWaitingForPdeReviewView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("VWaitingForPdeReviewList")), "", TableVar, true);
            string pageId = "view";
