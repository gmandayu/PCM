...
public partial class PCM {
    /// <summary>
    /// crewCertificateForAdminViewModeDelete
    /// </summary>
    public static CrewCertificateForAdminViewModeDelete crewCertificateForAdminViewModeDelete
    {
        get => HttpData.Get<CrewCertificateForAdminViewModeDelete>("crewCertificateForAdminViewModeDelete")!;
        set => HttpData["crewCertificateForAdminViewModeDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewCertificateForAdminViewMode
    /// </summary>
    public class CrewCertificateForAdminViewModeDelete : CrewCertificateForAdminViewModeDeleteBase
    {
        // Constructor
        public CrewCertificateForAdminViewModeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewCertificateForAdminViewModeDelete() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastDeletedCertificateCrewID = Session.GetInt("lastDeletedCertificateCrewID");
            Session.Remove("lastDeletedCertificateCrewID");
            url = "CrewCertificateForAdminViewModeList?crewID=" + ConvertToString(lastDeletedCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewCertificateForAdminViewModeDeleteBase : CrewCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewCertificateForAdminViewModeDelete";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewCertificateForAdminViewModeDelete";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewCertificateForAdminViewModeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewCertificateForAdminViewModeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewCertificateForAdminViewModeDelete?.PageRender();
            }
            return PageResult();
        }
