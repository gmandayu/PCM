...
public partial class PCM {
    /// <summary>
    /// crewMedicalCertificateForAdminViewModeSearch
    /// </summary>
    public static CrewMedicalCertificateForAdminViewModeSearch crewMedicalCertificateForAdminViewModeSearch
    {
        get => HttpData.Get<CrewMedicalCertificateForAdminViewModeSearch>("crewMedicalCertificateForAdminViewModeSearch")!;
        set => HttpData["crewMedicalCertificateForAdminViewModeSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalCertificateForAdminViewMode
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeSearch : CrewMedicalCertificateForAdminViewModeSearchBase
    {
        // Constructor
        public CrewMedicalCertificateForAdminViewModeSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalCertificateForAdminViewModeSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeSearchBase : CrewMedicalCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalCertificateForAdminViewModeSearch";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewMedicalCertificateForAdminViewModeSearch";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewMedicalCertificateForAdminViewModeList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalCertificateForAdminViewModeSearch?.PageRender();
            }
            return PageResult();
        }
