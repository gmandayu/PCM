...
public partial class PCM {
    /// <summary>
    /// crewExperienceForAdminViewModeEdit
    /// </summary>
    public static CrewExperienceForAdminViewModeEdit crewExperienceForAdminViewModeEdit
    {
        get => HttpData.Get<CrewExperienceForAdminViewModeEdit>("crewExperienceForAdminViewModeEdit")!;
        set => HttpData["crewExperienceForAdminViewModeEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewExperienceForAdminViewMode
    /// </summary>
    public class CrewExperienceForAdminViewModeEdit : CrewExperienceForAdminViewModeEditBase
    {
        // Constructor
        public CrewExperienceForAdminViewModeEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewExperienceForAdminViewModeEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewExperienceForAdminViewModeList?crewID=" + ConvertToString(lastUpdatedExperienceCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewExperienceForAdminViewModeEditBase : CrewExperienceForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewExperienceForAdminViewModeEdit";
        ...
        // Constructor
        public CrewExperienceForAdminViewModeEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewExperienceForAdminViewModeEdit";
        ...
        // Constructor
        public CrewExperienceForAdminViewModeEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewExperienceForAdminViewModeList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewExperienceForAdminViewModeEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
