...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtCrewDocument mtCrewDocument
    {
        get => HttpData.Resolve<MtCrewDocument>("MTCrewDocument");
        set => HttpData["MTCrewDocument"] = value;
    }

    /// <summary>
    /// Table class for MTCrewDocument
    /// </summary>
    public class MtCrewDocument : DbTable, IQueryFactory
    {
        ...
        public MtCrewDocument()
        {
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            IsDraft = new (this, "x_IsDraft", 11, SqlDbType.Bit) {
                Name = "IsDraft",
                Expression = "[IsDraft]",
                BasicSearchExpression = "[IsDraft]",
                DateTimeFormat = -1,
                VirtualExpression = "[IsDraft]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "IsDraft", "CustomMsg"),
                IsUpload = false
            };
            IsDraft.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("IsDraft", "MTCrewDocument", true, "IsDraft", new List<string> {"IsDraft", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("IsDraft", "MTCrewDocument", true, "IsDraft", new List<string> {"IsDraft", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("IsDraft", "MTCrewDocument", true, "IsDraft", new List<string> {"IsDraft", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            IsDraft.GetDefault = () => 1;
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTDocumentID = new (this, "x_MTDocumentID", 3, SqlDbType.Int) {
                Name = "MTDocumentID",
                Expression = "[MTDocumentID]",
                BasicSearchExpression = "CAST([MTDocumentID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[MTDocumentID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "MTDocumentID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CountryOfIssue_CountryID = new (this, "x_CountryOfIssue_CountryID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "CountryOfIssue_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Number = new (this, "x_Number", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "Number", "CustomMsg"),
                IsUpload = false
            };
            Number.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Number", "MTCrewDocument", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Number", "MTCrewDocument", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Number", "MTCrewDocument", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            DateOfIssue = new (this, "x_DateOfIssue", 133, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "DateOfIssue", "CustomMsg"),
                IsUpload = false
            };
            DateOfIssue.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateOfIssue", "MTCrewDocument", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateOfIssue", "MTCrewDocument", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateOfIssue", "MTCrewDocument", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PlaceOfIssue = new (this, "x_PlaceOfIssue", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "PlaceOfIssue", "CustomMsg"),
                IsUpload = false
            };
            PlaceOfIssue.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PlaceOfIssue", "MTCrewDocument", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PlaceOfIssue", "MTCrewDocument", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PlaceOfIssue", "MTCrewDocument", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("PlaceOfIssue", PlaceOfIssue);

            // DateValidUntil
            DateValidUntil = new (this, "x_DateValidUntil", 133, SqlDbType.DateTime) {
                Name = "DateValidUntil",
                Expression = "[DateValidUntil]",
                BasicSearchExpression = CastDateFieldForLike("[DateValidUntil]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[DateValidUntil]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "DateValidUntil", "CustomMsg"),
                IsUpload = false
            };
            DateValidUntil.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateValidUntil", "MTCrewDocument", true, "DateValidUntil", new List<string> {"DateValidUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateValidUntil", "MTCrewDocument", true, "DateValidUntil", new List<string> {"DateValidUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateValidUntil", "MTCrewDocument", true, "DateValidUntil", new List<string> {"DateValidUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Image = new (this, "x_Image", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "Image", "CustomMsg"),
                IsUpload = true
            };
            Image.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Image", "MTCrewDocument", true, "Image", new List<string> {"Image", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Image", "MTCrewDocument", true, "Image", new List<string> {"Image", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Image", "MTCrewDocument", true, "Image", new List<string> {"Image", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Image.GetUploadPath = () => "files/document";
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCrewDocument", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCrewDocument", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCrewDocument", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewDocument", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewDocument", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewDocument", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewDocument", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "MtCrewDocumentView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCrewDocumentEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCrewDocumentAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCrewDocumentView",
                Config.ApiAddAction => "MtCrewDocumentAdd",
                Config.ApiEditAction => "MtCrewDocumentEdit",
                Config.ApiDeleteAction => "MtCrewDocumentDelete",
                Config.ApiListAction => "MtCrewDocumentList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCrewDocumentList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCrewDocumentView", parm);
            else
                url = KeyUrl("MtCrewDocumentView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCrewDocumentAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtCrewDocumentAdd?" + parm;
            else
                url = "MtCrewDocumentAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewDocumentEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewDocumentList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewDocumentAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewDocumentList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCrewDocumentDelete")); // DN
        ...
        {
            string pageName = "MtCrewDocumentList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IsDraft
            IsDraft.SetupEditAttributes();
            IsDraft.EditValue = IsDraft.Options(true);
            ...
            curVal = ConvertToString(MTDocumentID.CurrentValue)?.Trim() ?? "";
            if (MTDocumentID.Lookup != null && IsDictionary(MTDocumentID.Lookup?.Options) && MTDocumentID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                MTDocumentID.EditValue = MTDocumentID.Lookup?.Options.Values.ToList();
            } else { // Lookup from database
                filterWrk = "";
                sqlWrk = MTDocumentID.Lookup?.GetSql(true, filterWrk, null, this, false, true);
                rswrk = sqlWrk != null ? Connection.GetRows(sqlWrk) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
                MTDocumentID.EditValue = rswrk;
            }
            MTDocumentID.PlaceHolder = RemoveHtml(MTDocumentID.Caption);
            if (!Empty(MTDocumentID.EditValue) && IsNumeric(MTDocumentID.EditValue))
                MTDocumentID.EditValue = FormatNumber(MTDocumentID.EditValue, null);
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            ...
            if ((object) crewQueryResult != null)
            {
                ...
                if ((object) documentQueryResult != null)
                {
                    ...
                    rsnew["Image"] = crewIndividualCodeNumber + "-" + documentTypeURLFriendly + imageFileExtension;
                }
            }
            return true;
        }
