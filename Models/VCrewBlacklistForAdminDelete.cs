...
public partial class PCM {
    /// <summary>
    /// vCrewBlacklistForAdminDelete
    /// </summary>
    public static VCrewBlacklistForAdminDelete vCrewBlacklistForAdminDelete
    {
        get => HttpData.Get<VCrewBlacklistForAdminDelete>("vCrewBlacklistForAdminDelete")!;
        set => HttpData["vCrewBlacklistForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for v_CrewBlacklistForAdmin
    /// </summary>
    public class VCrewBlacklistForAdminDelete : VCrewBlacklistForAdminDeleteBase
    {
        // Constructor
        public VCrewBlacklistForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewBlacklistForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewBlacklistForAdminDeleteBase : VCrewBlacklistForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewBlacklistForAdminDelete";
        ...
        // Constructor
        public VCrewBlacklistForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewBlacklistForAdminDelete";
        ...
        // Constructor
        public VCrewBlacklistForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("VCrewBlacklistForAdminList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("VCrewBlacklistForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewBlacklistForAdminDelete?.PageRender();
            }
            return PageResult();
        }
