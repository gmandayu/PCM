...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtCrewCertificate mtCrewCertificate
    {
        get => HttpData.Resolve<MtCrewCertificate>("MTCrewCertificate");
        set => HttpData["MTCrewCertificate"] = value;
    }

    /// <summary>
    /// Table class for MTCrewCertificate
    /// </summary>
    public class MtCrewCertificate : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtCrewCertificate()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTCrewCertificate";
            Name = "MTCrewCertificate";
            Type = "TABLE";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            MTCrewID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MTCrewID", "MTCrew", true, "ID", new List<string> {"IndividualCodeNumber", "FullName", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "<span>{{:df}} - {{:df2}}</span>", "CONCAT([IndividualCodeNumber],'" + ValueSeparator(1, MTCrewID) + "',[FullName])"),
                "id-ID" => new Lookup<DbField>("MTCrewID", "MTCrew", true, "ID", new List<string> {"IndividualCodeNumber", "FullName", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "<span>{{:df}} - {{:df2}}</span>", "CONCAT([IndividualCodeNumber],'" + ValueSeparator(1, MTCrewID) + "',[FullName])"),
                _ => new Lookup<DbField>("MTCrewID", "MTCrew", true, "ID", new List<string> {"IndividualCodeNumber", "FullName", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "<span>{{:df}} - {{:df2}}</span>", "CONCAT([IndividualCodeNumber],'" + ValueSeparator(1, MTCrewID) + "',[FullName])")
            };
            ...
            MTCertificateID = new (this, "x_MTCertificateID", 3, SqlDbType.Int) {
                ...
                Expression = "[MTCertificateID]",
                BasicSearchExpression = "CAST([MTCertificateID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[MTCertificateID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "MTCertificateID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CountryOfIssue_CountryID = new (this, "x_CountryOfIssue_CountryID", 3, SqlDbType.Int) {
                ...
                Expression = "[CountryOfIssue_CountryID]",
                BasicSearchExpression = "CAST([CountryOfIssue_CountryID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[CountryOfIssue_CountryID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "CountryOfIssue_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Number = new (this, "x_Number", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "Number", "CustomMsg"),
                IsUpload = false
            };
            Number.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Number", "MTCrewCertificate", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Number", "MTCrewCertificate", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Number", "MTCrewCertificate", true, "Number", new List<string> {"Number", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            DateOfIssue = new (this, "x_DateOfIssue", 133, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "DateOfIssue", "CustomMsg"),
                IsUpload = false
            };
            DateOfIssue.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateOfIssue", "MTCrewCertificate", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateOfIssue", "MTCrewCertificate", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateOfIssue", "MTCrewCertificate", true, "DateOfIssue", new List<string> {"DateOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("DateOfIssue", DateOfIssue);

            // DateOfExpiry
            DateOfExpiry = new (this, "x_DateOfExpiry", 133, SqlDbType.DateTime) {
                Name = "DateOfExpiry",
                Expression = "[DateOfExpiry]",
                BasicSearchExpression = CastDateFieldForLike("[DateOfExpiry]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[DateOfExpiry]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "DateOfExpiry", "CustomMsg"),
                IsUpload = false
            };
            DateOfExpiry.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateOfExpiry", "MTCrewCertificate", true, "DateOfExpiry", new List<string> {"DateOfExpiry", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateOfExpiry", "MTCrewCertificate", true, "DateOfExpiry", new List<string> {"DateOfExpiry", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateOfExpiry", "MTCrewCertificate", true, "DateOfExpiry", new List<string> {"DateOfExpiry", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PlaceOfIssue = new (this, "x_PlaceOfIssue", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "PlaceOfIssue", "CustomMsg"),
                IsUpload = false
            };
            PlaceOfIssue.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PlaceOfIssue", "MTCrewCertificate", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PlaceOfIssue", "MTCrewCertificate", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PlaceOfIssue", "MTCrewCertificate", true, "PlaceOfIssue", new List<string> {"PlaceOfIssue", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            IssuingAuthority = new (this, "x_IssuingAuthority", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[IssuingAuthority]",
                DateTimeFormat = -1,
                VirtualExpression = "[IssuingAuthority]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "IssuingAuthority", "CustomMsg"),
                IsUpload = false
            };
            IssuingAuthority.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("IssuingAuthority", "MTCrewCertificate", true, "IssuingAuthority", new List<string> {"IssuingAuthority", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("IssuingAuthority", "MTCrewCertificate", true, "IssuingAuthority", new List<string> {"IssuingAuthority", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("IssuingAuthority", "MTCrewCertificate", true, "IssuingAuthority", new List<string> {"IssuingAuthority", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Level = new (this, "x_Level", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "Level", "CustomMsg"),
                IsUpload = false
            };
            Level.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Level", "MTCrewCertificate", true, "Level", new List<string> {"Level", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Level", "MTCrewCertificate", true, "Level", new List<string> {"Level", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Level", "MTCrewCertificate", true, "Level", new List<string> {"Level", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PaxVesselType = new (this, "x_PaxVesselType", 202, SqlDbType.NVarChar) {
                Name = "PaxVesselType",
                Expression = "[PaxVesselType]",
                UseBasicSearch = true,
                BasicSearchExpression = "[PaxVesselType]",
                DateTimeFormat = -1,
                VirtualExpression = "[PaxVesselType]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "PaxVesselType", "CustomMsg"),
                IsUpload = false
            };
            PaxVesselType.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PaxVesselType", "MTCrewCertificate", true, "PaxVesselType", new List<string> {"PaxVesselType", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PaxVesselType", "MTCrewCertificate", true, "PaxVesselType", new List<string> {"PaxVesselType", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PaxVesselType", "MTCrewCertificate", true, "PaxVesselType", new List<string> {"PaxVesselType", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Image = new (this, "x_Image", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "Image", "CustomMsg"),
                IsUpload = true
            };
            Image.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Image", "MTCrewCertificate", true, "Image", new List<string> {"Image", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Image", "MTCrewCertificate", true, "Image", new List<string> {"Image", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Image", "MTCrewCertificate", true, "Image", new List<string> {"Image", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Image.GetUploadPath = () => "files/certificate";
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCrewCertificate", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCrewCertificate", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCrewCertificate", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewCertificate", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewCertificate", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewCertificate", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewCertificate", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "MtCrewCertificateView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCrewCertificateEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCrewCertificateAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCrewCertificateView",
                Config.ApiAddAction => "MtCrewCertificateAdd",
                Config.ApiEditAction => "MtCrewCertificateEdit",
                Config.ApiDeleteAction => "MtCrewCertificateDelete",
                Config.ApiListAction => "MtCrewCertificateList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCrewCertificateList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCrewCertificateView", parm);
            else
                url = KeyUrl("MtCrewCertificateView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCrewCertificateAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtCrewCertificateAdd?" + parm;
            else
                url = "MtCrewCertificateAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewCertificateEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewCertificateList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewCertificateAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewCertificateList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCrewCertificateDelete")); // DN
        ...
        {
            string pageName = "MtCrewCertificateList";
