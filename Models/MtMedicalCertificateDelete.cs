...
public partial class PCM {
    /// <summary>
    /// mtMedicalCertificateDelete
    /// </summary>
    public static MtMedicalCertificateDelete mtMedicalCertificateDelete
    {
        get => HttpData.Get<MtMedicalCertificateDelete>("mtMedicalCertificateDelete")!;
        set => HttpData["mtMedicalCertificateDelete"] = value;
    }

    /// <summary>
    /// Page class for MTMedicalCertificate
    /// </summary>
    public class MtMedicalCertificateDelete : MtMedicalCertificateDeleteBase
    {
        // Constructor
        public MtMedicalCertificateDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtMedicalCertificateDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtMedicalCertificateDeleteBase : MtMedicalCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtMedicalCertificateDelete";
        ...
        // Constructor
        public MtMedicalCertificateDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtMedicalCertificateDelete";
        ...
        // Constructor
        public MtMedicalCertificateDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtMedicalCertificateList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtMedicalCertificateList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtMedicalCertificateDelete?.PageRender();
            }
            return PageResult();
        }
