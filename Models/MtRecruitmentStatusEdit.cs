...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusEdit
    /// </summary>
    public static MtRecruitmentStatusEdit mtRecruitmentStatusEdit
    {
        get => HttpData.Get<MtRecruitmentStatusEdit>("mtRecruitmentStatusEdit")!;
        set => HttpData["mtRecruitmentStatusEdit"] = value;
    }

    /// <summary>
    /// Page class for MTRecruitmentStatus
    /// </summary>
    public class MtRecruitmentStatusEdit : MtRecruitmentStatusEditBase
    {
        // Constructor
        public MtRecruitmentStatusEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRecruitmentStatusEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRecruitmentStatusEditBase : MtRecruitmentStatus
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRecruitmentStatusEdit";
        ...
        // Constructor
        public MtRecruitmentStatusEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtRecruitmentStatusEdit";
        ...
        // Constructor
        public MtRecruitmentStatusEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtRecruitmentStatusList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "MtRecruitmentStatusList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtRecruitmentStatusList") {
                                ...
                                returnUrl = "MtRecruitmentStatusList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtRecruitmentStatusEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected async Task LoadFormValues() {
            ...
            if (!Code.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("Code") && !CurrentForm.HasValue("x_Code")) // DN
                    ...
                    Code.SetFormValue(val, true, validate);
            }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                Code.EditValue = Code.CurrentValue; // DN
                Code.PlaceHolder = RemoveHtml(Code.Caption);
                if (!Empty(Code.EditValue) && IsNumeric(Code.EditValue))
                    Code.EditValue = FormatNumber(Code.EditValue, null);
        ...
        protected async Task<bool> ValidateForm() {
            ...
            if (!CheckInteger(Code.FormValue)) {
                Code.AddErrorMessage(Code.GetErrorMessage(false));
            }
