...
public partial class PCM {
    /// <summary>
    /// crewFormalEducationForAdminViewModeAdd
    /// </summary>
    public static CrewFormalEducationForAdminViewModeAdd crewFormalEducationForAdminViewModeAdd
    {
        get => HttpData.Get<CrewFormalEducationForAdminViewModeAdd>("crewFormalEducationForAdminViewModeAdd")!;
        set => HttpData["crewFormalEducationForAdminViewModeAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewFormalEducationForAdminViewMode
    /// </summary>
    public class CrewFormalEducationForAdminViewModeAdd : CrewFormalEducationForAdminViewModeAddBase
    {
        // Constructor
        public CrewFormalEducationForAdminViewModeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFormalEducationForAdminViewModeAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewFormalEducationForAdminViewModeList?crewID=" + ConvertToString(lastAddedFormalEducationCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFormalEducationForAdminViewModeAddBase : CrewFormalEducationForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFormalEducationForAdminViewModeAdd";
        ...
        // Constructor
        public CrewFormalEducationForAdminViewModeAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewFormalEducationForAdminViewModeAdd";
        ...
        // Constructor
        public CrewFormalEducationForAdminViewModeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewFormalEducationForAdminViewModeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "CrewFormalEducationForAdminViewModeView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFormalEducationForAdminViewModeAdd?.PageRender();
            }
            return PageResult();
        }
