...
public partial class PCM {
    /// <summary>
    /// crewMedicalHistoryForAdmin
    /// </summary>
    [MaybeNull]
    public static CrewMedicalHistoryForAdmin crewMedicalHistoryForAdmin
    {
        get => HttpData.Resolve<CrewMedicalHistoryForAdmin>("CrewMedicalHistoryForAdmin");
        set => HttpData["CrewMedicalHistoryForAdmin"] = value;
    }

    /// <summary>
    /// Table class for CrewMedicalHistoryForAdmin
    /// </summary>
    public class CrewMedicalHistoryForAdmin : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public CrewMedicalHistoryForAdmin()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewMedicalHistoryForAdmin";
            Name = "CrewMedicalHistoryForAdmin";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Type = new (this, "x__Type", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "_Type", "CustomMsg"),
                IsUpload = false
            };
            _Type.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Type", "CrewMedicalHistoryForAdmin", true, "Type", new List<string> {"Type", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Type", "CrewMedicalHistoryForAdmin", true, "Type", new List<string> {"Type", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Type", "CrewMedicalHistoryForAdmin", true, "Type", new List<string> {"Type", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            VesselName = new (this, "x_VesselName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "VesselName", "CustomMsg"),
                IsUpload = false
            };
            VesselName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("VesselName", "CrewMedicalHistoryForAdmin", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("VesselName", "CrewMedicalHistoryForAdmin", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("VesselName", "CrewMedicalHistoryForAdmin", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            DateOccurence = new (this, "x_DateOccurence", 133, SqlDbType.Date) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "DateOccurence", "CustomMsg"),
                IsUpload = false
            };
            DateOccurence.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateOccurence", "CrewMedicalHistoryForAdmin", true, "DateOccurence", new List<string> {"DateOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateOccurence", "CrewMedicalHistoryForAdmin", true, "DateOccurence", new List<string> {"DateOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateOccurence", "CrewMedicalHistoryForAdmin", true, "DateOccurence", new List<string> {"DateOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PlaceOccurence = new (this, "x_PlaceOccurence", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "PlaceOccurence", "CustomMsg"),
                IsUpload = false
            };
            PlaceOccurence.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PlaceOccurence", "CrewMedicalHistoryForAdmin", true, "PlaceOccurence", new List<string> {"PlaceOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PlaceOccurence", "CrewMedicalHistoryForAdmin", true, "PlaceOccurence", new List<string> {"PlaceOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PlaceOccurence", "CrewMedicalHistoryForAdmin", true, "PlaceOccurence", new List<string> {"PlaceOccurence", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PeriodOfDisability = new (this, "x_PeriodOfDisability", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "PeriodOfDisability", "CustomMsg"),
                IsUpload = false
            };
            PeriodOfDisability.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PeriodOfDisability", "CrewMedicalHistoryForAdmin", true, "PeriodOfDisability", new List<string> {"PeriodOfDisability", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PeriodOfDisability", "CrewMedicalHistoryForAdmin", true, "PeriodOfDisability", new List<string> {"PeriodOfDisability", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PeriodOfDisability", "CrewMedicalHistoryForAdmin", true, "PeriodOfDisability", new List<string> {"PeriodOfDisability", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            PresentCondition = new (this, "x_PresentCondition", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "PresentCondition", "CustomMsg"),
                IsUpload = false
            };
            PresentCondition.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("PresentCondition", "CrewMedicalHistoryForAdmin", true, "PresentCondition", new List<string> {"PresentCondition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("PresentCondition", "CrewMedicalHistoryForAdmin", true, "PresentCondition", new List<string> {"PresentCondition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("PresentCondition", "CrewMedicalHistoryForAdmin", true, "PresentCondition", new List<string> {"PresentCondition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Treatment = new (this, "x_Treatment", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "Treatment", "CustomMsg"),
                IsUpload = false
            };
            Treatment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Treatment", "CrewMedicalHistoryForAdmin", true, "Treatment", new List<string> {"Treatment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Treatment", "CrewMedicalHistoryForAdmin", true, "Treatment", new List<string> {"Treatment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Treatment", "CrewMedicalHistoryForAdmin", true, "Treatment", new List<string> {"Treatment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Details = new (this, "x_Details", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "Details", "CustomMsg"),
                IsUpload = false
            };
            Details.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Details", "CrewMedicalHistoryForAdmin", true, "Details", new List<string> {"Details", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Details", "CrewMedicalHistoryForAdmin", true, "Details", new List<string> {"Details", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Details", "CrewMedicalHistoryForAdmin", true, "Details", new List<string> {"Details", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewMedicalHistoryForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewMedicalHistoryForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewMedicalHistoryForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewMedicalHistoryForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewMedicalHistoryForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewMedicalHistoryForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMedicalHistoryForAdmin", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewMedicalHistoryForAdminList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewMedicalHistoryForAdminView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewMedicalHistoryForAdminEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewMedicalHistoryForAdminAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewMedicalHistoryForAdminView",
                Config.ApiAddAction => "CrewMedicalHistoryForAdminAdd",
                Config.ApiEditAction => "CrewMedicalHistoryForAdminEdit",
                Config.ApiDeleteAction => "CrewMedicalHistoryForAdminDelete",
                Config.ApiListAction => "CrewMedicalHistoryForAdminList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewMedicalHistoryForAdminList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewMedicalHistoryForAdminView", parm);
            else
                url = KeyUrl("CrewMedicalHistoryForAdminView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewMedicalHistoryForAdminAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewMedicalHistoryForAdminAdd?" + parm;
            else
                url = "CrewMedicalHistoryForAdminAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewMedicalHistoryForAdminEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewMedicalHistoryForAdminList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewMedicalHistoryForAdminAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewMedicalHistoryForAdminList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewMedicalHistoryForAdminDelete")); // DN
        ...
        {
            string pageName = "CrewMedicalHistoryForAdminList";
