...
public partial class PCM {
    ...
    public static partial class Config
    {
        ...
        // Product version
        public const string ProductVersion = "20.1.0";

        // Project
        public const string ProjectNamespace = "PCM";

        public const string ProjectClassName = "PCM.Models.PCM"; // DN
        ...
        public const string ProjectName = "PCM"; // Project name
        ...
        public static int SessionTimeout = 500; // Session timeout time (minutes)

        // Session keep alive interval
        public static int SessionKeepAliveInterval = 600; // Session keep alive interval (seconds)

        public static int SessionTimeoutCountdown = 600; // Session timeout count down interval (seconds)
        ...
        // Export Log
        public static string ExportPath = "export-858e8d60-55d9-41e6-8104-7b793c2843c4"; // Export folder
        ...
        public static string UserLevelTableName = "MTUserLevel"; // User level (table name)
        ...
        public static string UserLevelTable = "dbo.MTUserLevel"; // For SQL
        ...
        public static string UserLevelPrivTableName = "MTUserLevelPermission"; // User level permissions (table name)
        ...
        public static string UserLevelPrivTable = "dbo.MTUserLevelPermission"; // For SQL
        ...
        public static string UserTableName = "MTUser";
        ...
        public static string UserLevelFieldName = "MTUserLevelID";
        ...
        public static string UserTable = "dbo.MTUser";
        ...
        public static string UploadAllowedFileExtensions = "gif,jpg,jpeg,bmp,png,doc,docx,csv,xls,xlsx,pdf,zip,pptx"; // Allowed file extensions

        public static List<string> ImageAllowedFileExtensions = new () { "gif","jpe","jpeg","jpg","png","bmp" }; // Allowed file extensions for images

        public static List<string> DownloadAllowedFileExtensions = new () {"csv","pdf","xls","doc","xlsx","docx","pptx","mp4"}; // Allowed file extensions for download (non-image)
        ...
        public static string ImportFileAllowedExtensions = "csv,xlsx, xls"; // Import file allowed extensions
        ...
        public static bool ExportFieldCaption { get; set; } = true; // True to export field caption
        ...
        {
            {"MTCertificate", typeof(MtCertificate)},
            {"MTCertificateOnRank", typeof(MtCertificateOnRank)},
            {"MTClothesSize", typeof(MtClothesSize)},
            {"MTCountry", typeof(MtCountry)},
            {"MTCrew", typeof(MtCrew)},
            {"MTCrewCertificate", typeof(MtCrewCertificate)},
            {"MTCrewDocument", typeof(MtCrewDocument)},
            {"MTCrewExperience", typeof(MtCrewExperience)},
            {"MTCrewFamily", typeof(MtCrewFamily)},
            {"MTCrewMedicalHistory", typeof(MtCrewMedicalHistory)},
            {"MTDocument", typeof(MtDocument)},
            {"MTRank", typeof(MtRank)},
            {"MTReligion", typeof(MtReligion)},
            {"MTVesselType", typeof(MtVesselType)},
            {"TRChecklist", typeof(TrChecklist)},
            {"TRChecklistPerformance", typeof(TrChecklistPerformance)},
            {"MTUser", typeof(MtUser)},
            {"MTUserLevel", typeof(MtUserLevel)},
            {"MTUserLevelPermission", typeof(MtUserLevelPermission)},
            {"CrewPersonalDataForAdmin", typeof(CrewPersonalDataForAdmin)},
            {"CrewDocumentForAdmin", typeof(CrewDocumentForAdmin)},
            {"CrewFamilyForAdmin", typeof(CrewFamilyForAdmin)},
            {"CrewCertificateForAdmin", typeof(CrewCertificateForAdmin)},
            {"CrewExperienceForAdmin", typeof(CrewExperienceForAdmin)},
            {"CrewMedicalHistoryForAdmin", typeof(CrewMedicalHistoryForAdmin)},
            {"CrewGeneralDataForAdmin", typeof(CrewGeneralDataForAdmin)},
            {"TREmployeeStatus", typeof(TrEmployeeStatus)},
            {"v_WaitingForPDEReview", typeof(VWaitingForPdeReview)},
            {"CrewPersonalDataForAdminViewMode", typeof(CrewPersonalDataForAdminViewMode)},
            {"CrewDocumentForAdminViewMode", typeof(CrewDocumentForAdminViewMode)},
            {"CrewFamilyForAdminViewMode", typeof(CrewFamilyForAdminViewMode)},
            {"CrewCertificateForAdminViewMode", typeof(CrewCertificateForAdminViewMode)},
            {"CrewExperienceForAdminViewMode", typeof(CrewExperienceForAdminViewMode)},
            {"CrewMedicalHistoryForAdminViewMode", typeof(CrewMedicalHistoryForAdminViewMode)},
            {"CrewGeneralDataForAdminViewMode", typeof(CrewGeneralDataForAdminViewMode)},
            {"TREmailHistory", typeof(TrEmailHistory)},
            {"MTCrewBankAccount", typeof(MtCrewBankAccount)},
            {"MTCrewFormalEducation", typeof(MtCrewFormalEducation)},
            {"MTCrewMedicalCertificate", typeof(MtCrewMedicalCertificate)},
            {"MTMedicalCertificate", typeof(MtMedicalCertificate)},
            {"MTCrewAppraisal", typeof(MtCrewAppraisal)},
            {"CrewBankAccountForAdmin", typeof(CrewBankAccountForAdmin)},
            {"CrewBankAccountForAdminViewMode", typeof(CrewBankAccountForAdminViewMode)},
            {"CrewFormalEducationForAdmin", typeof(CrewFormalEducationForAdmin)},
            {"CrewFormalEducationForAdminViewMode", typeof(CrewFormalEducationForAdminViewMode)},
            {"CrewMedicalCertificateForAdmin", typeof(CrewMedicalCertificateForAdmin)},
            {"CrewMedicalCertificateForAdminViewMode", typeof(CrewMedicalCertificateForAdminViewMode)},
            {"CrewAppraisalForAdmin", typeof(CrewAppraisalForAdmin)},
            {"CrewAppraisalForAdminViewMode", typeof(CrewAppraisalForAdminViewMode)},
            {"CrewChecklistForAdmin", typeof(CrewChecklistForAdmin)},
            {"TRMCUResult", typeof(TrmcuResult)},
            {"Registration", typeof(Registration)},
            {"Checklist", typeof(Checklist)},
            {"MTCurrency", typeof(MtCurrency)},
            {"CrewMcuResultForAdmin", typeof(CrewMcuResultForAdmin)},
            {"McuResult", typeof(McuResult)},
            {"TRNotification", typeof(TrNotification)},
            {"v_CrewAcceptedForAdmin", typeof(VCrewAcceptedForAdmin)},
            {"v_CrewBlacklistForAdmin", typeof(VCrewBlacklistForAdmin)},
            {"v_CrewRejectedForAdmin", typeof(VCrewRejectedForAdmin)},
            {"v_CrewTemporaryRejectedForAdmin", typeof(VCrewTemporaryRejectedForAdmin)},
            {"CrewNotificationForAdmin", typeof(CrewNotificationForAdmin)},
            {"NotificationForAdmin", typeof(NotificationForAdmin)},
            {"NotificationForCrew", typeof(NotificationForCrew)},
            {"MTRecruitmentStatus", typeof(MtRecruitmentStatus)},
        ...
        {
            {"MTCertificate", "DB"},
            {"MTCertificateOnRank", "DB"},
            {"MTClothesSize", "DB"},
            {"MTCountry", "DB"},
            {"MTCrew", "DB"},
            {"MTCrewCertificate", "DB"},
            {"MTCrewDocument", "DB"},
            {"MTCrewExperience", "DB"},
            {"MTCrewFamily", "DB"},
            {"MTCrewMedicalHistory", "DB"},
            {"MTDocument", "DB"},
            {"MTRank", "DB"},
            {"MTReligion", "DB"},
            {"MTVesselType", "DB"},
            {"TRChecklist", "DB"},
            {"TRChecklistPerformance", "DB"},
            {"MTUser", "DB"},
            {"MTUserLevel", "DB"},
            {"MTUserLevelPermission", "DB"},
            {"CrewPersonalDataForAdmin", "DB"},
            {"CrewDocumentForAdmin", "DB"},
            {"CrewFamilyForAdmin", "DB"},
            {"CrewCertificateForAdmin", "DB"},
            {"CrewExperienceForAdmin", "DB"},
            {"CrewMedicalHistoryForAdmin", "DB"},
            {"CrewGeneralDataForAdmin", "DB"},
            {"TREmployeeStatus", "DB"},
            {"v_WaitingForPDEReview", "DB"},
            {"CrewPersonalDataForAdminViewMode", "DB"},
            {"CrewDocumentForAdminViewMode", "DB"},
            {"CrewFamilyForAdminViewMode", "DB"},
            {"CrewCertificateForAdminViewMode", "DB"},
            {"CrewExperienceForAdminViewMode", "DB"},
            {"CrewMedicalHistoryForAdminViewMode", "DB"},
            {"CrewGeneralDataForAdminViewMode", "DB"},
            {"TREmailHistory", "DB"},
            {"MTCrewBankAccount", "DB"},
            {"MTCrewFormalEducation", "DB"},
            {"MTCrewMedicalCertificate", "DB"},
            {"MTMedicalCertificate", "DB"},
            {"MTCrewAppraisal", "DB"},
            {"CrewBankAccountForAdmin", "DB"},
            {"CrewBankAccountForAdminViewMode", "DB"},
            {"CrewFormalEducationForAdmin", "DB"},
            {"CrewFormalEducationForAdminViewMode", "DB"},
            {"CrewMedicalCertificateForAdmin", "DB"},
            {"CrewMedicalCertificateForAdminViewMode", "DB"},
            {"CrewAppraisalForAdmin", "DB"},
            {"CrewAppraisalForAdminViewMode", "DB"},
            {"CrewChecklistForAdmin", "DB"},
            {"TRMCUResult", "DB"},
            {"Registration", "DB"},
            {"Checklist", "DB"},
            {"MTCurrency", "DB"},
            {"CrewMcuResultForAdmin", "DB"},
            {"McuResult", "DB"},
            {"TRNotification", "DB"},
            {"v_CrewAcceptedForAdmin", "DB"},
            {"v_CrewBlacklistForAdmin", "DB"},
            {"v_CrewRejectedForAdmin", "DB"},
            {"v_CrewTemporaryRejectedForAdmin", "DB"},
            {"CrewNotificationForAdmin", "DB"},
            {"NotificationForAdmin", "DB"},
            {"NotificationForCrew", "DB"},
            {"MTRecruitmentStatus", "DB"},
        ...
        public static List<object[]> MenuItems = new ()
        {
            ...
            new object[] { 283, "mci_Reports", "283", "", -1, "", false, false, true, "fa-file-lines", "", false, true },
            new object[] { 206, "mi_v_CrewAcceptedForAdmin", "206", "VCrewAcceptedForAdminList", 283, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}v_CrewAcceptedForAdmin", false, false, "", "", false, true },
            ...
            new object[] { 54, "mi_MTRank", "54", "MtRankList", 20, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTRank", false, false, "", "", false, true },
            new object[] { 46, "mi_MTCertificateOnRank", "46", "MtCertificateOnRankList", 20, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCertificateOnRank", false, false, "", "", false, true },
            new object[] { 176, "mi_MTMedicalCertificate", "176", "MtMedicalCertificateList", 20, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTMedicalCertificate", false, false, "", "", false, true },
            new object[] { 53, "mi_MTDocument", "53", "MtDocumentList", 20, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTDocument", false, false, "", "", false, true },
            new object[] { 56, "mi_MTVesselType", "56", "MtVesselTypeList", 20, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTVesselType", false, false, "", "", false, true },
            new object[] { 47, "mi_MTClothesSize", "47", "MtClothesSizeList", 20, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTClothesSize", false, false, "", "", false, true },
            new object[] { 62, "mi_MTCountry", "62", "MtCountryList", 20, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCountry", false, false, "", "", false, true },
            ...
            new object[] { 63, "mi_MTCrewCertificate", "63", "MtCrewCertificateList?cmd=resetall", 39, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCrewCertificate", false, false, "", "", false, true },
            new object[] { 50, "mi_MTCrewExperience", "50", "MtCrewExperienceList?cmd=resetall", 39, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCrewExperience", false, false, "", "", false, true },
            new object[] { 52, "mi_MTCrewMedicalHistory", "52", "MtCrewMedicalHistoryList?cmd=resetall", 39, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCrewMedicalHistory", false, false, "", "", false, true },
            new object[] { 173, "mi_MTCrewBankAccount", "173", "MtCrewBankAccountList", 39, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCrewBankAccount", false, false, "", "", false, true },
            new object[] { 174, "mi_MTCrewFormalEducation", "174", "MtCrewFormalEducationList", 39, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCrewFormalEducation", false, false, "", "", false, true },
            new object[] { 175, "mi_MTCrewMedicalCertificate", "175", "MtCrewMedicalCertificateList", 39, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCrewMedicalCertificate", false, false, "", "", false, true },
            new object[] { 177, "mi_MTCrewAppraisal", "177", "MtCrewAppraisalList", 39, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTCrewAppraisal", false, false, "", "", false, true },
            new object[] { 23, "mci_User_Management", "23", "", -1, "", false, false, true, "fa-users", "", false, true },
            new object[] { 59, "mi_MTUser", "59", "MtUserList", 23, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTUser", false, false, "", "", false, true },
            new object[] { 60, "mi_MTUserLevel", "60", "MtUserLevelList", 23, "", "{858E8D60-55D9-41E6-8104-7B793C2843C4}MTUserLevel", false, false, "", "", false, true }
        };
        ...
        public static bool UseLookupCache = false;
        ...
        public static bool DatetimeWithoutSeconds = true;
        ...
        // Filter
        public static bool ShowCurrentFilter { get; set; } = true; // True to show current filter
        ...
        // Embed PDF documents
        public static bool EmbedPdf = false;
