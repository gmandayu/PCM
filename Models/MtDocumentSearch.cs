...
public partial class PCM {
    ...
    /// mtDocumentSearch
    /// </summary>
    public static MtDocumentSearch mtDocumentSearch
    {
        get => HttpData.Get<MtDocumentSearch>("mtDocumentSearch")!;
        set => HttpData["mtDocumentSearch"] = value;
    }

    /// <summary>
    /// Page class for MTDocument
    /// </summary>
    public class MtDocumentSearch : MtDocumentSearchBase
    {
        // Constructor
        public MtDocumentSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtDocumentSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtDocumentSearchBase : MtDocument
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtDocumentSearch";
        ...
        // Page name
        public string PageName => "MtDocumentSearch";
        ...
        // Constructor
        public MtDocumentSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtDocumentList?" + srchStr;
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!_Type.Raw)
                    _Type.AdvancedSearch.SearchValue = HtmlDecode(_Type.AdvancedSearch.SearchValue);
                _Type.EditValue = HtmlEncode(_Type.AdvancedSearch.SearchValue);
