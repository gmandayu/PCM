...
public partial class PCM {
    /// <summary>
    /// crewExperienceForAdminViewMode
    /// </summary>
    [MaybeNull]
    public static CrewExperienceForAdminViewMode crewExperienceForAdminViewMode
    {
        get => HttpData.Resolve<CrewExperienceForAdminViewMode>("CrewExperienceForAdminViewMode");
        set => HttpData["CrewExperienceForAdminViewMode"] = value;
    }

    /// <summary>
    /// Table class for CrewExperienceForAdminViewMode
    /// </summary>
    public class CrewExperienceForAdminViewMode : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public CrewExperienceForAdminViewMode()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewExperienceForAdminViewMode";
            Name = "CrewExperienceForAdminViewMode";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CompanyName = new (this, "x_CompanyName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "CompanyName", "CustomMsg"),
                IsUpload = false
            };
            CompanyName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CompanyName", "CrewExperienceForAdminViewMode", true, "CompanyName", new List<string> {"CompanyName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CompanyName", "CrewExperienceForAdminViewMode", true, "CompanyName", new List<string> {"CompanyName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CompanyName", "CrewExperienceForAdminViewMode", true, "CompanyName", new List<string> {"CompanyName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            FlagName_CountryID = new (this, "x_FlagName_CountryID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "FlagName_CountryID", "CustomMsg"),
                IsUpload = false
            };
            ...
            VesselName = new (this, "x_VesselName", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "VesselName", "CustomMsg"),
                IsUpload = false
            };
            VesselName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("VesselName", "CrewExperienceForAdminViewMode", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("VesselName", "CrewExperienceForAdminViewMode", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("VesselName", "CrewExperienceForAdminViewMode", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTVesselTypeID = new (this, "x_MTVesselTypeID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "MTVesselTypeID", "CustomMsg"),
                IsUpload = false
            };
            ...
            GRT = new (this, "x_GRT", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "GRT", "CustomMsg"),
                IsUpload = false
            };
            GRT.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("GRT", "CrewExperienceForAdminViewMode", true, "GRT", new List<string> {"GRT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("GRT", "CrewExperienceForAdminViewMode", true, "GRT", new List<string> {"GRT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("GRT", "CrewExperienceForAdminViewMode", true, "GRT", new List<string> {"GRT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("GRT", GRT);
            ...
            DWT = new (this, "x_DWT", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "DWT", "CustomMsg"),
                IsUpload = false
            };
            DWT.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DWT", "CrewExperienceForAdminViewMode", true, "DWT", new List<string> {"DWT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DWT", "CrewExperienceForAdminViewMode", true, "DWT", new List<string> {"DWT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DWT", "CrewExperienceForAdminViewMode", true, "DWT", new List<string> {"DWT", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("DWT", DWT);
            ...
            MainEngine = new (this, "x_MainEngine", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "MainEngine", "CustomMsg"),
                IsUpload = false
            };
            MainEngine.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MainEngine", "CrewExperienceForAdminViewMode", true, "MainEngine", new List<string> {"MainEngine", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MainEngine", "CrewExperienceForAdminViewMode", true, "MainEngine", new List<string> {"MainEngine", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MainEngine", "CrewExperienceForAdminViewMode", true, "MainEngine", new List<string> {"MainEngine", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            BHP = new (this, "x_BHP", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "BHP", "CustomMsg"),
                IsUpload = false
            };
            BHP.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("BHP", "CrewExperienceForAdminViewMode", true, "BHP", new List<string> {"BHP", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("BHP", "CrewExperienceForAdminViewMode", true, "BHP", new List<string> {"BHP", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("BHP", "CrewExperienceForAdminViewMode", true, "BHP", new List<string> {"BHP", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("BHP", BHP);
            ...
            MTRankID = new (this, "x_MTRankID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "MTRankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            DateFrom = new (this, "x_DateFrom", 133, SqlDbType.Date) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "DateFrom", "CustomMsg"),
                IsUpload = false
            };
            DateFrom.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateFrom", "CrewExperienceForAdminViewMode", true, "DateFrom", new List<string> {"DateFrom", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateFrom", "CrewExperienceForAdminViewMode", true, "DateFrom", new List<string> {"DateFrom", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateFrom", "CrewExperienceForAdminViewMode", true, "DateFrom", new List<string> {"DateFrom", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            DateUntil = new (this, "x_DateUntil", 133, SqlDbType.Date) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "DateUntil", "CustomMsg"),
                IsUpload = false
            };
            DateUntil.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateUntil", "CrewExperienceForAdminViewMode", true, "DateUntil", new List<string> {"DateUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateUntil", "CrewExperienceForAdminViewMode", true, "DateUntil", new List<string> {"DateUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateUntil", "CrewExperienceForAdminViewMode", true, "DateUntil", new List<string> {"DateUntil", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewExperienceForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewExperienceForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewExperienceForAdminViewMode", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewExperienceForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewExperienceForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewExperienceForAdminViewMode", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            SignOnPortName = new (this, "x_SignOnPortName", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "SignOnPortName", "CustomMsg"),
                IsUpload = false
            };
            SignOnPortName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SignOnPortName", "CrewExperienceForAdminViewMode", true, "SignOnPortName", new List<string> {"SignOnPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SignOnPortName", "CrewExperienceForAdminViewMode", true, "SignOnPortName", new List<string> {"SignOnPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SignOnPortName", "CrewExperienceForAdminViewMode", true, "SignOnPortName", new List<string> {"SignOnPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            SignOffPortName = new (this, "x_SignOffPortName", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "SignOffPortName", "CustomMsg"),
                IsUpload = false
            };
            SignOffPortName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SignOffPortName", "CrewExperienceForAdminViewMode", true, "SignOffPortName", new List<string> {"SignOffPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SignOffPortName", "CrewExperienceForAdminViewMode", true, "SignOffPortName", new List<string> {"SignOffPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SignOffPortName", "CrewExperienceForAdminViewMode", true, "SignOffPortName", new List<string> {"SignOffPortName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            SignOffReason = new (this, "x_SignOffReason", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewExperienceForAdminViewMode", "SignOffReason", "CustomMsg"),
                IsUpload = false
            };
            SignOffReason.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SignOffReason", "CrewExperienceForAdminViewMode", true, "SignOffReason", new List<string> {"SignOffReason", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SignOffReason", "CrewExperienceForAdminViewMode", true, "SignOffReason", new List<string> {"SignOffReason", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SignOffReason", "CrewExperienceForAdminViewMode", true, "SignOffReason", new List<string> {"SignOffReason", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewExperienceForAdminViewModeList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewExperienceForAdminViewModeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewExperienceForAdminViewModeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewExperienceForAdminViewModeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewExperienceForAdminViewModeView",
                Config.ApiAddAction => "CrewExperienceForAdminViewModeAdd",
                Config.ApiEditAction => "CrewExperienceForAdminViewModeEdit",
                Config.ApiDeleteAction => "CrewExperienceForAdminViewModeDelete",
                Config.ApiListAction => "CrewExperienceForAdminViewModeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewExperienceForAdminViewModeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewExperienceForAdminViewModeView", parm);
            else
                url = KeyUrl("CrewExperienceForAdminViewModeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewExperienceForAdminViewModeAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewExperienceForAdminViewModeAdd?" + parm;
            else
                url = "CrewExperienceForAdminViewModeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewExperienceForAdminViewModeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewExperienceForAdminViewModeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewExperienceForAdminViewModeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewExperienceForAdminViewModeList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewExperienceForAdminViewModeDelete")); // DN
        ...
        {
            string pageName = "CrewExperienceForAdminViewModeList";
        ...
        public void RowDeleted(Dictionary<string, object> rs) {
            //Log("Row Deleted");
            Session.SetInt("lastDeletedExperienceCrewID", ConvertToInt(rs["MTCrewID"]));
        }
