...
public partial class PCM {
    /// <summary>
    /// crewAppraisalForAdmin
    /// </summary>
    [MaybeNull]
    public static CrewAppraisalForAdmin crewAppraisalForAdmin
    {
        get => HttpData.Resolve<CrewAppraisalForAdmin>("CrewAppraisalForAdmin");
        set => HttpData["CrewAppraisalForAdmin"] = value;
    }

    /// <summary>
    /// Table class for CrewAppraisalForAdmin
    /// </summary>
    public class CrewAppraisalForAdmin : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public CrewAppraisalForAdmin()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewAppraisalForAdmin";
            Name = "CrewAppraisalForAdmin";
            Type = "CUSTOMVIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            VesselName = new (this, "x_VesselName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "VesselName", "CustomMsg"),
                IsUpload = false
            };
            VesselName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("VesselName", "CrewAppraisalForAdmin", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("VesselName", "CrewAppraisalForAdmin", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("VesselName", "CrewAppraisalForAdmin", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTRankID = new (this, "x_MTRankID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "MTRankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Questionnaire = new (this, "x_Questionnaire", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "Questionnaire", "CustomMsg"),
                IsUpload = false
            };
            Questionnaire.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Questionnaire", "CrewAppraisalForAdmin", true, "Questionnaire", new List<string> {"Questionnaire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Questionnaire", "CrewAppraisalForAdmin", true, "Questionnaire", new List<string> {"Questionnaire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Questionnaire", "CrewAppraisalForAdmin", true, "Questionnaire", new List<string> {"Questionnaire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Approved = new (this, "x_Approved", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "Approved", "CustomMsg"),
                IsUpload = false
            };
            Approved.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Approved", "CrewAppraisalForAdmin", true, "Approved", new List<string> {"Approved", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Approved", "CrewAppraisalForAdmin", true, "Approved", new List<string> {"Approved", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Approved", "CrewAppraisalForAdmin", true, "Approved", new List<string> {"Approved", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            AverageRating = new (this, "x_AverageRating", 131, SqlDbType.Decimal) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "AverageRating", "CustomMsg"),
                IsUpload = false
            };
            AverageRating.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("AverageRating", "CrewAppraisalForAdmin", true, "AverageRating", new List<string> {"AverageRating", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("AverageRating", "CrewAppraisalForAdmin", true, "AverageRating", new List<string> {"AverageRating", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("AverageRating", "CrewAppraisalForAdmin", true, "AverageRating", new List<string> {"AverageRating", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Rehire = new (this, "x_Rehire", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "Rehire", "CustomMsg"),
                IsUpload = false
            };
            Rehire.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Rehire", "CrewAppraisalForAdmin", true, "Rehire", new List<string> {"Rehire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Rehire", "CrewAppraisalForAdmin", true, "Rehire", new List<string> {"Rehire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Rehire", "CrewAppraisalForAdmin", true, "Rehire", new List<string> {"Rehire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Promote = new (this, "x_Promote", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "Promote", "CustomMsg"),
                IsUpload = false
            };
            Promote.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Promote", "CrewAppraisalForAdmin", true, "Promote", new List<string> {"Promote", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Promote", "CrewAppraisalForAdmin", true, "Promote", new List<string> {"Promote", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Promote", "CrewAppraisalForAdmin", true, "Promote", new List<string> {"Promote", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Appraiser = new (this, "x_Appraiser", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "Appraiser", "CustomMsg"),
                IsUpload = false
            };
            Appraiser.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Appraiser", "CrewAppraisalForAdmin", true, "Appraiser", new List<string> {"Appraiser", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Appraiser", "CrewAppraisalForAdmin", true, "Appraiser", new List<string> {"Appraiser", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Appraiser", "CrewAppraisalForAdmin", true, "Appraiser", new List<string> {"Appraiser", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            DateInput = new (this, "x_DateInput", 133, SqlDbType.Date) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "DateInput", "CustomMsg"),
                IsUpload = false
            };
            DateInput.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateInput", "CrewAppraisalForAdmin", true, "DateInput", new List<string> {"DateInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateInput", "CrewAppraisalForAdmin", true, "DateInput", new List<string> {"DateInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateInput", "CrewAppraisalForAdmin", true, "DateInput", new List<string> {"DateInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewAppraisalForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewAppraisalForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewAppraisalForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewAppraisalForAdmin", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewAppraisalForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewAppraisalForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewAppraisalForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewAppraisalForAdminList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewAppraisalForAdminView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewAppraisalForAdminEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewAppraisalForAdminAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewAppraisalForAdminView",
                Config.ApiAddAction => "CrewAppraisalForAdminAdd",
                Config.ApiEditAction => "CrewAppraisalForAdminEdit",
                Config.ApiDeleteAction => "CrewAppraisalForAdminDelete",
                Config.ApiListAction => "CrewAppraisalForAdminList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewAppraisalForAdminList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewAppraisalForAdminView", parm);
            else
                url = KeyUrl("CrewAppraisalForAdminView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewAppraisalForAdminAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewAppraisalForAdminAdd?" + parm;
            else
                url = "CrewAppraisalForAdminAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewAppraisalForAdminEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewAppraisalForAdminList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewAppraisalForAdminAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewAppraisalForAdminList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewAppraisalForAdminDelete")); // DN
        ...
        {
            string pageName = "CrewAppraisalForAdminList";
