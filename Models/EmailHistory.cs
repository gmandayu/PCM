...
public partial class PCM {
    ...
    {
        get => HttpData.Resolve<EmailHistory>("EmailHistory");
        set => HttpData["EmailHistory"] = value;
    }

    /// <summary>
    /// Table class for EmailHistory
    /// </summary>
    public class EmailHistory : DbTable, IQueryFactory
    {
        ...
        public EmailHistory()
        {
            ...
            Name = "EmailHistory";
            Type = "VIEW";
            UpdateTable = "dbo.EmailHistory"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new (this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("EmailHistory", "Id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Id", Id);
            ...
            CrewSeafarerIDWithName = new (this, "x_CrewSeafarerIDWithName", 202, SqlDbType.NVarChar) {
                ...
                Expression = "[CrewSeafarerIDWithName]",
                UseBasicSearch = true,
                BasicSearchExpression = "[CrewSeafarerIDWithName]",
                DateTimeFormat = -1,
                VirtualExpression = "[CrewSeafarerIDWithName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("EmailHistory", "CrewSeafarerIDWithName", "CustomMsg"),
                IsUpload = false
            };
            CrewSeafarerIDWithName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CrewSeafarerIDWithName", "EmailHistory", true, "CrewSeafarerIDWithName", new List<string> {"CrewSeafarerIDWithName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CrewSeafarerIDWithName", "EmailHistory", true, "CrewSeafarerIDWithName", new List<string> {"CrewSeafarerIDWithName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CrewSeafarerIDWithName", "EmailHistory", true, "CrewSeafarerIDWithName", new List<string> {"CrewSeafarerIDWithName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            To = new (this, "x_To", 202, SqlDbType.NVarChar) {
                ...
                Expression = "[To]",
                UseBasicSearch = true,
                BasicSearchExpression = "[To]",
                DateTimeFormat = -1,
                VirtualExpression = "[To]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("EmailHistory", "To", "CustomMsg"),
                IsUpload = false
            };
            To.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("To", "EmailHistory", true, "To", new List<string> {"To", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("To", "EmailHistory", true, "To", new List<string> {"To", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("To", "EmailHistory", true, "To", new List<string> {"To", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("To", To);
            ...
            Subject = new (this, "x_Subject", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("EmailHistory", "Subject", "CustomMsg"),
                IsUpload = false
            };
            Subject.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Subject", "EmailHistory", true, "Subject", new List<string> {"Subject", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Subject", "EmailHistory", true, "Subject", new List<string> {"Subject", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Subject", "EmailHistory", true, "Subject", new List<string> {"Subject", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            _Message = new (this, "x__Message", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("EmailHistory", "_Message", "CustomMsg"),
                IsUpload = false
            };
            ...
            IsSent = new (this, "x_IsSent", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("EmailHistory", "IsSent", "CustomMsg"),
                IsUpload = false
            };
            IsSent.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("IsSent", "EmailHistory", true, "IsSent", new List<string> {"IsSent", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("IsSent", "EmailHistory", true, "IsSent", new List<string> {"IsSent", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("IsSent", "EmailHistory", true, "IsSent", new List<string> {"IsSent", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            SentDateTime = new (this, "x_SentDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[SentDateTime]", 1, "DB"),
                DateTimeFormat = 1,
                ...
                CustomMessage = Language.FieldPhrase("EmailHistory", "SentDateTime", "CustomMsg"),
                IsUpload = false
            };
            SentDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SentDateTime", "EmailHistory", true, "SentDateTime", new List<string> {"SentDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SentDateTime", "EmailHistory", true, "SentDateTime", new List<string> {"SentDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SentDateTime", "EmailHistory", true, "SentDateTime", new List<string> {"SentDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            if (SameString(pageName, "EmailHistoryView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "EmailHistoryEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "EmailHistoryAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "EmailHistoryView",
                Config.ApiAddAction => "EmailHistoryAdd",
                Config.ApiEditAction => "EmailHistoryEdit",
                Config.ApiDeleteAction => "EmailHistoryDelete",
                Config.ApiListAction => "EmailHistoryList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "EmailHistoryList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("EmailHistoryView", parm);
            else
                url = KeyUrl("EmailHistoryView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "EmailHistoryAdd";
        ...
        {
            string url = "";
            url = KeyUrl("EmailHistoryEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("EmailHistoryList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("EmailHistoryAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("EmailHistoryList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("EmailHistoryDelete")); // DN
        ...
        {
            string pageName = "EmailHistoryList";
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!To.Raw)
                To.CurrentValue = HtmlDecode(To.CurrentValue);
