...
public partial class PCM {
    /// <summary>
    /// mtCrewMedicalHistoryList
    /// </summary>
    public static MtCrewMedicalHistoryList mtCrewMedicalHistoryList
    {
        get => HttpData.Get<MtCrewMedicalHistoryList>("mtCrewMedicalHistoryList")!;
        set => HttpData["mtCrewMedicalHistoryList"] = value;
    }

    /// <summary>
    /// Page class for MTCrewMedicalHistory
    /// </summary>
    public class MtCrewMedicalHistoryList : MtCrewMedicalHistoryListBase
    {
        // Constructor
        public MtCrewMedicalHistoryList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCrewMedicalHistoryList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewMedicalHistoryListBase : MtCrewMedicalHistory
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "MTCrewMedicalHistory";

        // Page object name
        public string PageObjName = "mtCrewMedicalHistoryList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMTCrewMedicalHistorylist";
        ...
        // Constructor
        public MtCrewMedicalHistoryListBase()
        {
            // CSS class name as context
            TableVar = "MTCrewMedicalHistory";
            ...
            // Table object (mtCrewMedicalHistory)
            if (mtCrewMedicalHistory == null || mtCrewMedicalHistory is MtCrewMedicalHistory)
                mtCrewMedicalHistory = this;

            // Initialize URLs
            AddUrl = "MtCrewMedicalHistoryAdd";
            ...
            MultiDeleteUrl = "MtCrewMedicalHistoryDelete";
            MultiUpdateUrl = "MtCrewMedicalHistoryUpdate";
        ...
        // Page name
        public string PageName => "MtCrewMedicalHistoryList";
        ...
        // Constructor
        public MtCrewMedicalHistoryListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "MtCrewMedicalHistoryView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fMTCrewMedicalHistorygrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCrewMedicalHistoryList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTCrewMedicalHistorylist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTCrewMedicalHistorylist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fMTCrewMedicalHistorysrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fMTCrewMedicalHistorysrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fMTCrewMedicalHistorylist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_MTCrewMedicalHistory");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtCrewMedicalHistoryList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtCrewMedicalHistoryList.RowCount) + "_MTCrewMedicalHistory");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtCrewMedicalHistoryList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtCrewMedicalHistoryList.RowType == RowType.Add || IsEdit && mtCrewMedicalHistoryList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fMTCrewMedicalHistorysrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"MTCrewMedicalHistory\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("MtCrewMedicalHistorySearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("MtCrewMedicalHistorySearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
