...
public partial class PCM {
    ...
    /// mtCurrencyEdit
    /// </summary>
    public static MtCurrencyEdit mtCurrencyEdit
    {
        get => HttpData.Get<MtCurrencyEdit>("mtCurrencyEdit")!;
        set => HttpData["mtCurrencyEdit"] = value;
    }

    /// <summary>
    /// Page class for MTCurrency
    /// </summary>
    public class MtCurrencyEdit : MtCurrencyEditBase
    {
        // Constructor
        public MtCurrencyEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCurrencyEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCurrencyEditBase : MtCurrency
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCurrencyEdit";
        ...
        // Page name
        public string PageName => "MtCurrencyEdit";
        ...
        // Constructor
        public MtCurrencyEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtCurrencyList"); // No matching record, return to list
                        }
                    break;
