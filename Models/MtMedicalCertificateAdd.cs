...
public partial class PCM {
    /// <summary>
    /// mtMedicalCertificateAdd
    /// </summary>
    public static MtMedicalCertificateAdd mtMedicalCertificateAdd
    {
        get => HttpData.Get<MtMedicalCertificateAdd>("mtMedicalCertificateAdd")!;
        set => HttpData["mtMedicalCertificateAdd"] = value;
    }

    /// <summary>
    /// Page class for MTMedicalCertificate
    /// </summary>
    public class MtMedicalCertificateAdd : MtMedicalCertificateAddBase
    {
        // Constructor
        public MtMedicalCertificateAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtMedicalCertificateAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtMedicalCertificateAddBase : MtMedicalCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtMedicalCertificateAdd";
        ...
        // Constructor
        public MtMedicalCertificateAddBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtMedicalCertificateAdd";
        ...
        // Constructor
        public MtMedicalCertificateAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtMedicalCertificateList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtMedicalCertificateList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtMedicalCertificateView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtMedicalCertificateList") {
                                ...
                                returnUrl = "MtMedicalCertificateList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtMedicalCertificateAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'Enabled' before field var 'x_Enabled'
            val = CurrentForm.HasValue("Enabled") ? CurrentForm.GetValue("Enabled") : CurrentForm.GetValue("x_Enabled");
            if (!Enabled.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("Enabled") && !CurrentForm.HasValue("x_Enabled")) // DN
                    Enabled.Visible = false; // Disable update for API request
                else
                    Enabled.SetFormValue(val);
            }
        ...
        public void RestoreFormValues()
        {
            ...
            Enabled.CurrentValue = Enabled.FormValue;
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            if (Enabled.Required) {
                if (Empty(Enabled.FormValue)) {
                    Enabled.AddErrorMessage(ConvertToString(Enabled.RequiredErrorMessage).Replace("%s", Enabled.Caption));
                }
            }
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // Enabled
                Enabled.SetDbValue(rsnew, ConvertToBool(Enabled.CurrentValue));
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtMedicalCertificateList")), "", TableVar, true);
