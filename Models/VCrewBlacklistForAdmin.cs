...
public partial class PCM {
    /// <summary>
    /// vCrewBlacklistForAdmin
    /// </summary>
    [MaybeNull]
    public static VCrewBlacklistForAdmin vCrewBlacklistForAdmin
    {
        get => HttpData.Resolve<VCrewBlacklistForAdmin>("v_CrewBlacklistForAdmin");
        set => HttpData["v_CrewBlacklistForAdmin"] = value;
    }

    /// <summary>
    /// Table class for v_CrewBlacklistForAdmin
    /// </summary>
    public class VCrewBlacklistForAdmin : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public VCrewBlacklistForAdmin()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "v_CrewBlacklistForAdmin";
            Name = "v_CrewBlacklistForAdmin";
            Type = "VIEW";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            IndividualCodeNumber = new (this, "x_IndividualCodeNumber", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "IndividualCodeNumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            FullName = new (this, "x_FullName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "FullName", "CustomMsg"),
                IsUpload = false
            };
            ...
            RequiredPhoto = new (this, "x_RequiredPhoto", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "RequiredPhoto", "CustomMsg"),
                IsUpload = false
            };
            ...
            VisaPhoto = new (this, "x_VisaPhoto", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "VisaPhoto", "CustomMsg"),
                IsUpload = false
            };
            ...
            CityOfBirth = new (this, "x_CityOfBirth", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "CityOfBirth", "CustomMsg"),
                IsUpload = false
            };
            ...
            DateOfBirth = new (this, "x_DateOfBirth", 133, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "DateOfBirth", "CustomMsg"),
                IsUpload = false
            };
            ...
            Gender = new (this, "x_Gender", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "Gender", "CustomMsg"),
                IsUpload = false
            };
            ...
            RankAppliedFor_RankID = new (this, "x_RankAppliedFor_RankID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "RankAppliedFor_RankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            WillAcceptLowRank = new (this, "x_WillAcceptLowRank", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "WillAcceptLowRank", "CustomMsg"),
                IsUpload = false
            };
            WillAcceptLowRank.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("WillAcceptLowRank", "v_CrewBlacklistForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("WillAcceptLowRank", "v_CrewBlacklistForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("WillAcceptLowRank", "v_CrewBlacklistForAdmin", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            AvailableFrom = new (this, "x_AvailableFrom", 133, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "AvailableFrom", "CustomMsg"),
                IsUpload = false
            };
            ...
            AvailableUntil = new (this, "x_AvailableUntil", 133, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "AvailableUntil", "CustomMsg"),
                IsUpload = false
            };
            ...
            EmployeeStatus = new (this, "x_EmployeeStatus", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_CrewBlacklistForAdmin", "EmployeeStatus", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.v_CrewBlacklistForAdmin";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "VCrewBlacklistForAdminList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "VCrewBlacklistForAdminView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "VCrewBlacklistForAdminEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "VCrewBlacklistForAdminAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VCrewBlacklistForAdminView",
                Config.ApiAddAction => "VCrewBlacklistForAdminAdd",
                Config.ApiEditAction => "VCrewBlacklistForAdminEdit",
                Config.ApiDeleteAction => "VCrewBlacklistForAdminDelete",
                Config.ApiListAction => "VCrewBlacklistForAdminList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VCrewBlacklistForAdminList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VCrewBlacklistForAdminView", parm);
            else
                url = KeyUrl("VCrewBlacklistForAdminView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VCrewBlacklistForAdminAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "VCrewBlacklistForAdminAdd?" + parm;
            else
                url = "VCrewBlacklistForAdminAdd";
        ...
        {
            string url = "";
            url = KeyUrl("VCrewBlacklistForAdminEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VCrewBlacklistForAdminList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("VCrewBlacklistForAdminAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VCrewBlacklistForAdminList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("VCrewBlacklistForAdminDelete")); // DN
        ...
        {
            string pageName = "VCrewBlacklistForAdminList";
