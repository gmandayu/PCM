...
public partial class PCM {
    /// <summary>
    /// mtManningAgentDelete
    /// </summary>
    public static MtManningAgentDelete mtManningAgentDelete
    {
        get => HttpData.Get<MtManningAgentDelete>("mtManningAgentDelete")!;
        set => HttpData["mtManningAgentDelete"] = value;
    }

    /// <summary>
    /// Page class for MTManningAgent
    /// </summary>
    public class MtManningAgentDelete : MtManningAgentDeleteBase
    {
        // Constructor
        public MtManningAgentDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtManningAgentDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtManningAgentDeleteBase : MtManningAgent
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtManningAgentDelete";
        ...
        // Constructor
        public MtManningAgentDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtManningAgentDelete";
        ...
        // Constructor
        public MtManningAgentDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtManningAgentList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtManningAgentList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtManningAgentDelete?.PageRender();
            }
            return PageResult();
        }
