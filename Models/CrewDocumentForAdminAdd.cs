...
public partial class PCM {
    /// <summary>
    /// crewDocumentForAdminAdd
    /// </summary>
    public static CrewDocumentForAdminAdd crewDocumentForAdminAdd
    {
        get => HttpData.Get<CrewDocumentForAdminAdd>("crewDocumentForAdminAdd")!;
        set => HttpData["crewDocumentForAdminAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewDocumentForAdmin
    /// </summary>
    public class CrewDocumentForAdminAdd : CrewDocumentForAdminAddBase
    {
        // Constructor
        public CrewDocumentForAdminAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewDocumentForAdminAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewDocumentForAdminAdd?crewID=" + ConvertToString(lastAddedDocumentCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewDocumentForAdminAddBase : CrewDocumentForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewDocumentForAdminAdd";
        ...
        // Constructor
        public CrewDocumentForAdminAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewDocumentForAdminAdd";
        ...
        // Constructor
        public CrewDocumentForAdminAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewDocumentForAdminList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "CrewDocumentForAdminView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewDocumentForAdminAdd?.PageRender();
            }
            return PageResult();
        }
