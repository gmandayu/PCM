...
public partial class PCM {
    /// <summary>
    /// crewMcuResultForAdmin
    /// </summary>
    [MaybeNull]
    public static CrewMcuResultForAdmin crewMcuResultForAdmin
    {
        get => HttpData.Resolve<CrewMcuResultForAdmin>("CrewMcuResultForAdmin");
        set => HttpData["CrewMcuResultForAdmin"] = value;
    }

    /// <summary>
    /// Table class for CrewMcuResultForAdmin
    /// </summary>
    public class CrewMcuResultForAdmin : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public CrewMcuResultForAdmin()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "CrewMcuResultForAdmin";
            Name = "CrewMcuResultForAdmin";
            Type = "VIEW";
            UpdateTable = "dbo.TRMCUResult"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            McuResult_ID = new (this, "x_McuResult_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "McuResult_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTCrew_ID = new (this, "x_MTCrew_ID", 3, SqlDbType.Int) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "MTCrew_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            McuDate = new (this, "x_McuDate", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "McuDate", "CustomMsg"),
                IsUpload = false
            };
            McuDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuDate", "CrewMcuResultForAdmin", true, "McuDate", new List<string> {"McuDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuDate", "CrewMcuResultForAdmin", true, "McuDate", new List<string> {"McuDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuDate", "CrewMcuResultForAdmin", true, "McuDate", new List<string> {"McuDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            McuExpirationDate = new (this, "x_McuExpirationDate", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "McuExpirationDate", "CustomMsg"),
                IsUpload = false
            };
            McuExpirationDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuExpirationDate", "CrewMcuResultForAdmin", true, "McuExpirationDate", new List<string> {"McuExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuExpirationDate", "CrewMcuResultForAdmin", true, "McuExpirationDate", new List<string> {"McuExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuExpirationDate", "CrewMcuResultForAdmin", true, "McuExpirationDate", new List<string> {"McuExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            HealthStatus = new (this, "x_HealthStatus", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "HealthStatus", "CustomMsg"),
                IsUpload = false
            };
            HealthStatus.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("HealthStatus", "CrewMcuResultForAdmin", true, "HealthStatus", new List<string> {"HealthStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("HealthStatus", "CrewMcuResultForAdmin", true, "HealthStatus", new List<string> {"HealthStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("HealthStatus", "CrewMcuResultForAdmin", true, "HealthStatus", new List<string> {"HealthStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            McuLocation = new (this, "x_McuLocation", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "McuLocation", "CustomMsg"),
                IsUpload = false
            };
            McuLocation.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuLocation", "CrewMcuResultForAdmin", true, "McuLocation", new List<string> {"McuLocation", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuLocation", "CrewMcuResultForAdmin", true, "McuLocation", new List<string> {"McuLocation", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuLocation", "CrewMcuResultForAdmin", true, "McuLocation", new List<string> {"McuLocation", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            McuAttachment = new (this, "x_McuAttachment", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "McuAttachment", "CustomMsg"),
                IsUpload = true
            };
            McuAttachment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuAttachment", "CrewMcuResultForAdmin", true, "McuAttachment", new List<string> {"McuAttachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuAttachment", "CrewMcuResultForAdmin", true, "McuAttachment", new List<string> {"McuAttachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuAttachment", "CrewMcuResultForAdmin", true, "McuAttachment", new List<string> {"McuAttachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            CreatedByUserID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedByUserID", "CrewMcuResultForAdmin", true, "CreatedByUserID", new List<string> {"CreatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedByUserID", "CrewMcuResultForAdmin", true, "CreatedByUserID", new List<string> {"CreatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedByUserID", "CrewMcuResultForAdmin", true, "CreatedByUserID", new List<string> {"CreatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "CrewMcuResultForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "CrewMcuResultForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "CrewMcuResultForAdmin", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedByUserID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedByUserID", "CrewMcuResultForAdmin", true, "LastUpdatedByUserID", new List<string> {"LastUpdatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedByUserID", "CrewMcuResultForAdmin", true, "LastUpdatedByUserID", new List<string> {"LastUpdatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedByUserID", "CrewMcuResultForAdmin", true, "LastUpdatedByUserID", new List<string> {"LastUpdatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "CrewMcuResultForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "CrewMcuResultForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "CrewMcuResultForAdmin", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            McuScheduleDate = new (this, "x_McuScheduleDate", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "McuScheduleDate", "CustomMsg"),
                IsUpload = false
            };
            McuScheduleDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuScheduleDate", "CrewMcuResultForAdmin", true, "McuScheduleDate", new List<string> {"McuScheduleDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuScheduleDate", "CrewMcuResultForAdmin", true, "McuScheduleDate", new List<string> {"McuScheduleDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuScheduleDate", "CrewMcuResultForAdmin", true, "McuScheduleDate", new List<string> {"McuScheduleDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            McuRemark = new (this, "x_McuRemark", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CrewMcuResultForAdmin", "McuRemark", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.CrewMcuResultForAdmin";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            try {
                ...
                McuResult_ID.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "CrewMcuResultForAdminList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "CrewMcuResultForAdminView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CrewMcuResultForAdminEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CrewMcuResultForAdminAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CrewMcuResultForAdminView",
                Config.ApiAddAction => "CrewMcuResultForAdminAdd",
                Config.ApiEditAction => "CrewMcuResultForAdminEdit",
                Config.ApiDeleteAction => "CrewMcuResultForAdminDelete",
                Config.ApiListAction => "CrewMcuResultForAdminList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CrewMcuResultForAdminList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CrewMcuResultForAdminView", parm);
            else
                url = KeyUrl("CrewMcuResultForAdminView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CrewMcuResultForAdminAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "CrewMcuResultForAdminAdd?" + parm;
            else
                url = "CrewMcuResultForAdminAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CrewMcuResultForAdminEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewMcuResultForAdminList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CrewMcuResultForAdminAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CrewMcuResultForAdminList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CrewMcuResultForAdminDelete")); // DN
        ...
        {
            string pageName = "CrewMcuResultForAdminList";
        ...
        public async Task RenderListRow()
        {
            ...
            // HealthStatus
            if (!Empty(HealthStatus.CurrentValue)) {
                HealthStatus.ViewValue = HealthStatus.HighlightLookup(ConvertToString(HealthStatus.CurrentValue), HealthStatus.OptionCaption(ConvertToString(HealthStatus.CurrentValue)));
            } else {
                HealthStatus.ViewValue = DbNullValue;
            }
            ...
            if (McuAttachment.UseColorbox) {
                if (Empty(McuAttachment.TooltipValue))
                    McuAttachment.LinkAttrs["title"] = Language.Phrase("ViewImageGallery");
                McuAttachment.LinkAttrs["data-rel"] = "CrewMcuResultForAdmin_x_McuAttachment";
                if (McuAttachment.LinkAttrs.ContainsKey("class")) {
                    McuAttachment.LinkAttrs.AppendClass("ew-lightbox");
                } else {
                    McuAttachment.LinkAttrs["class"] = "ew-lightbox";
                }
            }
        ...
        public async Task RenderEditRow()
        {
            ...
            McuResult_ID.EditValue = McuResult_ID.CurrentValue;
            McuResult_ID.ViewCustomAttributes = "";
            ...
            HealthStatus.EditValue = HealthStatus.Options(true);
        ...
        public async Task<IActionResult> GetFileData(string fldparm, string[] keys, bool resize, int width = -1, int height = -1)
        {
            ...
            if (SameText(fldparm, "McuAttachment")) {
        ...
        public void RowSelected(Dictionary<string, object> row) {
            ...
            if ((object) individualCodeNumberObject != null)
            {
                ...
                McuAttachment.UploadPath = "uploads/" + individualCodeNumber;
            }
        }
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            ...
            dynamic crewQueryResult = QueryBuilder("MTCrew").Where("ID", rsnew["MTCrew_ID"].ToString()).Select("IndividualCodeNumber").FirstOrDefault();
            if ((object) crewQueryResult != null)
            {
                string crewIndividualCodeNumber = crewQueryResult.IndividualCodeNumber;
                string fileName, fileExtension, newFileName, newFileNameURLFriendly;
                if (rsnew.ContainsKey("McuAttachment"))
                {
                    McuAttachment.UploadPath = "uploads/" + crewIndividualCodeNumber;
                    fileName = rsnew["McuAttachment"].ToString();
                    fileExtension = System.IO.Path.GetExtension(fileName);
                    newFileName = rsnew["McuDate"].ToString();
                    newFileNameURLFriendly = GenerateSlug(newFileName);
                    rsnew["McuAttachment"] = crewIndividualCodeNumber + "-mcu" + fileExtension;
                }
            }
            return true;
        }
