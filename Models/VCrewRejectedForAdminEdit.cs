...
public partial class PCM {
    /// <summary>
    /// vCrewRejectedForAdminEdit
    /// </summary>
    public static VCrewRejectedForAdminEdit vCrewRejectedForAdminEdit
    {
        get => HttpData.Get<VCrewRejectedForAdminEdit>("vCrewRejectedForAdminEdit")!;
        set => HttpData["vCrewRejectedForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for v_CrewRejectedForAdmin
    /// </summary>
    public class VCrewRejectedForAdminEdit : VCrewRejectedForAdminEditBase
    {
        // Constructor
        public VCrewRejectedForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewRejectedForAdminEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewRejectedForAdminEditBase : VCrewRejectedForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewRejectedForAdminEdit";
        ...
        // Constructor
        public VCrewRejectedForAdminEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewRejectedForAdminEdit";
        ...
        // Constructor
        public VCrewRejectedForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("VCrewRejectedForAdminList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "VCrewRejectedForAdminList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "VCrewRejectedForAdminList") {
                                ...
                                returnUrl = "VCrewRejectedForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewRejectedForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
