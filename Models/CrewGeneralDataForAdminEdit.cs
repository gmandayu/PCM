...
public partial class PCM {
    /// <summary>
    /// crewGeneralDataForAdminEdit
    /// </summary>
    public static CrewGeneralDataForAdminEdit crewGeneralDataForAdminEdit
    {
        get => HttpData.Get<CrewGeneralDataForAdminEdit>("crewGeneralDataForAdminEdit")!;
        set => HttpData["crewGeneralDataForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewGeneralDataForAdmin
    /// </summary>
    public class CrewGeneralDataForAdminEdit : CrewGeneralDataForAdminEditBase
    {
        // Constructor
        public CrewGeneralDataForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewGeneralDataForAdminEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewGeneralDataForAdminEditBase : CrewGeneralDataForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewGeneralDataForAdminEdit";
        ...
        // Constructor
        public CrewGeneralDataForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewGeneralDataForAdminEdit";
        ...
        // Constructor
        public CrewGeneralDataForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewGeneralDataForAdminList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = EditUrl;
                    if (GetPageName(returnUrl) == "CrewGeneralDataForAdminList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewGeneralDataForAdminList") {
                                ...
                                returnUrl = "CrewGeneralDataForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewGeneralDataForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("CrewGeneralDataForAdminList")), "", TableVar, true);
            string pageId = "edit";
