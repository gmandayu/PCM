...
public partial class PCM {
    /// <summary>
    /// mtMedicalCertificate
    /// </summary>
    [MaybeNull]
    public static MtMedicalCertificate mtMedicalCertificate
    {
        get => HttpData.Resolve<MtMedicalCertificate>("MTMedicalCertificate");
        set => HttpData["MTMedicalCertificate"] = value;
    }

    /// <summary>
    /// Table class for MTMedicalCertificate
    /// </summary>
    public class MtMedicalCertificate : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Enabled;
        ...
        // Constructor
        public MtMedicalCertificate()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTMedicalCertificate";
            Name = "MTMedicalCertificate";
            Type = "TABLE";
            UpdateTable = "dbo.MTMedicalCertificate"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            _Name = new (this, "x__Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "_Name", "CustomMsg"),
                IsUpload = false
            };
            _Name.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Name", "MTMedicalCertificate", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Name", "MTMedicalCertificate", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Name", "MTMedicalCertificate", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Name", _Name);

            // Enabled
            Enabled = new (this, "x_Enabled", 11, SqlDbType.Bit) {
                Name = "Enabled",
                Expression = "[Enabled]",
                BasicSearchExpression = "[Enabled]",
                DateTimeFormat = -1,
                VirtualExpression = "[Enabled]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "Enabled", "CustomMsg"),
                IsUpload = false
            };
            Enabled.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Enabled", "MTMedicalCertificate", true, "Enabled", new List<string> {"Enabled", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Enabled", "MTMedicalCertificate", true, "Enabled", new List<string> {"Enabled", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Enabled", "MTMedicalCertificate", true, "Enabled", new List<string> {"Enabled", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTMedicalCertificate", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTMedicalCertificate", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTMedicalCertificate", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTMedicalCertificate", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTMedicalCertificate", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTMedicalCertificate", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTMedicalCertificate", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTMedicalCertificate";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Enabled.DbValue = (ConvertToBool(row["Enabled"]) ? "1" : "0"); // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "MtMedicalCertificateList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "MtMedicalCertificateView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtMedicalCertificateEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtMedicalCertificateAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtMedicalCertificateView",
                Config.ApiAddAction => "MtMedicalCertificateAdd",
                Config.ApiEditAction => "MtMedicalCertificateEdit",
                Config.ApiDeleteAction => "MtMedicalCertificateDelete",
                Config.ApiListAction => "MtMedicalCertificateList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtMedicalCertificateList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtMedicalCertificateView", parm);
            else
                url = KeyUrl("MtMedicalCertificateView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtMedicalCertificateAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtMedicalCertificateAdd?" + parm;
            else
                url = "MtMedicalCertificateAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtMedicalCertificateEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtMedicalCertificateList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtMedicalCertificateAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtMedicalCertificateList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtMedicalCertificateDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            Enabled.SetDbValue(ConvertToBool(dr["Enabled"]) ? "1" : "0");
        ...
        {
            string pageName = "MtMedicalCertificateList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Enabled
            Enabled.EditValue = Enabled.Options(false);
            Enabled.PlaceHolder = RemoveHtml(Enabled.Caption);
