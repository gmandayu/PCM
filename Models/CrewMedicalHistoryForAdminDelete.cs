...
public partial class PCM {
    /// <summary>
    /// crewMedicalHistoryForAdminDelete
    /// </summary>
    public static CrewMedicalHistoryForAdminDelete crewMedicalHistoryForAdminDelete
    {
        get => HttpData.Get<CrewMedicalHistoryForAdminDelete>("crewMedicalHistoryForAdminDelete")!;
        set => HttpData["crewMedicalHistoryForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalHistoryForAdmin
    /// </summary>
    public class CrewMedicalHistoryForAdminDelete : CrewMedicalHistoryForAdminDeleteBase
    {
        // Constructor
        public CrewMedicalHistoryForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalHistoryForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalHistoryForAdminDeleteBase : CrewMedicalHistoryForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalHistoryForAdminDelete";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewMedicalHistoryForAdminDelete";
        ...
        // Constructor
        public CrewMedicalHistoryForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewMedicalHistoryForAdminList"); // Prevent SQL injection, return to List page
            ...
            using (Recordset = await Connection.OpenDataReaderAsync(sql)) {
                if (Recordset != null) {
                    ...
                    if (!res)
                        return Terminate("CrewMedicalHistoryForAdminList"); // Return to List page
                }
            }
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewMedicalHistoryForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalHistoryForAdminDelete?.PageRender();
            }
            return PageResult();
        }
