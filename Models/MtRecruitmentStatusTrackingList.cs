...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusTrackingList
    /// </summary>
    public static MtRecruitmentStatusTrackingList mtRecruitmentStatusTrackingList
    {
        get => HttpData.Get<MtRecruitmentStatusTrackingList>("mtRecruitmentStatusTrackingList")!;
        set => HttpData["mtRecruitmentStatusTrackingList"] = value;
    }

    /// <summary>
    /// Page class for MTRecruitmentStatusTracking
    /// </summary>
    public class MtRecruitmentStatusTrackingList : MtRecruitmentStatusTrackingListBase
    {
        // Constructor
        public MtRecruitmentStatusTrackingList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRecruitmentStatusTrackingList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRecruitmentStatusTrackingListBase : MtRecruitmentStatusTracking
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "MTRecruitmentStatusTracking";

        // Page object name
        public string PageObjName = "mtRecruitmentStatusTrackingList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMTRecruitmentStatusTrackinglist";
        ...
        // Constructor
        public MtRecruitmentStatusTrackingListBase()
        {
            // CSS class name as context
            TableVar = "MTRecruitmentStatusTracking";
            ...
            // Table object (mtRecruitmentStatusTracking)
            if (mtRecruitmentStatusTracking == null || mtRecruitmentStatusTracking is MtRecruitmentStatusTracking)
                mtRecruitmentStatusTracking = this;

            // Initialize URLs
            AddUrl = "MtRecruitmentStatusTrackingAdd";
            ...
            MultiDeleteUrl = "MtRecruitmentStatusTrackingDelete";
            MultiUpdateUrl = "MtRecruitmentStatusTrackingUpdate";
        ...
        // Page name
        public string PageName => "MtRecruitmentStatusTrackingList";
        ...
        public void SetVisibility()
        {
            ...
            MTRecruitmentStatusID.SetVisibility();
            Flag.SetVisibility();
            FlagDescription.SetVisibility();
        ...
        // Constructor
        public MtRecruitmentStatusTrackingListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "MtRecruitmentStatusTrackingView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fMTRecruitmentStatusTrackinggrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtRecruitmentStatusTrackingList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(MTRecruitmentStatusID.AdvancedSearch.ToJson())); // Field MTRecruitmentStatusID
            filters.Merge(JObject.Parse(Flag.AdvancedSearch.ToJson())); // Field Flag
            filters.Merge(JObject.Parse(FlagDescription.AdvancedSearch.ToJson())); // Field FlagDescription
        ...
        protected bool RestoreFilterList() {
            ...
            // Field MTRecruitmentStatusID
            if (filter?.TryGetValue("x_MTRecruitmentStatusID", out sv) ?? false) {
                MTRecruitmentStatusID.AdvancedSearch.SearchValue = sv;
                MTRecruitmentStatusID.AdvancedSearch.SearchOperator = filter["z_MTRecruitmentStatusID"];
                MTRecruitmentStatusID.AdvancedSearch.SearchCondition = filter["v_MTRecruitmentStatusID"];
                MTRecruitmentStatusID.AdvancedSearch.SearchValue2 = filter["y_MTRecruitmentStatusID"];
                MTRecruitmentStatusID.AdvancedSearch.SearchOperator2 = filter["w_MTRecruitmentStatusID"];
                MTRecruitmentStatusID.AdvancedSearch.Save();
            }
            ...
            if (filter?.TryGetValue("x_FlagDescription", out sv) ?? false) {
                FlagDescription.AdvancedSearch.SearchValue = sv;
                FlagDescription.AdvancedSearch.SearchOperator = filter["z_FlagDescription"];
                FlagDescription.AdvancedSearch.SearchCondition = filter["v_FlagDescription"];
                FlagDescription.AdvancedSearch.SearchValue2 = filter["y_FlagDescription"];
                FlagDescription.AdvancedSearch.SearchOperator2 = filter["w_FlagDescription"];
                FlagDescription.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(FlagDescription);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(MTRecruitmentStatusID, ctrl); // MTRecruitmentStatusID
                UpdateSort(Flag, ctrl); // Flag
                UpdateSort(FlagDescription, ctrl); // FlagDescription
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    ID.Sort = "";
                    MTCrewID.Sort = "";
                    MTRecruitmentStatusID.Sort = "";
                    Flag.Sort = "";
                    FlagDescription.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""MTRecruitmentStatusTracking"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""MTRecruitmentStatusTracking"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""MTRecruitmentStatusTracking"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTRecruitmentStatusTrackinglist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTRecruitmentStatusTrackinglist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""MTRecruitmentStatusTracking"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("MTRecruitmentStatusID")); // DN
                CreateColumnOption(option.Add("Flag")); // DN
                CreateColumnOption(option.Add("FlagDescription")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fMTRecruitmentStatusTrackingsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fMTRecruitmentStatusTrackingsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fMTRecruitmentStatusTrackinglist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_MTRecruitmentStatusTracking");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtRecruitmentStatusTrackingList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtRecruitmentStatusTrackingList.RowCount) + "_MTRecruitmentStatusTracking");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtRecruitmentStatusTrackingList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtRecruitmentStatusTrackingList.RowType == RowType.Add || IsEdit && mtRecruitmentStatusTrackingList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            MTRecruitmentStatusID.SetDbValue(row["MTRecruitmentStatusID"]);
            Flag.SetDbValue(row["Flag"]);
            FlagDescription.SetDbValue(row["FlagDescription"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("MTRecruitmentStatusID", MTRecruitmentStatusID.DefaultValue ?? DbNullValue); // DN
            row.Add("Flag", Flag.DefaultValue ?? DbNullValue); // DN
            row.Add("FlagDescription", FlagDescription.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // MTRecruitmentStatusID
                MTRecruitmentStatusID.ViewValue = MTRecruitmentStatusID.CurrentValue;
                MTRecruitmentStatusID.ViewValue = FormatNumber(MTRecruitmentStatusID.ViewValue, MTRecruitmentStatusID.FormatPattern);
                MTRecruitmentStatusID.ViewCustomAttributes = "";

                // Flag
                Flag.ViewValue = Flag.CurrentValue;
                Flag.ViewValue = FormatNumber(Flag.ViewValue, Flag.FormatPattern);
                Flag.ViewCustomAttributes = "";

                // FlagDescription
                FlagDescription.ViewValue = ConvertToString(FlagDescription.CurrentValue); // DN
                FlagDescription.ViewCustomAttributes = "";
                ...
                // MTRecruitmentStatusID
                MTRecruitmentStatusID.HrefValue = "";
                MTRecruitmentStatusID.TooltipValue = "";
                ...
                // FlagDescription
                FlagDescription.HrefValue = "";
                FlagDescription.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fMTRecruitmentStatusTrackinglist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fMTRecruitmentStatusTrackinglist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fMTRecruitmentStatusTrackinglist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fMTRecruitmentStatusTrackingsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
