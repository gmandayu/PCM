...
public partial class PCM {
    /// <summary>
    /// vCrewBlacklistForAdminSearch
    /// </summary>
    public static VCrewBlacklistForAdminSearch vCrewBlacklistForAdminSearch
    {
        get => HttpData.Get<VCrewBlacklistForAdminSearch>("vCrewBlacklistForAdminSearch")!;
        set => HttpData["vCrewBlacklistForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for v_CrewBlacklistForAdmin
    /// </summary>
    public class VCrewBlacklistForAdminSearch : VCrewBlacklistForAdminSearchBase
    {
        // Constructor
        public VCrewBlacklistForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewBlacklistForAdminSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewBlacklistForAdminSearchBase : VCrewBlacklistForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewBlacklistForAdminSearch";
        ...
        // Constructor
        public VCrewBlacklistForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewBlacklistForAdminSearch";
        ...
        // Constructor
        public VCrewBlacklistForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "VCrewBlacklistForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewBlacklistForAdminSearch?.PageRender();
            }
            return PageResult();
        }
