...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static TrNotification trNotification
    {
        get => HttpData.Resolve<TrNotification>("TRNotification");
        set => HttpData["TRNotification"] = value;
    }

    /// <summary>
    /// Table class for TRNotification
    /// </summary>
    public class TrNotification : DbTable, IQueryFactory
    {
        ...
        public TrNotification()
        {
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TRNotification", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TRNotification", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Subject = new (this, "x_Subject", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TRNotification", "Subject", "CustomMsg"),
                IsUpload = false
            };
            ...
            Body = new (this, "x_Body", 202, SqlDbType.NVarChar) {
                ...
                Expression = "[Body]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Body]",
                DateTimeFormat = -1,
                VirtualExpression = "[Body]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("TRNotification", "Body", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRNotification", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRNotification", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRNotification", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRNotification", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            MarkAsRead = new (this, "x_MarkAsRead", 11, SqlDbType.Bit) {
                Name = "MarkAsRead",
                Expression = "[MarkAsRead]",
                BasicSearchExpression = "[MarkAsRead]",
                DateTimeFormat = -1,
                VirtualExpression = "[MarkAsRead]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("TRNotification", "MarkAsRead", "CustomMsg"),
                IsUpload = false
            };
            MarkAsRead.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("MarkAsRead", "TRNotification", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("MarkAsRead", "TRNotification", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("MarkAsRead", "TRNotification", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            if (SameString(pageName, "TrNotificationView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TrNotificationEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TrNotificationAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TrNotificationView",
                Config.ApiAddAction => "TrNotificationAdd",
                Config.ApiEditAction => "TrNotificationEdit",
                Config.ApiDeleteAction => "TrNotificationDelete",
                Config.ApiListAction => "TrNotificationList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TrNotificationList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TrNotificationView", parm);
            else
                url = KeyUrl("TrNotificationView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TrNotificationAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TrNotificationAdd?" + parm;
            else
                url = "TrNotificationAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TrNotificationEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrNotificationList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TrNotificationAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrNotificationList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TrNotificationDelete")); // DN
        ...
        {
            string pageName = "TrNotificationList";
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(MarkAsRead);
                        } else {
                            await doc.ExportField(MTUserID);
                            await doc.ExportField(Subject);
                            await doc.ExportField(Body);
