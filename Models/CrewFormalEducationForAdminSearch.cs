...
public partial class PCM {
    /// <summary>
    /// crewFormalEducationForAdminSearch
    /// </summary>
    public static CrewFormalEducationForAdminSearch crewFormalEducationForAdminSearch
    {
        get => HttpData.Get<CrewFormalEducationForAdminSearch>("crewFormalEducationForAdminSearch")!;
        set => HttpData["crewFormalEducationForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewFormalEducationForAdmin
    /// </summary>
    public class CrewFormalEducationForAdminSearch : CrewFormalEducationForAdminSearchBase
    {
        // Constructor
        public CrewFormalEducationForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFormalEducationForAdminSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFormalEducationForAdminSearchBase : CrewFormalEducationForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFormalEducationForAdminSearch";
        ...
        // Constructor
        public CrewFormalEducationForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewFormalEducationForAdminSearch";
        ...
        // Constructor
        public CrewFormalEducationForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewFormalEducationForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFormalEducationForAdminSearch?.PageRender();
            }
            return PageResult();
        }
