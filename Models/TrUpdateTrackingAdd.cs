...
public partial class PCM {
    ...
    /// trUpdateTrackingAdd
    /// </summary>
    public static TrUpdateTrackingAdd trUpdateTrackingAdd
    {
        get => HttpData.Get<TrUpdateTrackingAdd>("trUpdateTrackingAdd")!;
        set => HttpData["trUpdateTrackingAdd"] = value;
    }

    /// <summary>
    /// Page class for TRUpdateTracking
    /// </summary>
    public class TrUpdateTrackingAdd : TrUpdateTrackingAddBase
    {
        // Constructor
        public TrUpdateTrackingAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrUpdateTrackingAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrUpdateTrackingAddBase : TrUpdateTracking
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trUpdateTrackingAdd";
        ...
        // Constructor
        public TrUpdateTrackingAddBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TrUpdateTrackingAdd";
        ...
        // Constructor
        public TrUpdateTrackingAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("TrUpdateTrackingList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "TrUpdateTrackingView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                trUpdateTrackingAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // TabName
                TabName.SetDbValue(rsnew, TabName.CurrentValue);

                // ColumnName
                ColumnName.SetDbValue(rsnew, ColumnName.CurrentValue);

                // ChangeType
                ChangeType.SetDbValue(rsnew, ChangeType.CurrentValue);
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
