...
public partial class PCM {
    ...
    /// mtReligionDelete
    /// </summary>
    public static MtReligionDelete mtReligionDelete
    {
        get => HttpData.Get<MtReligionDelete>("mtReligionDelete")!;
        set => HttpData["mtReligionDelete"] = value;
    }

    /// <summary>
    /// Page class for MTReligion
    /// </summary>
    public class MtReligionDelete : MtReligionDeleteBase
    {
        // Constructor
        public MtReligionDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtReligionDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtReligionDeleteBase : MtReligion
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtReligionDelete";
        ...
        // Page name
        public string PageName => "MtReligionDelete";
        ...
        // Constructor
        public MtReligionDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtReligionList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtReligionList"); // Return to list
                }
            }
