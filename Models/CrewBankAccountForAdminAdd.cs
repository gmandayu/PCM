...
public partial class PCM {
    /// <summary>
    /// crewBankAccountForAdminAdd
    /// </summary>
    public static CrewBankAccountForAdminAdd crewBankAccountForAdminAdd
    {
        get => HttpData.Get<CrewBankAccountForAdminAdd>("crewBankAccountForAdminAdd")!;
        set => HttpData["crewBankAccountForAdminAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewBankAccountForAdmin
    /// </summary>
    public class CrewBankAccountForAdminAdd : CrewBankAccountForAdminAddBase
    {
        // Constructor
        public CrewBankAccountForAdminAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewBankAccountForAdminAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewBankAccountForAdminAdd?crewID=" + ConvertToString(lastAddedBankAccountCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewBankAccountForAdminAddBase : CrewBankAccountForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewBankAccountForAdminAdd";
        ...
        // Constructor
        public CrewBankAccountForAdminAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewBankAccountForAdminAdd";
        ...
        // Constructor
        public CrewBankAccountForAdminAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewBankAccountForAdminList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "CrewBankAccountForAdminList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "CrewBankAccountForAdminView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewBankAccountForAdminList") {
                                ...
                                returnUrl = "CrewBankAccountForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewBankAccountForAdminAdd?.PageRender();
            }
            return PageResult();
        }
