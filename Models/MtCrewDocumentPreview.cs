...
public partial class PCM {
    /// <summary>
    /// mtCrewDocumentPreview
    /// </summary>
    public static MtCrewDocumentPreview mtCrewDocumentPreview
    {
        get => HttpData.Get<MtCrewDocumentPreview>("mtCrewDocumentPreview")!;
        set => HttpData["mtCrewDocumentPreview"] = value;
    }

    /// <summary>
    /// Page class for MTCrewDocument
    /// </summary>
    public class MtCrewDocumentPreview : MtCrewDocumentPreviewBase
    {
        // Constructor
        public MtCrewDocumentPreview(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCrewDocumentPreview() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewDocumentPreviewBase : MtCrewDocument
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewDocumentPreview";
        ...
        // Constructor
        public MtCrewDocumentPreviewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCrewDocumentPreview";
        ...
        // Constructor
        public MtCrewDocumentPreviewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void HideFieldsForAddEdit() {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCrewDocumentPreview?.PageRender();
            }
                return PageResult();
            }
