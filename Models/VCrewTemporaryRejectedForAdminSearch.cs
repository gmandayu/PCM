...
public partial class PCM {
    /// <summary>
    /// vCrewTemporaryRejectedForAdminSearch
    /// </summary>
    public static VCrewTemporaryRejectedForAdminSearch vCrewTemporaryRejectedForAdminSearch
    {
        get => HttpData.Get<VCrewTemporaryRejectedForAdminSearch>("vCrewTemporaryRejectedForAdminSearch")!;
        set => HttpData["vCrewTemporaryRejectedForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for v_CrewTemporaryRejectedForAdmin
    /// </summary>
    public class VCrewTemporaryRejectedForAdminSearch : VCrewTemporaryRejectedForAdminSearchBase
    {
        // Constructor
        public VCrewTemporaryRejectedForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewTemporaryRejectedForAdminSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewTemporaryRejectedForAdminSearchBase : VCrewTemporaryRejectedForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewTemporaryRejectedForAdminSearch";
        ...
        // Constructor
        public VCrewTemporaryRejectedForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewTemporaryRejectedForAdminSearch";
        ...
        // Constructor
        public VCrewTemporaryRejectedForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "VCrewTemporaryRejectedForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewTemporaryRejectedForAdminSearch?.PageRender();
            }
            return PageResult();
        }
