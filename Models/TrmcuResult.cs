...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static TrmcuResult trmcuResult
    {
        get => HttpData.Resolve<TrmcuResult>("TRMCUResult");
        set => HttpData["TRMCUResult"] = value;
    }

    /// <summary>
    /// Table class for TRMCUResult
    /// </summary>
    public class TrmcuResult : DbTable, IQueryFactory
    {
        ...
        public TrmcuResult()
        {
            ...
            McuResult_ID = new (this, "x_McuResult_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TRMCUResult", "McuResult_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            MTCrew_ID = new (this, "x_MTCrew_ID", 3, SqlDbType.Int) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "MTCrew_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            McuDate = new (this, "x_McuDate", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("TRMCUResult", "McuDate", "CustomMsg"),
                IsUpload = false
            };
            McuDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuDate", "TRMCUResult", true, "McuDate", new List<string> {"McuDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuDate", "TRMCUResult", true, "McuDate", new List<string> {"McuDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuDate", "TRMCUResult", true, "McuDate", new List<string> {"McuDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            McuExpirationDate = new (this, "x_McuExpirationDate", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "McuExpirationDate", "CustomMsg"),
                IsUpload = false
            };
            McuExpirationDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuExpirationDate", "TRMCUResult", true, "McuExpirationDate", new List<string> {"McuExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuExpirationDate", "TRMCUResult", true, "McuExpirationDate", new List<string> {"McuExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuExpirationDate", "TRMCUResult", true, "McuExpirationDate", new List<string> {"McuExpirationDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            HealthStatus = new (this, "x_HealthStatus", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TRMCUResult", "HealthStatus", "CustomMsg"),
                IsUpload = false
            };
            HealthStatus.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("HealthStatus", "TRMCUResult", true, "HealthStatus", new List<string> {"HealthStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("HealthStatus", "TRMCUResult", true, "HealthStatus", new List<string> {"HealthStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("HealthStatus", "TRMCUResult", true, "HealthStatus", new List<string> {"HealthStatus", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            McuLocation = new (this, "x_McuLocation", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "McuLocation", "CustomMsg"),
                IsUpload = false
            };
            McuLocation.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuLocation", "TRMCUResult", true, "McuLocation", new List<string> {"McuLocation", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuLocation", "TRMCUResult", true, "McuLocation", new List<string> {"McuLocation", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuLocation", "TRMCUResult", true, "McuLocation", new List<string> {"McuLocation", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            McuAttachment = new (this, "x_McuAttachment", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TRMCUResult", "McuAttachment", "CustomMsg"),
                IsUpload = true
            };
            McuAttachment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("McuAttachment", "TRMCUResult", true, "McuAttachment", new List<string> {"McuAttachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("McuAttachment", "TRMCUResult", true, "McuAttachment", new List<string> {"McuAttachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("McuAttachment", "TRMCUResult", true, "McuAttachment", new List<string> {"McuAttachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            CreatedByUserID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedByUserID", "TRMCUResult", true, "CreatedByUserID", new List<string> {"CreatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedByUserID", "TRMCUResult", true, "CreatedByUserID", new List<string> {"CreatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedByUserID", "TRMCUResult", true, "CreatedByUserID", new List<string> {"CreatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "TRMCUResult", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "TRMCUResult", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "TRMCUResult", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedByUserID.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedByUserID", "TRMCUResult", true, "LastUpdatedByUserID", new List<string> {"LastUpdatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedByUserID", "TRMCUResult", true, "LastUpdatedByUserID", new List<string> {"LastUpdatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedByUserID", "TRMCUResult", true, "LastUpdatedByUserID", new List<string> {"LastUpdatedByUserID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "TRMCUResult", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "TRMCUResult", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "TRMCUResult", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            McuScheduleDate = new (this, "x_McuScheduleDate", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "McuScheduleDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            McuRemark = new (this, "x_McuRemark", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TRMCUResult", "McuRemark", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "TrmcuResultView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TrmcuResultEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TrmcuResultAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TrmcuResultView",
                Config.ApiAddAction => "TrmcuResultAdd",
                Config.ApiEditAction => "TrmcuResultEdit",
                Config.ApiDeleteAction => "TrmcuResultDelete",
                Config.ApiListAction => "TrmcuResultList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TrmcuResultList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TrmcuResultView", parm);
            else
                url = KeyUrl("TrmcuResultView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TrmcuResultAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TrmcuResultEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrmcuResultList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TrmcuResultAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrmcuResultList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TrmcuResultDelete")); // DN
        ...
        {
            string pageName = "TrmcuResultList";
