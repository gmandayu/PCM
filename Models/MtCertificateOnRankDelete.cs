...
public partial class PCM {
    /// <summary>
    /// mtCertificateOnRankDelete
    /// </summary>
    public static MtCertificateOnRankDelete mtCertificateOnRankDelete
    {
        get => HttpData.Get<MtCertificateOnRankDelete>("mtCertificateOnRankDelete")!;
        set => HttpData["mtCertificateOnRankDelete"] = value;
    }

    /// <summary>
    /// Page class for MTCertificateOnRank
    /// </summary>
    public class MtCertificateOnRankDelete : MtCertificateOnRankDeleteBase
    {
        // Constructor
        public MtCertificateOnRankDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateOnRankDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateOnRankDeleteBase : MtCertificateOnRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateOnRankDelete";
        ...
        // Constructor
        public MtCertificateOnRankDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCertificateOnRankDelete";
        ...
        // Constructor
        public MtCertificateOnRankDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtCertificateOnRankList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtCertificateOnRankList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCertificateOnRankDelete?.PageRender();
            }
            return PageResult();
        }
