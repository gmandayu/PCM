...
public partial class PCM {
    /// <summary>
    /// mtMedicalCertificateEdit
    /// </summary>
    public static MtMedicalCertificateEdit mtMedicalCertificateEdit
    {
        get => HttpData.Get<MtMedicalCertificateEdit>("mtMedicalCertificateEdit")!;
        set => HttpData["mtMedicalCertificateEdit"] = value;
    }

    /// <summary>
    /// Page class for MTMedicalCertificate
    /// </summary>
    public class MtMedicalCertificateEdit : MtMedicalCertificateEditBase
    {
        // Constructor
        public MtMedicalCertificateEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtMedicalCertificateEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtMedicalCertificateEditBase : MtMedicalCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtMedicalCertificateEdit";
        ...
        // Constructor
        public MtMedicalCertificateEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtMedicalCertificateEdit";
        ...
        // Constructor
        public MtMedicalCertificateEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtMedicalCertificateList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtMedicalCertificateEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // Enabled
            Enabled.SetDbValue(rsnew, ConvertToBool(Enabled.CurrentValue), Enabled.ReadOnly);
