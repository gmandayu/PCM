...
public partial class PCM {
    ...
    /// mtBankAdd
    /// </summary>
    public static MtBankAdd mtBankAdd
    {
        get => HttpData.Get<MtBankAdd>("mtBankAdd")!;
        set => HttpData["mtBankAdd"] = value;
    }

    /// <summary>
    /// Page class for MTBank
    /// </summary>
    public class MtBankAdd : MtBankAddBase
    {
        // Constructor
        public MtBankAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBankAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBankAddBase : MtBank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBankAdd";
        ...
        // Page name
        public string PageName => "MtBankAdd";
        ...
        // Constructor
        public MtBankAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtBankList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtBankList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtBankView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtBankList") {
                                ...
                                returnUrl = "MtBankList"; // Return list page content
                            }
                        }
