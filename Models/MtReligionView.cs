...
public partial class PCM {
    ...
    /// mtReligionView
    /// </summary>
    public static MtReligionView mtReligionView
    {
        get => HttpData.Get<MtReligionView>("mtReligionView")!;
        set => HttpData["mtReligionView"] = value;
    }

    /// <summary>
    /// Page class for MTReligion
    /// </summary>
    public class MtReligionView : MtReligionViewBase
    {
        // Constructor
        public MtReligionView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtReligionView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtReligionViewBase : MtReligion
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtReligionView";
        ...
        // Page name
        public string PageName => "MtReligionView";
        ...
        // Constructor
        public MtReligionViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtReligionList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtReligionList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTReligionview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtReligionList")), "", TableVar, true);
            string pageId = "view";
