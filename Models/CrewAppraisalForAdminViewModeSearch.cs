...
public partial class PCM {
    /// <summary>
    /// crewAppraisalForAdminViewModeSearch
    /// </summary>
    public static CrewAppraisalForAdminViewModeSearch crewAppraisalForAdminViewModeSearch
    {
        get => HttpData.Get<CrewAppraisalForAdminViewModeSearch>("crewAppraisalForAdminViewModeSearch")!;
        set => HttpData["crewAppraisalForAdminViewModeSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewAppraisalForAdminViewMode
    /// </summary>
    public class CrewAppraisalForAdminViewModeSearch : CrewAppraisalForAdminViewModeSearchBase
    {
        // Constructor
        public CrewAppraisalForAdminViewModeSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewAppraisalForAdminViewModeSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewAppraisalForAdminViewModeSearchBase : CrewAppraisalForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewAppraisalForAdminViewModeSearch";
        ...
        // Constructor
        public CrewAppraisalForAdminViewModeSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewAppraisalForAdminViewModeSearch";
        ...
        // Constructor
        public CrewAppraisalForAdminViewModeSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewAppraisalForAdminViewModeList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewAppraisalForAdminViewModeSearch?.PageRender();
            }
            return PageResult();
        }
