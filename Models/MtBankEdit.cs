...
public partial class PCM {
    ...
    /// mtBankEdit
    /// </summary>
    public static MtBankEdit mtBankEdit
    {
        get => HttpData.Get<MtBankEdit>("mtBankEdit")!;
        set => HttpData["mtBankEdit"] = value;
    }

    /// <summary>
    /// Page class for MTBank
    /// </summary>
    public class MtBankEdit : MtBankEditBase
    {
        // Constructor
        public MtBankEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBankEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBankEditBase : MtBank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBankEdit";
        ...
        // Page name
        public string PageName => "MtBankEdit";
        ...
        // Constructor
        public MtBankEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtBankList"); // No matching record, return to list
                        }
                    break;
