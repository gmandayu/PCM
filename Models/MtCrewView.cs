...
public partial class PCM {
    ...
    /// mtCrewView
    /// </summary>
    public static MtCrewView mtCrewView
    {
        get => HttpData.Get<MtCrewView>("mtCrewView")!;
        set => HttpData["mtCrewView"] = value;
    }

    /// <summary>
    /// Page class for MTCrew
    /// </summary>
    public class MtCrewView : MtCrewViewBase
    {
        // Constructor
        public MtCrewView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCrewView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewViewBase : MtCrew
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewView";
        ...
        // Page name
        public string PageName => "MtCrewView";
        ...
        public void SetVisibility()
        {
            ...
            DocumentCheckDateTime.SetVisibility();
            InterviewManagerDateTime.SetVisibility();
            InterviewGMDateTime.SetVisibility();
            MCUScheduleDateTime.SetVisibility();
            RejectedReason.SetVisibility();
            RejectedDateTime.SetVisibility();
        ...
        // Constructor
        public MtCrewViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtCrewList"; // Return to list
            }
        ...
        public void SetupOtherOptions()
        {
            ...
            item = option.Add("detail_MTCrewCertificate");
            body = Language.Phrase("ViewPageDetailLink") + Language.TablePhrase("MTCrewCertificate", "TblCaption");
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("MtCrewCertificateList?" + Config.TableShowMaster + "=MTCrew&" + ForeignKeyUrl("fk_ID", ID.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
            detailPage = Resolve("MtCrewCertificateGrid");
            if (detailPage?.DetailView && Security.CanView && Security.AllowView(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" + Language.Phrase("MasterDetailViewLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetViewUrl(Config.TableShowDetail + "=MTCrewCertificate"))) + "\">" + Language.Phrase("MasterDetailViewLink", null) + "</a></li>";
                if (!Empty(detailViewTblVar))
                    detailViewTblVar += ",";
                detailViewTblVar += "MTCrewCertificate";
            }
            if (detailPage?.DetailEdit && Security.CanEdit && Security.AllowEdit(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" + Language.Phrase("MasterDetailEditLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetEditUrl(Config.TableShowDetail + "=MTCrewCertificate"))) + "\">" + Language.Phrase("MasterDetailEditLink", null) + "</a></li>";
            ...
            item = option.Add("detail_MTCrewDocument");
            body = Language.Phrase("ViewPageDetailLink") + Language.TablePhrase("MTCrewDocument", "TblCaption");
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("MtCrewDocumentList?" + Config.TableShowMaster + "=MTCrew&" + ForeignKeyUrl("fk_ID", ID.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
            detailPage = Resolve("MtCrewDocumentGrid");
            if (detailPage?.DetailView && Security.CanView && Security.AllowView(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" + Language.Phrase("MasterDetailViewLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetViewUrl(Config.TableShowDetail + "=MTCrewDocument"))) + "\">" + Language.Phrase("MasterDetailViewLink", null) + "</a></li>";
                if (!Empty(detailViewTblVar))
                    detailViewTblVar += ",";
                detailViewTblVar += "MTCrewDocument";
            }
            if (detailPage?.DetailEdit && Security.CanEdit && Security.AllowEdit(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" + Language.Phrase("MasterDetailEditLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetEditUrl(Config.TableShowDetail + "=MTCrewDocument"))) + "\">" + Language.Phrase("MasterDetailEditLink", null) + "</a></li>";
                if (!Empty(detailEditTblVar))
                    detailEditTblVar += ",";
            ...
            item = option.Add("detail_MTCrewExperience");
            body = Language.Phrase("ViewPageDetailLink") + Language.TablePhrase("MTCrewExperience", "TblCaption");
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("MtCrewExperienceList?" + Config.TableShowMaster + "=MTCrew&" + ForeignKeyUrl("fk_ID", ID.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
            detailPage = Resolve("MtCrewExperienceGrid");
            if (detailPage?.DetailView && Security.CanView && Security.AllowView(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" + Language.Phrase("MasterDetailViewLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetViewUrl(Config.TableShowDetail + "=MTCrewExperience"))) + "\">" + Language.Phrase("MasterDetailViewLink", null) + "</a></li>";
                if (!Empty(detailViewTblVar))
                    detailViewTblVar += ",";
                detailViewTblVar += "MTCrewExperience";
            }
            if (detailPage?.DetailEdit && Security.CanEdit && Security.AllowEdit(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" + Language.Phrase("MasterDetailEditLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetEditUrl(Config.TableShowDetail + "=MTCrewExperience"))) + "\">" + Language.Phrase("MasterDetailEditLink", null) + "</a></li>";
                if (!Empty(detailEditTblVar))
                    detailEditTblVar += ",";
            ...
            // "detail_MTCrewFamily"
            item = option.Add("detail_MTCrewFamily");
            body = Language.Phrase("ViewPageDetailLink") + Language.TablePhrase("MTCrewFamily", "TblCaption");
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("MtCrewFamilyList?" + Config.TableShowMaster + "=MTCrew&" + ForeignKeyUrl("fk_ID", ID.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
            detailPage = Resolve("MtCrewFamilyGrid");
            if (detailPage?.DetailView && Security.CanView && Security.AllowView(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" + Language.Phrase("MasterDetailViewLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetViewUrl(Config.TableShowDetail + "=MTCrewFamily"))) + "\">" + Language.Phrase("MasterDetailViewLink", null) + "</a></li>";
                if (!Empty(detailViewTblVar))
                    detailViewTblVar += ",";
                detailViewTblVar += "MTCrewFamily";
            }
            if (detailPage?.DetailEdit && Security.CanEdit && Security.AllowEdit(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" + Language.Phrase("MasterDetailEditLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetEditUrl(Config.TableShowDetail + "=MTCrewFamily"))) + "\">" + Language.Phrase("MasterDetailEditLink", null) + "</a></li>";
                if (!Empty(detailEditTblVar))
                    detailEditTblVar += ",";
            ...
            item = option.Add("detail_MTCrewMedicalHistory");
            body = Language.Phrase("ViewPageDetailLink") + Language.TablePhrase("MTCrewMedicalHistory", "TblCaption");
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("MtCrewMedicalHistoryList?" + Config.TableShowMaster + "=MTCrew&" + ForeignKeyUrl("fk_ID", ID.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
            detailPage = Resolve("MtCrewMedicalHistoryGrid");
            if (detailPage?.DetailView && Security.CanView && Security.AllowView(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" + Language.Phrase("MasterDetailViewLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetViewUrl(Config.TableShowDetail + "=MTCrewMedicalHistory"))) + "\">" + Language.Phrase("MasterDetailViewLink", null) + "</a></li>";
                if (!Empty(detailViewTblVar))
                    detailViewTblVar += ",";
                detailViewTblVar += "MTCrewMedicalHistory";
            }
            if (detailPage?.DetailEdit && Security.CanEdit && Security.AllowEdit(CurrentProjectID + "MTCrew") ?? false) {
                links += "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" + Language.Phrase("MasterDetailEditLink", true) + "\" href=\"" + HtmlEncode(AppPath(GetEditUrl(Config.TableShowDetail + "=MTCrewMedicalHistory"))) + "\">" + Language.Phrase("MasterDetailEditLink", null) + "</a></li>";
                if (!Empty(detailEditTblVar))
                    detailEditTblVar += ",";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTCrewview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        public async Task ExportData(dynamic? doc, string[] keys)
        {
            ...
            // Export detail records (MTCrewCertificate)
            if (Config.ExportDetailRecords && CurrentDetailTables.Contains("MTCrewCertificate")) {
                mtCrewCertificate = new MtCrewCertificateList();
                if (mtCrewCertificate != null) {
                    var c = await GetConnection2Async(mtCrewCertificate.DbId); // Note: Use new connection for detail records // DN
                    using var rsdetail = await mtCrewCertificate.LoadReader(mtCrewCertificate.DetailFilterFromSession, mtCrewCertificate.SessionOrderBy, c); // Load detail records
                    if (rsdetail?.HasRows ?? false) { // DN
                        exportStyle = doc.Style;
                        doc.SetStyle("h"); // Change to horizontal
                        if (Export != "csv" || Config.ExportDetailRecordsForCsv) {
                            doc.ExportEmptyRow();
                            int detailcnt = await mtCrewCertificate.LoadRecordCountAsync(mtCrewCertificate.DetailFilterFromSession); // DN
                            var oldtbl = doc.Table;
                            doc.Table = mtCrewCertificate;
                            await mtCrewCertificate.ExportDocument(doc, rsdetail, 1, detailcnt);
                            doc.Table = oldtbl;
                        }
            ...
            // Export detail records (MTCrewDocument)
            if (Config.ExportDetailRecords && CurrentDetailTables.Contains("MTCrewDocument")) {
                mtCrewDocument = new MtCrewDocumentList();
                if (mtCrewDocument != null) {
                    var c = await GetConnection2Async(mtCrewDocument.DbId); // Note: Use new connection for detail records // DN
                    using var rsdetail = await mtCrewDocument.LoadReader(mtCrewDocument.DetailFilterFromSession, mtCrewDocument.SessionOrderBy, c); // Load detail records
                    if (rsdetail?.HasRows ?? false) { // DN
                        exportStyle = doc.Style;
                        doc.SetStyle("h"); // Change to horizontal
                        if (Export != "csv" || Config.ExportDetailRecordsForCsv) {
                            doc.ExportEmptyRow();
                            int detailcnt = await mtCrewDocument.LoadRecordCountAsync(mtCrewDocument.DetailFilterFromSession); // DN
                            var oldtbl = doc.Table;
                            doc.Table = mtCrewDocument;
                            await mtCrewDocument.ExportDocument(doc, rsdetail, 1, detailcnt);
                            doc.Table = oldtbl;
                        }
                        doc.SetStyle(exportStyle); // Restore
                    }
            ...
            // Export detail records (MTCrewExperience)
            if (Config.ExportDetailRecords && CurrentDetailTables.Contains("MTCrewExperience")) {
                mtCrewExperience = new MtCrewExperienceList();
                if (mtCrewExperience != null) {
                    var c = await GetConnection2Async(mtCrewExperience.DbId); // Note: Use new connection for detail records // DN
                    using var rsdetail = await mtCrewExperience.LoadReader(mtCrewExperience.DetailFilterFromSession, mtCrewExperience.SessionOrderBy, c); // Load detail records
                    if (rsdetail?.HasRows ?? false) { // DN
                        exportStyle = doc.Style;
                        doc.SetStyle("h"); // Change to horizontal
                        if (Export != "csv" || Config.ExportDetailRecordsForCsv) {
                            doc.ExportEmptyRow();
                            int detailcnt = await mtCrewExperience.LoadRecordCountAsync(mtCrewExperience.DetailFilterFromSession); // DN
                            var oldtbl = doc.Table;
                            doc.Table = mtCrewExperience;
                            await mtCrewExperience.ExportDocument(doc, rsdetail, 1, detailcnt);
                            doc.Table = oldtbl;
                        }
                        doc.SetStyle(exportStyle); // Restore
                    }
            ...
            // Export detail records (MTCrewFamily)
            if (Config.ExportDetailRecords && CurrentDetailTables.Contains("MTCrewFamily")) {
                mtCrewFamily = new MtCrewFamilyList();
                if (mtCrewFamily != null) {
                    var c = await GetConnection2Async(mtCrewFamily.DbId); // Note: Use new connection for detail records // DN
                    using var rsdetail = await mtCrewFamily.LoadReader(mtCrewFamily.DetailFilterFromSession, mtCrewFamily.SessionOrderBy, c); // Load detail records
                    if (rsdetail?.HasRows ?? false) { // DN
                        exportStyle = doc.Style;
                        doc.SetStyle("h"); // Change to horizontal
                        if (Export != "csv" || Config.ExportDetailRecordsForCsv) {
                            doc.ExportEmptyRow();
                            int detailcnt = await mtCrewFamily.LoadRecordCountAsync(mtCrewFamily.DetailFilterFromSession); // DN
                            var oldtbl = doc.Table;
                            doc.Table = mtCrewFamily;
                            await mtCrewFamily.ExportDocument(doc, rsdetail, 1, detailcnt);
                            doc.Table = oldtbl;
                        }
                        doc.SetStyle(exportStyle); // Restore
                    }
            ...
            // Export detail records (MTCrewMedicalHistory)
            if (Config.ExportDetailRecords && CurrentDetailTables.Contains("MTCrewMedicalHistory")) {
                mtCrewMedicalHistory = new MtCrewMedicalHistoryList();
                if (mtCrewMedicalHistory != null) {
                    var c = await GetConnection2Async(mtCrewMedicalHistory.DbId); // Note: Use new connection for detail records // DN
                    using var rsdetail = await mtCrewMedicalHistory.LoadReader(mtCrewMedicalHistory.DetailFilterFromSession, mtCrewMedicalHistory.SessionOrderBy, c); // Load detail records
                    if (rsdetail?.HasRows ?? false) { // DN
                        exportStyle = doc.Style;
                        doc.SetStyle("h"); // Change to horizontal
                        if (Export != "csv" || Config.ExportDetailRecordsForCsv) {
                            doc.ExportEmptyRow();
                            int detailcnt = await mtCrewMedicalHistory.LoadRecordCountAsync(mtCrewMedicalHistory.DetailFilterFromSession); // DN
                            var oldtbl = doc.Table;
                            doc.Table = mtCrewMedicalHistory;
                            await mtCrewMedicalHistory.ExportDocument(doc, rsdetail, 1, detailcnt);
                            doc.Table = oldtbl;
                        }
                        doc.SetStyle(exportStyle); // Restore
                    }
        ...
        protected void SetupDetailParms() {
            ...
            if (!Empty(detailTblVar)) {
                ...
                if (detailTblVars.Contains("MTCrewCertificate")) {
                    ...
                    if (mtCrewCertificateGrid?.DetailView ?? false) {
                        mtCrewCertificateGrid.CurrentMode = "view";
                ...
                if (detailTblVars.Contains("MTCrewDocument")) {
                    ...
                    if (mtCrewDocumentGrid?.DetailView ?? false) {
                        mtCrewDocumentGrid.CurrentMode = "view";
                ...
                if (detailTblVars.Contains("MTCrewExperience")) {
                    ...
                    if (mtCrewExperienceGrid?.DetailView ?? false) {
                        mtCrewExperienceGrid.CurrentMode = "view";
                ...
                if (detailTblVars.Contains("MTCrewFamily")) {
                    ...
                    if (mtCrewFamilyGrid?.DetailView ?? false) {
                        mtCrewFamilyGrid.CurrentMode = "view";
                ...
                if (detailTblVars.Contains("MTCrewMedicalHistory")) {
                    ...
                    if (mtCrewMedicalHistoryGrid?.DetailView ?? false) {
                        mtCrewMedicalHistoryGrid.CurrentMode = "view";
