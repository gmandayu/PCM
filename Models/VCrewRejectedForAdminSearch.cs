...
public partial class PCM {
    /// <summary>
    /// vCrewRejectedForAdminSearch
    /// </summary>
    public static VCrewRejectedForAdminSearch vCrewRejectedForAdminSearch
    {
        get => HttpData.Get<VCrewRejectedForAdminSearch>("vCrewRejectedForAdminSearch")!;
        set => HttpData["vCrewRejectedForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for v_CrewRejectedForAdmin
    /// </summary>
    public class VCrewRejectedForAdminSearch : VCrewRejectedForAdminSearchBase
    {
        // Constructor
        public VCrewRejectedForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewRejectedForAdminSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewRejectedForAdminSearchBase : VCrewRejectedForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewRejectedForAdminSearch";
        ...
        // Constructor
        public VCrewRejectedForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewRejectedForAdminSearch";
        ...
        // Constructor
        public VCrewRejectedForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "VCrewRejectedForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewRejectedForAdminSearch?.PageRender();
            }
            return PageResult();
        }
