...
public partial class PCM {
    /// <summary>
    /// mtMedicalCertificateView
    /// </summary>
    public static MtMedicalCertificateView mtMedicalCertificateView
    {
        get => HttpData.Get<MtMedicalCertificateView>("mtMedicalCertificateView")!;
        set => HttpData["mtMedicalCertificateView"] = value;
    }

    /// <summary>
    /// Page class for MTMedicalCertificate
    /// </summary>
    public class MtMedicalCertificateView : MtMedicalCertificateViewBase
    {
        // Constructor
        public MtMedicalCertificateView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtMedicalCertificateView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtMedicalCertificateViewBase : MtMedicalCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtMedicalCertificateView";
        ...
        // Constructor
        public MtMedicalCertificateViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtMedicalCertificateView";
        ...
        // Constructor
        public MtMedicalCertificateViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtMedicalCertificateList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtMedicalCertificateList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtMedicalCertificateView?.PageRender();
            }
            return PageResult();
        }
