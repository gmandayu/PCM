...
public partial class PCM {
    ...
    /// mtRankView
    /// </summary>
    public static MtRankView mtRankView
    {
        get => HttpData.Get<MtRankView>("mtRankView")!;
        set => HttpData["mtRankView"] = value;
    }

    /// <summary>
    /// Page class for MTRank
    /// </summary>
    public class MtRankView : MtRankViewBase
    {
        // Constructor
        public MtRankView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRankView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRankViewBase : MtRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRankView";
        ...
        // Page name
        public string PageName => "MtRankView";
        ...
        // Constructor
        public MtRankViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtRankList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtRankList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtRankList")), "", TableVar, true);
            string pageId = "view";
