...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusTrackingDelete
    /// </summary>
    public static MtRecruitmentStatusTrackingDelete mtRecruitmentStatusTrackingDelete
    {
        get => HttpData.Get<MtRecruitmentStatusTrackingDelete>("mtRecruitmentStatusTrackingDelete")!;
        set => HttpData["mtRecruitmentStatusTrackingDelete"] = value;
    }

    /// <summary>
    /// Page class for MTRecruitmentStatusTracking
    /// </summary>
    public class MtRecruitmentStatusTrackingDelete : MtRecruitmentStatusTrackingDeleteBase
    {
        // Constructor
        public MtRecruitmentStatusTrackingDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRecruitmentStatusTrackingDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRecruitmentStatusTrackingDeleteBase : MtRecruitmentStatusTracking
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRecruitmentStatusTrackingDelete";
        ...
        // Constructor
        public MtRecruitmentStatusTrackingDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtRecruitmentStatusTrackingDelete";
        ...
        // Constructor
        public MtRecruitmentStatusTrackingDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtRecruitmentStatusTrackingList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtRecruitmentStatusTrackingList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtRecruitmentStatusTrackingDelete?.PageRender();
            }
            return PageResult();
        }
