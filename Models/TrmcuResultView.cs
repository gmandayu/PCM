...
public partial class PCM {
    ...
    /// trmcuResultView
    /// </summary>
    public static TrmcuResultView trmcuResultView
    {
        get => HttpData.Get<TrmcuResultView>("trmcuResultView")!;
        set => HttpData["trmcuResultView"] = value;
    }

    /// <summary>
    /// Page class for TRMCUResult
    /// </summary>
    public class TrmcuResultView : TrmcuResultViewBase
    {
        // Constructor
        public TrmcuResultView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrmcuResultView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrmcuResultViewBase : TrmcuResult
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trmcuResultView";
        ...
        // Page name
        public string PageName => "TrmcuResultView";
        ...
        // Constructor
        public TrmcuResultViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("McuResult_ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "TrmcuResultList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TrmcuResultList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fTRMCUResultview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
