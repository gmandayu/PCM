...
public partial class PCM {
    /// <summary>
    /// crewBankAccountForAdminViewModeDelete
    /// </summary>
    public static CrewBankAccountForAdminViewModeDelete crewBankAccountForAdminViewModeDelete
    {
        get => HttpData.Get<CrewBankAccountForAdminViewModeDelete>("crewBankAccountForAdminViewModeDelete")!;
        set => HttpData["crewBankAccountForAdminViewModeDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewBankAccountForAdminViewMode
    /// </summary>
    public class CrewBankAccountForAdminViewModeDelete : CrewBankAccountForAdminViewModeDeleteBase
    {
        // Constructor
        public CrewBankAccountForAdminViewModeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewBankAccountForAdminViewModeDelete() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastDeletedBankAccountCrewID = Session.GetInt("lastDeletedBankAccountCrewID");
            Session.Remove("lastDeletedBankAccountCrewID");
            url = "CrewBankAccountForAdminViewModeList?crewID=" + ConvertToString(lastDeletedBankAccountCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewBankAccountForAdminViewModeDeleteBase : CrewBankAccountForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewBankAccountForAdminViewModeDelete";
        ...
        // Constructor
        public CrewBankAccountForAdminViewModeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewBankAccountForAdminViewModeDelete";
        ...
        // Constructor
        public CrewBankAccountForAdminViewModeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewBankAccountForAdminViewModeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewBankAccountForAdminViewModeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewBankAccountForAdminViewModeDelete?.PageRender();
            }
            return PageResult();
        }
