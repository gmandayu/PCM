...
public partial class PCM {
    /// <summary>
    /// vCrewBlacklistForAdminEdit
    /// </summary>
    public static VCrewBlacklistForAdminEdit vCrewBlacklistForAdminEdit
    {
        get => HttpData.Get<VCrewBlacklistForAdminEdit>("vCrewBlacklistForAdminEdit")!;
        set => HttpData["vCrewBlacklistForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for v_CrewBlacklistForAdmin
    /// </summary>
    public class VCrewBlacklistForAdminEdit : VCrewBlacklistForAdminEditBase
    {
        // Constructor
        public VCrewBlacklistForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewBlacklistForAdminEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewBlacklistForAdminEditBase : VCrewBlacklistForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewBlacklistForAdminEdit";
        ...
        // Constructor
        public VCrewBlacklistForAdminEditBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewBlacklistForAdminEdit";
        ...
        // Constructor
        public VCrewBlacklistForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("VCrewBlacklistForAdminList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "VCrewBlacklistForAdminList")
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "VCrewBlacklistForAdminList") {
                                ...
                                returnUrl = "VCrewBlacklistForAdminList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewBlacklistForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
