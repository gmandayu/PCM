...
public partial class PCM {
    /// <summary>
    /// crewFormalEducationForAdminViewModeSearch
    /// </summary>
    public static CrewFormalEducationForAdminViewModeSearch crewFormalEducationForAdminViewModeSearch
    {
        get => HttpData.Get<CrewFormalEducationForAdminViewModeSearch>("crewFormalEducationForAdminViewModeSearch")!;
        set => HttpData["crewFormalEducationForAdminViewModeSearch"] = value;
    }

    /// <summary>
    /// Page class for CrewFormalEducationForAdminViewMode
    /// </summary>
    public class CrewFormalEducationForAdminViewModeSearch : CrewFormalEducationForAdminViewModeSearchBase
    {
        // Constructor
        public CrewFormalEducationForAdminViewModeSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFormalEducationForAdminViewModeSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFormalEducationForAdminViewModeSearchBase : CrewFormalEducationForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFormalEducationForAdminViewModeSearch";
        ...
        // Constructor
        public CrewFormalEducationForAdminViewModeSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewFormalEducationForAdminViewModeSearch";
        ...
        // Constructor
        public CrewFormalEducationForAdminViewModeSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "CrewFormalEducationForAdminViewModeList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFormalEducationForAdminViewModeSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                StartDate.EditValue = UnformatDateTime(StartDate.AdvancedSearch.SearchValue, StartDate.FormatPattern); // DN
                StartDate.PlaceHolder = RemoveHtml(StartDate.Caption);

                // EndDate
                EndDate.SetupEditAttributes();
                EndDate.EditValue = UnformatDateTime(EndDate.AdvancedSearch.SearchValue, EndDate.FormatPattern); // DN
