...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static TrEmailHistory trEmailHistory
    {
        get => HttpData.Resolve<TrEmailHistory>("TREmailHistory");
        set => HttpData["TREmailHistory"] = value;
    }

    /// <summary>
    /// Table class for TREmailHistory
    /// </summary>
    public class TrEmailHistory : DbTable, IQueryFactory
    {
        ...
        public TrEmailHistory()
        {
            ...
            Name = "TREmailHistory";
            Type = "TABLE";
            UpdateTable = "dbo.TREmailHistory"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            To = new (this, "x_To", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TREmailHistory", "To", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("To", To);
            ...
            MTCrew_ID = new (this, "x_MTCrew_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TREmailHistory", "MTCrew_ID", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.TREmailHistory";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "TrEmailHistoryView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TrEmailHistoryEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TrEmailHistoryAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TrEmailHistoryView",
                Config.ApiAddAction => "TrEmailHistoryAdd",
                Config.ApiEditAction => "TrEmailHistoryEdit",
                Config.ApiDeleteAction => "TrEmailHistoryDelete",
                Config.ApiListAction => "TrEmailHistoryList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TrEmailHistoryList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TrEmailHistoryView", parm);
            else
                url = KeyUrl("TrEmailHistoryView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TrEmailHistoryAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TrEmailHistoryAdd?" + parm;
            else
                url = "TrEmailHistoryAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TrEmailHistoryEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrEmailHistoryList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TrEmailHistoryAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TrEmailHistoryList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TrEmailHistoryDelete")); // DN
        ...
        {
            string pageName = "TrEmailHistoryList";
