...
public partial class PCM {
    ...
    /// mtRankEdit
    /// </summary>
    public static MtRankEdit mtRankEdit
    {
        get => HttpData.Get<MtRankEdit>("mtRankEdit")!;
        set => HttpData["mtRankEdit"] = value;
    }

    /// <summary>
    /// Page class for MTRank
    /// </summary>
    public class MtRankEdit : MtRankEditBase
    {
        // Constructor
        public MtRankEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRankEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRankEditBase : MtRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRankEdit";
        ...
        // Page name
        public string PageName => "MtRankEdit";
        ...
        // Constructor
        public MtRankEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtRankList"); // No matching record, return to list
                        }
                    break;
