...
public partial class PCM {
    /// <summary>
    /// mtMedicalCertificateSearch
    /// </summary>
    public static MtMedicalCertificateSearch mtMedicalCertificateSearch
    {
        get => HttpData.Get<MtMedicalCertificateSearch>("mtMedicalCertificateSearch")!;
        set => HttpData["mtMedicalCertificateSearch"] = value;
    }

    /// <summary>
    /// Page class for MTMedicalCertificate
    /// </summary>
    public class MtMedicalCertificateSearch : MtMedicalCertificateSearchBase
    {
        // Constructor
        public MtMedicalCertificateSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtMedicalCertificateSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtMedicalCertificateSearchBase : MtMedicalCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtMedicalCertificateSearch";
        ...
        // Constructor
        public MtMedicalCertificateSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtMedicalCertificateSearch";
        ...
        // Constructor
        public MtMedicalCertificateSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtMedicalCertificateList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtMedicalCertificateSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string BuildAdvancedSearch() {
            ...
            BuildSearchUrl(ref srchUrl, Enabled, true); // Enabled
        ...
        protected void LoadSearchValues() {
            ...
            // Enabled
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_Enabled"))
                    Enabled.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_Enabled");
            if (Form.ContainsKey("z_Enabled"))
                Enabled.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_Enabled");
