...
public partial class PCM {
    /// <summary>
    /// crewAppraisalForAdminDelete
    /// </summary>
    public static CrewAppraisalForAdminDelete crewAppraisalForAdminDelete
    {
        get => HttpData.Get<CrewAppraisalForAdminDelete>("crewAppraisalForAdminDelete")!;
        set => HttpData["crewAppraisalForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewAppraisalForAdmin
    /// </summary>
    public class CrewAppraisalForAdminDelete : CrewAppraisalForAdminDeleteBase
    {
        // Constructor
        public CrewAppraisalForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewAppraisalForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewAppraisalForAdminDeleteBase : CrewAppraisalForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewAppraisalForAdminDelete";
        ...
        // Constructor
        public CrewAppraisalForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewAppraisalForAdminDelete";
        ...
        // Constructor
        public CrewAppraisalForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewAppraisalForAdminList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewAppraisalForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewAppraisalForAdminDelete?.PageRender();
            }
            return PageResult();
        }
