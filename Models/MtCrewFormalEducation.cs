...
public partial class PCM {
    /// <summary>
    /// mtCrewFormalEducation
    /// </summary>
    [MaybeNull]
    public static MtCrewFormalEducation mtCrewFormalEducation
    {
        get => HttpData.Resolve<MtCrewFormalEducation>("MTCrewFormalEducation");
        set => HttpData["MTCrewFormalEducation"] = value;
    }

    /// <summary>
    /// Table class for MTCrewFormalEducation
    /// </summary>
    public class MtCrewFormalEducation : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtCrewFormalEducation()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTCrewFormalEducation";
            Name = "MTCrewFormalEducation";
            Type = "TABLE";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            EducationLevel = new (this, "x_EducationLevel", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[EducationLevel]",
                DateTimeFormat = -1,
                VirtualExpression = "[EducationLevel]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "EducationLevel", "CustomMsg"),
                IsUpload = false
            };
            EducationLevel.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("EducationLevel", "MTCrewFormalEducation", true, "EducationLevel", new List<string> {"EducationLevel", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("EducationLevel", "MTCrewFormalEducation", true, "EducationLevel", new List<string> {"EducationLevel", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("EducationLevel", "MTCrewFormalEducation", true, "EducationLevel", new List<string> {"EducationLevel", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            SchoolName = new (this, "x_SchoolName", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[SchoolName]",
                DateTimeFormat = -1,
                VirtualExpression = "[SchoolName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "SchoolName", "CustomMsg"),
                IsUpload = false
            };
            SchoolName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("SchoolName", "MTCrewFormalEducation", true, "SchoolName", new List<string> {"SchoolName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("SchoolName", "MTCrewFormalEducation", true, "SchoolName", new List<string> {"SchoolName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("SchoolName", "MTCrewFormalEducation", true, "SchoolName", new List<string> {"SchoolName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            City = new (this, "x_City", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "City", "CustomMsg"),
                IsUpload = false
            };
            City.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("City", "MTCrewFormalEducation", true, "City", new List<string> {"City", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("City", "MTCrewFormalEducation", true, "City", new List<string> {"City", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("City", "MTCrewFormalEducation", true, "City", new List<string> {"City", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Attachment = new (this, "x_Attachment", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "Attachment", "CustomMsg"),
                IsUpload = true
            };
            Attachment.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Attachment", "MTCrewFormalEducation", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Attachment", "MTCrewFormalEducation", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Attachment", "MTCrewFormalEducation", true, "Attachment", new List<string> {"Attachment", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Attachment", Attachment);

            // StartDate
            StartDate = new (this, "x_StartDate", 133, SqlDbType.DateTime) {
                Name = "StartDate",
                Expression = "[StartDate]",
                BasicSearchExpression = CastDateFieldForLike("[StartDate]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "StartDate", "CustomMsg"),
                IsUpload = false
            };
            StartDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("StartDate", "MTCrewFormalEducation", true, "StartDate", new List<string> {"StartDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("StartDate", "MTCrewFormalEducation", true, "StartDate", new List<string> {"StartDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("StartDate", "MTCrewFormalEducation", true, "StartDate", new List<string> {"StartDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("StartDate", StartDate);

            // EndDate
            EndDate = new (this, "x_EndDate", 133, SqlDbType.DateTime) {
                Name = "EndDate",
                Expression = "[EndDate]",
                BasicSearchExpression = CastDateFieldForLike("[EndDate]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "EndDate", "CustomMsg"),
                IsUpload = false
            };
            EndDate.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("EndDate", "MTCrewFormalEducation", true, "EndDate", new List<string> {"EndDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("EndDate", "MTCrewFormalEducation", true, "EndDate", new List<string> {"EndDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("EndDate", "MTCrewFormalEducation", true, "EndDate", new List<string> {"EndDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCrewFormalEducation", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCrewFormalEducation", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCrewFormalEducation", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewFormalEducation", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewFormalEducation", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewFormalEducation", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewFormalEducation", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "MtCrewFormalEducationList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "MtCrewFormalEducationView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCrewFormalEducationEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCrewFormalEducationAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCrewFormalEducationView",
                Config.ApiAddAction => "MtCrewFormalEducationAdd",
                Config.ApiEditAction => "MtCrewFormalEducationEdit",
                Config.ApiDeleteAction => "MtCrewFormalEducationDelete",
                Config.ApiListAction => "MtCrewFormalEducationList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCrewFormalEducationList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCrewFormalEducationView", parm);
            else
                url = KeyUrl("MtCrewFormalEducationView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCrewFormalEducationAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtCrewFormalEducationAdd?" + parm;
            else
                url = "MtCrewFormalEducationAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewFormalEducationEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewFormalEducationList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewFormalEducationAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewFormalEducationList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCrewFormalEducationDelete")); // DN
        ...
        {
            string pageName = "MtCrewFormalEducationList";
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!EducationLevel.Raw)
                EducationLevel.CurrentValue = HtmlDecode(EducationLevel.CurrentValue);
            EducationLevel.EditValue = HtmlEncode(EducationLevel.CurrentValue);
            ...
            StartDate.EditValue = FormatDateTime(StartDate.CurrentValue, StartDate.FormatPattern); // DN
            StartDate.PlaceHolder = RemoveHtml(StartDate.Caption);

            // EndDate
            EndDate.SetupEditAttributes();
            EndDate.EditValue = FormatDateTime(EndDate.CurrentValue, EndDate.FormatPattern); // DN
