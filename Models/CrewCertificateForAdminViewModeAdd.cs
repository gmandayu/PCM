...
public partial class PCM {
    /// <summary>
    /// crewCertificateForAdminViewModeAdd
    /// </summary>
    public static CrewCertificateForAdminViewModeAdd crewCertificateForAdminViewModeAdd
    {
        get => HttpData.Get<CrewCertificateForAdminViewModeAdd>("crewCertificateForAdminViewModeAdd")!;
        set => HttpData["crewCertificateForAdminViewModeAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewCertificateForAdminViewMode
    /// </summary>
    public class CrewCertificateForAdminViewModeAdd : CrewCertificateForAdminViewModeAddBase
    {
        // Constructor
        public CrewCertificateForAdminViewModeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewCertificateForAdminViewModeAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastAddedCertificateCrewID = Session.GetInt("lastAddedCertificateCrewID");
            Session.Remove("lastAddedCertificateCrewID");
            url = "CrewCertificateForAdminViewModeList?crewID=" + ConvertToString(lastAddedCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewCertificateForAdminViewModeAddBase : CrewCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewCertificateForAdminViewModeAdd";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewCertificateForAdminViewModeAdd";
        ...
        // Constructor
        public CrewCertificateForAdminViewModeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewCertificateForAdminViewModeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "CrewCertificateForAdminViewModeList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "CrewCertificateForAdminViewModeView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "CrewCertificateForAdminViewModeList") {
                                ...
                                returnUrl = "CrewCertificateForAdminViewModeList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewCertificateForAdminViewModeAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("CrewCertificateForAdminViewModeList")), "", TableVar, true);
