...
public partial class PCM {
    ...
    /// mtCrewEdit
    /// </summary>
    public static MtCrewEdit mtCrewEdit
    {
        get => HttpData.Get<MtCrewEdit>("mtCrewEdit")!;
        set => HttpData["mtCrewEdit"] = value;
    }

    /// <summary>
    /// Page class for MTCrew
    /// </summary>
    public class MtCrewEdit : MtCrewEditBase
    {
        // Constructor
        public MtCrewEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCrewEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewEditBase : MtCrew
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewEdit";
        ...
        // Page name
        public string PageName => "MtCrewEdit";
        ...
        // Constructor
        public MtCrewEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtCrewList"); // No matching record, return to list
                        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            if (detailTblVar.Contains("MTCrewCertificate") && mtCrewCertificate?.DetailEdit == true) {
            ...
            if (detailTblVar.Contains("MTCrewDocument") && mtCrewDocument?.DetailEdit == true) {
            ...
            if (detailTblVar.Contains("MTCrewExperience") && mtCrewExperience?.DetailEdit == true) {
            ...
            if (detailTblVar.Contains("MTCrewFamily") && mtCrewFamily?.DetailEdit == true) {
            ...
            if (detailTblVar.Contains("MTCrewMedicalHistory") && mtCrewMedicalHistory?.DetailEdit == true) {
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // PrimaryAddressFax
            PrimaryAddressFax.SetDbValue(rsnew, PrimaryAddressFax.CurrentValue, PrimaryAddressFax.ReadOnly);
            ...
            // ContactMethodEmail
            ContactMethodEmail.SetDbValue(rsnew, ConvertToBool(ContactMethodEmail.CurrentValue), ContactMethodEmail.ReadOnly);

            // ContactMethodFax
            ContactMethodFax.SetDbValue(rsnew, ConvertToBool(ContactMethodFax.CurrentValue), ContactMethodFax.ReadOnly);

            // ContactMethodMobilePhone
            ContactMethodMobilePhone.SetDbValue(rsnew, ConvertToBool(ContactMethodMobilePhone.CurrentValue), ContactMethodMobilePhone.ReadOnly);

            // ContactMethodHomePhone
            ContactMethodHomePhone.SetDbValue(rsnew, ConvertToBool(ContactMethodHomePhone.CurrentValue), ContactMethodHomePhone.ReadOnly);

            // ContactMethodPost
            ContactMethodPost.SetDbValue(rsnew, ConvertToBool(ContactMethodPost.CurrentValue), ContactMethodPost.ReadOnly);

            // CollarSize
            CollarSize.SetDbValue(rsnew, CollarSize.CurrentValue, CollarSize.ReadOnly);

            // ChestSize
            ChestSize.SetDbValue(rsnew, ChestSize.CurrentValue, ChestSize.ReadOnly);

            // WaistSize
            WaistSize.SetDbValue(rsnew, WaistSize.CurrentValue, WaistSize.ReadOnly);

            // InsideLegSize
            InsideLegSize.SetDbValue(rsnew, InsideLegSize.CurrentValue, InsideLegSize.ReadOnly);

            // CapSize
            CapSize.SetDbValue(rsnew, CapSize.CurrentValue, CapSize.ReadOnly);

            // SweaterSize_ClothesSizeID
            SweaterSize_ClothesSizeID.SetDbValue(rsnew, SweaterSize_ClothesSizeID.CurrentValue, SweaterSize_ClothesSizeID.ReadOnly);

            // BoilersuitSize_ClothesSizeID
            BoilersuitSize_ClothesSizeID.SetDbValue(rsnew, BoilersuitSize_ClothesSizeID.CurrentValue, BoilersuitSize_ClothesSizeID.ReadOnly);
            ...
            // NomineeValidVisa
            NomineeValidVisa.SetDbValue(rsnew, NomineeValidVisa.CurrentValue, NomineeValidVisa.ReadOnly);

            // BankName
            BankName.SetDbValue(rsnew, BankName.CurrentValue, BankName.ReadOnly);

            // BankAddress
            BankAddress.SetDbValue(rsnew, BankAddress.CurrentValue, BankAddress.ReadOnly);

            // BankAccountName
            BankAccountName.SetDbValue(rsnew, BankAccountName.CurrentValue, BankAccountName.ReadOnly);

            // BankAccountNumber
            BankAccountNumber.SetDbValue(rsnew, BankAccountNumber.CurrentValue, BankAccountNumber.ReadOnly);

            // BankSortCode
            BankSortCode.SetDbValue(rsnew, BankSortCode.CurrentValue, BankSortCode.ReadOnly);

            // MNOPF
            MNOPF.SetDbValue(rsnew, MNOPF.CurrentValue, MNOPF.ReadOnly);

            // MembershipNumber
            MembershipNumber.SetDbValue(rsnew, MembershipNumber.CurrentValue, MembershipNumber.ReadOnly);

            // NationalInsuranceNumber
            NationalInsuranceNumber.SetDbValue(rsnew, NationalInsuranceNumber.CurrentValue, NationalInsuranceNumber.ReadOnly);

            // AVC
            AVC.SetDbValue(rsnew, AVC.CurrentValue, AVC.ReadOnly);
            ...
            // FinalAcceptedDate
            FinalAcceptedDate.SetDbValue(rsnew, ConvertToDateTimeOffset(FinalAcceptedDate.CurrentValue, DateTimeStyles.AssumeUniversal), FinalAcceptedDate.ReadOnly);
            ...
            // RevisedReason
            RevisedReason.SetDbValue(rsnew, RevisedReason.CurrentValue, RevisedReason.ReadOnly);

            // RevisedDateTime
            RevisedDateTime.SetDbValue(rsnew, ConvertToDateTimeOffset(RevisedDateTime.CurrentValue, DateTimeStyles.AssumeUniversal), RevisedDateTime.ReadOnly);
                    ...
                    if (result) {
                        if (detailTblVar.Contains("MTCrewCertificate") && mtCrewCertificate?.DetailEdit == true) {
                            ...
                            if (mtCrewCertificateGrid != null) {
                                ...
                                result = await mtCrewCertificateGrid.GridUpdate();
                    ...
                    if (result) {
                        if (detailTblVar.Contains("MTCrewDocument") && mtCrewDocument?.DetailEdit == true) {
                            ...
                            if (mtCrewDocumentGrid != null) {
                                ...
                                result = await mtCrewDocumentGrid.GridUpdate();
                                Security.LoadCurrentUserLevel(ProjectID + TableName); // Restore user level of master table
                            }
                        }
                    }
                    if (result) {
                        if (detailTblVar.Contains("MTCrewExperience") && mtCrewExperience?.DetailEdit == true) {
                            ...
                            if (mtCrewExperienceGrid != null) {
                                ...
                                result = await mtCrewExperienceGrid.GridUpdate();
                                Security.LoadCurrentUserLevel(ProjectID + TableName); // Restore user level of master table
                            }
                        }
                    }
                    if (result) {
                        if (detailTblVar.Contains("MTCrewFamily") && mtCrewFamily?.DetailEdit == true) {
                            ...
                            if (mtCrewFamilyGrid != null) {
                                ...
                                result = await mtCrewFamilyGrid.GridUpdate();
                                Security.LoadCurrentUserLevel(ProjectID + TableName); // Restore user level of master table
                            }
                        }
                    }
                    if (result) {
                        if (detailTblVar.Contains("MTCrewMedicalHistory") && mtCrewMedicalHistory?.DetailEdit == true) {
                            ...
                            if (mtCrewMedicalHistoryGrid != null) {
                                ...
                                result = await mtCrewMedicalHistoryGrid.GridUpdate();
                                Security.LoadCurrentUserLevel(ProjectID + TableName); // Restore user level of master table
                            }
                        }
                    }
        ...
        protected void SetupDetailParms() {
            ...
            if (!Empty(detailTblVar)) {
                ...
                if (detailTblVars.Contains("MTCrewCertificate")) {
                    ...
                    if (mtCrewCertificateGrid?.DetailEdit ?? false) {
                        mtCrewCertificateGrid.CurrentMode = "edit";
                        mtCrewCertificateGrid.CurrentAction = "gridedit";
                ...
                if (detailTblVars.Contains("MTCrewDocument")) {
                    ...
                    if (mtCrewDocumentGrid?.DetailEdit ?? false) {
                        mtCrewDocumentGrid.CurrentMode = "edit";
                        mtCrewDocumentGrid.CurrentAction = "gridedit";
                ...
                if (detailTblVars.Contains("MTCrewExperience")) {
                    ...
                    if (mtCrewExperienceGrid?.DetailEdit ?? false) {
                        mtCrewExperienceGrid.CurrentMode = "edit";
                        mtCrewExperienceGrid.CurrentAction = "gridedit";
                ...
                if (detailTblVars.Contains("MTCrewFamily")) {
                    ...
                    if (mtCrewFamilyGrid?.DetailEdit ?? false) {
                        mtCrewFamilyGrid.CurrentMode = "edit";
                        mtCrewFamilyGrid.CurrentAction = "gridedit";
                ...
                if (detailTblVars.Contains("MTCrewMedicalHistory")) {
                    ...
                    if (mtCrewMedicalHistoryGrid?.DetailEdit ?? false) {
                        mtCrewMedicalHistoryGrid.CurrentMode = "edit";
                        mtCrewMedicalHistoryGrid.CurrentAction = "gridedit";
