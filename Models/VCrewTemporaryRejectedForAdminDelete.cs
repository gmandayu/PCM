...
public partial class PCM {
    /// <summary>
    /// vCrewTemporaryRejectedForAdminDelete
    /// </summary>
    public static VCrewTemporaryRejectedForAdminDelete vCrewTemporaryRejectedForAdminDelete
    {
        get => HttpData.Get<VCrewTemporaryRejectedForAdminDelete>("vCrewTemporaryRejectedForAdminDelete")!;
        set => HttpData["vCrewTemporaryRejectedForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for v_CrewTemporaryRejectedForAdmin
    /// </summary>
    public class VCrewTemporaryRejectedForAdminDelete : VCrewTemporaryRejectedForAdminDeleteBase
    {
        // Constructor
        public VCrewTemporaryRejectedForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewTemporaryRejectedForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewTemporaryRejectedForAdminDeleteBase : VCrewTemporaryRejectedForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewTemporaryRejectedForAdminDelete";
        ...
        // Constructor
        public VCrewTemporaryRejectedForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewTemporaryRejectedForAdminDelete";
        ...
        // Constructor
        public VCrewTemporaryRejectedForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("VCrewTemporaryRejectedForAdminList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("VCrewTemporaryRejectedForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewTemporaryRejectedForAdminDelete?.PageRender();
            }
            return PageResult();
        }
