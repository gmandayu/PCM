...
public partial class PCM {
    ...
    /// registrationEdit
    /// </summary>
    public static RegistrationEdit registrationEdit
    {
        get => HttpData.Get<RegistrationEdit>("registrationEdit")!;
        set => HttpData["registrationEdit"] = value;
    }

    /// <summary>
    /// Page class for Registration
    /// </summary>
    public class RegistrationEdit : RegistrationEditBase
    {
        // Constructor
        public RegistrationEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RegistrationEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RegistrationEditBase : Registration
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "registrationEdit";
        ...
        // Page name
        public string PageName => "RegistrationEdit";
        ...
        // Constructor
        public RegistrationEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("RegistrationList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) {
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "RegistrationList") {
                                ...
                                returnUrl = "RegistrationList"; // Return list page content
                            }
                        }
