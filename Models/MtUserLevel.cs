...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtUserLevel mtUserLevel
    {
        get => HttpData.Resolve<MtUserLevel>("MTUserLevel");
        set => HttpData["MTUserLevel"] = value;
    }

    /// <summary>
    /// Table class for MTUserLevel
    /// </summary>
    public class MtUserLevel : DbTable, IQueryFactory
    {
        ...
        public MtUserLevel()
        {
            ...
            Name = "MTUserLevel";
            Type = "TABLE";
            UpdateTable = "dbo.MTUserLevel"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            UserLevelID = new (this, "x_UserLevelID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTUserLevel", "UserLevelID", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserLevelName = new (this, "x_UserLevelName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTUserLevel", "UserLevelName", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "MtUserLevelView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtUserLevelEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtUserLevelAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtUserLevelView",
                Config.ApiAddAction => "MtUserLevelAdd",
                Config.ApiEditAction => "MtUserLevelEdit",
                Config.ApiDeleteAction => "MtUserLevelDelete",
                Config.ApiListAction => "MtUserLevelList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtUserLevelList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtUserLevelView", parm);
            else
                url = KeyUrl("MtUserLevelView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtUserLevelAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtUserLevelEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtUserLevelList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtUserLevelAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtUserLevelList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtUserLevelDelete")); // DN
        ...
        {
            string pageName = "MtUserLevelList";
