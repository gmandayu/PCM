...
public partial class PCM {
    ...
    /// trmcuResultDelete
    /// </summary>
    public static TrmcuResultDelete trmcuResultDelete
    {
        get => HttpData.Get<TrmcuResultDelete>("trmcuResultDelete")!;
        set => HttpData["trmcuResultDelete"] = value;
    }

    /// <summary>
    /// Page class for TRMCUResult
    /// </summary>
    public class TrmcuResultDelete : TrmcuResultDeleteBase
    {
        // Constructor
        public TrmcuResultDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrmcuResultDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrmcuResultDeleteBase : TrmcuResult
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trmcuResultDelete";
        ...
        // Page name
        public string PageName => "TrmcuResultDelete";
        ...
        // Constructor
        public TrmcuResultDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("TrmcuResultList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("TrmcuResultList"); // Return to list
                }
            }
