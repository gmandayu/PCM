...
public partial class PCM {
    /// <summary>
    /// crewDocumentForAdminViewModeEdit
    /// </summary>
    public static CrewDocumentForAdminViewModeEdit crewDocumentForAdminViewModeEdit
    {
        get => HttpData.Get<CrewDocumentForAdminViewModeEdit>("crewDocumentForAdminViewModeEdit")!;
        set => HttpData["crewDocumentForAdminViewModeEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewDocumentForAdminViewMode
    /// </summary>
    public class CrewDocumentForAdminViewModeEdit : CrewDocumentForAdminViewModeEditBase
    {
        // Constructor
        public CrewDocumentForAdminViewModeEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewDocumentForAdminViewModeEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewDocumentForAdminViewModeList?crewID=" + ConvertToString(lastUpdatedDocumentCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewDocumentForAdminViewModeEditBase : CrewDocumentForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewDocumentForAdminViewModeEdit";
        ...
        // Constructor
        public CrewDocumentForAdminViewModeEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewDocumentForAdminViewModeEdit";
        ...
        // Constructor
        public CrewDocumentForAdminViewModeEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewDocumentForAdminViewModeList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewDocumentForAdminViewModeEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
