...
public partial class PCM {
    /// <summary>
    /// mtCertificateOnRankAdd
    /// </summary>
    public static MtCertificateOnRankAdd mtCertificateOnRankAdd
    {
        get => HttpData.Get<MtCertificateOnRankAdd>("mtCertificateOnRankAdd")!;
        set => HttpData["mtCertificateOnRankAdd"] = value;
    }

    /// <summary>
    /// Page class for MTCertificateOnRank
    /// </summary>
    public class MtCertificateOnRankAdd : MtCertificateOnRankAddBase
    {
        // Constructor
        public MtCertificateOnRankAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCertificateOnRankAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCertificateOnRankAddBase : MtCertificateOnRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCertificateOnRankAdd";
        ...
        // Constructor
        public MtCertificateOnRankAddBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCertificateOnRankAdd";
        ...
        // Constructor
        public MtCertificateOnRankAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtCertificateOnRankList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtCertificateOnRankList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtCertificateOnRankView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtCertificateOnRankList") {
                                ...
                                returnUrl = "MtCertificateOnRankList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCertificateOnRankAdd?.PageRender();
            }
            return PageResult();
        }
