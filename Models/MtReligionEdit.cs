...
public partial class PCM {
    ...
    /// mtReligionEdit
    /// </summary>
    public static MtReligionEdit mtReligionEdit
    {
        get => HttpData.Get<MtReligionEdit>("mtReligionEdit")!;
        set => HttpData["mtReligionEdit"] = value;
    }

    /// <summary>
    /// Page class for MTReligion
    /// </summary>
    public class MtReligionEdit : MtReligionEditBase
    {
        // Constructor
        public MtReligionEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtReligionEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtReligionEditBase : MtReligion
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtReligionEdit";
        ...
        // Page name
        public string PageName => "MtReligionEdit";
        ...
        // Constructor
        public MtReligionEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtReligionList"); // No matching record, return to list
                        }
                    break;
