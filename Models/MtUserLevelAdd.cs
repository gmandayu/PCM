...
public partial class PCM {
    ...
    /// mtUserLevelAdd
    /// </summary>
    public static MtUserLevelAdd mtUserLevelAdd
    {
        get => HttpData.Get<MtUserLevelAdd>("mtUserLevelAdd")!;
        set => HttpData["mtUserLevelAdd"] = value;
    }

    /// <summary>
    /// Page class for MTUserLevel
    /// </summary>
    public class MtUserLevelAdd : MtUserLevelAddBase
    {
        // Constructor
        public MtUserLevelAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserLevelAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserLevelAddBase : MtUserLevel
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserLevelAdd";
        ...
        // Page name
        public string PageName => "MtUserLevelAdd";
        ...
        // Constructor
        public MtUserLevelAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (postBack) {
                ...
                foreach (string privilege in Config.Privileges)
                    priv += CurrentForm.GetInt("x__Allow" + TitleCase(privilege));
                if (!IsSysAdmin())
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtUserLevelList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtUserLevelList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtUserLevelView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtUserLevelList") {
                                ...
                                returnUrl = "MtUserLevelList"; // Return list page content
                            }
                        }
