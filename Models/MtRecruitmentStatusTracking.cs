...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusTracking
    /// </summary>
    [MaybeNull]
    public static MtRecruitmentStatusTracking mtRecruitmentStatusTracking
    {
        get => HttpData.Resolve<MtRecruitmentStatusTracking>("MTRecruitmentStatusTracking");
        set => HttpData["MTRecruitmentStatusTracking"] = value;
    }

    /// <summary>
    /// Table class for MTRecruitmentStatusTracking
    /// </summary>
    public class MtRecruitmentStatusTracking : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> MTRecruitmentStatusID;

        public readonly DbField<SqlDbType> Flag;

        public readonly DbField<SqlDbType> FlagDescription;
        ...
        // Constructor
        public MtRecruitmentStatusTracking()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTRecruitmentStatusTracking";
            Name = "MTRecruitmentStatusTracking";
            Type = "TABLE";
            UpdateTable = "dbo.MTRecruitmentStatusTracking"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MTCrewID", MTCrewID);

            // MTRecruitmentStatusID
            MTRecruitmentStatusID = new (this, "x_MTRecruitmentStatusID", 3, SqlDbType.Int) {
                Name = "MTRecruitmentStatusID",
                Expression = "[MTRecruitmentStatusID]",
                BasicSearchExpression = "CAST([MTRecruitmentStatusID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[MTRecruitmentStatusID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "MTRecruitmentStatusID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MTRecruitmentStatusID", MTRecruitmentStatusID);

            // Flag
            Flag = new (this, "x_Flag", 3, SqlDbType.Int) {
                Name = "Flag",
                Expression = "[Flag]",
                BasicSearchExpression = "CAST([Flag] AS NVARCHAR)",
                DateTimeFormat = -1,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "Flag", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Flag", Flag);

            // FlagDescription
            FlagDescription = new (this, "x_FlagDescription", 200, SqlDbType.VarChar) {
                Name = "FlagDescription",
                Expression = "[FlagDescription]",
                UseBasicSearch = true,
                BasicSearchExpression = "[FlagDescription]",
                DateTimeFormat = -1,
                VirtualExpression = "[FlagDescription]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "FlagDescription", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("FlagDescription", FlagDescription);
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTRecruitmentStatusTracking", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.MTRecruitmentStatusTracking";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                MTRecruitmentStatusID.DbValue = row["MTRecruitmentStatusID"]; // Set DB value only
                Flag.DbValue = row["Flag"]; // Set DB value only
                FlagDescription.DbValue = row["FlagDescription"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "MtRecruitmentStatusTrackingList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "MtRecruitmentStatusTrackingView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtRecruitmentStatusTrackingEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtRecruitmentStatusTrackingAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtRecruitmentStatusTrackingView",
                Config.ApiAddAction => "MtRecruitmentStatusTrackingAdd",
                Config.ApiEditAction => "MtRecruitmentStatusTrackingEdit",
                Config.ApiDeleteAction => "MtRecruitmentStatusTrackingDelete",
                Config.ApiListAction => "MtRecruitmentStatusTrackingList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtRecruitmentStatusTrackingList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtRecruitmentStatusTrackingView", parm);
            else
                url = KeyUrl("MtRecruitmentStatusTrackingView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtRecruitmentStatusTrackingAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtRecruitmentStatusTrackingAdd?" + parm;
            else
                url = "MtRecruitmentStatusTrackingAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtRecruitmentStatusTrackingEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtRecruitmentStatusTrackingList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtRecruitmentStatusTrackingAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtRecruitmentStatusTrackingList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtRecruitmentStatusTrackingDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            MTRecruitmentStatusID.SetDbValue(dr["MTRecruitmentStatusID"]);
            Flag.SetDbValue(dr["Flag"]);
            FlagDescription.SetDbValue(dr["FlagDescription"]);
        ...
        {
            string pageName = "MtRecruitmentStatusTrackingList";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(MTRecruitmentStatusID);
                        doc.ExportCaption(Flag);
                        doc.ExportCaption(FlagDescription);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(MTRecruitmentStatusID);
                            await doc.ExportField(Flag);
                            await doc.ExportField(FlagDescription);
