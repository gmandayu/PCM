...
public partial class PCM {
    /// <summary>
    /// notificationForAdminSearch
    /// </summary>
    public static NotificationForAdminSearch notificationForAdminSearch
    {
        get => HttpData.Get<NotificationForAdminSearch>("notificationForAdminSearch")!;
        set => HttpData["notificationForAdminSearch"] = value;
    }

    /// <summary>
    /// Page class for NotificationForAdmin
    /// </summary>
    public class NotificationForAdminSearch : NotificationForAdminSearchBase
    {
        // Constructor
        public NotificationForAdminSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public NotificationForAdminSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class NotificationForAdminSearchBase : NotificationForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "notificationForAdminSearch";
        ...
        // Constructor
        public NotificationForAdminSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "NotificationForAdminSearch";
        ...
        // Constructor
        public NotificationForAdminSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "NotificationForAdminList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                notificationForAdminSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("NotificationForAdminList")), "", TableVar, true);
