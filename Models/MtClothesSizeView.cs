...
public partial class PCM {
    ...
    /// mtClothesSizeView
    /// </summary>
    public static MtClothesSizeView mtClothesSizeView
    {
        get => HttpData.Get<MtClothesSizeView>("mtClothesSizeView")!;
        set => HttpData["mtClothesSizeView"] = value;
    }

    /// <summary>
    /// Page class for MTClothesSize
    /// </summary>
    public class MtClothesSizeView : MtClothesSizeViewBase
    {
        // Constructor
        public MtClothesSizeView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtClothesSizeView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtClothesSizeViewBase : MtClothesSize
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtClothesSizeView";
        ...
        // Page name
        public string PageName => "MtClothesSizeView";
        ...
        public void SetVisibility()
        {
            ...
            ShoulderSize.SetVisibility();
            LongSleeveSize.SetVisibility();
            FrontLengthSize.SetVisibility();
        ...
        // Constructor
        public MtClothesSizeViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtClothesSizeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtClothesSizeList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTClothesSizeview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
