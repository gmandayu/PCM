...
public partial class PCM {
    /// <summary>
    /// mtMedicalCertificateList
    /// </summary>
    public static MtMedicalCertificateList mtMedicalCertificateList
    {
        get => HttpData.Get<MtMedicalCertificateList>("mtMedicalCertificateList")!;
        set => HttpData["mtMedicalCertificateList"] = value;
    }

    /// <summary>
    /// Page class for MTMedicalCertificate
    /// </summary>
    public class MtMedicalCertificateList : MtMedicalCertificateListBase
    {
        // Constructor
        public MtMedicalCertificateList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtMedicalCertificateList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtMedicalCertificateListBase : MtMedicalCertificate
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "MTMedicalCertificate";

        // Page object name
        public string PageObjName = "mtMedicalCertificateList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMTMedicalCertificatelist";
        ...
        // Constructor
        public MtMedicalCertificateListBase()
        {
            // CSS class name as context
            TableVar = "MTMedicalCertificate";
            ...
            // Table object (mtMedicalCertificate)
            if (mtMedicalCertificate == null || mtMedicalCertificate is MtMedicalCertificate)
                mtMedicalCertificate = this;

            // Initialize URLs
            AddUrl = "MtMedicalCertificateAdd";
            ...
            MultiDeleteUrl = "MtMedicalCertificateDelete";
            MultiUpdateUrl = "MtMedicalCertificateUpdate";
        ...
        // Page name
        public string PageName => "MtMedicalCertificateList";
        ...
        // Constructor
        public MtMedicalCertificateListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "MtMedicalCertificateView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtMedicalCertificateList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(Enabled.AdvancedSearch.ToJson())); // Field Enabled
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Enabled
            if (filter?.TryGetValue("x_Enabled", out sv) ?? false) {
                Enabled.AdvancedSearch.SearchValue = sv;
                Enabled.AdvancedSearch.SearchOperator = filter["z_Enabled"];
                Enabled.AdvancedSearch.SearchCondition = filter["v_Enabled"];
                Enabled.AdvancedSearch.SearchValue2 = filter["y_Enabled"];
                Enabled.AdvancedSearch.SearchOperator2 = filter["w_Enabled"];
                Enabled.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, Enabled, def, true); // Enabled
            ...
            if (!def && Command == "search") {
                ...
                Enabled.AdvancedSearch.Save(); // Enabled
        ...
        public void ShowFilterList()
        {
            ...
            // Field Enabled
            filter = QueryBuilderWhere("Enabled");
            if (Empty(filter))
                BuildSearchSql(ref filter, Enabled, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Enabled.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        protected bool CheckSearchParms() {
            ...
            if (_Name.AdvancedSearch.IssetSession)
                return true;
            if (Enabled.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            Enabled.AdvancedSearch.UnsetSession();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Enabled, ctrl); // Enabled
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""MTMedicalCertificate"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""MTMedicalCertificate"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTMedicalCertificatelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMTMedicalCertificatelist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""MTMedicalCertificate"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Enabled")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fMTMedicalCertificatesrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fMTMedicalCertificatesrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fMTMedicalCertificatelist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_MTMedicalCertificate");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtMedicalCertificateList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtMedicalCertificateList.RowCount) + "_MTMedicalCertificate");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtMedicalCertificateList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtMedicalCertificateList.RowType == RowType.Add || IsEdit && mtMedicalCertificateList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            // Enabled
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Enabled[]"))
                    Enabled.AdvancedSearch.SearchValue = Get("x_Enabled[]");
                else
                    Enabled.AdvancedSearch.SearchValue = Get("Enabled"); // Default Value // DN
            if (!Empty(Enabled.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_Enabled"))
                Enabled.AdvancedSearch.SearchOperator = Get("z_Enabled");
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Enabled.SetDbValue((ConvertToBool(row["Enabled"]) ? "1" : "0"));
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Enabled", Enabled.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            // Enabled
            Enabled.CellCssStyle = "white-space: nowrap;";
            ...
            if (RowType == RowType.View) {
                ...
                // Enabled
                if (ConvertToBool(Enabled.CurrentValue)) {
                    Enabled.ViewValue = Enabled.TagCaption(1) != "" ? Enabled.TagCaption(1) : "Yes";
                } else {
                    Enabled.ViewValue = Enabled.TagCaption(2) != "" ? Enabled.TagCaption(2) : "No";
                }
                Enabled.ViewCustomAttributes = "";
                ...
                // Enabled
                if (Enabled.UseFilter && !Empty(Enabled.AdvancedSearch.SearchValue)) {
                    Enabled.EditValue = ConvertToString(Enabled.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fMTMedicalCertificatesrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"MTMedicalCertificate\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("MtMedicalCertificateSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("MtMedicalCertificateSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
