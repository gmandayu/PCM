...
public partial class PCM {
    /// <summary>
    /// mtCrewMedicalCertificateSearch
    /// </summary>
    public static MtCrewMedicalCertificateSearch mtCrewMedicalCertificateSearch
    {
        get => HttpData.Get<MtCrewMedicalCertificateSearch>("mtCrewMedicalCertificateSearch")!;
        set => HttpData["mtCrewMedicalCertificateSearch"] = value;
    }

    /// <summary>
    /// Page class for MTCrewMedicalCertificate
    /// </summary>
    public class MtCrewMedicalCertificateSearch : MtCrewMedicalCertificateSearchBase
    {
        // Constructor
        public MtCrewMedicalCertificateSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtCrewMedicalCertificateSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtCrewMedicalCertificateSearchBase : MtCrewMedicalCertificate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtCrewMedicalCertificateSearch";
        ...
        // Constructor
        public MtCrewMedicalCertificateSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtCrewMedicalCertificateSearch";
        ...
        // Constructor
        public MtCrewMedicalCertificateSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtCrewMedicalCertificateList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtCrewMedicalCertificateSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string BuildAdvancedSearch() {
            ...
            BuildSearchUrl(ref srchUrl, MTMedicalCertificateID); // MTMedicalCertificateID
            ...
            BuildSearchUrl(ref srchUrl, ExpirationDate); // ExpirationDate
        ...
        protected void LoadSearchValues() {
            ...
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_MTMedicalCertificateID"))
                    MTMedicalCertificateID.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_MTMedicalCertificateID");
            if (Form.ContainsKey("z_MTMedicalCertificateID"))
                MTMedicalCertificateID.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_MTMedicalCertificateID");
            ...
            // ExpirationDate
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_ExpirationDate"))
                    ExpirationDate.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_ExpirationDate");
            if (Form.ContainsKey("z_ExpirationDate"))
                ExpirationDate.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_ExpirationDate");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                curVal = ConvertToString(MTMedicalCertificateID.AdvancedSearch.SearchValue)?.Trim() ?? "";
                if (MTMedicalCertificateID.Lookup != null && IsDictionary(MTMedicalCertificateID.Lookup?.Options) && MTMedicalCertificateID.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    ...
                    if (curVal == "") {
                        ...
                        filterWrk = SearchFilter("[ID]", "=", MTMedicalCertificateID.AdvancedSearch.SearchValue, DataType.Number, "");
                    }
                    lookupFilter = () => MTMedicalCertificateID.GetSelectFilter();
                ...
                ExpirationDate.EditValue = FormatDateTime(UnformatDateTime(ExpirationDate.AdvancedSearch.SearchValue, ExpirationDate.FormatPattern), ExpirationDate.FormatPattern); // DN
        ...
        protected bool ValidateSearch() {
            ...
            if (!CheckDate(ConvertToString(ExpirationDate.AdvancedSearch.SearchValue), ExpirationDate.FormatPattern)) {
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MtCrewMedicalCertificateList")), "", TableVar, true);
