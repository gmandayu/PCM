...
public partial class PCM {
    /// <summary>
    /// crewFamilyForAdminEdit
    /// </summary>
    public static CrewFamilyForAdminEdit crewFamilyForAdminEdit
    {
        get => HttpData.Get<CrewFamilyForAdminEdit>("crewFamilyForAdminEdit")!;
        set => HttpData["crewFamilyForAdminEdit"] = value;
    }

    /// <summary>
    /// Page class for CrewFamilyForAdmin
    /// </summary>
    public class CrewFamilyForAdminEdit : CrewFamilyForAdminEditBase
    {
        // Constructor
        public CrewFamilyForAdminEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewFamilyForAdminEdit() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewFamilyForAdminAdd?crewID=" + ConvertToString(lastUpdatedFamilyCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewFamilyForAdminEditBase : CrewFamilyForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewFamilyForAdminEdit";
        ...
        // Constructor
        public CrewFamilyForAdminEditBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewFamilyForAdminEdit";
        ...
        // Constructor
        public CrewFamilyForAdminEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CrewFamilyForAdminList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewFamilyForAdminEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
