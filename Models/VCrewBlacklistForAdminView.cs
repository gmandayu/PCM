...
public partial class PCM {
    /// <summary>
    /// vCrewBlacklistForAdminView
    /// </summary>
    public static VCrewBlacklistForAdminView vCrewBlacklistForAdminView
    {
        get => HttpData.Get<VCrewBlacklistForAdminView>("vCrewBlacklistForAdminView")!;
        set => HttpData["vCrewBlacklistForAdminView"] = value;
    }

    /// <summary>
    /// Page class for v_CrewBlacklistForAdmin
    /// </summary>
    public class VCrewBlacklistForAdminView : VCrewBlacklistForAdminViewBase
    {
        // Constructor
        public VCrewBlacklistForAdminView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewBlacklistForAdminView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewBlacklistForAdminViewBase : VCrewBlacklistForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewBlacklistForAdminView";
        ...
        // Constructor
        public VCrewBlacklistForAdminViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewBlacklistForAdminView";
        ...
        // Constructor
        public VCrewBlacklistForAdminViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "VCrewBlacklistForAdminList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("VCrewBlacklistForAdminList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewBlacklistForAdminView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("VCrewBlacklistForAdminList")), "", TableVar, true);
            string pageId = "view";
