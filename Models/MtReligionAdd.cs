...
public partial class PCM {
    ...
    /// mtReligionAdd
    /// </summary>
    public static MtReligionAdd mtReligionAdd
    {
        get => HttpData.Get<MtReligionAdd>("mtReligionAdd")!;
        set => HttpData["mtReligionAdd"] = value;
    }

    /// <summary>
    /// Page class for MTReligion
    /// </summary>
    public class MtReligionAdd : MtReligionAddBase
    {
        // Constructor
        public MtReligionAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtReligionAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtReligionAddBase : MtReligion
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtReligionAdd";
        ...
        // Page name
        public string PageName => "MtReligionAdd";
        ...
        // Constructor
        public MtReligionAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtReligionList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "MtReligionList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "MtReligionView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MtReligionList") {
                                ...
                                returnUrl = "MtReligionList"; // Return list page content
                            }
                        }
