...
public partial class PCM {
    ...
    /// mtVesselTypeView
    /// </summary>
    public static MtVesselTypeView mtVesselTypeView
    {
        get => HttpData.Get<MtVesselTypeView>("mtVesselTypeView")!;
        set => HttpData["mtVesselTypeView"] = value;
    }

    /// <summary>
    /// Page class for MTVesselType
    /// </summary>
    public class MtVesselTypeView : MtVesselTypeViewBase
    {
        // Constructor
        public MtVesselTypeView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtVesselTypeView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtVesselTypeViewBase : MtVesselType
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtVesselTypeView";
        ...
        // Page name
        public string PageName => "MtVesselTypeView";
        ...
        // Constructor
        public MtVesselTypeViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtVesselTypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtVesselTypeList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fMTVesselTypeview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
