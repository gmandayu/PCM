...
public partial class PCM {
    /// <summary>
    /// crewMedicalCertificateForAdminViewModeDelete
    /// </summary>
    public static CrewMedicalCertificateForAdminViewModeDelete crewMedicalCertificateForAdminViewModeDelete
    {
        get => HttpData.Get<CrewMedicalCertificateForAdminViewModeDelete>("crewMedicalCertificateForAdminViewModeDelete")!;
        set => HttpData["crewMedicalCertificateForAdminViewModeDelete"] = value;
    }

    /// <summary>
    /// Page class for CrewMedicalCertificateForAdminViewMode
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeDelete : CrewMedicalCertificateForAdminViewModeDeleteBase
    {
        // Constructor
        public CrewMedicalCertificateForAdminViewModeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewMedicalCertificateForAdminViewModeDelete() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            //url = newurl;
            int lastDeletedMedicalCertificateCrewID = Session.GetInt("lastDeletedMedicalCertificateCrewID");
            Session.Remove("lastDeletedMedicalCertificateCrewID");
            url = "CrewMedicalCertificateForAdminViewModeList?crewID=" + ConvertToString(lastDeletedMedicalCertificateCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewMedicalCertificateForAdminViewModeDeleteBase : CrewMedicalCertificateForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewMedicalCertificateForAdminViewModeDelete";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "CrewMedicalCertificateForAdminViewModeDelete";
        ...
        // Constructor
        public CrewMedicalCertificateForAdminViewModeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CrewMedicalCertificateForAdminViewModeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CrewMedicalCertificateForAdminViewModeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewMedicalCertificateForAdminViewModeDelete?.PageRender();
            }
            return PageResult();
        }
