...
public partial class PCM {
    ...
    /// </summary>
    [MaybeNull]
    public static MtCrewAppraisal mtCrewAppraisal
    {
        get => HttpData.Resolve<MtCrewAppraisal>("MTCrewAppraisal");
        set => HttpData["MTCrewAppraisal"] = value;
    }

    /// <summary>
    /// Table class for MTCrewAppraisal
    /// </summary>
    public class MtCrewAppraisal : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public MtCrewAppraisal()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MTCrewAppraisal";
            Name = "MTCrewAppraisal";
            Type = "TABLE";
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            MTCrewID = new (this, "x_MTCrewID", 3, SqlDbType.Int) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "MTCrewID", "CustomMsg"),
                IsUpload = false
            };
            ...
            VesselName = new (this, "x_VesselName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "VesselName", "CustomMsg"),
                IsUpload = false
            };
            VesselName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("VesselName", "MTCrewAppraisal", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("VesselName", "MTCrewAppraisal", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("VesselName", "MTCrewAppraisal", true, "VesselName", new List<string> {"VesselName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTRankID = new (this, "x_MTRankID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "MTRankID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Questionnaire = new (this, "x_Questionnaire", 202, SqlDbType.NVarChar) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = "[Questionnaire]",
                DateTimeFormat = -1,
                VirtualExpression = "[Questionnaire]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "Questionnaire", "CustomMsg"),
                IsUpload = false
            };
            Questionnaire.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Questionnaire", "MTCrewAppraisal", true, "Questionnaire", new List<string> {"Questionnaire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Questionnaire", "MTCrewAppraisal", true, "Questionnaire", new List<string> {"Questionnaire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Questionnaire", "MTCrewAppraisal", true, "Questionnaire", new List<string> {"Questionnaire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Approved = new (this, "x_Approved", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "Approved", "CustomMsg"),
                IsUpload = false
            };
            Approved.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Approved", "MTCrewAppraisal", true, "Approved", new List<string> {"Approved", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Approved", "MTCrewAppraisal", true, "Approved", new List<string> {"Approved", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Approved", "MTCrewAppraisal", true, "Approved", new List<string> {"Approved", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            AverageRating = new (this, "x_AverageRating", 131, SqlDbType.Decimal) {
                ...
                BasicSearchExpression = "CAST([AverageRating] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[AverageRating]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "AverageRating", "CustomMsg"),
                IsUpload = false
            };
            AverageRating.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("AverageRating", "MTCrewAppraisal", true, "AverageRating", new List<string> {"AverageRating", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("AverageRating", "MTCrewAppraisal", true, "AverageRating", new List<string> {"AverageRating", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("AverageRating", "MTCrewAppraisal", true, "AverageRating", new List<string> {"AverageRating", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Rehire = new (this, "x_Rehire", 11, SqlDbType.Bit) {
                ...
                Expression = "[Rehire]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Rehire]",
                DateTimeFormat = -1,
                VirtualExpression = "[Rehire]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "Rehire", "CustomMsg"),
                IsUpload = false
            };
            Rehire.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Rehire", "MTCrewAppraisal", true, "Rehire", new List<string> {"Rehire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Rehire", "MTCrewAppraisal", true, "Rehire", new List<string> {"Rehire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Rehire", "MTCrewAppraisal", true, "Rehire", new List<string> {"Rehire", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Promote = new (this, "x_Promote", 11, SqlDbType.Bit) {
                ...
                Expression = "[Promote]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Promote]",
                DateTimeFormat = -1,
                VirtualExpression = "[Promote]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "Promote", "CustomMsg"),
                IsUpload = false
            };
            Promote.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Promote", "MTCrewAppraisal", true, "Promote", new List<string> {"Promote", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Promote", "MTCrewAppraisal", true, "Promote", new List<string> {"Promote", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Promote", "MTCrewAppraisal", true, "Promote", new List<string> {"Promote", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Appraiser = new (this, "x_Appraiser", 202, SqlDbType.NVarChar) {
                Name = "Appraiser",
                Expression = "[Appraiser]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Appraiser]",
                DateTimeFormat = -1,
                VirtualExpression = "[Appraiser]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "Appraiser", "CustomMsg"),
                IsUpload = false
            };
            Appraiser.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("Appraiser", "MTCrewAppraisal", true, "Appraiser", new List<string> {"Appraiser", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("Appraiser", "MTCrewAppraisal", true, "Appraiser", new List<string> {"Appraiser", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("Appraiser", "MTCrewAppraisal", true, "Appraiser", new List<string> {"Appraiser", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Appraiser", Appraiser);

            // DateInput
            DateInput = new (this, "x_DateInput", 133, SqlDbType.DateTime) {
                Name = "DateInput",
                Expression = "[DateInput]",
                BasicSearchExpression = CastDateFieldForLike("[DateInput]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[DateInput]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "DateInput", "CustomMsg"),
                IsUpload = false
            };
            DateInput.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("DateInput", "MTCrewAppraisal", true, "DateInput", new List<string> {"DateInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("DateInput", "MTCrewAppraisal", true, "DateInput", new List<string> {"DateInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("DateInput", "MTCrewAppraisal", true, "DateInput", new List<string> {"DateInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            MTUserID = new (this, "x_MTUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "MTUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            ActiveDescription = new (this, "x_ActiveDescription", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "ActiveDescription", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            CreatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("CreatedDateTime", "MTCrewAppraisal", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("CreatedDateTime", "MTCrewAppraisal", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("CreatedDateTime", "MTCrewAppraisal", true, "CreatedDateTime", new List<string> {"CreatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            LastUpdatedByUserID = new (this, "x_LastUpdatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "LastUpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDateTime = new (this, "x_LastUpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("MTCrewAppraisal", "LastUpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDateTime.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewAppraisal", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewAppraisal", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>("LastUpdatedDateTime", "MTCrewAppraisal", true, "LastUpdatedDateTime", new List<string> {"LastUpdatedDateTime", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
        ...
        {
            if (SameString(pageName, "MtCrewAppraisalView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtCrewAppraisalEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtCrewAppraisalAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtCrewAppraisalView",
                Config.ApiAddAction => "MtCrewAppraisalAdd",
                Config.ApiEditAction => "MtCrewAppraisalEdit",
                Config.ApiDeleteAction => "MtCrewAppraisalDelete",
                Config.ApiListAction => "MtCrewAppraisalList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtCrewAppraisalList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtCrewAppraisalView", parm);
            else
                url = KeyUrl("MtCrewAppraisalView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtCrewAppraisalAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtCrewAppraisalAdd?" + parm;
            else
                url = "MtCrewAppraisalAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewAppraisalEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewAppraisalList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtCrewAppraisalAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtCrewAppraisalList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtCrewAppraisalDelete")); // DN
        ...
        {
            string pageName = "MtCrewAppraisalList";
