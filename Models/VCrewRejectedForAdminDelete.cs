...
public partial class PCM {
    /// <summary>
    /// vCrewRejectedForAdminDelete
    /// </summary>
    public static VCrewRejectedForAdminDelete vCrewRejectedForAdminDelete
    {
        get => HttpData.Get<VCrewRejectedForAdminDelete>("vCrewRejectedForAdminDelete")!;
        set => HttpData["vCrewRejectedForAdminDelete"] = value;
    }

    /// <summary>
    /// Page class for v_CrewRejectedForAdmin
    /// </summary>
    public class VCrewRejectedForAdminDelete : VCrewRejectedForAdminDeleteBase
    {
        // Constructor
        public VCrewRejectedForAdminDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VCrewRejectedForAdminDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VCrewRejectedForAdminDeleteBase : VCrewRejectedForAdmin
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vCrewRejectedForAdminDelete";
        ...
        // Constructor
        public VCrewRejectedForAdminDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "VCrewRejectedForAdminDelete";
        ...
        // Constructor
        public VCrewRejectedForAdminDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("VCrewRejectedForAdminList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("VCrewRejectedForAdminList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vCrewRejectedForAdminDelete?.PageRender();
            }
            return PageResult();
        }
