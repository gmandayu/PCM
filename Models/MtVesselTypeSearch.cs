...
public partial class PCM {
    ...
    /// mtVesselTypeSearch
    /// </summary>
    public static MtVesselTypeSearch mtVesselTypeSearch
    {
        get => HttpData.Get<MtVesselTypeSearch>("mtVesselTypeSearch")!;
        set => HttpData["mtVesselTypeSearch"] = value;
    }

    /// <summary>
    /// Page class for MTVesselType
    /// </summary>
    public class MtVesselTypeSearch : MtVesselTypeSearchBase
    {
        // Constructor
        public MtVesselTypeSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtVesselTypeSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtVesselTypeSearchBase : MtVesselType
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtVesselTypeSearch";
        ...
        // Page name
        public string PageName => "MtVesselTypeSearch";
        ...
        // Constructor
        public MtVesselTypeSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "MtVesselTypeList?" + srchStr;
        ...
        protected string BuildAdvancedSearch() {
            string srchUrl = "";
            BuildSearchUrl(ref srchUrl, Abbreviation); // Abbreviation
        ...
        protected void LoadSearchValues() {
            // Abbreviation
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_Abbreviation"))
                    Abbreviation.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_Abbreviation");
            if (Form.ContainsKey("z_Abbreviation"))
                Abbreviation.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_Abbreviation");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!Abbreviation.Raw)
                    Abbreviation.AdvancedSearch.SearchValue = HtmlDecode(Abbreviation.AdvancedSearch.SearchValue);
                Abbreviation.EditValue = HtmlEncode(Abbreviation.AdvancedSearch.SearchValue);
