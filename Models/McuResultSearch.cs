...
public partial class PCM {
    ...
    /// mcuResultSearch
    /// </summary>
    public static McuResultSearch mcuResultSearch
    {
        get => HttpData.Get<McuResultSearch>("mcuResultSearch")!;
        set => HttpData["mcuResultSearch"] = value;
    }

    /// <summary>
    /// Page class for McuResult
    /// </summary>
    public class McuResultSearch : McuResultSearchBase
    {
        // Constructor
        public McuResultSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public McuResultSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class McuResultSearchBase : McuResult
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mcuResultSearch";
        ...
        // Page name
        public string PageName => "McuResultSearch";
        ...
        // Constructor
        public McuResultSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!HealthStatus.Raw)
                    HealthStatus.AdvancedSearch.SearchValue = HtmlDecode(HealthStatus.AdvancedSearch.SearchValue);
                HealthStatus.EditValue = HtmlEncode(HealthStatus.AdvancedSearch.SearchValue);
