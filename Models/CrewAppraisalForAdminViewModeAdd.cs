...
public partial class PCM {
    /// <summary>
    /// crewAppraisalForAdminViewModeAdd
    /// </summary>
    public static CrewAppraisalForAdminViewModeAdd crewAppraisalForAdminViewModeAdd
    {
        get => HttpData.Get<CrewAppraisalForAdminViewModeAdd>("crewAppraisalForAdminViewModeAdd")!;
        set => HttpData["crewAppraisalForAdminViewModeAdd"] = value;
    }

    /// <summary>
    /// Page class for CrewAppraisalForAdminViewMode
    /// </summary>
    public class CrewAppraisalForAdminViewModeAdd : CrewAppraisalForAdminViewModeAddBase
    {
        // Constructor
        public CrewAppraisalForAdminViewModeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CrewAppraisalForAdminViewModeAdd() : base()
        {
        }
        ...
        public override void PageRedirecting(ref string url) {
            ...
            url = "CrewAppraisalForAdminViewModeList?crewID=" + ConvertToString(lastAddedAppraisalCrewID);
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CrewAppraisalForAdminViewModeAddBase : CrewAppraisalForAdminViewMode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "crewAppraisalForAdminViewModeAdd";
        ...
        // Constructor
        public CrewAppraisalForAdminViewModeAddBase()
        {
            // Custom template // DN
        ...
        // Page name
        public string PageName => "CrewAppraisalForAdminViewModeAdd";
        ...
        // Constructor
        public CrewAppraisalForAdminViewModeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CrewAppraisalForAdminViewModeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "CrewAppraisalForAdminViewModeView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                crewAppraisalForAdminViewModeAdd?.PageRender();
            }
            return PageResult();
        }
