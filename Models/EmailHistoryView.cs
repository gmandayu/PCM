...
public partial class PCM {
    ...
    /// emailHistoryView
    /// </summary>
    public static EmailHistoryView emailHistoryView
    {
        get => HttpData.Get<EmailHistoryView>("emailHistoryView")!;
        set => HttpData["emailHistoryView"] = value;
    }

    /// <summary>
    /// Page class for EmailHistory
    /// </summary>
    public class EmailHistoryView : EmailHistoryViewBase
    {
        // Constructor
        public EmailHistoryView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public EmailHistoryView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class EmailHistoryViewBase : EmailHistory
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "emailHistoryView";
        ...
        // Page name
        public string PageName => "EmailHistoryView";
        ...
        // Constructor
        public EmailHistoryViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "EmailHistoryList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("EmailHistoryList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fEmailHistoryview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
