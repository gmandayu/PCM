...
public partial class PCM {
    ...
    /// mtRankDelete
    /// </summary>
    public static MtRankDelete mtRankDelete
    {
        get => HttpData.Get<MtRankDelete>("mtRankDelete")!;
        set => HttpData["mtRankDelete"] = value;
    }

    /// <summary>
    /// Page class for MTRank
    /// </summary>
    public class MtRankDelete : MtRankDeleteBase
    {
        // Constructor
        public MtRankDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRankDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRankDeleteBase : MtRank
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRankDelete";
        ...
        // Page name
        public string PageName => "MtRankDelete";
        ...
        // Constructor
        public MtRankDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtRankList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtRankList"); // Return to list
                }
            }
