...
public partial class PCM {
    /// <summary>
    /// mtRecruitmentStatusTrackingView
    /// </summary>
    public static MtRecruitmentStatusTrackingView mtRecruitmentStatusTrackingView
    {
        get => HttpData.Get<MtRecruitmentStatusTrackingView>("mtRecruitmentStatusTrackingView")!;
        set => HttpData["mtRecruitmentStatusTrackingView"] = value;
    }

    /// <summary>
    /// Page class for MTRecruitmentStatusTracking
    /// </summary>
    public class MtRecruitmentStatusTrackingView : MtRecruitmentStatusTrackingViewBase
    {
        // Constructor
        public MtRecruitmentStatusTrackingView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtRecruitmentStatusTrackingView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtRecruitmentStatusTrackingViewBase : MtRecruitmentStatusTracking
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtRecruitmentStatusTrackingView";
        ...
        // Constructor
        public MtRecruitmentStatusTrackingViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtRecruitmentStatusTrackingView";
        ...
        // Constructor
        public MtRecruitmentStatusTrackingViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtRecruitmentStatusTrackingList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtRecruitmentStatusTrackingList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtRecruitmentStatusTrackingView?.PageRender();
            }
            return PageResult();
        }
